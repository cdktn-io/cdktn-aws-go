// cdk-terrain bindings for the DRS (Elastic Disaster Recovery) group of terraform-provider-aws 6.62.0
package drs
...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AwsReplicationConfigurationTemplate)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/aws-drs.AwsReplicationConfigurationTemplate.PitPolicyProperty",
		reflect.TypeOf((*AwsReplicationConfigurationTemplate_PitPolicyProperty)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/aws-drs.AwsReplicationConfigurationTemplate.PitPolicyPropertyList",
		reflect.TypeOf((*AwsReplicationConfigurationTemplate_PitPolicyPropertyList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AwsReplicationConfigurationTemplate_PitPolicyPropertyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/aws-drs.AwsReplicationConfigurationTemplate.TimeoutsProperty",
		reflect.TypeOf((*AwsReplicationConfigurationTemplate_TimeoutsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/aws-drs.AwsReplicationConfigurationTemplate.TimeoutsPropertyOutputReference",
		reflect.TypeOf((*AwsReplicationConfigurationTemplate_TimeoutsPropertyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/aws-drs.AwsReplicationConfigurationTemplateConfig",
		reflect.TypeOf((*AwsReplicationConfigurationTemplateConfig)(nil)).Elem(),
	)
}
