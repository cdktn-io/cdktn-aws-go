...
// Experimental.
type AwsSsmResourceDataSync_S3DestinationProperty struct {
	...
	// Experimental.
	DestinationDataSharing *AwsSsmResourceDataSync_DestinationDataSharingProperty `field:"optional" json:"destinationDataSharing" yaml:"destinationDataSharing"`
