...
type DataAwsSsmInstances interface {
	...
	// Experimental.
	Filter() DataAwsSsmInstances_FilterPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsSsmInstances) Filter() DataAwsSsmInstances_FilterPropertyList {
	var returns DataAwsSsmInstances_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
