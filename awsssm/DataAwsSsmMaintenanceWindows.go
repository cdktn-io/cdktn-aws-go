...
type DataAwsSsmMaintenanceWindows interface {
	...
	// Experimental.
	Filter() DataAwsSsmMaintenanceWindows_FilterPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsSsmMaintenanceWindows) Filter() DataAwsSsmMaintenanceWindows_FilterPropertyList {
	var returns DataAwsSsmMaintenanceWindows_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
