...
// Experimental.
type AwsSsmMaintenanceWindowTaskConfig struct {
	// Experimental.
	...
	// Experimental.
	TaskInvocationParameters *AwsSsmMaintenanceWindowTask_TaskInvocationParametersProperty `field:"optional" json:"taskInvocationParameters" yaml:"taskInvocationParameters"`
}
