...
type DataAwsSsmPatchBaseline interface {
	...
	// Experimental.
	ApprovalRule() DataAwsSsmPatchBaseline_ApprovalRulePropertyList
	// Experimental.
	...
	// Experimental.
	GlobalFilter() DataAwsSsmPatchBaseline_GlobalFilterPropertyList
	// Experimental.
	Id() *string
	// Experimental.
	SetId(val *string)
	...
	// Experimental.
	Source() DataAwsSsmPatchBaseline_SourcePropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsSsmPatchBaseline) ApprovalRule() DataAwsSsmPatchBaseline_ApprovalRulePropertyList {
	var returns DataAwsSsmPatchBaseline_ApprovalRulePropertyList
	_jsii_.Get(
		j,
		"approvalRule",
		&returns,
...
func (j *jsiiProxy_DataAwsSsmPatchBaseline) GlobalFilter() DataAwsSsmPatchBaseline_GlobalFilterPropertyList {
	var returns DataAwsSsmPatchBaseline_GlobalFilterPropertyList
	_jsii_.Get(
		j,
		"globalFilter",
		&returns,
...
func (j *jsiiProxy_DataAwsSsmPatchBaseline) Source() DataAwsSsmPatchBaseline_SourcePropertyList {
	var returns DataAwsSsmPatchBaseline_SourcePropertyList
	_jsii_.Get(
		j,
		"source",
		&returns,
