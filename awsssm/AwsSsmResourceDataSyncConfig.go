...
// Experimental.
type AwsSsmResourceDataSyncConfig struct {
	// Experimental.
	...
	// Experimental.
	S3Destination *AwsSsmResourceDataSync_S3DestinationProperty `field:"required" json:"s3Destination" yaml:"s3Destination"`
