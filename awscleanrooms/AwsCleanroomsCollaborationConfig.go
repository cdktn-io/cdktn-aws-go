...
// Experimental.
type AwsCleanroomsCollaborationConfig struct {
	// Experimental.
	...
	// Experimental.
	DataEncryptionMetadata *AwsCleanroomsCollaboration_DataEncryptionMetadataProperty `field:"optional" json:"dataEncryptionMetadata" yaml:"dataEncryptionMetadata"`
	// member block.
	//
	...
	// Experimental.
	Timeouts *AwsCleanroomsCollaboration_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
