...
// Experimental.
type TfConfiguredTableConfig struct {
	// Experimental.
	...
	// Experimental.
	TableReference *TfConfiguredTable_TableReferenceProperty `field:"required" json:"tableReference" yaml:"tableReference"`
	...
	// Experimental.
	Timeouts *TfConfiguredTable_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
