...
func (j *jsiiProxy_AwsDataSource_S3ConfigurationPropertyOutputReference) BucketArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketArn",
...
func (j *jsiiProxy_AwsDataSource_S3ConfigurationPropertyOutputReference) BucketArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketArnInput",
...
func (j *jsiiProxy_AwsDataSource_S3ConfigurationPropertyOutputReference) BucketOwnerAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsDataSource_S3ConfigurationPropertyOutputReference) BucketOwnerAccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsDataSource_S3ConfigurationPropertyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
// Experimental.
func NewAwsDataSource_S3ConfigurationPropertyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) AwsDataSource_S3ConfigurationPropertyOutputReference {
	_init_.Initialize()

	if err := validateNewAwsDataSource_S3ConfigurationPropertyOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_AwsDataSource_S3ConfigurationPropertyOutputReference{}

	_jsii_.Create(
		"@cdktn/aws-bedrock-agents.AwsDataSource.S3ConfigurationPropertyOutputReference",
...
// Experimental.
func NewAwsDataSource_S3ConfigurationPropertyOutputReference_Override(a AwsDataSource_S3ConfigurationPropertyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AwsDataSource_S3ConfigurationPropertyOutputReference)SetBucketArn(val *string) {
...
func (j *jsiiProxy_AwsDataSource_S3ConfigurationPropertyOutputReference)SetBucketOwnerAccountId(val *string) {
...
func (j *jsiiProxy_AwsDataSource_S3ConfigurationPropertyOutputReference)SetInternalValue(val interface{}) {
...
func (a *jsiiProxy_AwsDataSource_S3ConfigurationPropertyOutputReference) ResetBucketOwnerAccountId() {
	_jsii_.InvokeVoid(
		a,
		"resetBucketOwnerAccountId",
		nil, // no parameters
