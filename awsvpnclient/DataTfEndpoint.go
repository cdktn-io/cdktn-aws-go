...
type DataTfEndpoint interface {
	...
	Arn() *string
	// Experimental.
	AuthenticationOptions() DataTfEndpoint_AuthenticationOptionsPropertyList
	// Experimental.
	CdktfStack() cdktn.TerraformStack
	// Experimental.
	ClientCidrBlock() *string
	// Experimental.
	ClientConnectOptions() DataTfEndpoint_ClientConnectOptionsPropertyList
	// Experimental.
	ClientLoginBannerOptions() DataTfEndpoint_ClientLoginBannerOptionsPropertyList
	// Experimental.
	ClientRouteEnforcementOptions() DataTfEndpoint_ClientRouteEnforcementOptionsPropertyList
	// Experimental.
	...
	// Experimental.
	ConnectionLogOptions() DataTfEndpoint_ConnectionLogOptionsPropertyList
	// Experimental.
	...
	// Experimental.
	Filter() DataTfEndpoint_FilterPropertyList
	// Experimental.
	...
	// Experimental.
	Timeouts() DataTfEndpoint_TimeoutsPropertyOutputReference
	// Experimental.
	TimeoutsInput() interface{}
	// Experimental.
	TrafficIpAddressType() *string
	// Experimental.
	TransitGatewayConfiguration() DataTfEndpoint_TransitGatewayConfigurationPropertyList
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataTfEndpoint_TimeoutsProperty)
...
func (j *jsiiProxy_DataTfEndpoint) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_DataTfEndpoint) AuthenticationOptions() DataTfEndpoint_AuthenticationOptionsPropertyList {
	var returns DataTfEndpoint_AuthenticationOptionsPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataTfEndpoint) ClientCidrBlock() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clientCidrBlock",
...
func (j *jsiiProxy_DataTfEndpoint) ClientConnectOptions() DataTfEndpoint_ClientConnectOptionsPropertyList {
	var returns DataTfEndpoint_ClientConnectOptionsPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataTfEndpoint) ClientLoginBannerOptions() DataTfEndpoint_ClientLoginBannerOptionsPropertyList {
	var returns DataTfEndpoint_ClientLoginBannerOptionsPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataTfEndpoint) ClientRouteEnforcementOptions() DataTfEndpoint_ClientRouteEnforcementOptionsPropertyList {
	var returns DataTfEndpoint_ClientRouteEnforcementOptionsPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataTfEndpoint) ClientVpnEndpointId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clientVpnEndpointId",
...
func (j *jsiiProxy_DataTfEndpoint) ClientVpnEndpointIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataTfEndpoint) ConnectionLogOptions() DataTfEndpoint_ConnectionLogOptionsPropertyList {
	var returns DataTfEndpoint_ConnectionLogOptionsPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataTfEndpoint) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DataTfEndpoint) DnsName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dnsName",
...
func (j *jsiiProxy_DataTfEndpoint) DnsServers() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dnsServers",
...
func (j *jsiiProxy_DataTfEndpoint) EndpointIpAddressType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataTfEndpoint) Filter() DataTfEndpoint_FilterPropertyList {
	var returns DataTfEndpoint_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataTfEndpoint) FilterInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"filterInput",
...
func (j *jsiiProxy_DataTfEndpoint) SecurityGroupIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"securityGroupIds",
...
func (j *jsiiProxy_DataTfEndpoint) SelfServicePortal() *string {
	var returns *string
	_jsii_.Get(
		j,
		"selfServicePortal",
...
func (j *jsiiProxy_DataTfEndpoint) SelfServicePortalUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataTfEndpoint) ServerCertificateArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataTfEndpoint) SessionTimeoutHours() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"sessionTimeoutHours",
...
func (j *jsiiProxy_DataTfEndpoint) SplitTunnel() cdktn.IResolvable {
...
func (j *jsiiProxy_DataTfEndpoint) Timeouts() DataTfEndpoint_TimeoutsPropertyOutputReference {
	var returns DataTfEndpoint_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_DataTfEndpoint) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
func (j *jsiiProxy_DataTfEndpoint) TrafficIpAddressType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataTfEndpoint) TransitGatewayConfiguration() DataTfEndpoint_TransitGatewayConfigurationPropertyList {
	var returns DataTfEndpoint_TransitGatewayConfigurationPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataTfEndpoint) TransportProtocol() *string {
	var returns *string
	_jsii_.Get(
		j,
		"transportProtocol",
...
func (j *jsiiProxy_DataTfEndpoint) VpcId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcId",
...
func (j *jsiiProxy_DataTfEndpoint) VpnPort() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"vpnPort",
...
func (j *jsiiProxy_DataTfEndpoint)SetClientVpnEndpointId(val *string) {
...
func (d *jsiiProxy_DataTfEndpoint) PutFilter(value interface{}) {
...
func (d *jsiiProxy_DataTfEndpoint) PutTimeouts(value *DataTfEndpoint_TimeoutsProperty) {
...
func (d *jsiiProxy_DataTfEndpoint) ResetClientVpnEndpointId() {
	_jsii_.InvokeVoid(
		d,
		"resetClientVpnEndpointId",
		nil, // no parameters
...
func (d *jsiiProxy_DataTfEndpoint) ResetFilter() {
	_jsii_.InvokeVoid(
		d,
		"resetFilter",
		nil, // no parameters
...
func (d *jsiiProxy_DataTfEndpoint) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
