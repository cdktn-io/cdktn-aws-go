...
// Experimental.
type AwsMedialiveInputConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsMedialiveInput_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
	// vpc block.
	//
	...
	// Experimental.
	Vpc *AwsMedialiveInput_VpcProperty `field:"optional" json:"vpc" yaml:"vpc"`
}
