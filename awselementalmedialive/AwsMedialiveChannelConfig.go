...
// Experimental.
type AwsMedialiveChannelConfig struct {
	// Experimental.
	...
	// Experimental.
	EncoderSettings *AwsMedialiveChannel_EncoderSettingsProperty `field:"required" json:"encoderSettings" yaml:"encoderSettings"`
	...
	// Experimental.
	InputSpecification *AwsMedialiveChannel_InputSpecificationProperty `field:"required" json:"inputSpecification" yaml:"inputSpecification"`
	...
	// Experimental.
	CdiInputSpecification *AwsMedialiveChannel_CdiInputSpecificationProperty `field:"optional" json:"cdiInputSpecification" yaml:"cdiInputSpecification"`
	...
	// Experimental.
	Maintenance *AwsMedialiveChannel_MaintenanceProperty `field:"optional" json:"maintenance" yaml:"maintenance"`
	...
	// Experimental.
	Timeouts *AwsMedialiveChannel_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
	// vpc block.
	//
	...
	// Experimental.
	Vpc *AwsMedialiveChannel_VpcProperty `field:"optional" json:"vpc" yaml:"vpc"`
}
