...
// Experimental.
type AwsMedialiveChannel_HlsGroupSettingsProperty struct {
	// destination block.
	//
	...
	// Experimental.
	Destination *AwsMedialiveChannel_EncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsDestinationProperty `field:"required" json:"destination" yaml:"destination"`
	...
	// Experimental.
	KeyProviderSettings *AwsMedialiveChannel_KeyProviderSettingsProperty `field:"optional" json:"keyProviderSettings" yaml:"keyProviderSettings"`
