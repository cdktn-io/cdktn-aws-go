...
// Experimental.
type AwsMedialiveChannel_NielsenWatermarksSettingsProperty struct {
	...
	// Experimental.
	NielsenCbetSettings *AwsMedialiveChannel_NielsenCbetSettingsProperty `field:"optional" json:"nielsenCbetSettings" yaml:"nielsenCbetSettings"`
