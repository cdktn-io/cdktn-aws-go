...
// Experimental.
type TfChannel_DestinationsProperty struct {
	...
	// Experimental.
	MultiplexSettings *TfChannel_MultiplexSettingsProperty `field:"optional" json:"multiplexSettings" yaml:"multiplexSettings"`
	// settings block.
	//
