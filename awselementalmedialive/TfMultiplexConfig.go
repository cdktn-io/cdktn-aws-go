...
type TfMultiplexConfig struct {
	...
	// Experimental.
	MultiplexSettings *TfMultiplex_MultiplexSettingsProperty `field:"optional" json:"multiplexSettings" yaml:"multiplexSettings"`
	...
	// Experimental.
	Timeouts *TfMultiplex_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
