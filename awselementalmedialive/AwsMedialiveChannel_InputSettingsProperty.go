...
// Experimental.
type AwsMedialiveChannel_InputSettingsProperty struct {
	...
	// Experimental.
	NetworkInputSettings *AwsMedialiveChannel_NetworkInputSettingsProperty `field:"optional" json:"networkInputSettings" yaml:"networkInputSettings"`
	...
	// Experimental.
	VideoSelector *AwsMedialiveChannel_VideoSelectorProperty `field:"optional" json:"videoSelector" yaml:"videoSelector"`
}
