...
// Experimental.
type AwsMedialiveChannel_AudioSelectorProperty struct {
	...
	// Experimental.
	SelectorSettings *AwsMedialiveChannel_InputAttachmentsInputSettingsAudioSelectorSelectorSettingsProperty `field:"optional" json:"selectorSettings" yaml:"selectorSettings"`
}
