...
// Experimental.
type TfChannel_BurnInDestinationSettingsProperty struct {
	...
	// Experimental.
	Font *TfChannel_EncoderSettingsCaptionDescriptionsDestinationSettingsBurnInDestinationSettingsFontProperty `field:"optional" json:"font" yaml:"font"`
