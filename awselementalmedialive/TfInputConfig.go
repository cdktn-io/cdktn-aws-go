...
type TfInputConfig struct {
	...
	// Experimental.
	Timeouts *TfInput_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
	// vpc block.
	//
	...
	// Experimental.
	Vpc *TfInput_VpcProperty `field:"optional" json:"vpc" yaml:"vpc"`
}
