...
func (t *jsiiProxy_TfCluster) validatePutBootstrapActionParameters(value interface{}) error {
	...
	case *[]*TfCluster_BootstrapActionProperty:
		value := value.(*[]*TfCluster_BootstrapActionProperty)
	...
	case []*TfCluster_BootstrapActionProperty:
		value_ := value.([]*TfCluster_BootstrapActionProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*TfCluster_BootstrapActionProperty; received %#v (a %T)", value, value)
		}
	}
...
func (t *jsiiProxy_TfCluster) validatePutPlacementGroupConfigParameters(value interface{}) error {
	...
	case *[]*TfCluster_PlacementGroupConfigProperty:
		value := value.(*[]*TfCluster_PlacementGroupConfigProperty)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*TfCluster_PlacementGroupConfigProperty:
		value_ := value.([]*TfCluster_PlacementGroupConfigProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*TfCluster_PlacementGroupConfigProperty; received %#v (a %T)", value, value)
		}
	}
...
func (t *jsiiProxy_TfCluster) validatePutStepParameters(value interface{}) error {
	...
	case *[]*TfCluster_StepProperty:
		value := value.(*[]*TfCluster_StepProperty)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*TfCluster_StepProperty:
		value_ := value.([]*TfCluster_StepProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*TfCluster_StepProperty; received %#v (a %T)", value, value)
		}
	}
