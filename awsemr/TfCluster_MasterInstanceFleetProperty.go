...
// Experimental.
type TfCluster_MasterInstanceFleetProperty struct {
	...
	// Experimental.
	LaunchSpecifications *TfCluster_MasterInstanceFleetLaunchSpecificationsProperty `field:"optional" json:"launchSpecifications" yaml:"launchSpecifications"`
