...
// Experimental.
type AwsEmrCluster_CoreInstanceFleetProperty struct {
	...
	// Experimental.
	LaunchSpecifications *AwsEmrCluster_CoreInstanceFleetLaunchSpecificationsProperty `field:"optional" json:"launchSpecifications" yaml:"launchSpecifications"`
