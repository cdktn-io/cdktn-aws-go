...
type DataAwsEmrReleaseLabels interface {
	...
	// Experimental.
	Filters() DataAwsEmrReleaseLabels_FiltersPropertyOutputReference
	// Experimental.
	FiltersInput() *DataAwsEmrReleaseLabels_FiltersProperty
	// Experimental.
	...
	// Experimental.
	PutFilters(value *DataAwsEmrReleaseLabels_FiltersProperty)
...
func (j *jsiiProxy_DataAwsEmrReleaseLabels) Filters() DataAwsEmrReleaseLabels_FiltersPropertyOutputReference {
	var returns DataAwsEmrReleaseLabels_FiltersPropertyOutputReference
	_jsii_.Get(
		j,
		"filters",
		&returns,
...
func (j *jsiiProxy_DataAwsEmrReleaseLabels) FiltersInput() *DataAwsEmrReleaseLabels_FiltersProperty {
...
func (d *jsiiProxy_DataAwsEmrReleaseLabels) PutFilters(value *DataAwsEmrReleaseLabels_FiltersProperty) {
