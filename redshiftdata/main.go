// cdk-terrain bindings for the Redshift Data group of terraform-provider-aws 6.62.0
...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/aws-redshift-data.AwsStatement",
		reflect.TypeOf((*AwsStatement)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_AwsStatement{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktn/aws-redshift-data.AwsStatement.ParametersProperty",
		reflect.TypeOf((*AwsStatement_ParametersProperty)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/aws-redshift-data.AwsStatement.ParametersPropertyList",
		reflect.TypeOf((*AwsStatement_ParametersPropertyList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AwsStatement_ParametersPropertyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/aws-redshift-data.AwsStatement.TimeoutsProperty",
		reflect.TypeOf((*AwsStatement_TimeoutsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/aws-redshift-data.AwsStatement.TimeoutsPropertyOutputReference",
		reflect.TypeOf((*AwsStatement_TimeoutsPropertyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/aws-redshift-data.AwsStatementConfig",
		reflect.TypeOf((*AwsStatementConfig)(nil)).Elem(),
	)
}
