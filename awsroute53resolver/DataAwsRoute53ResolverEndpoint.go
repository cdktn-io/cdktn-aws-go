...
type DataAwsRoute53ResolverEndpoint interface {
	...
	Direction() *string
	// Experimental.
	Filter() DataAwsRoute53ResolverEndpoint_FilterPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsRoute53ResolverEndpoint) Filter() DataAwsRoute53ResolverEndpoint_FilterPropertyList {
	var returns DataAwsRoute53ResolverEndpoint_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
