...
type DataAwsRoute53ResolverRule interface {
	...
	// Experimental.
	TargetIps() DataAwsRoute53ResolverRule_TargetIpsPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsRoute53ResolverRule) TargetIps() DataAwsRoute53ResolverRule_TargetIpsPropertyList {
	var returns DataAwsRoute53ResolverRule_TargetIpsPropertyList
	_jsii_.Get(
		j,
		"targetIps",
		&returns,
