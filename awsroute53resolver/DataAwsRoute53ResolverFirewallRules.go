...
type DataAwsRoute53ResolverFirewallRules interface {
	...
	// Experimental.
	FirewallRules() DataAwsRoute53ResolverFirewallRules_FirewallRulesPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallRules) FirewallRules() DataAwsRoute53ResolverFirewallRules_FirewallRulesPropertyList {
	var returns DataAwsRoute53ResolverFirewallRules_FirewallRulesPropertyList
	_jsii_.Get(
		j,
		"firewallRules",
		&returns,
