...
// Experimental.
type AwsFirewallTransitGatewayAttachmentAccepterConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsFirewallTransitGatewayAttachmentAccepter_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
