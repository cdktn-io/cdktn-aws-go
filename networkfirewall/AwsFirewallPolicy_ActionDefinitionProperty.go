...
// Experimental.
type AwsFirewallPolicy_ActionDefinitionProperty struct {
	...
	// Experimental.
	PublishMetricAction *AwsFirewallPolicy_PublishMetricActionProperty `field:"required" json:"publishMetricAction" yaml:"publishMetricAction"`
}
