...
// Experimental.
type AwsRuleGroup_RuleGroupProperty struct {
	// rules_source block.
	//
	...
	// Experimental.
	RulesSource *AwsRuleGroup_RulesSourceProperty `field:"required" json:"rulesSource" yaml:"rulesSource"`
	...
	// Experimental.
	ReferenceSets *AwsRuleGroup_ReferenceSetsProperty `field:"optional" json:"referenceSets" yaml:"referenceSets"`
	...
	// Experimental.
	RuleVariables *AwsRuleGroup_RuleVariablesProperty `field:"optional" json:"ruleVariables" yaml:"ruleVariables"`
	...
	// Experimental.
	StatefulRuleOptions *AwsRuleGroup_StatefulRuleOptionsProperty `field:"optional" json:"statefulRuleOptions" yaml:"statefulRuleOptions"`
}
