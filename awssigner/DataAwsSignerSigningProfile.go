...
type DataAwsSignerSigningProfile interface {
	...
	RegionInput() *string
	// Experimental.
	RevocationRecord() DataAwsSignerSigningProfile_RevocationRecordPropertyList
	// Experimental.
	SignatureValidityPeriod() DataAwsSignerSigningProfile_SignatureValidityPeriodPropertyList
	// Experimental.
	SigningMaterial() DataAwsSignerSigningProfile_SigningMaterialPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsSignerSigningProfile) RevocationRecord() DataAwsSignerSigningProfile_RevocationRecordPropertyList {
	var returns DataAwsSignerSigningProfile_RevocationRecordPropertyList
	_jsii_.Get(
		j,
		"revocationRecord",
		&returns,
...
func (j *jsiiProxy_DataAwsSignerSigningProfile) SignatureValidityPeriod() DataAwsSignerSigningProfile_SignatureValidityPeriodPropertyList {
	var returns DataAwsSignerSigningProfile_SignatureValidityPeriodPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsSignerSigningProfile) SigningMaterial() DataAwsSignerSigningProfile_SigningMaterialPropertyList {
	var returns DataAwsSignerSigningProfile_SigningMaterialPropertyList
	_jsii_.Get(
		j,
		"signingMaterial",
		&returns,
...
func NewDataAwsSignerSigningProfile(scope constructs.Construct, id *string, config *DataAwsSignerSigningProfileConfig) DataAwsSignerSigningProfile {
	...
	_jsii_.Create(
		"@cdktn/aws-signer.DataAwsSignerSigningProfile",
