...
// Experimental.
type TfSigningJobConfig struct {
	// Experimental.
	...
	// Experimental.
	Destination *TfSigningJob_DestinationProperty `field:"required" json:"destination" yaml:"destination"`
	...
	// Experimental.
	Source *TfSigningJob_SourceProperty `field:"required" json:"source" yaml:"source"`
