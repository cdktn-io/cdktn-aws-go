...
type DataAwsSignerSigningJob interface {
	...
	RequestedBy() *string
	// Experimental.
	RevocationRecord() DataAwsSignerSigningJob_RevocationRecordPropertyList
	// Experimental.
	SignatureExpiresAt() *string
	// Experimental.
	SignedObject() DataAwsSignerSigningJob_SignedObjectPropertyList
	// Experimental.
	Source() DataAwsSignerSigningJob_SourcePropertyList
	// Experimental.
	Status() *string
	// Experimental.
	StatusReason() *string
...
func (j *jsiiProxy_DataAwsSignerSigningJob) RevocationRecord() DataAwsSignerSigningJob_RevocationRecordPropertyList {
	var returns DataAwsSignerSigningJob_RevocationRecordPropertyList
	_jsii_.Get(
		j,
		"revocationRecord",
		&returns,
...
func (j *jsiiProxy_DataAwsSignerSigningJob) SignedObject() DataAwsSignerSigningJob_SignedObjectPropertyList {
	var returns DataAwsSignerSigningJob_SignedObjectPropertyList
	_jsii_.Get(
		j,
		"signedObject",
		&returns,
...
func (j *jsiiProxy_DataAwsSignerSigningJob) Source() DataAwsSignerSigningJob_SourcePropertyList {
	var returns DataAwsSignerSigningJob_SourcePropertyList
	_jsii_.Get(
		j,
		"source",
		&returns,
...
func NewDataAwsSignerSigningJob(scope constructs.Construct, id *string, config *DataAwsSignerSigningJobConfig) DataAwsSignerSigningJob {
	...
	_jsii_.Create(
		"@cdktn/aws-signer.DataAwsSignerSigningJob",
