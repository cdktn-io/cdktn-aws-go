...
// Experimental.
type TfSigningProfileConfig struct {
	// Experimental.
	...
	// Experimental.
	SignatureValidityPeriod *TfSigningProfile_SignatureValidityPeriodProperty `field:"optional" json:"signatureValidityPeriod" yaml:"signatureValidityPeriod"`
	...
	// Experimental.
	SigningMaterial *TfSigningProfile_SigningMaterialProperty `field:"optional" json:"signingMaterial" yaml:"signingMaterial"`
