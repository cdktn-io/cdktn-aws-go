...
// Experimental.
type AwsResourceShareConfig struct {
	// Experimental.
	...
	// Experimental.
	ResourceShareConfiguration *AwsResourceShare_ResourceShareConfigurationProperty `field:"optional" json:"resourceShareConfiguration" yaml:"resourceShareConfiguration"`
	...
	// Experimental.
	Timeouts *AwsResourceShare_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
