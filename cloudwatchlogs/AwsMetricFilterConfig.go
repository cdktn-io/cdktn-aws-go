...
// Experimental.
type AwsMetricFilterConfig struct {
	// Experimental.
	...
	// Experimental.
	MetricTransformation *AwsMetricFilter_MetricTransformationProperty `field:"required" json:"metricTransformation" yaml:"metricTransformation"`
