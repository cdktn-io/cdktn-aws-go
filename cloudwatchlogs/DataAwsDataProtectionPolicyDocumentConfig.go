...
// Experimental.
type DataAwsDataProtectionPolicyDocumentConfig struct {
	// Experimental.
	...
	// Experimental.
	Configuration *DataAwsDataProtectionPolicyDocument_ConfigurationProperty `field:"optional" json:"configuration" yaml:"configuration"`
