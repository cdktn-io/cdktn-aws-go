...
// Experimental.
type DataAwsDataProtectionPolicyDocument_DeidentifyProperty struct {
	// mask_config block.
	//
	...
	// Experimental.
	MaskConfig *DataAwsDataProtectionPolicyDocument_MaskConfigProperty `field:"required" json:"maskConfig" yaml:"maskConfig"`
}
