...
// Experimental.
type AwsGlueClassifierConfig struct {
	// Experimental.
	...
	// Experimental.
	CsvClassifier *AwsGlueClassifier_CsvClassifierProperty `field:"optional" json:"csvClassifier" yaml:"csvClassifier"`
	...
	// Experimental.
	GrokClassifier *AwsGlueClassifier_GrokClassifierProperty `field:"optional" json:"grokClassifier" yaml:"grokClassifier"`
	...
	// Experimental.
	JsonClassifier *AwsGlueClassifier_JsonClassifierProperty `field:"optional" json:"jsonClassifier" yaml:"jsonClassifier"`
	...
	// Experimental.
	XmlClassifier *AwsGlueClassifier_XmlClassifierProperty `field:"optional" json:"xmlClassifier" yaml:"xmlClassifier"`
}
