...
type DataAwsGlueConnection interface {
	...
	// Experimental.
	AuthenticationConfiguration() DataAwsGlueConnection_AuthenticationConfigurationPropertyList
	// Experimental.
	CatalogId() *string
	// Experimental.
	...
	// Experimental.
	PhysicalConnectionRequirements() DataAwsGlueConnection_PhysicalConnectionRequirementsPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsGlueConnection) AuthenticationConfiguration() DataAwsGlueConnection_AuthenticationConfigurationPropertyList {
	var returns DataAwsGlueConnection_AuthenticationConfigurationPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsGlueConnection) PhysicalConnectionRequirements() DataAwsGlueConnection_PhysicalConnectionRequirementsPropertyList {
	var returns DataAwsGlueConnection_PhysicalConnectionRequirementsPropertyList
	_jsii_.Get(
		j,
