...
type DataAwsGlueCatalogTable interface {
	...
	// Experimental.
	PartitionIndex() DataAwsGlueCatalogTable_PartitionIndexPropertyList
	// Experimental.
	PartitionKeys() DataAwsGlueCatalogTable_PartitionKeysPropertyList
	// Experimental.
	...
	Retention() *float64
	// Experimental.
	StorageDescriptor() DataAwsGlueCatalogTable_StorageDescriptorPropertyList
	// Experimental.
	TableType() *string
	// Experimental.
	TargetTable() DataAwsGlueCatalogTable_TargetTablePropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsGlueCatalogTable) PartitionIndex() DataAwsGlueCatalogTable_PartitionIndexPropertyList {
	var returns DataAwsGlueCatalogTable_PartitionIndexPropertyList
	_jsii_.Get(
		j,
		"partitionIndex",
		&returns,
...
func (j *jsiiProxy_DataAwsGlueCatalogTable) PartitionKeys() DataAwsGlueCatalogTable_PartitionKeysPropertyList {
	var returns DataAwsGlueCatalogTable_PartitionKeysPropertyList
	_jsii_.Get(
		j,
		"partitionKeys",
		&returns,
...
func (j *jsiiProxy_DataAwsGlueCatalogTable) StorageDescriptor() DataAwsGlueCatalogTable_StorageDescriptorPropertyList {
	var returns DataAwsGlueCatalogTable_StorageDescriptorPropertyList
	_jsii_.Get(
		j,
		"storageDescriptor",
		&returns,
...
func (j *jsiiProxy_DataAwsGlueCatalogTable) TargetTable() DataAwsGlueCatalogTable_TargetTablePropertyList {
	var returns DataAwsGlueCatalogTable_TargetTablePropertyList
	_jsii_.Get(
		j,
		"targetTable",
		&returns,
