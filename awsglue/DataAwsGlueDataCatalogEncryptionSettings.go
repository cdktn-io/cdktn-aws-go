...
type DataAwsGlueDataCatalogEncryptionSettings interface {
	...
	// Experimental.
	DataCatalogEncryptionSettings() DataAwsGlueDataCatalogEncryptionSettings_DataCatalogEncryptionSettingsPropertyList
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
...
func (j *jsiiProxy_DataAwsGlueDataCatalogEncryptionSettings) DataCatalogEncryptionSettings() DataAwsGlueDataCatalogEncryptionSettings_DataCatalogEncryptionSettingsPropertyList {
	var returns DataAwsGlueDataCatalogEncryptionSettings_DataCatalogEncryptionSettingsPropertyList
	_jsii_.Get(
		j,
