...
// Experimental.
type AwsGluePartitionIndexConfig struct {
	// Experimental.
	...
	// Experimental.
	PartitionIndex *AwsGluePartitionIndex_PartitionIndexProperty `field:"required" json:"partitionIndex" yaml:"partitionIndex"`
	...
	// Experimental.
	Timeouts *AwsGluePartitionIndex_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
