...
// Experimental.
type AwsGlueTriggerConfig struct {
	// Experimental.
	...
	// Experimental.
	Predicate *AwsGlueTrigger_PredicateProperty `field:"optional" json:"predicate" yaml:"predicate"`
	...
	// Experimental.
	Timeouts *AwsGlueTrigger_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
