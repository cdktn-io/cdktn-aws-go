...
// Experimental.
type TfSecurityConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	EncryptionConfiguration *TfSecurityConfiguration_EncryptionConfigurationProperty `field:"required" json:"encryptionConfiguration" yaml:"encryptionConfiguration"`
