...
// Experimental.
type AwsGlueSecurityConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	EncryptionConfiguration *AwsGlueSecurityConfiguration_EncryptionConfigurationProperty `field:"required" json:"encryptionConfiguration" yaml:"encryptionConfiguration"`
