...
// Experimental.
type AwsGlueConnectionConfig struct {
	// Experimental.
	...
	// Experimental.
	AuthenticationConfiguration *AwsGlueConnection_AuthenticationConfigurationProperty `field:"optional" json:"authenticationConfiguration" yaml:"authenticationConfiguration"`
	...
	// Experimental.
	PhysicalConnectionRequirements *AwsGlueConnection_PhysicalConnectionRequirementsProperty `field:"optional" json:"physicalConnectionRequirements" yaml:"physicalConnectionRequirements"`
