...
// Experimental.
type AwsGlueConnection_AuthenticationConfigurationProperty struct {
	...
	// Experimental.
	BasicAuthenticationCredentials *AwsGlueConnection_BasicAuthenticationCredentialsProperty `field:"optional" json:"basicAuthenticationCredentials" yaml:"basicAuthenticationCredentials"`
	...
	// Experimental.
	Oauth2Properties *AwsGlueConnection_Oauth2PropertiesProperty `field:"optional" json:"oauth2Properties" yaml:"oauth2Properties"`
