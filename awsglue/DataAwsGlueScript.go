...
type DataAwsGlueScript interface {
	...
	// Experimental.
	DagEdge() DataAwsGlueScript_DagEdgePropertyList
	// Experimental.
	DagEdgeInput() interface{}
	// Experimental.
	DagNode() DataAwsGlueScript_DagNodePropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsGlueScript) DagEdge() DataAwsGlueScript_DagEdgePropertyList {
	var returns DataAwsGlueScript_DagEdgePropertyList
	_jsii_.Get(
		j,
		"dagEdge",
		&returns,
...
func (j *jsiiProxy_DataAwsGlueScript) DagNode() DataAwsGlueScript_DagNodePropertyList {
	var returns DataAwsGlueScript_DagNodePropertyList
	_jsii_.Get(
		j,
		"dagNode",
		&returns,
