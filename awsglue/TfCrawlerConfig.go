...
type TfCrawlerConfig struct {
	...
	// Experimental.
	LakeFormationConfiguration *TfCrawler_LakeFormationConfigurationProperty `field:"optional" json:"lakeFormationConfiguration" yaml:"lakeFormationConfiguration"`
	...
	// Experimental.
	LineageConfiguration *TfCrawler_LineageConfigurationProperty `field:"optional" json:"lineageConfiguration" yaml:"lineageConfiguration"`
	...
	// Experimental.
	RecrawlPolicy *TfCrawler_RecrawlPolicyProperty `field:"optional" json:"recrawlPolicy" yaml:"recrawlPolicy"`
	...
	// Experimental.
	SchemaChangePolicy *TfCrawler_SchemaChangePolicyProperty `field:"optional" json:"schemaChangePolicy" yaml:"schemaChangePolicy"`
