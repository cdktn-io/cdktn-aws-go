...
// Experimental.
type TfPartitionIndexConfig struct {
	// Experimental.
	...
	// Experimental.
	PartitionIndex *TfPartitionIndex_PartitionIndexProperty `field:"required" json:"partitionIndex" yaml:"partitionIndex"`
	...
	// Experimental.
	Timeouts *TfPartitionIndex_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
