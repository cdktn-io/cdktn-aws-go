...
type TfPolicyConfig struct {
	...
	// Experimental.
	PredictiveScalingConfiguration *TfPolicy_PredictiveScalingConfigurationProperty `field:"optional" json:"predictiveScalingConfiguration" yaml:"predictiveScalingConfiguration"`
	...
	// Experimental.
	TargetTrackingConfiguration *TfPolicy_TargetTrackingConfigurationProperty `field:"optional" json:"targetTrackingConfiguration" yaml:"targetTrackingConfiguration"`
}
