...
// Experimental.
type TfGroup_CapacityReservationSpecificationProperty struct {
	...
	// Experimental.
	CapacityReservationTarget *TfGroup_CapacityReservationTargetProperty `field:"optional" json:"capacityReservationTarget" yaml:"capacityReservationTarget"`
}
