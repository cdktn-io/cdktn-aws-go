...
// Experimental.
type TfPolicy_PredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationMetricDataQueriesProperty struct {
	...
	// Experimental.
	MetricStat *TfPolicy_PredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationMetricDataQueriesMetricStatProperty `field:"optional" json:"metricStat" yaml:"metricStat"`
