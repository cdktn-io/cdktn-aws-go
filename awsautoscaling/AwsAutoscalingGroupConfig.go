...
type AwsAutoscalingGroupConfig struct {
	...
	// Experimental.
	AvailabilityZoneDistribution *AwsAutoscalingGroup_AvailabilityZoneDistributionProperty `field:"optional" json:"availabilityZoneDistribution" yaml:"availabilityZoneDistribution"`
	...
	// Experimental.
	CapacityReservationSpecification *AwsAutoscalingGroup_CapacityReservationSpecificationProperty `field:"optional" json:"capacityReservationSpecification" yaml:"capacityReservationSpecification"`
	...
	// Experimental.
	InstanceLifecyclePolicy *AwsAutoscalingGroup_InstanceLifecyclePolicyProperty `field:"optional" json:"instanceLifecyclePolicy" yaml:"instanceLifecyclePolicy"`
	...
	// Experimental.
	InstanceMaintenancePolicy *AwsAutoscalingGroup_InstanceMaintenancePolicyProperty `field:"optional" json:"instanceMaintenancePolicy" yaml:"instanceMaintenancePolicy"`
	...
	// Experimental.
	InstanceRefresh *AwsAutoscalingGroup_InstanceRefreshProperty `field:"optional" json:"instanceRefresh" yaml:"instanceRefresh"`
	...
	// Experimental.
	LaunchTemplate *AwsAutoscalingGroup_LaunchTemplateProperty `field:"optional" json:"launchTemplate" yaml:"launchTemplate"`
	...
	// Experimental.
	MixedInstancesPolicy *AwsAutoscalingGroup_MixedInstancesPolicyProperty `field:"optional" json:"mixedInstancesPolicy" yaml:"mixedInstancesPolicy"`
	...
	// Experimental.
	Timeouts *AwsAutoscalingGroup_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
	...
	// Experimental.
	WarmPool *AwsAutoscalingGroup_WarmPoolProperty `field:"optional" json:"warmPool" yaml:"warmPool"`
}
