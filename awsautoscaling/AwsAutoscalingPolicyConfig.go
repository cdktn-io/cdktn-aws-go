...
// Experimental.
type AwsAutoscalingPolicyConfig struct {
	// Experimental.
	...
	// Experimental.
	PredictiveScalingConfiguration *AwsAutoscalingPolicy_PredictiveScalingConfigurationProperty `field:"optional" json:"predictiveScalingConfiguration" yaml:"predictiveScalingConfiguration"`
	...
	// Experimental.
	TargetTrackingConfiguration *AwsAutoscalingPolicy_TargetTrackingConfigurationProperty `field:"optional" json:"targetTrackingConfiguration" yaml:"targetTrackingConfiguration"`
}
