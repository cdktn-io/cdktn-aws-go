...
// Experimental.
type AwsAutoscalingPolicy_MetricsProperty struct {
	...
	// Experimental.
	MetricStat *AwsAutoscalingPolicy_TargetTrackingConfigurationCustomizedMetricSpecificationMetricsMetricStatProperty `field:"optional" json:"metricStat" yaml:"metricStat"`
