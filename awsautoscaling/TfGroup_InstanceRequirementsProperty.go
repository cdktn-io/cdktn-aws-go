...
// Experimental.
type TfGroup_InstanceRequirementsProperty struct {
	...
	// Experimental.
	AcceleratorCount *TfGroup_AcceleratorCountProperty `field:"optional" json:"acceleratorCount" yaml:"acceleratorCount"`
	...
	// Experimental.
	AcceleratorTotalMemoryMib *TfGroup_AcceleratorTotalMemoryMibProperty `field:"optional" json:"acceleratorTotalMemoryMib" yaml:"acceleratorTotalMemoryMib"`
	...
	// Experimental.
	BaselineEbsBandwidthMbps *TfGroup_BaselineEbsBandwidthMbpsProperty `field:"optional" json:"baselineEbsBandwidthMbps" yaml:"baselineEbsBandwidthMbps"`
	...
	// Experimental.
	MemoryGibPerVcpu *TfGroup_MemoryGibPerVcpuProperty `field:"optional" json:"memoryGibPerVcpu" yaml:"memoryGibPerVcpu"`
	// memory_mib block.
	//
	...
	// Experimental.
	MemoryMib *TfGroup_MemoryMibProperty `field:"optional" json:"memoryMib" yaml:"memoryMib"`
	...
	// Experimental.
	NetworkBandwidthGbps *TfGroup_NetworkBandwidthGbpsProperty `field:"optional" json:"networkBandwidthGbps" yaml:"networkBandwidthGbps"`
	...
	// Experimental.
	NetworkInterfaceCount *TfGroup_NetworkInterfaceCountProperty `field:"optional" json:"networkInterfaceCount" yaml:"networkInterfaceCount"`
	...
	// Experimental.
	TotalLocalStorageGb *TfGroup_TotalLocalStorageGbProperty `field:"optional" json:"totalLocalStorageGb" yaml:"totalLocalStorageGb"`
	// vcpu_count block.
	//
	...
	// Experimental.
	VcpuCount *TfGroup_VcpuCountProperty `field:"optional" json:"vcpuCount" yaml:"vcpuCount"`
}
