...
type DataAwsAutoscalingGroup interface {
	...
	IdInput() *string
	// Experimental.
	InstanceMaintenancePolicy() DataAwsAutoscalingGroup_InstanceMaintenancePolicyPropertyList
	// Experimental.
	LaunchConfiguration() *string
	// Experimental.
	LaunchTemplate() DataAwsAutoscalingGroup_LaunchTemplatePropertyList
	// Experimental.
	...
	MinSize() *float64
	// Experimental.
	MixedInstancesPolicy() DataAwsAutoscalingGroup_MixedInstancesPolicyPropertyList
	// Experimental.
	Name() *string
	// Experimental.
	SetName(val *string)
	...
	// Experimental.
	Tag() DataAwsAutoscalingGroup_TagPropertyList
	// Experimental.
	...
	// Experimental.
	TrafficSource() DataAwsAutoscalingGroup_TrafficSourcePropertyList
	// Experimental.
	VpcZoneIdentifier() *string
	// Experimental.
	WarmPool() DataAwsAutoscalingGroup_WarmPoolPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsAutoscalingGroup) InstanceMaintenancePolicy() DataAwsAutoscalingGroup_InstanceMaintenancePolicyPropertyList {
	var returns DataAwsAutoscalingGroup_InstanceMaintenancePolicyPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsAutoscalingGroup) LaunchTemplate() DataAwsAutoscalingGroup_LaunchTemplatePropertyList {
	var returns DataAwsAutoscalingGroup_LaunchTemplatePropertyList
	_jsii_.Get(
		j,
		"launchTemplate",
		&returns,
...
func (j *jsiiProxy_DataAwsAutoscalingGroup) MixedInstancesPolicy() DataAwsAutoscalingGroup_MixedInstancesPolicyPropertyList {
	var returns DataAwsAutoscalingGroup_MixedInstancesPolicyPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsAutoscalingGroup) Tag() DataAwsAutoscalingGroup_TagPropertyList {
	var returns DataAwsAutoscalingGroup_TagPropertyList
	_jsii_.Get(
		j,
		"tag",
		&returns,
...
func (j *jsiiProxy_DataAwsAutoscalingGroup) TrafficSource() DataAwsAutoscalingGroup_TrafficSourcePropertyList {
	var returns DataAwsAutoscalingGroup_TrafficSourcePropertyList
	_jsii_.Get(
		j,
		"trafficSource",
		&returns,
...
func (j *jsiiProxy_DataAwsAutoscalingGroup) WarmPool() DataAwsAutoscalingGroup_WarmPoolPropertyList {
	var returns DataAwsAutoscalingGroup_WarmPoolPropertyList
	_jsii_.Get(
		j,
		"warmPool",
		&returns,
...
func NewDataAwsAutoscalingGroup(scope constructs.Construct, id *string, config *DataAwsAutoscalingGroupConfig) DataAwsAutoscalingGroup {
	...
	_jsii_.Create(
		"@cdktn/aws-auto-scaling.DataAwsAutoscalingGroup",
