...
type DataAwsAutoscalingGroups interface {
	...
	// Experimental.
	Filter() DataAwsAutoscalingGroups_FilterPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsAutoscalingGroups) Filter() DataAwsAutoscalingGroups_FilterPropertyList {
	var returns DataAwsAutoscalingGroups_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func NewDataAwsAutoscalingGroups(scope constructs.Construct, id *string, config *DataAwsAutoscalingGroupsConfig) DataAwsAutoscalingGroups {
	...
	_jsii_.Create(
		"@cdktn/aws-auto-scaling.DataAwsAutoscalingGroups",
