...
type AwsDomainConfig struct {
	...
	// Experimental.
	DefaultUserSettings *AwsDomain_DefaultUserSettingsProperty `field:"required" json:"defaultUserSettings" yaml:"defaultUserSettings"`
	...
	// Experimental.
	DefaultSpaceSettings *AwsDomain_DefaultSpaceSettingsProperty `field:"optional" json:"defaultSpaceSettings" yaml:"defaultSpaceSettings"`
	...
	// Experimental.
	DomainSettings *AwsDomain_DomainSettingsProperty `field:"optional" json:"domainSettings" yaml:"domainSettings"`
	...
	// Experimental.
	RetentionPolicy *AwsDomain_RetentionPolicyProperty `field:"optional" json:"retentionPolicy" yaml:"retentionPolicy"`
