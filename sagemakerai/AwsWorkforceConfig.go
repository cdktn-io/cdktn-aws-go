...
// Experimental.
type AwsWorkforceConfig struct {
	// Experimental.
	...
	// Experimental.
	CognitoConfig *AwsWorkforce_CognitoConfigProperty `field:"optional" json:"cognitoConfig" yaml:"cognitoConfig"`
	...
	// Experimental.
	OidcConfig *AwsWorkforce_OidcConfigProperty `field:"optional" json:"oidcConfig" yaml:"oidcConfig"`
	...
	// Experimental.
	SourceIpConfig *AwsWorkforce_SourceIpConfigProperty `field:"optional" json:"sourceIpConfig" yaml:"sourceIpConfig"`
	...
	// Experimental.
	WorkforceVpcConfig *AwsWorkforce_WorkforceVpcConfigProperty `field:"optional" json:"workforceVpcConfig" yaml:"workforceVpcConfig"`
}
