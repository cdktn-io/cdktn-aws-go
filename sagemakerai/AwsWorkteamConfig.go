...
type AwsWorkteamConfig struct {
	...
	// Experimental.
	NotificationConfiguration *AwsWorkteam_NotificationConfigurationProperty `field:"optional" json:"notificationConfiguration" yaml:"notificationConfiguration"`
	...
	// Experimental.
	WorkerAccessConfiguration *AwsWorkteam_WorkerAccessConfigurationProperty `field:"optional" json:"workerAccessConfiguration" yaml:"workerAccessConfiguration"`
