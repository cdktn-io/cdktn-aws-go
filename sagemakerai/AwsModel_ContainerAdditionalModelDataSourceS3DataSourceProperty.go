...
// Experimental.
type AwsModel_ContainerAdditionalModelDataSourceS3DataSourceProperty struct {
	...
	// Experimental.
	ModelAccessConfig *AwsModel_ContainerAdditionalModelDataSourceS3DataSourceModelAccessConfigProperty `field:"optional" json:"modelAccessConfig" yaml:"modelAccessConfig"`
}
