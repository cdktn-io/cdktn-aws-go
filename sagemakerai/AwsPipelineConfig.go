...
type AwsPipelineConfig struct {
	...
	// Experimental.
	ParallelismConfiguration *AwsPipeline_ParallelismConfigurationProperty `field:"optional" json:"parallelismConfiguration" yaml:"parallelismConfiguration"`
	...
	// Experimental.
	PipelineDefinitionS3Location *AwsPipeline_PipelineDefinitionS3LocationProperty `field:"optional" json:"pipelineDefinitionS3Location" yaml:"pipelineDefinitionS3Location"`
