...
// Experimental.
type AwsModel_ContainerProperty struct {
	...
	// Experimental.
	ImageConfig *AwsModel_ContainerImageConfigProperty `field:"optional" json:"imageConfig" yaml:"imageConfig"`
	...
	// Experimental.
	ModelDataSource *AwsModel_ContainerModelDataSourceProperty `field:"optional" json:"modelDataSource" yaml:"modelDataSource"`
	...
	// Experimental.
	MultiModelConfig *AwsModel_ContainerMultiModelConfigProperty `field:"optional" json:"multiModelConfig" yaml:"multiModelConfig"`
}
