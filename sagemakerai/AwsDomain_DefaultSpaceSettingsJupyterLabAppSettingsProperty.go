...
// Experimental.
type AwsDomain_DefaultSpaceSettingsJupyterLabAppSettingsProperty struct {
	...
	// Experimental.
	AppLifecycleManagement *AwsDomain_DefaultSpaceSettingsJupyterLabAppSettingsAppLifecycleManagementProperty `field:"optional" json:"appLifecycleManagement" yaml:"appLifecycleManagement"`
	...
	// Experimental.
	DefaultResourceSpec *AwsDomain_DefaultSpaceSettingsJupyterLabAppSettingsDefaultResourceSpecProperty `field:"optional" json:"defaultResourceSpec" yaml:"defaultResourceSpec"`
	// emr_settings block.
	//
	...
	// Experimental.
	EmrSettings *AwsDomain_DefaultSpaceSettingsJupyterLabAppSettingsEmrSettingsProperty `field:"optional" json:"emrSettings" yaml:"emrSettings"`
