...
type AwsModelConfig struct {
	...
	// Experimental.
	InferenceExecutionConfig *AwsModel_InferenceExecutionConfigProperty `field:"optional" json:"inferenceExecutionConfig" yaml:"inferenceExecutionConfig"`
	...
	// Experimental.
	PrimaryContainer *AwsModel_PrimaryContainerProperty `field:"optional" json:"primaryContainer" yaml:"primaryContainer"`
	...
	// Experimental.
	VpcConfig *AwsModel_VpcConfigProperty `field:"optional" json:"vpcConfig" yaml:"vpcConfig"`
}
