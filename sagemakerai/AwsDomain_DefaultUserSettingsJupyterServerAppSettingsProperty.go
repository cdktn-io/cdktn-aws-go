...
// Experimental.
type AwsDomain_DefaultUserSettingsJupyterServerAppSettingsProperty struct {
	...
	// Experimental.
	DefaultResourceSpec *AwsDomain_DefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecProperty `field:"optional" json:"defaultResourceSpec" yaml:"defaultResourceSpec"`
