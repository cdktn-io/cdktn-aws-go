...
// Experimental.
type AwsDataQualityJobDefinitionConfig struct {
	// Experimental.
	...
	// Experimental.
	DataQualityAppSpecification *AwsDataQualityJobDefinition_DataQualityAppSpecificationProperty `field:"required" json:"dataQualityAppSpecification" yaml:"dataQualityAppSpecification"`
	...
	// Experimental.
	DataQualityJobInput *AwsDataQualityJobDefinition_DataQualityJobInputProperty `field:"required" json:"dataQualityJobInput" yaml:"dataQualityJobInput"`
	...
	// Experimental.
	DataQualityJobOutputConfig *AwsDataQualityJobDefinition_DataQualityJobOutputConfigProperty `field:"required" json:"dataQualityJobOutputConfig" yaml:"dataQualityJobOutputConfig"`
	// job_resources block.
	//
	...
	// Experimental.
	JobResources *AwsDataQualityJobDefinition_JobResourcesProperty `field:"required" json:"jobResources" yaml:"jobResources"`
	...
	// Experimental.
	DataQualityBaselineConfig *AwsDataQualityJobDefinition_DataQualityBaselineConfigProperty `field:"optional" json:"dataQualityBaselineConfig" yaml:"dataQualityBaselineConfig"`
	...
	// Experimental.
	NetworkConfig *AwsDataQualityJobDefinition_NetworkConfigProperty `field:"optional" json:"networkConfig" yaml:"networkConfig"`
	...
	// Experimental.
	StoppingCondition *AwsDataQualityJobDefinition_StoppingConditionProperty `field:"optional" json:"stoppingCondition" yaml:"stoppingCondition"`
