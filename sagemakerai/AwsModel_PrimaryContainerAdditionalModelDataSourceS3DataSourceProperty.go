...
// Experimental.
type AwsModel_PrimaryContainerAdditionalModelDataSourceS3DataSourceProperty struct {
	...
	// Experimental.
	ModelAccessConfig *AwsModel_PrimaryContainerAdditionalModelDataSourceS3DataSourceModelAccessConfigProperty `field:"optional" json:"modelAccessConfig" yaml:"modelAccessConfig"`
}
