...
// Experimental.
type AwsModel_ContainerImageConfigProperty struct {
	...
	// Experimental.
	RepositoryAuthConfig *AwsModel_ContainerImageConfigRepositoryAuthConfigProperty `field:"optional" json:"repositoryAuthConfig" yaml:"repositoryAuthConfig"`
}
