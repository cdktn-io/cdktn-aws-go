...
type AwsProjectConfig struct {
	...
	// Experimental.
	ServiceCatalogProvisioningDetails *AwsProject_ServiceCatalogProvisioningDetailsProperty `field:"required" json:"serviceCatalogProvisioningDetails" yaml:"serviceCatalogProvisioningDetails"`
