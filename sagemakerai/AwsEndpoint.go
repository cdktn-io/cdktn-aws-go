...
type AwsEndpoint interface {
	...
	// Experimental.
	DeploymentConfig() AwsEndpoint_DeploymentConfigPropertyOutputReference
	// Experimental.
	DeploymentConfigInput() *AwsEndpoint_DeploymentConfigProperty
	// Experimental.
	...
	// Experimental.
	PutDeploymentConfig(value *AwsEndpoint_DeploymentConfigProperty)
...
func (j *jsiiProxy_AwsEndpoint) DeploymentConfig() AwsEndpoint_DeploymentConfigPropertyOutputReference {
	var returns AwsEndpoint_DeploymentConfigPropertyOutputReference
	_jsii_.Get(
		j,
		"deploymentConfig",
		&returns,
...
func (j *jsiiProxy_AwsEndpoint) DeploymentConfigInput() *AwsEndpoint_DeploymentConfigProperty {
...
func (j *jsiiProxy_AwsEndpoint) EndpointConfigName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endpointConfigName",
...
func (j *jsiiProxy_AwsEndpoint) EndpointConfigNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewAwsEndpoint(scope constructs.Construct, id *string, config *AwsEndpointConfig) AwsEndpoint {
	...
	_jsii_.Create(
		"@cdktn/aws-sagemaker-ai.AwsEndpoint",
...
func (j *jsiiProxy_AwsEndpoint)SetEndpointConfigName(val *string) {
...
func (a *jsiiProxy_AwsEndpoint) PutDeploymentConfig(value *AwsEndpoint_DeploymentConfigProperty) {
...
func (a *jsiiProxy_AwsEndpoint) ResetDeploymentConfig() {
	_jsii_.InvokeVoid(
		a,
		"resetDeploymentConfig",
		nil, // no parameters
...
func (a *jsiiProxy_AwsEndpoint) ResetName() {
	_jsii_.InvokeVoid(
		a,
		"resetName",
		nil, // no parameters
