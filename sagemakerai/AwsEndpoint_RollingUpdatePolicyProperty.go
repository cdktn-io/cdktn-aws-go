...
// Experimental.
type AwsEndpoint_RollingUpdatePolicyProperty struct {
	...
	// Experimental.
	MaximumBatchSize *AwsEndpoint_MaximumBatchSizeProperty `field:"required" json:"maximumBatchSize" yaml:"maximumBatchSize"`
	...
	// Experimental.
	RollbackMaximumBatchSize *AwsEndpoint_RollbackMaximumBatchSizeProperty `field:"optional" json:"rollbackMaximumBatchSize" yaml:"rollbackMaximumBatchSize"`
}
