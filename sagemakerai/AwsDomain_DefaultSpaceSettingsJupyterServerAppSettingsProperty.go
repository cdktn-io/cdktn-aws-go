...
// Experimental.
type AwsDomain_DefaultSpaceSettingsJupyterServerAppSettingsProperty struct {
	...
	// Experimental.
	DefaultResourceSpec *AwsDomain_DefaultSpaceSettingsJupyterServerAppSettingsDefaultResourceSpecProperty `field:"optional" json:"defaultResourceSpec" yaml:"defaultResourceSpec"`
