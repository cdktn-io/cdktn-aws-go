...
// Experimental.
type AwsEndpointConfiguration_ProductionVariantsProperty struct {
	...
	// Experimental.
	CapacityReservationConfig *AwsEndpointConfiguration_ProductionVariantsCapacityReservationConfigProperty `field:"optional" json:"capacityReservationConfig" yaml:"capacityReservationConfig"`
	...
	// Experimental.
	CoreDumpConfig *AwsEndpointConfiguration_ProductionVariantsCoreDumpConfigProperty `field:"optional" json:"coreDumpConfig" yaml:"coreDumpConfig"`
	...
	// Experimental.
	ManagedInstanceScaling *AwsEndpointConfiguration_ProductionVariantsManagedInstanceScalingProperty `field:"optional" json:"managedInstanceScaling" yaml:"managedInstanceScaling"`
	...
	// Experimental.
	ServerlessConfig *AwsEndpointConfiguration_ProductionVariantsServerlessConfigProperty `field:"optional" json:"serverlessConfig" yaml:"serverlessConfig"`
