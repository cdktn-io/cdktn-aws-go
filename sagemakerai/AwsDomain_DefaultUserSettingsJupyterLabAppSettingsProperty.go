...
// Experimental.
type AwsDomain_DefaultUserSettingsJupyterLabAppSettingsProperty struct {
	...
	// Experimental.
	AppLifecycleManagement *AwsDomain_DefaultUserSettingsJupyterLabAppSettingsAppLifecycleManagementProperty `field:"optional" json:"appLifecycleManagement" yaml:"appLifecycleManagement"`
	...
	// Experimental.
	DefaultResourceSpec *AwsDomain_DefaultUserSettingsJupyterLabAppSettingsDefaultResourceSpecProperty `field:"optional" json:"defaultResourceSpec" yaml:"defaultResourceSpec"`
	// emr_settings block.
	//
	...
	// Experimental.
	EmrSettings *AwsDomain_DefaultUserSettingsJupyterLabAppSettingsEmrSettingsProperty `field:"optional" json:"emrSettings" yaml:"emrSettings"`
