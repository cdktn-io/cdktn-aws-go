...
// Experimental.
type AwsModel_ContainerModelDataSourceS3DataSourceProperty struct {
	...
	// Experimental.
	ModelAccessConfig *AwsModel_ContainerModelDataSourceS3DataSourceModelAccessConfigProperty `field:"optional" json:"modelAccessConfig" yaml:"modelAccessConfig"`
}
