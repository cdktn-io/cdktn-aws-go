...
func (a *jsiiProxy_AwsAlgorithm_InferenceSpecificationContainersModelDataSourceS3DataSourcePropertyOutputReference) validatePutHubAccessConfigParameters(value interface{}) error {
	...
	case *[]*AwsAlgorithm_InferenceSpecificationContainersModelDataSourceS3DataSourceHubAccessConfigProperty:
		value := value.(*[]*AwsAlgorithm_InferenceSpecificationContainersModelDataSourceS3DataSourceHubAccessConfigProperty)
	...
	case []*AwsAlgorithm_InferenceSpecificationContainersModelDataSourceS3DataSourceHubAccessConfigProperty:
		value_ := value.([]*AwsAlgorithm_InferenceSpecificationContainersModelDataSourceS3DataSourceHubAccessConfigProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AwsAlgorithm_InferenceSpecificationContainersModelDataSourceS3DataSourceHubAccessConfigProperty; received %#v (a %T)", value, value)
		}
	}
...
func (a *jsiiProxy_AwsAlgorithm_InferenceSpecificationContainersModelDataSourceS3DataSourcePropertyOutputReference) validatePutModelAccessConfigParameters(value interface{}) error {
	...
	case *[]*AwsAlgorithm_InferenceSpecificationContainersModelDataSourceS3DataSourceModelAccessConfigProperty:
		value := value.(*[]*AwsAlgorithm_InferenceSpecificationContainersModelDataSourceS3DataSourceModelAccessConfigProperty)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*AwsAlgorithm_InferenceSpecificationContainersModelDataSourceS3DataSourceModelAccessConfigProperty:
		value_ := value.([]*AwsAlgorithm_InferenceSpecificationContainersModelDataSourceS3DataSourceModelAccessConfigProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AwsAlgorithm_InferenceSpecificationContainersModelDataSourceS3DataSourceModelAccessConfigProperty; received %#v (a %T)", value, value)
		}
	}
