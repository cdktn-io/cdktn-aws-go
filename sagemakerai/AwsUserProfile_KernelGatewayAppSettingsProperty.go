...
// Experimental.
type AwsUserProfile_KernelGatewayAppSettingsProperty struct {
	// custom_image block.
	//
	...
	// Experimental.
	DefaultResourceSpec *AwsUserProfile_UserSettingsKernelGatewayAppSettingsDefaultResourceSpecProperty `field:"optional" json:"defaultResourceSpec" yaml:"defaultResourceSpec"`
