...
// Experimental.
type AwsMonitoringScheduleConfig struct {
	// Experimental.
	...
	// Experimental.
	MonitoringScheduleConfig *AwsMonitoringSchedule_MonitoringScheduleConfigProperty `field:"required" json:"monitoringScheduleConfig" yaml:"monitoringScheduleConfig"`
