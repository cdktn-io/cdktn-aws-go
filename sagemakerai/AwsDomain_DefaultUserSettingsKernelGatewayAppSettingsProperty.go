...
// Experimental.
type AwsDomain_DefaultUserSettingsKernelGatewayAppSettingsProperty struct {
	// custom_image block.
	//
	...
	// Experimental.
	DefaultResourceSpec *AwsDomain_DefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpecProperty `field:"optional" json:"defaultResourceSpec" yaml:"defaultResourceSpec"`
