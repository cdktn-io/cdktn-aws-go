...
// Experimental.
type AwsApplication_InputsSchemaProperty struct {
	...
	// Experimental.
	RecordFormat *AwsApplication_InputsSchemaRecordFormatProperty `field:"required" json:"recordFormat" yaml:"recordFormat"`
