...
type AwsReplicationConfigurationConfig struct {
	...
	// Experimental.
	ReplicationConfiguration *AwsReplicationConfiguration_ReplicationConfigurationProperty `field:"optional" json:"replicationConfiguration" yaml:"replicationConfiguration"`
}
