...
func (t *jsiiProxy_TfApplication) validatePutApplicationConfigurationParameters(value *TfApplication_ApplicationConfigurationProperty) error {
	return nil
}
...
func (j *jsiiProxy_TfApplication) validateSetApplicationModeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_TfApplication) validateSetForceStopParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_TfApplication) validateSetRuntimeEnvironmentParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_TfApplication) validateSetServiceExecutionRoleParameters(val *string) error {
	return nil
}
