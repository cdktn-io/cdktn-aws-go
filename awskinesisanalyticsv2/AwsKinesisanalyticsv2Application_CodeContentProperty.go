...
// Experimental.
type AwsKinesisanalyticsv2Application_CodeContentProperty struct {
	...
	// Experimental.
	S3ContentLocation *AwsKinesisanalyticsv2Application_S3ContentLocationProperty `field:"optional" json:"s3ContentLocation" yaml:"s3ContentLocation"`
