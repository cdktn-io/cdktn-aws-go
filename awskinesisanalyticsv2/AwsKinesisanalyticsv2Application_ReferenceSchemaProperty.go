...
// Experimental.
type AwsKinesisanalyticsv2Application_ReferenceSchemaProperty struct {
	// record_column block.
	//
	...
	// Experimental.
	RecordFormat *AwsKinesisanalyticsv2Application_ApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceReferenceSchemaRecordFormatProperty `field:"required" json:"recordFormat" yaml:"recordFormat"`
