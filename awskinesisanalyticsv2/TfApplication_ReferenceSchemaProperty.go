...
// Experimental.
type TfApplication_ReferenceSchemaProperty struct {
	// record_column block.
	//
	...
	// Experimental.
	RecordFormat *TfApplication_ApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceReferenceSchemaRecordFormatProperty `field:"required" json:"recordFormat" yaml:"recordFormat"`
