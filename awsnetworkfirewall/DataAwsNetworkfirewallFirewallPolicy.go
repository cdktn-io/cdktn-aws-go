...
type DataAwsNetworkfirewallFirewallPolicy interface {
	...
	Description() *string
	// Experimental.
	FirewallPolicy() DataAwsNetworkfirewallFirewallPolicy_FirewallPolicyPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsNetworkfirewallFirewallPolicy) FirewallPolicy() DataAwsNetworkfirewallFirewallPolicy_FirewallPolicyPropertyList {
	var returns DataAwsNetworkfirewallFirewallPolicy_FirewallPolicyPropertyList
	_jsii_.Get(
		j,
		"firewallPolicy",
		&returns,
...
func NewDataAwsNetworkfirewallFirewallPolicy(scope constructs.Construct, id *string, config *DataAwsNetworkfirewallFirewallPolicyConfig) DataAwsNetworkfirewallFirewallPolicy {
	...
	_jsii_.Create(
		"@cdktn/aws-network-firewall.DataAwsNetworkfirewallFirewallPolicy",
