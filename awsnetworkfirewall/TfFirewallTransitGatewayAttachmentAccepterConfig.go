...
// Experimental.
type TfFirewallTransitGatewayAttachmentAccepterConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *TfFirewallTransitGatewayAttachmentAccepter_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
