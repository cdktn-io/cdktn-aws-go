...
// Experimental.
type AwsNetworkfirewallLoggingConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	LoggingConfiguration *AwsNetworkfirewallLoggingConfiguration_LoggingConfigurationProperty `field:"required" json:"loggingConfiguration" yaml:"loggingConfiguration"`
