...
type TfRuleGroupConfig struct {
	...
	// Experimental.
	EncryptionConfiguration *TfRuleGroup_EncryptionConfigurationProperty `field:"optional" json:"encryptionConfiguration" yaml:"encryptionConfiguration"`
	...
	// Experimental.
	RuleGroup *TfRuleGroup_RuleGroupProperty `field:"optional" json:"ruleGroup" yaml:"ruleGroup"`
