...
// Experimental.
type AwsMediaInsightsPipelineConfiguration_AmazonTranscribeCallAnalyticsProcessorConfigurationProperty struct {
	...
	// Experimental.
	PostCallAnalyticsSettings *AwsMediaInsightsPipelineConfiguration_PostCallAnalyticsSettingsProperty `field:"optional" json:"postCallAnalyticsSettings" yaml:"postCallAnalyticsSettings"`
