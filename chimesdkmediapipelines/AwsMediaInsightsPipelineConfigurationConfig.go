...
// Experimental.
type AwsMediaInsightsPipelineConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	RealTimeAlertConfiguration *AwsMediaInsightsPipelineConfiguration_RealTimeAlertConfigurationProperty `field:"optional" json:"realTimeAlertConfiguration" yaml:"realTimeAlertConfiguration"`
	...
	// Experimental.
	Timeouts *AwsMediaInsightsPipelineConfiguration_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
