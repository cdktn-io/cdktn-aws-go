...
type TfActivityConfig struct {
	...
	// Experimental.
	EncryptionConfiguration *TfActivity_EncryptionConfigurationProperty `field:"optional" json:"encryptionConfiguration" yaml:"encryptionConfiguration"`
