...
func (a *jsiiProxy_AwsTimestreamqueryScheduledQuery_RecentlyFailedRunsQueryInsightsResponseQueryTemporalRangePropertyOutputReference) validatePutMaxParameters(value interface{}) error {
	...
	case *[]*AwsTimestreamqueryScheduledQuery_RecentlyFailedRunsQueryInsightsResponseQueryTemporalRangeMaxProperty:
		value := value.(*[]*AwsTimestreamqueryScheduledQuery_RecentlyFailedRunsQueryInsightsResponseQueryTemporalRangeMaxProperty)
	...
	case []*AwsTimestreamqueryScheduledQuery_RecentlyFailedRunsQueryInsightsResponseQueryTemporalRangeMaxProperty:
		value_ := value.([]*AwsTimestreamqueryScheduledQuery_RecentlyFailedRunsQueryInsightsResponseQueryTemporalRangeMaxProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AwsTimestreamqueryScheduledQuery_RecentlyFailedRunsQueryInsightsResponseQueryTemporalRangeMaxProperty; received %#v (a %T)", value, value)
		}
	}
