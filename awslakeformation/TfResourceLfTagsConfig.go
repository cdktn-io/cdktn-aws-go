...
// Experimental.
type TfResourceLfTagsConfig struct {
	// Experimental.
	...
	// Experimental.
	Database *TfResourceLfTags_DatabaseProperty `field:"optional" json:"database" yaml:"database"`
	...
	// Experimental.
	Table *TfResourceLfTags_TableProperty `field:"optional" json:"table" yaml:"table"`
	...
	// Experimental.
	TableWithColumns *TfResourceLfTags_TableWithColumnsProperty `field:"optional" json:"tableWithColumns" yaml:"tableWithColumns"`
	// timeouts block.
	//
	...
	// Experimental.
	Timeouts *TfResourceLfTags_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
