...
type DataAwsLakeformationDataLakeSettings interface {
	...
	// Experimental.
	CreateDatabaseDefaultPermissions() DataAwsLakeformationDataLakeSettings_CreateDatabaseDefaultPermissionsPropertyList
	// Experimental.
	CreateTableDefaultPermissions() DataAwsLakeformationDataLakeSettings_CreateTableDefaultPermissionsPropertyList
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
...
func (j *jsiiProxy_DataAwsLakeformationDataLakeSettings) CreateDatabaseDefaultPermissions() DataAwsLakeformationDataLakeSettings_CreateDatabaseDefaultPermissionsPropertyList {
	var returns DataAwsLakeformationDataLakeSettings_CreateDatabaseDefaultPermissionsPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsLakeformationDataLakeSettings) CreateTableDefaultPermissions() DataAwsLakeformationDataLakeSettings_CreateTableDefaultPermissionsPropertyList {
	var returns DataAwsLakeformationDataLakeSettings_CreateTableDefaultPermissionsPropertyList
	_jsii_.Get(
		j,
