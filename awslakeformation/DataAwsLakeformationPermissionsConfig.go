...
type DataAwsLakeformationPermissionsConfig struct {
	...
	// Experimental.
	Database *DataAwsLakeformationPermissions_DatabaseProperty `field:"optional" json:"database" yaml:"database"`
	...
	// Experimental.
	DataCellsFilter *DataAwsLakeformationPermissions_DataCellsFilterProperty `field:"optional" json:"dataCellsFilter" yaml:"dataCellsFilter"`
	// data_location block.
	//
	...
	// Experimental.
	DataLocation *DataAwsLakeformationPermissions_DataLocationProperty `field:"optional" json:"dataLocation" yaml:"dataLocation"`
	...
	// Experimental.
	LfTag *DataAwsLakeformationPermissions_LfTagProperty `field:"optional" json:"lfTag" yaml:"lfTag"`
	// lf_tag_policy block.
	//
	...
	// Experimental.
	LfTagPolicy *DataAwsLakeformationPermissions_LfTagPolicyProperty `field:"optional" json:"lfTagPolicy" yaml:"lfTagPolicy"`
	...
	// Experimental.
	Table *DataAwsLakeformationPermissions_TableProperty `field:"optional" json:"table" yaml:"table"`
	...
	// Experimental.
	TableWithColumns *DataAwsLakeformationPermissions_TableWithColumnsProperty `field:"optional" json:"tableWithColumns" yaml:"tableWithColumns"`
}
