...
// Experimental.
type DataTfPermissionsConfig struct {
	// Experimental.
	...
	// Experimental.
	Database *DataTfPermissions_DatabaseProperty `field:"optional" json:"database" yaml:"database"`
	...
	// Experimental.
	DataCellsFilter *DataTfPermissions_DataCellsFilterProperty `field:"optional" json:"dataCellsFilter" yaml:"dataCellsFilter"`
	// data_location block.
	//
	...
	// Experimental.
	DataLocation *DataTfPermissions_DataLocationProperty `field:"optional" json:"dataLocation" yaml:"dataLocation"`
	...
	// Experimental.
	LfTag *DataTfPermissions_LfTagProperty `field:"optional" json:"lfTag" yaml:"lfTag"`
	// lf_tag_policy block.
	//
	...
	// Experimental.
	LfTagPolicy *DataTfPermissions_LfTagPolicyProperty `field:"optional" json:"lfTagPolicy" yaml:"lfTagPolicy"`
	...
	// Experimental.
	Table *DataTfPermissions_TableProperty `field:"optional" json:"table" yaml:"table"`
	...
	// Experimental.
	TableWithColumns *DataTfPermissions_TableWithColumnsProperty `field:"optional" json:"tableWithColumns" yaml:"tableWithColumns"`
}
