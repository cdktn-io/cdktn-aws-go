...
// Experimental.
type AwsS3TablesTableBucketConfig struct {
	// Experimental.
	...
	// Experimental.
	EncryptionConfiguration *AwsS3TablesTableBucket_EncryptionConfigurationProperty `field:"optional" json:"encryptionConfiguration" yaml:"encryptionConfiguration"`
	...
	// Experimental.
	MaintenanceConfiguration *AwsS3TablesTableBucket_MaintenanceConfigurationProperty `field:"optional" json:"maintenanceConfiguration" yaml:"maintenanceConfiguration"`
