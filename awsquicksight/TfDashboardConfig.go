...
type TfDashboardConfig struct {
	...
	// Experimental.
	DashboardPublishOptions *TfDashboard_DashboardPublishOptionsProperty `field:"optional" json:"dashboardPublishOptions" yaml:"dashboardPublishOptions"`
	// definition block.
	//
	...
	// Experimental.
	Parameters *TfDashboard_ParametersProperty `field:"optional" json:"parameters" yaml:"parameters"`
	// permissions block.
	//
	...
	// Experimental.
	SourceEntity *TfDashboard_SourceEntityProperty `field:"optional" json:"sourceEntity" yaml:"sourceEntity"`
	...
	// Experimental.
	Timeouts *TfDashboard_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
