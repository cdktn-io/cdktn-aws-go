...
// Experimental.
type AwsQuicksightAnalysisConfig struct {
	// Experimental.
	...
	// Experimental.
	Parameters *AwsQuicksightAnalysis_ParametersProperty `field:"optional" json:"parameters" yaml:"parameters"`
	// permissions block.
	//
	...
	// Experimental.
	SourceEntity *AwsQuicksightAnalysis_SourceEntityProperty `field:"optional" json:"sourceEntity" yaml:"sourceEntity"`
	...
	// Experimental.
	Timeouts *AwsQuicksightAnalysis_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
