...
type DataAwsQuicksightTheme interface {
	...
	// Experimental.
	Configuration() DataAwsQuicksightTheme_ConfigurationPropertyList
	// Experimental.
	...
	// Experimental.
	Permissions() DataAwsQuicksightTheme_PermissionsPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsQuicksightTheme) Configuration() DataAwsQuicksightTheme_ConfigurationPropertyList {
	var returns DataAwsQuicksightTheme_ConfigurationPropertyList
	_jsii_.Get(
		j,
		"configuration",
		&returns,
...
func (j *jsiiProxy_DataAwsQuicksightTheme) Permissions() DataAwsQuicksightTheme_PermissionsPropertyList {
	var returns DataAwsQuicksightTheme_PermissionsPropertyList
	_jsii_.Get(
		j,
		"permissions",
		&returns,
...
func NewDataAwsQuicksightTheme(scope constructs.Construct, id *string, config *DataAwsQuicksightThemeConfig) DataAwsQuicksightTheme {
	...
	_jsii_.Create(
		"@cdktn/aws-quicksight.DataAwsQuicksightTheme",
