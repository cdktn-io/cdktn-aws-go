...
type TfDataSourceConfig struct {
	...
	// Experimental.
	Parameters *TfDataSource_ParametersProperty `field:"required" json:"parameters" yaml:"parameters"`
	...
	// Experimental.
	Credentials *TfDataSource_CredentialsProperty `field:"optional" json:"credentials" yaml:"credentials"`
	...
	// Experimental.
	SslProperties *TfDataSource_SslPropertiesProperty `field:"optional" json:"sslProperties" yaml:"sslProperties"`
	...
	// Experimental.
	VpcConnectionProperties *TfDataSource_VpcConnectionPropertiesProperty `field:"optional" json:"vpcConnectionProperties" yaml:"vpcConnectionProperties"`
}
