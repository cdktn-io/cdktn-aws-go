...
// Experimental.
type AwsQuicksightThemeConfig struct {
	// Experimental.
	...
	// Experimental.
	Configuration *AwsQuicksightTheme_ConfigurationProperty `field:"optional" json:"configuration" yaml:"configuration"`
	...
	// Experimental.
	Timeouts *AwsQuicksightTheme_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
