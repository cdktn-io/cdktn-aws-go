...
// Experimental.
type AwsStackSetInstanceConfig struct {
	// Experimental.
	...
	// Experimental.
	DeploymentTargets *AwsStackSetInstance_DeploymentTargetsProperty `field:"optional" json:"deploymentTargets" yaml:"deploymentTargets"`
	...
	// Experimental.
	OperationPreferences *AwsStackSetInstance_OperationPreferencesProperty `field:"optional" json:"operationPreferences" yaml:"operationPreferences"`
	...
	// Experimental.
	Timeouts *AwsStackSetInstance_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
