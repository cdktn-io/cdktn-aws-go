...
func (j *jsiiProxy_DataTfEndpoint) EndpointAddress() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endpointAddress",
...
func (j *jsiiProxy_DataTfEndpoint) EndpointTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endpointTypeInput",
...
func (j *jsiiProxy_DataTfEndpoint)SetEndpointType(val *string) {
...
func (d *jsiiProxy_DataTfEndpoint) ResetEndpointType() {
	_jsii_.InvokeVoid(
		d,
		"resetEndpointType",
		nil, // no parameters
