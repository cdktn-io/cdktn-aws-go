...
// Experimental.
type AwsIotDomainConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	AuthorizerConfig *AwsIotDomainConfiguration_AuthorizerConfigProperty `field:"optional" json:"authorizerConfig" yaml:"authorizerConfig"`
	...
	// Experimental.
	TlsConfig *AwsIotDomainConfiguration_TlsConfigProperty `field:"optional" json:"tlsConfig" yaml:"tlsConfig"`
