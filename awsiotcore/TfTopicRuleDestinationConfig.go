...
// Experimental.
type TfTopicRuleDestinationConfig struct {
	// Experimental.
	...
	// Experimental.
	VpcConfiguration *TfTopicRuleDestination_VpcConfigurationProperty `field:"required" json:"vpcConfiguration" yaml:"vpcConfiguration"`
	...
	// Experimental.
	Timeouts *TfTopicRuleDestination_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
