...
// Experimental.
type AwsIotTopicRule_ErrorActionTimestreamProperty struct {
	...
	// Experimental.
	Timestamp *AwsIotTopicRule_ErrorActionTimestreamTimestampProperty `field:"optional" json:"timestamp" yaml:"timestamp"`
}
