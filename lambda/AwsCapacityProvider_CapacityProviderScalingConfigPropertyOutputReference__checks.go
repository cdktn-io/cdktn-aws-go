...
func (a *jsiiProxy_AwsCapacityProvider_CapacityProviderScalingConfigPropertyOutputReference) validatePutScalingPoliciesParameters(value interface{}) error {
	...
	case *[]*AwsCapacityProvider_ScalingPoliciesProperty:
		value := value.(*[]*AwsCapacityProvider_ScalingPoliciesProperty)
	...
	case []*AwsCapacityProvider_ScalingPoliciesProperty:
		value_ := value.([]*AwsCapacityProvider_ScalingPoliciesProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AwsCapacityProvider_ScalingPoliciesProperty; received %#v (a %T)", value, value)
		}
	}
