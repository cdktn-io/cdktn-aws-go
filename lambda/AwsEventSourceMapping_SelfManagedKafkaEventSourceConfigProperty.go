...
// Experimental.
type AwsEventSourceMapping_SelfManagedKafkaEventSourceConfigProperty struct {
	...
	// Experimental.
	SchemaRegistryConfig *AwsEventSourceMapping_SelfManagedKafkaEventSourceConfigSchemaRegistryConfigProperty `field:"optional" json:"schemaRegistryConfig" yaml:"schemaRegistryConfig"`
}
