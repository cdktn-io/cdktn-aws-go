...
type AwsAliasConfig struct {
	...
	// Experimental.
	RoutingConfig *AwsAlias_RoutingConfigProperty `field:"optional" json:"routingConfig" yaml:"routingConfig"`
	// timeouts block.
	//
	...
	// Experimental.
	Timeouts *AwsAlias_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
