...
func (j *jsiiProxy_AwsCapacityProvider_InstanceRequirementsPropertyOutputReference) Architectures() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"architectures",
...
func (j *jsiiProxy_AwsCapacityProvider_InstanceRequirementsPropertyOutputReference) ArchitecturesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"architecturesInput",
...
func (j *jsiiProxy_AwsCapacityProvider_InstanceRequirementsPropertyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
// Experimental.
func NewAwsCapacityProvider_InstanceRequirementsPropertyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) AwsCapacityProvider_InstanceRequirementsPropertyOutputReference {
	_init_.Initialize()

	if err := validateNewAwsCapacityProvider_InstanceRequirementsPropertyOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
// Experimental.
func NewAwsCapacityProvider_InstanceRequirementsPropertyOutputReference_Override(a AwsCapacityProvider_InstanceRequirementsPropertyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AwsCapacityProvider_InstanceRequirementsPropertyOutputReference)SetArchitectures(val *[]*string) {
...
func (j *jsiiProxy_AwsCapacityProvider_InstanceRequirementsPropertyOutputReference)SetInternalValue(val interface{}) {
...
func (a *jsiiProxy_AwsCapacityProvider_InstanceRequirementsPropertyOutputReference) ResetArchitectures() {
	_jsii_.InvokeVoid(
		a,
		"resetArchitectures",
		nil, // no parameters
