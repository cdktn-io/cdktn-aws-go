...
type TfReplicationConfigurationConfig struct {
	...
	// Experimental.
	ReplicationConfiguration *TfReplicationConfiguration_ReplicationConfigurationProperty `field:"optional" json:"replicationConfiguration" yaml:"replicationConfiguration"`
}
