...
type TfRepositoryConfig struct {
	...
	// Experimental.
	ImageScanningConfiguration *TfRepository_ImageScanningConfigurationProperty `field:"optional" json:"imageScanningConfiguration" yaml:"imageScanningConfiguration"`
