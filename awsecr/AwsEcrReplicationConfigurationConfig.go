...
// Experimental.
type AwsEcrReplicationConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	ReplicationConfiguration *AwsEcrReplicationConfiguration_ReplicationConfigurationProperty `field:"optional" json:"replicationConfiguration" yaml:"replicationConfiguration"`
}
