...
type DataAwsEcrRepositoryCreationTemplate interface {
	...
	Description() *string
	// Experimental.
	EncryptionConfiguration() DataAwsEcrRepositoryCreationTemplate_EncryptionConfigurationPropertyList
	// Experimental.
	...
	// Experimental.
	ImageTagMutabilityExclusionFilter() DataAwsEcrRepositoryCreationTemplate_ImageTagMutabilityExclusionFilterPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsEcrRepositoryCreationTemplate) EncryptionConfiguration() DataAwsEcrRepositoryCreationTemplate_EncryptionConfigurationPropertyList {
	var returns DataAwsEcrRepositoryCreationTemplate_EncryptionConfigurationPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsEcrRepositoryCreationTemplate) ImageTagMutabilityExclusionFilter() DataAwsEcrRepositoryCreationTemplate_ImageTagMutabilityExclusionFilterPropertyList {
	var returns DataAwsEcrRepositoryCreationTemplate_ImageTagMutabilityExclusionFilterPropertyList
	_jsii_.Get(
		j,
