...
// Experimental.
type TfAlbTargetGroupConfig struct {
	// Experimental.
	...
	// Experimental.
	HealthCheck *TfAlbTargetGroup_HealthCheckProperty `field:"optional" json:"healthCheck" yaml:"healthCheck"`
	...
	// Experimental.
	Stickiness *TfAlbTargetGroup_StickinessProperty `field:"optional" json:"stickiness" yaml:"stickiness"`
	...
	// Experimental.
	TargetGroupHealth *TfAlbTargetGroup_TargetGroupHealthProperty `field:"optional" json:"targetGroupHealth" yaml:"targetGroupHealth"`
