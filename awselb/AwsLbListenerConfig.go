...
// Experimental.
type AwsLbListenerConfig struct {
	// Experimental.
	...
	// Experimental.
	MutualAuthentication *AwsLbListener_MutualAuthenticationProperty `field:"optional" json:"mutualAuthentication" yaml:"mutualAuthentication"`
	...
	// Experimental.
	Timeouts *AwsLbListener_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
