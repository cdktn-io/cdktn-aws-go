...
type DataAwsLbListener interface {
	...
	// Experimental.
	DefaultAction() DataAwsLbListener_DefaultActionPropertyList
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
	...
	// Experimental.
	MutualAuthentication() DataAwsLbListener_MutualAuthenticationPropertyList
	// The tree node.
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsLbListener_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsLbListener_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsLbListener) DefaultAction() DataAwsLbListener_DefaultActionPropertyList {
	var returns DataAwsLbListener_DefaultActionPropertyList
	_jsii_.Get(
		j,
		"defaultAction",
		&returns,
...
func (j *jsiiProxy_DataAwsLbListener) MutualAuthentication() DataAwsLbListener_MutualAuthenticationPropertyList {
	var returns DataAwsLbListener_MutualAuthenticationPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsLbListener) Timeouts() DataAwsLbListener_TimeoutsPropertyOutputReference {
	var returns DataAwsLbListener_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewDataAwsLbListener(scope constructs.Construct, id *string, config *DataAwsLbListenerConfig) DataAwsLbListener {
	...
	_jsii_.Create(
		"@cdktn/aws-elb.DataAwsLbListener",
...
func (d *jsiiProxy_DataAwsLbListener) PutTimeouts(value *DataAwsLbListener_TimeoutsProperty) {
