...
// Experimental.
type TfAlbListenerConfig struct {
	// Experimental.
	...
	// Experimental.
	MutualAuthentication *TfAlbListener_MutualAuthenticationProperty `field:"optional" json:"mutualAuthentication" yaml:"mutualAuthentication"`
	...
	// Experimental.
	Timeouts *TfAlbListener_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
