...
type TfLbConfig struct {
	...
	// Experimental.
	AccessLogs *TfLb_AccessLogsProperty `field:"optional" json:"accessLogs" yaml:"accessLogs"`
	...
	// Experimental.
	ConnectionLogs *TfLb_ConnectionLogsProperty `field:"optional" json:"connectionLogs" yaml:"connectionLogs"`
	...
	// Experimental.
	HealthCheckLogs *TfLb_HealthCheckLogsProperty `field:"optional" json:"healthCheckLogs" yaml:"healthCheckLogs"`
	...
	// Experimental.
	IpamPools *TfLb_IpamPoolsProperty `field:"optional" json:"ipamPools" yaml:"ipamPools"`
	...
	// Experimental.
	MinimumLoadBalancerCapacity *TfLb_MinimumLoadBalancerCapacityProperty `field:"optional" json:"minimumLoadBalancerCapacity" yaml:"minimumLoadBalancerCapacity"`
	...
	// Experimental.
	Timeouts *TfLb_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
