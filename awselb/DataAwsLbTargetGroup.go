...
type DataAwsLbTargetGroup interface {
	...
	// Experimental.
	HealthCheck() DataAwsLbTargetGroup_HealthCheckPropertyList
	// Experimental.
	Id() *string
	// Experimental.
	SetId(val *string)
	...
	SlowStart() *float64
	// Experimental.
	Stickiness() DataAwsLbTargetGroup_StickinessPropertyList
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsLbTargetGroup_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsLbTargetGroup_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsLbTargetGroup) HealthCheck() DataAwsLbTargetGroup_HealthCheckPropertyList {
	var returns DataAwsLbTargetGroup_HealthCheckPropertyList
	_jsii_.Get(
		j,
		"healthCheck",
		&returns,
...
func (j *jsiiProxy_DataAwsLbTargetGroup) Stickiness() DataAwsLbTargetGroup_StickinessPropertyList {
	var returns DataAwsLbTargetGroup_StickinessPropertyList
	_jsii_.Get(
		j,
		"stickiness",
		&returns,
...
func (j *jsiiProxy_DataAwsLbTargetGroup) Timeouts() DataAwsLbTargetGroup_TimeoutsPropertyOutputReference {
	var returns DataAwsLbTargetGroup_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewDataAwsLbTargetGroup(scope constructs.Construct, id *string, config *DataAwsLbTargetGroupConfig) DataAwsLbTargetGroup {
	...
	_jsii_.Create(
		"@cdktn/aws-elb.DataAwsLbTargetGroup",
...
func (d *jsiiProxy_DataAwsLbTargetGroup) PutTimeouts(value *DataAwsLbTargetGroup_TimeoutsProperty) {
