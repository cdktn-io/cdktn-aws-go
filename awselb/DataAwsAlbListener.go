...
type DataAwsAlbListener interface {
	...
	// Experimental.
	DefaultAction() DataAwsAlbListener_DefaultActionPropertyList
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
	...
	// Experimental.
	MutualAuthentication() DataAwsAlbListener_MutualAuthenticationPropertyList
	// The tree node.
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsAlbListener_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsAlbListener_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsAlbListener) DefaultAction() DataAwsAlbListener_DefaultActionPropertyList {
	var returns DataAwsAlbListener_DefaultActionPropertyList
	_jsii_.Get(
		j,
		"defaultAction",
		&returns,
...
func (j *jsiiProxy_DataAwsAlbListener) MutualAuthentication() DataAwsAlbListener_MutualAuthenticationPropertyList {
	var returns DataAwsAlbListener_MutualAuthenticationPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsAlbListener) Timeouts() DataAwsAlbListener_TimeoutsPropertyOutputReference {
	var returns DataAwsAlbListener_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewDataAwsAlbListener(scope constructs.Construct, id *string, config *DataAwsAlbListenerConfig) DataAwsAlbListener {
	...
	_jsii_.Create(
		"@cdktn/aws-elb.DataAwsAlbListener",
...
func (d *jsiiProxy_DataAwsAlbListener) PutTimeouts(value *DataAwsAlbListener_TimeoutsProperty) {
