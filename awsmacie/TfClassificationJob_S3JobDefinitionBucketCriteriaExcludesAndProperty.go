...
// Experimental.
type TfClassificationJob_S3JobDefinitionBucketCriteriaExcludesAndProperty struct {
	...
	// Experimental.
	SimpleCriterion *TfClassificationJob_S3JobDefinitionBucketCriteriaExcludesAndSimpleCriterionProperty `field:"optional" json:"simpleCriterion" yaml:"simpleCriterion"`
	// tag_criterion block.
	//
	...
	// Experimental.
	TagCriterion *TfClassificationJob_S3JobDefinitionBucketCriteriaExcludesAndTagCriterionProperty `field:"optional" json:"tagCriterion" yaml:"tagCriterion"`
}
