...
// Experimental.
type AwsMacie2ClassificationJob_S3JobDefinitionScopingIncludesAndProperty struct {
	...
	// Experimental.
	SimpleScopeTerm *AwsMacie2ClassificationJob_S3JobDefinitionScopingIncludesAndSimpleScopeTermProperty `field:"optional" json:"simpleScopeTerm" yaml:"simpleScopeTerm"`
	...
	// Experimental.
	TagScopeTerm *AwsMacie2ClassificationJob_S3JobDefinitionScopingIncludesAndTagScopeTermProperty `field:"optional" json:"tagScopeTerm" yaml:"tagScopeTerm"`
}
