...
// Experimental.
type TfFindingsFilterConfig struct {
	// Experimental.
	...
	// Experimental.
	FindingCriteria *TfFindingsFilter_FindingCriteriaProperty `field:"required" json:"findingCriteria" yaml:"findingCriteria"`
	...
	// Experimental.
	Timeouts *TfFindingsFilter_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
