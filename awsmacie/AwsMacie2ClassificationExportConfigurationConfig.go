...
// Experimental.
type AwsMacie2ClassificationExportConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	S3Destination *AwsMacie2ClassificationExportConfiguration_S3DestinationProperty `field:"required" json:"s3Destination" yaml:"s3Destination"`
