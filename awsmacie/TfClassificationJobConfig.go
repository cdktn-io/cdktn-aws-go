...
// Experimental.
type TfClassificationJobConfig struct {
	// Experimental.
	...
	// Experimental.
	S3JobDefinition *TfClassificationJob_S3JobDefinitionProperty `field:"required" json:"s3JobDefinition" yaml:"s3JobDefinition"`
	...
	// Experimental.
	ScheduleFrequency *TfClassificationJob_ScheduleFrequencyProperty `field:"optional" json:"scheduleFrequency" yaml:"scheduleFrequency"`
	...
	// Experimental.
	Timeouts *TfClassificationJob_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
