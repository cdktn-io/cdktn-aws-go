...
// Experimental.
type TfClassificationJob_S3JobDefinitionScopingExcludesAndProperty struct {
	...
	// Experimental.
	SimpleScopeTerm *TfClassificationJob_S3JobDefinitionScopingExcludesAndSimpleScopeTermProperty `field:"optional" json:"simpleScopeTerm" yaml:"simpleScopeTerm"`
	...
	// Experimental.
	TagScopeTerm *TfClassificationJob_S3JobDefinitionScopingExcludesAndTagScopeTermProperty `field:"optional" json:"tagScopeTerm" yaml:"tagScopeTerm"`
}
