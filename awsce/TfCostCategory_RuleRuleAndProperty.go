...
// Experimental.
type TfCostCategory_RuleRuleAndProperty struct {
	// and block.
	//
	...
	// Experimental.
	CostCategory *TfCostCategory_RuleRuleAndCostCategoryProperty `field:"optional" json:"costCategory" yaml:"costCategory"`
	// dimension block.
	//
	...
	// Experimental.
	Dimension *TfCostCategory_RuleRuleAndDimensionProperty `field:"optional" json:"dimension" yaml:"dimension"`
	// not block.
	//
	...
	// Experimental.
	Not *TfCostCategory_RuleRuleAndNotProperty `field:"optional" json:"not" yaml:"not"`
	// or block.
	//
	...
	// Experimental.
	Tags *TfCostCategory_RuleRuleAndTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
