...
// Experimental.
type AwsCeCostCategory_RuleRuleNotAndProperty struct {
	// cost_category block.
	//
	...
	// Experimental.
	CostCategory *AwsCeCostCategory_RuleRuleNotAndCostCategoryProperty `field:"optional" json:"costCategory" yaml:"costCategory"`
	// dimension block.
	//
	...
	// Experimental.
	Dimension *AwsCeCostCategory_RuleRuleNotAndDimensionProperty `field:"optional" json:"dimension" yaml:"dimension"`
	// tags block.
	//
	...
	// Experimental.
	Tags *AwsCeCostCategory_RuleRuleNotAndTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
