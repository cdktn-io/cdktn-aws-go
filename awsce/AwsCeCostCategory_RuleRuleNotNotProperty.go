...
// Experimental.
type AwsCeCostCategory_RuleRuleNotNotProperty struct {
	// cost_category block.
	//
	...
	// Experimental.
	CostCategory *AwsCeCostCategory_RuleRuleNotNotCostCategoryProperty `field:"optional" json:"costCategory" yaml:"costCategory"`
	// dimension block.
	//
	...
	// Experimental.
	Dimension *AwsCeCostCategory_RuleRuleNotNotDimensionProperty `field:"optional" json:"dimension" yaml:"dimension"`
	// tags block.
	//
	...
	// Experimental.
	Tags *AwsCeCostCategory_RuleRuleNotNotTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
