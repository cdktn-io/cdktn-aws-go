...
// Experimental.
type AwsCeCostCategory_RuleRuleAndProperty struct {
	// and block.
	//
	...
	// Experimental.
	CostCategory *AwsCeCostCategory_RuleRuleAndCostCategoryProperty `field:"optional" json:"costCategory" yaml:"costCategory"`
	// dimension block.
	//
	...
	// Experimental.
	Dimension *AwsCeCostCategory_RuleRuleAndDimensionProperty `field:"optional" json:"dimension" yaml:"dimension"`
	// not block.
	//
	...
	// Experimental.
	Not *AwsCeCostCategory_RuleRuleAndNotProperty `field:"optional" json:"not" yaml:"not"`
	// or block.
	//
	...
	// Experimental.
	Tags *AwsCeCostCategory_RuleRuleAndTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
