...
// Experimental.
type TfAnomalySubscriptionConfig struct {
	// Experimental.
	...
	// Experimental.
	ThresholdExpression *TfAnomalySubscription_ThresholdExpressionProperty `field:"optional" json:"thresholdExpression" yaml:"thresholdExpression"`
}
