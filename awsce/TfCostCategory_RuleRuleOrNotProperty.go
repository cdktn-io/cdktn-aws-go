...
// Experimental.
type TfCostCategory_RuleRuleOrNotProperty struct {
	// cost_category block.
	//
	...
	// Experimental.
	CostCategory *TfCostCategory_RuleRuleOrNotCostCategoryProperty `field:"optional" json:"costCategory" yaml:"costCategory"`
	// dimension block.
	//
	...
	// Experimental.
	Dimension *TfCostCategory_RuleRuleOrNotDimensionProperty `field:"optional" json:"dimension" yaml:"dimension"`
	// tags block.
	//
	...
	// Experimental.
	Tags *TfCostCategory_RuleRuleOrNotTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
