...
// Experimental.
type DataAwsCeTags_FilterProperty struct {
	// and block.
	//
	...
	// Experimental.
	CostCategory *DataAwsCeTags_FilterCostCategoryProperty `field:"optional" json:"costCategory" yaml:"costCategory"`
	// dimension block.
	//
	...
	// Experimental.
	Dimension *DataAwsCeTags_FilterDimensionProperty `field:"optional" json:"dimension" yaml:"dimension"`
	// not block.
	//
	...
	// Experimental.
	Not *DataAwsCeTags_NotProperty `field:"optional" json:"not" yaml:"not"`
	// or block.
	//
	...
	// Experimental.
	Tags *DataAwsCeTags_FilterTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
