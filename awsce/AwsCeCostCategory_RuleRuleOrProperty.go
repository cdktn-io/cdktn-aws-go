...
// Experimental.
type AwsCeCostCategory_RuleRuleOrProperty struct {
	// and block.
	//
	...
	// Experimental.
	CostCategory *AwsCeCostCategory_RuleRuleOrCostCategoryProperty `field:"optional" json:"costCategory" yaml:"costCategory"`
	// dimension block.
	//
	...
	// Experimental.
	Dimension *AwsCeCostCategory_RuleRuleOrDimensionProperty `field:"optional" json:"dimension" yaml:"dimension"`
	// not block.
	//
	...
	// Experimental.
	Not *AwsCeCostCategory_RuleRuleOrNotProperty `field:"optional" json:"not" yaml:"not"`
	// or block.
	//
	...
	// Experimental.
	Tags *AwsCeCostCategory_RuleRuleOrTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
