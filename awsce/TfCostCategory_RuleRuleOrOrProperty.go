...
// Experimental.
type TfCostCategory_RuleRuleOrOrProperty struct {
	// cost_category block.
	//
	...
	// Experimental.
	CostCategory *TfCostCategory_RuleRuleOrOrCostCategoryProperty `field:"optional" json:"costCategory" yaml:"costCategory"`
	// dimension block.
	//
	...
	// Experimental.
	Dimension *TfCostCategory_RuleRuleOrOrDimensionProperty `field:"optional" json:"dimension" yaml:"dimension"`
	// tags block.
	//
	...
	// Experimental.
	Tags *TfCostCategory_RuleRuleOrOrTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
