...
// Experimental.
type AwsCeCostCategory_RuleRuleOrNotProperty struct {
	// cost_category block.
	//
	...
	// Experimental.
	CostCategory *AwsCeCostCategory_RuleRuleOrNotCostCategoryProperty `field:"optional" json:"costCategory" yaml:"costCategory"`
	// dimension block.
	//
	...
	// Experimental.
	Dimension *AwsCeCostCategory_RuleRuleOrNotDimensionProperty `field:"optional" json:"dimension" yaml:"dimension"`
	// tags block.
	//
	...
	// Experimental.
	Tags *AwsCeCostCategory_RuleRuleOrNotTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
