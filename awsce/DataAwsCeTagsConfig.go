...
type DataAwsCeTagsConfig struct {
	...
	// Experimental.
	TimePeriod *DataAwsCeTags_TimePeriodProperty `field:"required" json:"timePeriod" yaml:"timePeriod"`
	// filter block.
	//
	...
	// Experimental.
	Filter *DataAwsCeTags_FilterProperty `field:"optional" json:"filter" yaml:"filter"`
