...
// Experimental.
type TfCostCategory_RuleRuleNotProperty struct {
	// and block.
	//
	...
	// Experimental.
	CostCategory *TfCostCategory_RuleRuleNotCostCategoryProperty `field:"optional" json:"costCategory" yaml:"costCategory"`
	// dimension block.
	//
	...
	// Experimental.
	Dimension *TfCostCategory_RuleRuleNotDimensionProperty `field:"optional" json:"dimension" yaml:"dimension"`
	// not block.
	//
	...
	// Experimental.
	Not *TfCostCategory_RuleRuleNotNotProperty `field:"optional" json:"not" yaml:"not"`
	// or block.
	//
	...
	// Experimental.
	Tags *TfCostCategory_RuleRuleNotTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
