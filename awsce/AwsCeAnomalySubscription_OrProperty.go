...
// Experimental.
type AwsCeAnomalySubscription_OrProperty struct {
	// cost_category block.
	//
	...
	// Experimental.
	CostCategory *AwsCeAnomalySubscription_ThresholdExpressionOrCostCategoryProperty `field:"optional" json:"costCategory" yaml:"costCategory"`
	// dimension block.
	//
	...
	// Experimental.
	Dimension *AwsCeAnomalySubscription_ThresholdExpressionOrDimensionProperty `field:"optional" json:"dimension" yaml:"dimension"`
	// tags block.
	//
	...
	// Experimental.
	Tags *AwsCeAnomalySubscription_ThresholdExpressionOrTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
