...
type DataTfTagsConfig struct {
	...
	// Experimental.
	TimePeriod *DataTfTags_TimePeriodProperty `field:"required" json:"timePeriod" yaml:"timePeriod"`
	// filter block.
	//
	...
	// Experimental.
	Filter *DataTfTags_FilterProperty `field:"optional" json:"filter" yaml:"filter"`
