...
// Experimental.
type AwsTransitGatewayConnectPeerAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsTransitGatewayConnectPeerAssociation_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
