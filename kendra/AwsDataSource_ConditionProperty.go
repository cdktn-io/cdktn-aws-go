...
// Experimental.
type AwsDataSource_ConditionProperty struct {
	...
	// Experimental.
	ConditionOnValue *AwsDataSource_CustomDocumentEnrichmentConfigurationInlineConfigurationsConditionConditionOnValueProperty `field:"optional" json:"conditionOnValue" yaml:"conditionOnValue"`
}
