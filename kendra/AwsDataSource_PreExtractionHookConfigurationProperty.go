...
// Experimental.
type AwsDataSource_PreExtractionHookConfigurationProperty struct {
	...
	// Experimental.
	InvocationCondition *AwsDataSource_CustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationConditionProperty `field:"optional" json:"invocationCondition" yaml:"invocationCondition"`
}
