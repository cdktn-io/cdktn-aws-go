...
func (j *jsiiProxy_AwsProvider) validateSetAssumeRoleParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*AwsProvider_AssumeRoleProperty:
		val := val.(*[]*AwsProvider_AssumeRoleProperty)
	...
	case []*AwsProvider_AssumeRoleProperty:
		val_ := val.([]*AwsProvider_AssumeRoleProperty)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*AwsProvider_AssumeRoleProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_AwsProvider) validateSetAssumeRoleWithWebIdentityParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*AwsProvider_AssumeRoleWithWebIdentityProperty:
		val := val.(*[]*AwsProvider_AssumeRoleWithWebIdentityProperty)
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
			}
	...
	case []*AwsProvider_AssumeRoleWithWebIdentityProperty:
		val_ := val.([]*AwsProvider_AssumeRoleWithWebIdentityProperty)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*AwsProvider_AssumeRoleWithWebIdentityProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_AwsProvider) validateSetDefaultTagsParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*AwsProvider_DefaultTagsProperty:
		val := val.(*[]*AwsProvider_DefaultTagsProperty)
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
			}
	...
	case []*AwsProvider_DefaultTagsProperty:
		val_ := val.([]*AwsProvider_DefaultTagsProperty)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*AwsProvider_DefaultTagsProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_AwsProvider) validateSetEndpointsParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*AwsProvider_EndpointsProperty:
		val := val.(*[]*AwsProvider_EndpointsProperty)
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
			}
	...
	case []*AwsProvider_EndpointsProperty:
		val_ := val.([]*AwsProvider_EndpointsProperty)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*AwsProvider_EndpointsProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_AwsProvider) validateSetIgnoreTagsParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*AwsProvider_IgnoreTagsProperty:
		val := val.(*[]*AwsProvider_IgnoreTagsProperty)
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
			}
	...
	case []*AwsProvider_IgnoreTagsProperty:
		val_ := val.([]*AwsProvider_IgnoreTagsProperty)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*AwsProvider_IgnoreTagsProperty; received %#v (a %T)", val, val)
		}
	}
