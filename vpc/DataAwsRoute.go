...
type DataAwsRoute interface {
	...
	// Experimental.
	Timeouts() DataAwsRoute_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsRoute_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsRoute) Timeouts() DataAwsRoute_TimeoutsPropertyOutputReference {
	var returns DataAwsRoute_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (d *jsiiProxy_DataAwsRoute) PutTimeouts(value *DataAwsRoute_TimeoutsProperty) {
