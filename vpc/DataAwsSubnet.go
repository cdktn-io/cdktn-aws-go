...
type DataAwsSubnet interface {
	...
	// Experimental.
	Filter() DataAwsSubnet_FilterPropertyList
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsSubnet_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsSubnet_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsSubnet) Filter() DataAwsSubnet_FilterPropertyList {
	var returns DataAwsSubnet_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsSubnet) Timeouts() DataAwsSubnet_TimeoutsPropertyOutputReference {
	var returns DataAwsSubnet_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (d *jsiiProxy_DataAwsSubnet) PutTimeouts(value *DataAwsSubnet_TimeoutsProperty) {
