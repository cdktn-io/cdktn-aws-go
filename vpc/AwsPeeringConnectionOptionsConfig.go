...
// Experimental.
type AwsPeeringConnectionOptionsConfig struct {
	// Experimental.
	...
	// Experimental.
	Accepter *AwsPeeringConnectionOptions_AccepterProperty `field:"optional" json:"accepter" yaml:"accepter"`
	...
	// Experimental.
	Requester *AwsPeeringConnectionOptions_RequesterProperty `field:"optional" json:"requester" yaml:"requester"`
}
