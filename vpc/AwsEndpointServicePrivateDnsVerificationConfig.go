...
// Experimental.
type AwsEndpointServicePrivateDnsVerificationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsEndpointServicePrivateDnsVerification_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
