...
// Experimental.
type AwsEc2NetworkInsightsPath_FilterAtDestinationProperty struct {
	...
	// Experimental.
	DestinationPortRange *AwsEc2NetworkInsightsPath_FilterAtDestinationDestinationPortRangeProperty `field:"optional" json:"destinationPortRange" yaml:"destinationPortRange"`
	...
	// Experimental.
	SourcePortRange *AwsEc2NetworkInsightsPath_FilterAtDestinationSourcePortRangeProperty `field:"optional" json:"sourcePortRange" yaml:"sourcePortRange"`
}
