...
// Experimental.
type AwsInsight_ThreatIntelIndicatorLastObservedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *AwsInsight_FiltersThreatIntelIndicatorLastObservedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
