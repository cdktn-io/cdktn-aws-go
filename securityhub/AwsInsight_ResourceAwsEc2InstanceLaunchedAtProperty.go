...
// Experimental.
type AwsInsight_ResourceAwsEc2InstanceLaunchedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *AwsInsight_FiltersResourceAwsEc2InstanceLaunchedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
