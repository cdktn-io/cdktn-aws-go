...
// Experimental.
type AwsInsight_ResourceContainerLaunchedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *AwsInsight_FiltersResourceContainerLaunchedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
