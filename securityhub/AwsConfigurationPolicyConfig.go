...
// Experimental.
type AwsConfigurationPolicyConfig struct {
	// Experimental.
	...
	// Experimental.
	ConfigurationPolicy *AwsConfigurationPolicy_ConfigurationPolicyProperty `field:"required" json:"configurationPolicy" yaml:"configurationPolicy"`
