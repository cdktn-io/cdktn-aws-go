...
// Experimental.
type AwsConfigurationPolicyAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsConfigurationPolicyAssociation_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
