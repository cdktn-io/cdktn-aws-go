...
// Experimental.
type AwsInsight_ProcessTerminatedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *AwsInsight_FiltersProcessTerminatedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
