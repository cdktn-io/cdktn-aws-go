...
// Experimental.
type AwsInsight_FirstObservedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *AwsInsight_FiltersFirstObservedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
