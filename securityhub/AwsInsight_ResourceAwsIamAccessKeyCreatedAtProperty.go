...
// Experimental.
type AwsInsight_ResourceAwsIamAccessKeyCreatedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *AwsInsight_FiltersResourceAwsIamAccessKeyCreatedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
