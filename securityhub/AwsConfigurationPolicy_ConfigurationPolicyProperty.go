...
// Experimental.
type AwsConfigurationPolicy_ConfigurationPolicyProperty struct {
	...
	// Experimental.
	SecurityControlsConfiguration *AwsConfigurationPolicy_SecurityControlsConfigurationProperty `field:"optional" json:"securityControlsConfiguration" yaml:"securityControlsConfiguration"`
}
