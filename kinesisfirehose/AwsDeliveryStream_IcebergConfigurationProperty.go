...
// Experimental.
type AwsDeliveryStream_IcebergConfigurationProperty struct {
	...
	// Experimental.
	S3Configuration *AwsDeliveryStream_IcebergConfigurationS3ConfigurationProperty `field:"required" json:"s3Configuration" yaml:"s3Configuration"`
	...
	// Experimental.
	CloudwatchLoggingOptions *AwsDeliveryStream_IcebergConfigurationCloudwatchLoggingOptionsProperty `field:"optional" json:"cloudwatchLoggingOptions" yaml:"cloudwatchLoggingOptions"`
	...
	// Experimental.
	ProcessingConfiguration *AwsDeliveryStream_IcebergConfigurationProcessingConfigurationProperty `field:"optional" json:"processingConfiguration" yaml:"processingConfiguration"`
