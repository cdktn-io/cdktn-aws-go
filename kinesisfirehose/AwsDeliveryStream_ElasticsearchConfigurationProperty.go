...
// Experimental.
type AwsDeliveryStream_ElasticsearchConfigurationProperty struct {
	...
	// Experimental.
	S3Configuration *AwsDeliveryStream_ElasticsearchConfigurationS3ConfigurationProperty `field:"required" json:"s3Configuration" yaml:"s3Configuration"`
	...
	// Experimental.
	CloudwatchLoggingOptions *AwsDeliveryStream_ElasticsearchConfigurationCloudwatchLoggingOptionsProperty `field:"optional" json:"cloudwatchLoggingOptions" yaml:"cloudwatchLoggingOptions"`
	...
	// Experimental.
	ProcessingConfiguration *AwsDeliveryStream_ElasticsearchConfigurationProcessingConfigurationProperty `field:"optional" json:"processingConfiguration" yaml:"processingConfiguration"`
	...
	// Experimental.
	VpcConfig *AwsDeliveryStream_ElasticsearchConfigurationVpcConfigProperty `field:"optional" json:"vpcConfig" yaml:"vpcConfig"`
}
