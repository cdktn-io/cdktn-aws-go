...
// Experimental.
type AwsDeliveryStream_OpensearchserverlessConfigurationProperty struct {
	...
	// Experimental.
	S3Configuration *AwsDeliveryStream_OpensearchserverlessConfigurationS3ConfigurationProperty `field:"required" json:"s3Configuration" yaml:"s3Configuration"`
	...
	// Experimental.
	CloudwatchLoggingOptions *AwsDeliveryStream_OpensearchserverlessConfigurationCloudwatchLoggingOptionsProperty `field:"optional" json:"cloudwatchLoggingOptions" yaml:"cloudwatchLoggingOptions"`
	...
	// Experimental.
	ProcessingConfiguration *AwsDeliveryStream_OpensearchserverlessConfigurationProcessingConfigurationProperty `field:"optional" json:"processingConfiguration" yaml:"processingConfiguration"`
	...
	// Experimental.
	VpcConfig *AwsDeliveryStream_OpensearchserverlessConfigurationVpcConfigProperty `field:"optional" json:"vpcConfig" yaml:"vpcConfig"`
}
