...
// Experimental.
type AwsDeliveryStream_OpensearchConfigurationProperty struct {
	...
	// Experimental.
	S3Configuration *AwsDeliveryStream_OpensearchConfigurationS3ConfigurationProperty `field:"required" json:"s3Configuration" yaml:"s3Configuration"`
	...
	// Experimental.
	CloudwatchLoggingOptions *AwsDeliveryStream_OpensearchConfigurationCloudwatchLoggingOptionsProperty `field:"optional" json:"cloudwatchLoggingOptions" yaml:"cloudwatchLoggingOptions"`
	...
	// Experimental.
	DocumentIdOptions *AwsDeliveryStream_DocumentIdOptionsProperty `field:"optional" json:"documentIdOptions" yaml:"documentIdOptions"`
	...
	// Experimental.
	ProcessingConfiguration *AwsDeliveryStream_OpensearchConfigurationProcessingConfigurationProperty `field:"optional" json:"processingConfiguration" yaml:"processingConfiguration"`
	...
	// Experimental.
	VpcConfig *AwsDeliveryStream_OpensearchConfigurationVpcConfigProperty `field:"optional" json:"vpcConfig" yaml:"vpcConfig"`
}
