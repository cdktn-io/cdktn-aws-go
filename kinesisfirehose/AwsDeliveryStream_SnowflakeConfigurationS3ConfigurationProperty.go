...
// Experimental.
type AwsDeliveryStream_SnowflakeConfigurationS3ConfigurationProperty struct {
	...
	// Experimental.
	CloudwatchLoggingOptions *AwsDeliveryStream_SnowflakeConfigurationS3ConfigurationCloudwatchLoggingOptionsProperty `field:"optional" json:"cloudwatchLoggingOptions" yaml:"cloudwatchLoggingOptions"`
