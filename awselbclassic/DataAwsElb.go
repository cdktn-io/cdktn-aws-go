...
type DataAwsElb interface {
	...
	// Experimental.
	AccessLogs() DataAwsElb_AccessLogsPropertyList
	// Experimental.
	Arn() *string
	// Experimental.
	...
	// Experimental.
	HealthCheck() DataAwsElb_HealthCheckPropertyList
	// Experimental.
	Id() *string
	// Experimental.
	SetId(val *string)
	...
	// Experimental.
	Listener() DataAwsElb_ListenerPropertyList
	// Experimental.
	Name() *string
	// Experimental.
	SetName(val *string)
...
func (j *jsiiProxy_DataAwsElb) AccessLogs() DataAwsElb_AccessLogsPropertyList {
	var returns DataAwsElb_AccessLogsPropertyList
	_jsii_.Get(
		j,
		"accessLogs",
		&returns,
...
func (j *jsiiProxy_DataAwsElb) HealthCheck() DataAwsElb_HealthCheckPropertyList {
	var returns DataAwsElb_HealthCheckPropertyList
	_jsii_.Get(
		j,
		"healthCheck",
		&returns,
...
func (j *jsiiProxy_DataAwsElb) Listener() DataAwsElb_ListenerPropertyList {
	var returns DataAwsElb_ListenerPropertyList
	_jsii_.Get(
		j,
		"listener",
		&returns,
