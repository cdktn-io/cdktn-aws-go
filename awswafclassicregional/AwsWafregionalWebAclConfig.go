...
// Experimental.
type AwsWafregionalWebAclConfig struct {
	// Experimental.
	...
	// Experimental.
	DefaultAction *AwsWafregionalWebAcl_DefaultActionProperty `field:"required" json:"defaultAction" yaml:"defaultAction"`
	...
	// Experimental.
	LoggingConfiguration *AwsWafregionalWebAcl_LoggingConfigurationProperty `field:"optional" json:"loggingConfiguration" yaml:"loggingConfiguration"`
