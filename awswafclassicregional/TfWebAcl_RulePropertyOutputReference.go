...
func (j *jsiiProxy_TfWebAcl_RulePropertyOutputReference) RuleId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ruleId",
...
func (j *jsiiProxy_TfWebAcl_RulePropertyOutputReference) RuleIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ruleIdInput",
...
func (j *jsiiProxy_TfWebAcl_RulePropertyOutputReference) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_TfWebAcl_RulePropertyOutputReference) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func (j *jsiiProxy_TfWebAcl_RulePropertyOutputReference)SetRuleId(val *string) {
...
func (j *jsiiProxy_TfWebAcl_RulePropertyOutputReference)SetType(val *string) {
...
func (t *jsiiProxy_TfWebAcl_RulePropertyOutputReference) ResetType() {
	_jsii_.InvokeVoid(
		t,
		"resetType",
		nil, // no parameters
