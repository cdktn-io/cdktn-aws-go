...
type TfEnvironment interface {
	...
	// Experimental.
	Monitor() TfEnvironment_MonitorPropertyList
	// Experimental.
...
func (j *jsiiProxy_TfEnvironment) ApplicationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationId",
...
func (j *jsiiProxy_TfEnvironment) ApplicationIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationIdInput",
...
func (j *jsiiProxy_TfEnvironment) EnvironmentId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"environmentId",
...
func (j *jsiiProxy_TfEnvironment) Monitor() TfEnvironment_MonitorPropertyList {
	var returns TfEnvironment_MonitorPropertyList
	_jsii_.Get(
		j,
		"monitor",
		&returns,
...
func (j *jsiiProxy_TfEnvironment) MonitorInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"monitorInput",
...
func (j *jsiiProxy_TfEnvironment) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_TfEnvironment) TagsAll() cdktn.StringMap {
...
func (j *jsiiProxy_TfEnvironment)SetApplicationId(val *string) {
...
func (t *jsiiProxy_TfEnvironment) PutMonitor(value interface{}) {
	if err := t.validatePutMonitorParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		t,
...
func (t *jsiiProxy_TfEnvironment) ResetMonitor() {
	_jsii_.InvokeVoid(
		t,
		"resetMonitor",
		nil, // no parameters
