...
type DataAwsRegions interface {
	...
	// Experimental.
	Regions() DataAwsRegions_RegionsPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsRegions) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_DataAwsRegions) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_DataAwsRegions) RegionOptStatusContains() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsRegions) RegionOptStatusContainsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsRegions) Regions() DataAwsRegions_RegionsPropertyList {
	var returns DataAwsRegions_RegionsPropertyList
	_jsii_.Get(
		j,
		"regions",
		&returns,
...
func NewDataAwsRegions(scope constructs.Construct, id *string, config *DataAwsRegionsConfig) DataAwsRegions {
	...
	_jsii_.Create(
		"@cdktn/aws-account-management.DataAwsRegions",
...
func (j *jsiiProxy_DataAwsRegions)SetAccountId(val *string) {
...
func (j *jsiiProxy_DataAwsRegions)SetRegionOptStatusContains(val *[]*string) {
...
func (d *jsiiProxy_DataAwsRegions) ResetAccountId() {
	_jsii_.InvokeVoid(
		d,
		"resetAccountId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsRegions) ResetRegionOptStatusContains() {
	_jsii_.InvokeVoid(
		d,
		"resetRegionOptStatusContains",
		nil, // no parameters
