...
type DataAwsPollyVoices interface {
	...
	// Experimental.
	Voices() DataAwsPollyVoices_VoicesPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsPollyVoices) Voices() DataAwsPollyVoices_VoicesPropertyList {
	var returns DataAwsPollyVoices_VoicesPropertyList
	_jsii_.Get(
		j,
		"voices",
		&returns,
