...
type DataAwsRoute53TrafficPolicyDocument interface {
	...
	// Experimental.
	Endpoint() DataAwsRoute53TrafficPolicyDocument_EndpointPropertyList
	// Experimental.
	...
	// Experimental.
	Rule() DataAwsRoute53TrafficPolicyDocument_RulePropertyList
	// Experimental.
	RuleInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_DataAwsRoute53TrafficPolicyDocument) Endpoint() DataAwsRoute53TrafficPolicyDocument_EndpointPropertyList {
	var returns DataAwsRoute53TrafficPolicyDocument_EndpointPropertyList
	_jsii_.Get(
		j,
		"endpoint",
		&returns,
...
func (j *jsiiProxy_DataAwsRoute53TrafficPolicyDocument) Rule() DataAwsRoute53TrafficPolicyDocument_RulePropertyList {
	var returns DataAwsRoute53TrafficPolicyDocument_RulePropertyList
	_jsii_.Get(
		j,
		"rule",
		&returns,
