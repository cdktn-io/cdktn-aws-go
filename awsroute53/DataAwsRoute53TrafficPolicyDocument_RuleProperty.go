...
// Experimental.
type DataAwsRoute53TrafficPolicyDocument_RuleProperty struct {
	...
	// Experimental.
	Primary *DataAwsRoute53TrafficPolicyDocument_PrimaryProperty `field:"optional" json:"primary" yaml:"primary"`
	// region block.
	//
	...
	// Experimental.
	Secondary *DataAwsRoute53TrafficPolicyDocument_SecondaryProperty `field:"optional" json:"secondary" yaml:"secondary"`
