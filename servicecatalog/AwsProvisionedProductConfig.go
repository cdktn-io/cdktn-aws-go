...
// Experimental.
type AwsProvisionedProductConfig struct {
	// Experimental.
	...
	// Experimental.
	StackSetProvisioningPreferences *AwsProvisionedProduct_StackSetProvisioningPreferencesProperty `field:"optional" json:"stackSetProvisioningPreferences" yaml:"stackSetProvisioningPreferences"`
	...
	// Experimental.
	Timeouts *AwsProvisionedProduct_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
