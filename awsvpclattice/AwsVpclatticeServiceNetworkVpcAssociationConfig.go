...
// Experimental.
type AwsVpclatticeServiceNetworkVpcAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	DnsOptions *AwsVpclatticeServiceNetworkVpcAssociation_DnsOptionsProperty `field:"optional" json:"dnsOptions" yaml:"dnsOptions"`
	...
	// Experimental.
	Timeouts *AwsVpclatticeServiceNetworkVpcAssociation_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
