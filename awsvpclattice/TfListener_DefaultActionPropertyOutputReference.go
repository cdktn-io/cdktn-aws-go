...
type TfListener_DefaultActionPropertyOutputReference interface {
	...
	// Experimental.
	Forward() TfListener_ForwardPropertyList
	// Experimental.
	ForwardInput() interface{}
	// Experimental.
	Fqn() *string
	// Experimental.
	InternalValue() *TfListener_DefaultActionProperty
	// Experimental.
	SetInternalValue(val *TfListener_DefaultActionProperty)
	// Experimental.
...
func (j *jsiiProxy_TfListener_DefaultActionPropertyOutputReference) Forward() TfListener_ForwardPropertyList {
	var returns TfListener_ForwardPropertyList
	_jsii_.Get(
		j,
		"forward",
		&returns,
...
func (j *jsiiProxy_TfListener_DefaultActionPropertyOutputReference) ForwardInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"forwardInput",
...
func (j *jsiiProxy_TfListener_DefaultActionPropertyOutputReference) InternalValue() *TfListener_DefaultActionProperty {
...
// Experimental.
func NewTfListener_DefaultActionPropertyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) TfListener_DefaultActionPropertyOutputReference {
	_init_.Initialize()

	if err := validateNewTfListener_DefaultActionPropertyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
// Experimental.
func NewTfListener_DefaultActionPropertyOutputReference_Override(t TfListener_DefaultActionPropertyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_TfListener_DefaultActionPropertyOutputReference)SetInternalValue(val *TfListener_DefaultActionProperty) {
...
func (t *jsiiProxy_TfListener_DefaultActionPropertyOutputReference) PutForward(value interface{}) {
