...
// Experimental.
type AwsVpclatticeListenerConfig struct {
	// Experimental.
	...
	// Experimental.
	DefaultAction *AwsVpclatticeListener_DefaultActionProperty `field:"required" json:"defaultAction" yaml:"defaultAction"`
	...
	// Experimental.
	Timeouts *AwsVpclatticeListener_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
