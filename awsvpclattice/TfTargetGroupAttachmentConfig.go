...
// Experimental.
type TfTargetGroupAttachmentConfig struct {
	// Experimental.
	...
	// Experimental.
	Target *TfTargetGroupAttachment_TargetProperty `field:"required" json:"target" yaml:"target"`
	...
	// Experimental.
	Timeouts *TfTargetGroupAttachment_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
