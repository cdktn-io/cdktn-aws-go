...
// Experimental.
type AwsVpclatticeTargetGroupConfig struct {
	// Experimental.
	...
	// Experimental.
	Config *AwsVpclatticeTargetGroup_ConfigProperty `field:"optional" json:"config" yaml:"config"`
	...
	// Experimental.
	Timeouts *AwsVpclatticeTargetGroup_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
