...
// Experimental.
type AwsVpclatticeResourceConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsVpclatticeResourceConfiguration_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
