...
// Experimental.
type AwsVpclatticeListenerRule_PathMatchProperty struct {
	// match block.
	//
	...
	// Experimental.
	Match *AwsVpclatticeListenerRule_MatchHttpMatchPathMatchMatchProperty `field:"required" json:"match" yaml:"match"`
