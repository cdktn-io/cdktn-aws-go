...
// Experimental.
type TfServiceNetworkResourceAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *TfServiceNetworkResourceAssociation_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
