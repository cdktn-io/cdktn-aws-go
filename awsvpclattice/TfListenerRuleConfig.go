...
// Experimental.
type TfListenerRuleConfig struct {
	// Experimental.
	...
	// Experimental.
	Action *TfListenerRule_ActionProperty `field:"required" json:"action" yaml:"action"`
	...
	// Experimental.
	Match *TfListenerRule_MatchProperty `field:"required" json:"match" yaml:"match"`
	...
	// Experimental.
	Timeouts *TfListenerRule_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
