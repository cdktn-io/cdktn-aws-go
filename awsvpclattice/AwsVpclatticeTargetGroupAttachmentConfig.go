...
// Experimental.
type AwsVpclatticeTargetGroupAttachmentConfig struct {
	// Experimental.
	...
	// Experimental.
	Target *AwsVpclatticeTargetGroupAttachment_TargetProperty `field:"required" json:"target" yaml:"target"`
	...
	// Experimental.
	Timeouts *AwsVpclatticeTargetGroupAttachment_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
