...
// Experimental.
type AwsCodebuildProjectConfig struct {
	// Experimental.
	...
	// Experimental.
	Artifacts *AwsCodebuildProject_ArtifactsProperty `field:"required" json:"artifacts" yaml:"artifacts"`
	// environment block.
	//
	...
	// Experimental.
	Environment *AwsCodebuildProject_EnvironmentProperty `field:"required" json:"environment" yaml:"environment"`
	...
	// Experimental.
	Source *AwsCodebuildProject_SourceProperty `field:"required" json:"source" yaml:"source"`
	...
	// Experimental.
	BuildBatchConfig *AwsCodebuildProject_BuildBatchConfigProperty `field:"optional" json:"buildBatchConfig" yaml:"buildBatchConfig"`
	...
	// Experimental.
	Cache *AwsCodebuildProject_CacheProperty `field:"optional" json:"cache" yaml:"cache"`
	...
	// Experimental.
	LogsConfig *AwsCodebuildProject_LogsConfigProperty `field:"optional" json:"logsConfig" yaml:"logsConfig"`
	...
	// Experimental.
	VpcConfig *AwsCodebuildProject_VpcConfigProperty `field:"optional" json:"vpcConfig" yaml:"vpcConfig"`
}
