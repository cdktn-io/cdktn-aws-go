...
// Experimental.
type AwsCodebuildProject_SourceProperty struct {
	...
	// Experimental.
	Auth *AwsCodebuildProject_SourceAuthProperty `field:"optional" json:"auth" yaml:"auth"`
	...
	// Experimental.
	BuildStatusConfig *AwsCodebuildProject_SourceBuildStatusConfigProperty `field:"optional" json:"buildStatusConfig" yaml:"buildStatusConfig"`
	...
	// Experimental.
	GitSubmodulesConfig *AwsCodebuildProject_SourceGitSubmodulesConfigProperty `field:"optional" json:"gitSubmodulesConfig" yaml:"gitSubmodulesConfig"`
