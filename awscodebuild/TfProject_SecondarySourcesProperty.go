...
// Experimental.
type TfProject_SecondarySourcesProperty struct {
	...
	// Experimental.
	Auth *TfProject_SecondarySourcesAuthProperty `field:"optional" json:"auth" yaml:"auth"`
	...
	// Experimental.
	BuildStatusConfig *TfProject_SecondarySourcesBuildStatusConfigProperty `field:"optional" json:"buildStatusConfig" yaml:"buildStatusConfig"`
	...
	// Experimental.
	GitSubmodulesConfig *TfProject_SecondarySourcesGitSubmodulesConfigProperty `field:"optional" json:"gitSubmodulesConfig" yaml:"gitSubmodulesConfig"`
