...
// Experimental.
type AwsCodebuildWebhookConfig struct {
	// Experimental.
	...
	// Experimental.
	PullRequestBuildPolicy *AwsCodebuildWebhook_PullRequestBuildPolicyProperty `field:"optional" json:"pullRequestBuildPolicy" yaml:"pullRequestBuildPolicy"`
	...
	// Experimental.
	ScopeConfiguration *AwsCodebuildWebhook_ScopeConfigurationProperty `field:"optional" json:"scopeConfiguration" yaml:"scopeConfiguration"`
}
