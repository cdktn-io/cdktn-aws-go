...
type TfKeyspaceConfig struct {
	...
	// Experimental.
	ReplicationSpecification *TfKeyspace_ReplicationSpecificationProperty `field:"optional" json:"replicationSpecification" yaml:"replicationSpecification"`
	...
	// Experimental.
	Timeouts *TfKeyspace_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
