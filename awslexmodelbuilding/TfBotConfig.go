...
type TfBotConfig struct {
	...
	// Experimental.
	AbortStatement *TfBot_AbortStatementProperty `field:"required" json:"abortStatement" yaml:"abortStatement"`
	...
	// Experimental.
	ClarificationPrompt *TfBot_ClarificationPromptProperty `field:"optional" json:"clarificationPrompt" yaml:"clarificationPrompt"`
	...
	// Experimental.
	Timeouts *TfBot_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
