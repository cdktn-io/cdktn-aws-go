...
type DataAwsLexSlotType interface {
	...
	Description() *string
	// Experimental.
	EnumerationValue() DataAwsLexSlotType_EnumerationValuePropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsLexSlotType) EnumerationValue() DataAwsLexSlotType_EnumerationValuePropertyList {
	var returns DataAwsLexSlotType_EnumerationValuePropertyList
	_jsii_.Get(
		j,
		"enumerationValue",
		&returns,
