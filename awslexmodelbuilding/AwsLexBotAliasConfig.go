...
// Experimental.
type AwsLexBotAliasConfig struct {
	// Experimental.
	...
	// Experimental.
	ConversationLogs *AwsLexBotAlias_ConversationLogsProperty `field:"optional" json:"conversationLogs" yaml:"conversationLogs"`
	...
	// Experimental.
	Timeouts *AwsLexBotAlias_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
