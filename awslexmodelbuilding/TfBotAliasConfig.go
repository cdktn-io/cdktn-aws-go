...
type TfBotAliasConfig struct {
	...
	// Experimental.
	ConversationLogs *TfBotAlias_ConversationLogsProperty `field:"optional" json:"conversationLogs" yaml:"conversationLogs"`
	...
	// Experimental.
	Timeouts *TfBotAlias_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
