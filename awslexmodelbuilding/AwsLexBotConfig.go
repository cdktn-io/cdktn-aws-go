...
type AwsLexBotConfig struct {
	...
	// Experimental.
	AbortStatement *AwsLexBot_AbortStatementProperty `field:"required" json:"abortStatement" yaml:"abortStatement"`
	...
	// Experimental.
	ClarificationPrompt *AwsLexBot_ClarificationPromptProperty `field:"optional" json:"clarificationPrompt" yaml:"clarificationPrompt"`
	...
	// Experimental.
	Timeouts *AwsLexBot_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
