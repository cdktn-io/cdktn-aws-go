...
// Experimental.
type AwsDomainAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	CertificateSettings *AwsDomainAssociation_CertificateSettingsProperty `field:"optional" json:"certificateSettings" yaml:"certificateSettings"`
