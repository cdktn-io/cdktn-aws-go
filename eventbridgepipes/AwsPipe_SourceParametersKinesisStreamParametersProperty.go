...
// Experimental.
type AwsPipe_SourceParametersKinesisStreamParametersProperty struct {
	...
	// Experimental.
	DeadLetterConfig *AwsPipe_SourceParametersKinesisStreamParametersDeadLetterConfigProperty `field:"optional" json:"deadLetterConfig" yaml:"deadLetterConfig"`
