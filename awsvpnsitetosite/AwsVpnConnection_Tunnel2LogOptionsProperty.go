...
// Experimental.
type AwsVpnConnection_Tunnel2LogOptionsProperty struct {
	...
	// Experimental.
	CloudwatchLogOptions *AwsVpnConnection_Tunnel2LogOptionsCloudwatchLogOptionsProperty `field:"optional" json:"cloudwatchLogOptions" yaml:"cloudwatchLogOptions"`
}
