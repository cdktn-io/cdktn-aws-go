...
// Experimental.
type TfConnection_Tunnel2LogOptionsProperty struct {
	...
	// Experimental.
	CloudwatchLogOptions *TfConnection_Tunnel2LogOptionsCloudwatchLogOptionsProperty `field:"optional" json:"cloudwatchLogOptions" yaml:"cloudwatchLogOptions"`
}
