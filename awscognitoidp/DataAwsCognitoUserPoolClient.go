...
type DataAwsCognitoUserPoolClient interface {
	...
	// Experimental.
	AnalyticsConfiguration() DataAwsCognitoUserPoolClient_AnalyticsConfigurationPropertyList
	// Experimental.
	CallbackUrls() *[]*string
	// Experimental.
	...
	// Experimental.
	RefreshTokenRotation() DataAwsCognitoUserPoolClient_RefreshTokenRotationPropertyList
	// Experimental.
	...
	// Experimental.
	TokenValidityUnits() DataAwsCognitoUserPoolClient_TokenValidityUnitsPropertyList
	// Experimental.
	UserPoolId() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsCognitoUserPoolClient) AnalyticsConfiguration() DataAwsCognitoUserPoolClient_AnalyticsConfigurationPropertyList {
	var returns DataAwsCognitoUserPoolClient_AnalyticsConfigurationPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsCognitoUserPoolClient) RefreshTokenRotation() DataAwsCognitoUserPoolClient_RefreshTokenRotationPropertyList {
	var returns DataAwsCognitoUserPoolClient_RefreshTokenRotationPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsCognitoUserPoolClient) TokenValidityUnits() DataAwsCognitoUserPoolClient_TokenValidityUnitsPropertyList {
	var returns DataAwsCognitoUserPoolClient_TokenValidityUnitsPropertyList
	_jsii_.Get(
		j,
		"tokenValidityUnits",
		&returns,
