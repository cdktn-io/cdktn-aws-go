...
// Experimental.
type TfUserPool_LambdaConfigProperty struct {
	...
	// Experimental.
	CustomEmailSender *TfUserPool_CustomEmailSenderProperty `field:"optional" json:"customEmailSender" yaml:"customEmailSender"`
	...
	// Experimental.
	CustomSmsSender *TfUserPool_CustomSmsSenderProperty `field:"optional" json:"customSmsSender" yaml:"customSmsSender"`
	...
	// Experimental.
	PreTokenGenerationConfig *TfUserPool_PreTokenGenerationConfigProperty `field:"optional" json:"preTokenGenerationConfig" yaml:"preTokenGenerationConfig"`
