...
// Experimental.
type AwsCognitoRiskConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	AccountTakeoverRiskConfiguration *AwsCognitoRiskConfiguration_AccountTakeoverRiskConfigurationProperty `field:"optional" json:"accountTakeoverRiskConfiguration" yaml:"accountTakeoverRiskConfiguration"`
	...
	// Experimental.
	CompromisedCredentialsRiskConfiguration *AwsCognitoRiskConfiguration_CompromisedCredentialsRiskConfigurationProperty `field:"optional" json:"compromisedCredentialsRiskConfiguration" yaml:"compromisedCredentialsRiskConfiguration"`
	...
	// Experimental.
	RiskExceptionConfiguration *AwsCognitoRiskConfiguration_RiskExceptionConfigurationProperty `field:"optional" json:"riskExceptionConfiguration" yaml:"riskExceptionConfiguration"`
}
