...
// Experimental.
type AwsTableExportConfig struct {
	// Experimental.
	...
	// Experimental.
	IncrementalExportSpecification *AwsTableExport_IncrementalExportSpecificationProperty `field:"optional" json:"incrementalExportSpecification" yaml:"incrementalExportSpecification"`
	...
	// Experimental.
	Timeouts *AwsTableExport_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
