...
// Experimental.
type DataAwsTableConfig struct {
	// Experimental.
	...
	// Experimental.
	ServerSideEncryption *DataAwsTable_ServerSideEncryptionProperty `field:"optional" json:"serverSideEncryption" yaml:"serverSideEncryption"`
