...
func (j *jsiiProxy_AwsDomainName) AppsyncDomainName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"appsyncDomainName",
...
func (j *jsiiProxy_AwsDomainName) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_AwsDomainName) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_AwsDomainName) HostedZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostedZoneId",
...
func (j *jsiiProxy_AwsDomainName)SetDescription(val *string) {
...
func (a *jsiiProxy_AwsDomainName) ResetDescription() {
	_jsii_.InvokeVoid(
		a,
		"resetDescription",
		nil, // no parameters
