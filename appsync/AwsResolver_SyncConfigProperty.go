...
// Experimental.
type AwsResolver_SyncConfigProperty struct {
	...
	// Experimental.
	LambdaConflictHandlerConfig *AwsResolver_LambdaConflictHandlerConfigProperty `field:"optional" json:"lambdaConflictHandlerConfig" yaml:"lambdaConflictHandlerConfig"`
}
