...
type DataAwsResourcegroupstaggingapiResources interface {
	...
	// Experimental.
	ResourceTagMappingList() DataAwsResourcegroupstaggingapiResources_ResourceTagMappingListPropertyList
	// Experimental.
	...
	// Experimental.
	TagFilter() DataAwsResourcegroupstaggingapiResources_TagFilterPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsResourcegroupstaggingapiResources) ResourceTagMappingList() DataAwsResourcegroupstaggingapiResources_ResourceTagMappingListPropertyList {
	var returns DataAwsResourcegroupstaggingapiResources_ResourceTagMappingListPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsResourcegroupstaggingapiResources) TagFilter() DataAwsResourcegroupstaggingapiResources_TagFilterPropertyList {
	var returns DataAwsResourcegroupstaggingapiResources_TagFilterPropertyList
	_jsii_.Get(
		j,
		"tagFilter",
		&returns,
