...
type AwsFleetConfig struct {
	...
	// Experimental.
	ComputeConfiguration *AwsFleet_ComputeConfigurationProperty `field:"optional" json:"computeConfiguration" yaml:"computeConfiguration"`
	...
	// Experimental.
	ScalingConfiguration *AwsFleet_ScalingConfigurationProperty `field:"optional" json:"scalingConfiguration" yaml:"scalingConfiguration"`
