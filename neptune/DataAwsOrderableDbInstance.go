...
func (j *jsiiProxy_DataAwsOrderableDbInstance) ReadReplicaCapable() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"readReplicaCapable",
...
func (j *jsiiProxy_DataAwsOrderableDbInstance) SupportsEnhancedMonitoring() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsOrderableDbInstance) SupportsIamDatabaseAuthentication() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsOrderableDbInstance) SupportsIops() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"supportsIops",
...
func (j *jsiiProxy_DataAwsOrderableDbInstance) SupportsPerformanceInsights() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsOrderableDbInstance) SupportsStorageEncryption() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (d *jsiiProxy_DataAwsOrderableDbInstance) ResetEngine() {
	_jsii_.InvokeVoid(
		d,
		"resetEngine",
		nil, // no parameters
