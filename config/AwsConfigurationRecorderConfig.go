...
// Experimental.
type AwsConfigurationRecorderConfig struct {
	// Experimental.
	...
	// Experimental.
	RecordingGroup *AwsConfigurationRecorder_RecordingGroupProperty `field:"optional" json:"recordingGroup" yaml:"recordingGroup"`
	...
	// Experimental.
	RecordingMode *AwsConfigurationRecorder_RecordingModeProperty `field:"optional" json:"recordingMode" yaml:"recordingMode"`
