...
// Experimental.
type AwsConfigRuleConfig struct {
	// Experimental.
	...
	// Experimental.
	Source *AwsConfigRule_SourceProperty `field:"required" json:"source" yaml:"source"`
	...
	// Experimental.
	Scope *AwsConfigRule_ScopeProperty `field:"optional" json:"scope" yaml:"scope"`
