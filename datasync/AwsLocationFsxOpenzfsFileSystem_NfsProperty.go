...
// Experimental.
type AwsLocationFsxOpenzfsFileSystem_NfsProperty struct {
	// mount_options block.
	//
	...
	// Experimental.
	MountOptions *AwsLocationFsxOpenzfsFileSystem_MountOptionsProperty `field:"required" json:"mountOptions" yaml:"mountOptions"`
}
