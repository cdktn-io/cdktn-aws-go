...
// Experimental.
type AwsLocationNfsConfig struct {
	// Experimental.
	...
	// Experimental.
	OnPremConfig *AwsLocationNfs_OnPremConfigProperty `field:"required" json:"onPremConfig" yaml:"onPremConfig"`
	...
	// Experimental.
	MountOptions *AwsLocationNfs_MountOptionsProperty `field:"optional" json:"mountOptions" yaml:"mountOptions"`
