...
// Experimental.
type AwsLifecyclePolicy_CrossRegionCopyProperty struct {
	...
	// Experimental.
	EncryptionConfiguration *AwsLifecyclePolicy_EncryptionConfigurationProperty `field:"required" json:"encryptionConfiguration" yaml:"encryptionConfiguration"`
	...
	// Experimental.
	RetainRule *AwsLifecyclePolicy_PolicyDetailsActionCrossRegionCopyRetainRuleProperty `field:"optional" json:"retainRule" yaml:"retainRule"`
}
