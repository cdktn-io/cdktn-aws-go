...
// Experimental.
type AwsImagebuilderInfrastructureConfiguration_LoggingProperty struct {
	// s3_logs block.
	//
	...
	// Experimental.
	S3Logs *AwsImagebuilderInfrastructureConfiguration_S3LogsProperty `field:"required" json:"s3Logs" yaml:"s3Logs"`
}
