...
type DataAwsImagebuilderImagePipeline interface {
	...
	// Experimental.
	ImageScanningConfiguration() DataAwsImagebuilderImagePipeline_ImageScanningConfigurationPropertyList
	// Experimental.
	ImageTestsConfiguration() DataAwsImagebuilderImagePipeline_ImageTestsConfigurationPropertyList
	// Experimental.
	...
	RegionInput() *string
	// Experimental.
	Schedule() DataAwsImagebuilderImagePipeline_SchedulePropertyList
	// Experimental.
	Status() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsImagebuilderImagePipeline) ImageScanningConfiguration() DataAwsImagebuilderImagePipeline_ImageScanningConfigurationPropertyList {
	var returns DataAwsImagebuilderImagePipeline_ImageScanningConfigurationPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsImagebuilderImagePipeline) ImageTestsConfiguration() DataAwsImagebuilderImagePipeline_ImageTestsConfigurationPropertyList {
	var returns DataAwsImagebuilderImagePipeline_ImageTestsConfigurationPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsImagebuilderImagePipeline) Schedule() DataAwsImagebuilderImagePipeline_SchedulePropertyList {
	var returns DataAwsImagebuilderImagePipeline_SchedulePropertyList
	_jsii_.Get(
		j,
		"schedule",
		&returns,
...
func NewDataAwsImagebuilderImagePipeline(scope constructs.Construct, id *string, config *DataAwsImagebuilderImagePipelineConfig) DataAwsImagebuilderImagePipeline {
	...
	_jsii_.Create(
		"@cdktn/aws-ec2-image-builder.DataAwsImagebuilderImagePipeline",
