...
type DataAwsImagebuilderInfrastructureConfigurations interface {
	...
	// Experimental.
	Filter() DataAwsImagebuilderInfrastructureConfigurations_FilterPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfigurations) Filter() DataAwsImagebuilderInfrastructureConfigurations_FilterPropertyList {
	var returns DataAwsImagebuilderInfrastructureConfigurations_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func NewDataAwsImagebuilderInfrastructureConfigurations(scope constructs.Construct, id *string, config *DataAwsImagebuilderInfrastructureConfigurationsConfig) DataAwsImagebuilderInfrastructureConfigurations {
	...
	_jsii_.Create(
		"@cdktn/aws-ec2-image-builder.DataAwsImagebuilderInfrastructureConfigurations",
