...
type DataAwsImagebuilderImageRecipe interface {
	...
	ArnInput() *string
	// Experimental.
	BlockDeviceMapping() DataAwsImagebuilderImageRecipe_BlockDeviceMappingPropertyList
	// Experimental.
	CdktfStack() cdktn.TerraformStack
	// Experimental.
	Component() DataAwsImagebuilderImageRecipe_ComponentPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipe) BlockDeviceMapping() DataAwsImagebuilderImageRecipe_BlockDeviceMappingPropertyList {
	var returns DataAwsImagebuilderImageRecipe_BlockDeviceMappingPropertyList
	_jsii_.Get(
		j,
		"blockDeviceMapping",
		&returns,
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipe) Component() DataAwsImagebuilderImageRecipe_ComponentPropertyList {
	var returns DataAwsImagebuilderImageRecipe_ComponentPropertyList
	_jsii_.Get(
		j,
		"component",
		&returns,
...
func NewDataAwsImagebuilderImageRecipe(scope constructs.Construct, id *string, config *DataAwsImagebuilderImageRecipeConfig) DataAwsImagebuilderImageRecipe {
	...
	_jsii_.Create(
		"@cdktn/aws-ec2-image-builder.DataAwsImagebuilderImageRecipe",
