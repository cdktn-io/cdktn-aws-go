...
type DataAwsImagebuilderImageRecipes interface {
	...
	// Experimental.
	Filter() DataAwsImagebuilderImageRecipes_FilterPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipes) Filter() DataAwsImagebuilderImageRecipes_FilterPropertyList {
	var returns DataAwsImagebuilderImageRecipes_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func NewDataAwsImagebuilderImageRecipes(scope constructs.Construct, id *string, config *DataAwsImagebuilderImageRecipesConfig) DataAwsImagebuilderImageRecipes {
	...
	_jsii_.Create(
		"@cdktn/aws-ec2-image-builder.DataAwsImagebuilderImageRecipes",
