...
type DataAwsImagebuilderComponents interface {
	...
	// Experimental.
	Filter() DataAwsImagebuilderComponents_FilterPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsImagebuilderComponents) Filter() DataAwsImagebuilderComponents_FilterPropertyList {
	var returns DataAwsImagebuilderComponents_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func NewDataAwsImagebuilderComponents(scope constructs.Construct, id *string, config *DataAwsImagebuilderComponentsConfig) DataAwsImagebuilderComponents {
	...
	_jsii_.Create(
		"@cdktn/aws-ec2-image-builder.DataAwsImagebuilderComponents",
