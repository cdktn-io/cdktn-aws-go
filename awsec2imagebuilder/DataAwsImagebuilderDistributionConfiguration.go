...
type DataAwsImagebuilderDistributionConfiguration interface {
	...
	Description() *string
	// Experimental.
	Distribution() DataAwsImagebuilderDistributionConfiguration_DistributionPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsImagebuilderDistributionConfiguration) Distribution() DataAwsImagebuilderDistributionConfiguration_DistributionPropertyList {
	var returns DataAwsImagebuilderDistributionConfiguration_DistributionPropertyList
	_jsii_.Get(
		j,
		"distribution",
		&returns,
...
func NewDataAwsImagebuilderDistributionConfiguration(scope constructs.Construct, id *string, config *DataAwsImagebuilderDistributionConfigurationConfig) DataAwsImagebuilderDistributionConfiguration {
	...
	_jsii_.Create(
		"@cdktn/aws-ec2-image-builder.DataAwsImagebuilderDistributionConfiguration",
