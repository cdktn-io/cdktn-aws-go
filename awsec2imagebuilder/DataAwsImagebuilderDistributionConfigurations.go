...
type DataAwsImagebuilderDistributionConfigurations interface {
	...
	// Experimental.
	Filter() DataAwsImagebuilderDistributionConfigurations_FilterPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsImagebuilderDistributionConfigurations) Filter() DataAwsImagebuilderDistributionConfigurations_FilterPropertyList {
	var returns DataAwsImagebuilderDistributionConfigurations_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func NewDataAwsImagebuilderDistributionConfigurations(scope constructs.Construct, id *string, config *DataAwsImagebuilderDistributionConfigurationsConfig) DataAwsImagebuilderDistributionConfigurations {
	...
	_jsii_.Create(
		"@cdktn/aws-ec2-image-builder.DataAwsImagebuilderDistributionConfigurations",
