...
// Experimental.
type AwsImagebuilderImageRecipeConfig struct {
	// Experimental.
	...
	// Experimental.
	SystemsManagerAgent *AwsImagebuilderImageRecipe_SystemsManagerAgentProperty `field:"optional" json:"systemsManagerAgent" yaml:"systemsManagerAgent"`
