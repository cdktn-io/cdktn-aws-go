...
// Experimental.
type AwsImagebuilderInfrastructureConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	InstanceMetadataOptions *AwsImagebuilderInfrastructureConfiguration_InstanceMetadataOptionsProperty `field:"optional" json:"instanceMetadataOptions" yaml:"instanceMetadataOptions"`
	...
	// Experimental.
	Logging *AwsImagebuilderInfrastructureConfiguration_LoggingProperty `field:"optional" json:"logging" yaml:"logging"`
	// placement block.
	//
	...
	// Experimental.
	Placement *AwsImagebuilderInfrastructureConfiguration_PlacementProperty `field:"optional" json:"placement" yaml:"placement"`
