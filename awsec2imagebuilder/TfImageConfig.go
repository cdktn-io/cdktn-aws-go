...
type TfImageConfig struct {
	...
	// Experimental.
	ImageScanningConfiguration *TfImage_ImageScanningConfigurationProperty `field:"optional" json:"imageScanningConfiguration" yaml:"imageScanningConfiguration"`
	...
	// Experimental.
	ImageTestsConfiguration *TfImage_ImageTestsConfigurationProperty `field:"optional" json:"imageTestsConfiguration" yaml:"imageTestsConfiguration"`
	...
	// Experimental.
	LoggingConfiguration *TfImage_LoggingConfigurationProperty `field:"optional" json:"loggingConfiguration" yaml:"loggingConfiguration"`
