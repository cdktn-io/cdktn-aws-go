...
// Experimental.
type AwsImagebuilderDistributionConfiguration_DistributionProperty struct {
	...
	// Experimental.
	AmiDistributionConfiguration *AwsImagebuilderDistributionConfiguration_AmiDistributionConfigurationProperty `field:"optional" json:"amiDistributionConfiguration" yaml:"amiDistributionConfiguration"`
	...
	// Experimental.
	ContainerDistributionConfiguration *AwsImagebuilderDistributionConfiguration_ContainerDistributionConfigurationProperty `field:"optional" json:"containerDistributionConfiguration" yaml:"containerDistributionConfiguration"`
	...
	// Experimental.
	S3ExportConfiguration *AwsImagebuilderDistributionConfiguration_S3ExportConfigurationProperty `field:"optional" json:"s3ExportConfiguration" yaml:"s3ExportConfiguration"`
