...
type DataAwsImagebuilderInfrastructureConfiguration interface {
	...
	IdInput() *string
	// Experimental.
	InstanceMetadataOptions() DataAwsImagebuilderInfrastructureConfiguration_InstanceMetadataOptionsPropertyList
	// Experimental.
	...
	// Experimental.
	Logging() DataAwsImagebuilderInfrastructureConfiguration_LoggingPropertyList
	// Experimental.
	Name() *string
	// The tree node.
	// Experimental.
	...
	// Experimental.
	Placement() DataAwsImagebuilderInfrastructureConfiguration_PlacementPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfiguration) InstanceMetadataOptions() DataAwsImagebuilderInfrastructureConfiguration_InstanceMetadataOptionsPropertyList {
	var returns DataAwsImagebuilderInfrastructureConfiguration_InstanceMetadataOptionsPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfiguration) Logging() DataAwsImagebuilderInfrastructureConfiguration_LoggingPropertyList {
	var returns DataAwsImagebuilderInfrastructureConfiguration_LoggingPropertyList
	_jsii_.Get(
		j,
		"logging",
		&returns,
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfiguration) Placement() DataAwsImagebuilderInfrastructureConfiguration_PlacementPropertyList {
	var returns DataAwsImagebuilderInfrastructureConfiguration_PlacementPropertyList
	_jsii_.Get(
		j,
		"placement",
		&returns,
...
func NewDataAwsImagebuilderInfrastructureConfiguration(scope constructs.Construct, id *string, config *DataAwsImagebuilderInfrastructureConfigurationConfig) DataAwsImagebuilderInfrastructureConfiguration {
	...
	_jsii_.Create(
		"@cdktn/aws-ec2-image-builder.DataAwsImagebuilderInfrastructureConfiguration",
