...
type DataAwsImagebuilderImage interface {
	...
	// Experimental.
	ImageScanningConfiguration() DataAwsImagebuilderImage_ImageScanningConfigurationPropertyList
	// Experimental.
	ImageTestsConfiguration() DataAwsImagebuilderImage_ImageTestsConfigurationPropertyList
	// Experimental.
	...
	OsVersion() *string
	// Experimental.
	OutputResources() DataAwsImagebuilderImage_OutputResourcesPropertyList
	// Experimental.
	Platform() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsImagebuilderImage) ImageScanningConfiguration() DataAwsImagebuilderImage_ImageScanningConfigurationPropertyList {
	var returns DataAwsImagebuilderImage_ImageScanningConfigurationPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsImagebuilderImage) ImageTestsConfiguration() DataAwsImagebuilderImage_ImageTestsConfigurationPropertyList {
	var returns DataAwsImagebuilderImage_ImageTestsConfigurationPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsImagebuilderImage) OutputResources() DataAwsImagebuilderImage_OutputResourcesPropertyList {
	var returns DataAwsImagebuilderImage_OutputResourcesPropertyList
	_jsii_.Get(
		j,
		"outputResources",
		&returns,
...
func NewDataAwsImagebuilderImage(scope constructs.Construct, id *string, config *DataAwsImagebuilderImageConfig) DataAwsImagebuilderImage {
	...
	_jsii_.Create(
		"@cdktn/aws-ec2-image-builder.DataAwsImagebuilderImage",
