...
// Experimental.
type TfDistributionConfiguration_AmiDistributionConfigurationProperty struct {
	...
	// Experimental.
	LaunchPermission *TfDistributionConfiguration_LaunchPermissionProperty `field:"optional" json:"launchPermission" yaml:"launchPermission"`
