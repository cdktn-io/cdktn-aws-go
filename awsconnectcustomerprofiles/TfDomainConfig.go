...
type TfDomainConfig struct {
	...
	// Experimental.
	Matching *TfDomain_MatchingProperty `field:"optional" json:"matching" yaml:"matching"`
	...
	// Experimental.
	RuleBasedMatching *TfDomain_RuleBasedMatchingProperty `field:"optional" json:"ruleBasedMatching" yaml:"ruleBasedMatching"`
