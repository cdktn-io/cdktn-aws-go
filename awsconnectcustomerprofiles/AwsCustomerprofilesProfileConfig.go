...
// Experimental.
type AwsCustomerprofilesProfileConfig struct {
	// Experimental.
	...
	// Experimental.
	Address *AwsCustomerprofilesProfile_AddressProperty `field:"optional" json:"address" yaml:"address"`
	...
	// Experimental.
	BillingAddress *AwsCustomerprofilesProfile_BillingAddressProperty `field:"optional" json:"billingAddress" yaml:"billingAddress"`
	...
	// Experimental.
	MailingAddress *AwsCustomerprofilesProfile_MailingAddressProperty `field:"optional" json:"mailingAddress" yaml:"mailingAddress"`
	...
	// Experimental.
	ShippingAddress *AwsCustomerprofilesProfile_ShippingAddressProperty `field:"optional" json:"shippingAddress" yaml:"shippingAddress"`
}
