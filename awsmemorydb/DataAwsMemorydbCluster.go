...
type DataAwsMemorydbCluster interface {
	...
	// Experimental.
	ClusterEndpoint() DataAwsMemorydbCluster_ClusterEndpointPropertyList
	// Experimental.
	...
	// Experimental.
	Shards() DataAwsMemorydbCluster_ShardsPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsMemorydbCluster) ClusterEndpoint() DataAwsMemorydbCluster_ClusterEndpointPropertyList {
	var returns DataAwsMemorydbCluster_ClusterEndpointPropertyList
	_jsii_.Get(
		j,
		"clusterEndpoint",
		&returns,
...
func (j *jsiiProxy_DataAwsMemorydbCluster) Shards() DataAwsMemorydbCluster_ShardsPropertyList {
	var returns DataAwsMemorydbCluster_ShardsPropertyList
	_jsii_.Get(
		j,
		"shards",
		&returns,
