...
// Experimental.
type AwsBedrockagentDataSource_DataSourceConfigurationConfluenceConfigurationCrawlerConfigurationFilterConfigurationPatternObjectFilterProperty struct {
	// filters block.
	//
