...
func (j *jsiiProxy_TfDataSource_S3ConfigurationPropertyOutputReference) BucketArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketArn",
...
func (j *jsiiProxy_TfDataSource_S3ConfigurationPropertyOutputReference) BucketArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketArnInput",
...
func (j *jsiiProxy_TfDataSource_S3ConfigurationPropertyOutputReference) BucketOwnerAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TfDataSource_S3ConfigurationPropertyOutputReference) BucketOwnerAccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TfDataSource_S3ConfigurationPropertyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
// Experimental.
func NewTfDataSource_S3ConfigurationPropertyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) TfDataSource_S3ConfigurationPropertyOutputReference {
	_init_.Initialize()

	if err := validateNewTfDataSource_S3ConfigurationPropertyOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
// Experimental.
func NewTfDataSource_S3ConfigurationPropertyOutputReference_Override(t TfDataSource_S3ConfigurationPropertyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_TfDataSource_S3ConfigurationPropertyOutputReference)SetBucketArn(val *string) {
...
func (j *jsiiProxy_TfDataSource_S3ConfigurationPropertyOutputReference)SetBucketOwnerAccountId(val *string) {
...
func (j *jsiiProxy_TfDataSource_S3ConfigurationPropertyOutputReference)SetInternalValue(val interface{}) {
...
func (t *jsiiProxy_TfDataSource_S3ConfigurationPropertyOutputReference) ResetBucketOwnerAccountId() {
	_jsii_.InvokeVoid(
		t,
		"resetBucketOwnerAccountId",
		nil, // no parameters
