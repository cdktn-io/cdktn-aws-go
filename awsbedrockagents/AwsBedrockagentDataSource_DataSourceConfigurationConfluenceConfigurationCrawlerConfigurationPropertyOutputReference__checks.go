...
func (a *jsiiProxy_AwsBedrockagentDataSource_DataSourceConfigurationConfluenceConfigurationCrawlerConfigurationPropertyOutputReference) validatePutFilterConfigurationParameters(value interface{}) error {
	...
	case *[]*AwsBedrockagentDataSource_DataSourceConfigurationConfluenceConfigurationCrawlerConfigurationFilterConfigurationProperty:
		value := value.(*[]*AwsBedrockagentDataSource_DataSourceConfigurationConfluenceConfigurationCrawlerConfigurationFilterConfigurationProperty)
	...
	case []*AwsBedrockagentDataSource_DataSourceConfigurationConfluenceConfigurationCrawlerConfigurationFilterConfigurationProperty:
		value_ := value.([]*AwsBedrockagentDataSource_DataSourceConfigurationConfluenceConfigurationCrawlerConfigurationFilterConfigurationProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AwsBedrockagentDataSource_DataSourceConfigurationConfluenceConfigurationCrawlerConfigurationFilterConfigurationProperty; received %#v (a %T)", value, value)
		}
	}
