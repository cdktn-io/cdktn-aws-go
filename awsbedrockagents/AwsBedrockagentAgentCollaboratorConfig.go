...
// Experimental.
type AwsBedrockagentAgentCollaboratorConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsBedrockagentAgentCollaborator_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
