...
// Experimental.
type AwsBedrockagentAgentKnowledgeBaseAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsBedrockagentAgentKnowledgeBaseAssociation_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
