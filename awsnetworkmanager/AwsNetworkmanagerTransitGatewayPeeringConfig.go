...
// Experimental.
type AwsNetworkmanagerTransitGatewayPeeringConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsNetworkmanagerTransitGatewayPeering_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
