...
// Experimental.
type AwsNetworkmanagerCoreNetworkPolicyAttachmentConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsNetworkmanagerCoreNetworkPolicyAttachment_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
