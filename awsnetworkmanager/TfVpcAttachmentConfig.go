...
// Experimental.
type TfVpcAttachmentConfig struct {
	// Experimental.
	...
	// Experimental.
	Options *TfVpcAttachment_OptionsProperty `field:"optional" json:"options" yaml:"options"`
	...
	// Experimental.
	Timeouts *TfVpcAttachment_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
