...
// Experimental.
type TfTransitGatewayRouteTableAttachmentConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *TfTransitGatewayRouteTableAttachment_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
