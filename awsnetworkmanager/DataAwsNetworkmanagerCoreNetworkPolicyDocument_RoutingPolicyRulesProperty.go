...
// Experimental.
type DataAwsNetworkmanagerCoreNetworkPolicyDocument_RoutingPolicyRulesProperty struct {
	...
	// Experimental.
	RuleDefinition *DataAwsNetworkmanagerCoreNetworkPolicyDocument_RuleDefinitionProperty `field:"required" json:"ruleDefinition" yaml:"ruleDefinition"`
