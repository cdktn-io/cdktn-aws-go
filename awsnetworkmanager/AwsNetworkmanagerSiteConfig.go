...
// Experimental.
type AwsNetworkmanagerSiteConfig struct {
	// Experimental.
	...
	// Experimental.
	Location *AwsNetworkmanagerSite_LocationProperty `field:"optional" json:"location" yaml:"location"`
	...
	// Experimental.
	Timeouts *AwsNetworkmanagerSite_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
