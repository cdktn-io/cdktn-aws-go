...
// Experimental.
type DataAwsNetworkmanagerCoreNetworkPolicyDocument_AttachmentRoutingPolicyRulesProperty struct {
	// action block.
	//
	...
	// Experimental.
	Action *DataAwsNetworkmanagerCoreNetworkPolicyDocument_AttachmentRoutingPolicyRulesActionProperty `field:"required" json:"action" yaml:"action"`
	// conditions block.
	//
