...
type TfSiteConfig struct {
	...
	// Experimental.
	Location *TfSite_LocationProperty `field:"optional" json:"location" yaml:"location"`
	...
	// Experimental.
	Timeouts *TfSite_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
