...
func (a *jsiiProxy_AwsBedrockEvaluationJob_EvaluationConfigAutomatedCustomMetricConfigEvaluatorModelConfigPropertyOutputReference) validatePutBedrockEvaluatorModelParameters(value interface{}) error {
	...
	case *[]*AwsBedrockEvaluationJob_EvaluationConfigAutomatedCustomMetricConfigEvaluatorModelConfigBedrockEvaluatorModelProperty:
		value := value.(*[]*AwsBedrockEvaluationJob_EvaluationConfigAutomatedCustomMetricConfigEvaluatorModelConfigBedrockEvaluatorModelProperty)
	...
	case []*AwsBedrockEvaluationJob_EvaluationConfigAutomatedCustomMetricConfigEvaluatorModelConfigBedrockEvaluatorModelProperty:
		value_ := value.([]*AwsBedrockEvaluationJob_EvaluationConfigAutomatedCustomMetricConfigEvaluatorModelConfigBedrockEvaluatorModelProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AwsBedrockEvaluationJob_EvaluationConfigAutomatedCustomMetricConfigEvaluatorModelConfigBedrockEvaluatorModelProperty; received %#v (a %T)", value, value)
		}
	}
