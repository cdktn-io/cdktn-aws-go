...
type DataAwsBedrockFoundationModels interface {
	...
	// Experimental.
	ModelSummaries() DataAwsBedrockFoundationModels_ModelSummariesPropertyList
	// The tree node.
	// Experimental.
...
func (j *jsiiProxy_DataAwsBedrockFoundationModels) ModelSummaries() DataAwsBedrockFoundationModels_ModelSummariesPropertyList {
	var returns DataAwsBedrockFoundationModels_ModelSummariesPropertyList
	_jsii_.Get(
		j,
		"modelSummaries",
		&returns,
...
func NewDataAwsBedrockFoundationModels(scope constructs.Construct, id *string, config *DataAwsBedrockFoundationModelsConfig) DataAwsBedrockFoundationModels {
	...
	_jsii_.Create(
		"@cdktn/aws-bedrock.DataAwsBedrockFoundationModels",
