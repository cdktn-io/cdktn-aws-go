...
func (a *jsiiProxy_AwsPlan_RulePropertyOutputReference) validatePutCopyActionParameters(value interface{}) error {
	...
	case *[]*AwsPlan_CopyActionProperty:
		value := value.(*[]*AwsPlan_CopyActionProperty)
	...
	case []*AwsPlan_CopyActionProperty:
		value_ := value.([]*AwsPlan_CopyActionProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AwsPlan_CopyActionProperty; received %#v (a %T)", value, value)
		}
	}
...
func (a *jsiiProxy_AwsPlan_RulePropertyOutputReference) validatePutScanActionParameters(value interface{}) error {
	...
	case *[]*AwsPlan_ScanActionProperty:
		value := value.(*[]*AwsPlan_ScanActionProperty)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*AwsPlan_ScanActionProperty:
		value_ := value.([]*AwsPlan_ScanActionProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AwsPlan_ScanActionProperty; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_AwsPlan_RulePropertyOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case *AwsPlan_RuleProperty:
		val := val.(*AwsPlan_RuleProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case AwsPlan_RuleProperty:
		val_ := val.(AwsPlan_RuleProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *AwsPlan_RuleProperty; received %#v (a %T)", val, val)
		}
	}
