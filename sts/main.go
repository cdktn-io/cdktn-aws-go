// cdk-terrain bindings for the STS (Security Token) group of terraform-provider-aws 6.62.0
package sts
...
func init() {
	...
	_jsii_.RegisterClass(
		"@cdktn/aws-sts.EphemeralAwsWebIdentityToken",
		reflect.TypeOf((*EphemeralAwsWebIdentityToken)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
		...
		func() interface{} {
			j := jsiiProxy_EphemeralAwsWebIdentityToken{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnTerraformEphemeralResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktn/aws-sts.EphemeralAwsWebIdentityTokenConfig",
		reflect.TypeOf((*EphemeralAwsWebIdentityTokenConfig)(nil)).Elem(),
	)
}
