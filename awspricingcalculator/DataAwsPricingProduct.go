...
type DataAwsPricingProduct interface {
	...
	// Experimental.
	Filters() DataAwsPricingProduct_FiltersPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsPricingProduct) Filters() DataAwsPricingProduct_FiltersPropertyList {
	var returns DataAwsPricingProduct_FiltersPropertyList
	_jsii_.Get(
		j,
		"filters",
		&returns,
