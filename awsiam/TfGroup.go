...
func (j *jsiiProxy_TfGroup) Path() *string {
	var returns *string
	_jsii_.Get(
		j,
		"path",
...
func (j *jsiiProxy_TfGroup) PathInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pathInput",
...
func (j *jsiiProxy_TfGroup) UniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uniqueId",
...
func (j *jsiiProxy_TfGroup)SetPath(val *string) {
...
func (t *jsiiProxy_TfGroup) ResetPath() {
	_jsii_.InvokeVoid(
		t,
		"resetPath",
		nil, // no parameters
