...
type DataAwsIamRole interface {
	...
	// Experimental.
	RoleLastUsed() DataAwsIamRole_RoleLastUsedPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsIamRole) RoleLastUsed() DataAwsIamRole_RoleLastUsedPropertyList {
	var returns DataAwsIamRole_RoleLastUsedPropertyList
	_jsii_.Get(
		j,
		"roleLastUsed",
		&returns,
