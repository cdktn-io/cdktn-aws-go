...
type DataAwsIamPrincipalPolicySimulation interface {
	...
	// Experimental.
	Context() DataAwsIamPrincipalPolicySimulation_ContextPropertyList
	// Experimental.
	...
	// Experimental.
	Results() DataAwsIamPrincipalPolicySimulation_ResultsPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsIamPrincipalPolicySimulation) Context() DataAwsIamPrincipalPolicySimulation_ContextPropertyList {
	var returns DataAwsIamPrincipalPolicySimulation_ContextPropertyList
	_jsii_.Get(
		j,
		"context",
		&returns,
...
func (j *jsiiProxy_DataAwsIamPrincipalPolicySimulation) Results() DataAwsIamPrincipalPolicySimulation_ResultsPropertyList {
	var returns DataAwsIamPrincipalPolicySimulation_ResultsPropertyList
	_jsii_.Get(
		j,
		"results",
		&returns,
