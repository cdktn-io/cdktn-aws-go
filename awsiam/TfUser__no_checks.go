...
func (j *jsiiProxy_TfUser) validateSetForceDestroyParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_TfUser) validateSetPathParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_TfUser) validateSetPermissionsBoundaryParameters(val *string) error {
	return nil
}
