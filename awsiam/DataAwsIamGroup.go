...
type DataAwsIamGroup interface {
	...
	// Experimental.
	Users() DataAwsIamGroup_UsersPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsIamGroup) Users() DataAwsIamGroup_UsersPropertyList {
	var returns DataAwsIamGroup_UsersPropertyList
	_jsii_.Get(
		j,
		"users",
		&returns,
