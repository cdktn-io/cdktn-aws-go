...
type DataAwsIamPolicyDocument interface {
	...
	// Experimental.
	Statement() DataAwsIamPolicyDocument_StatementPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsIamPolicyDocument) Statement() DataAwsIamPolicyDocument_StatementPropertyList {
	var returns DataAwsIamPolicyDocument_StatementPropertyList
	_jsii_.Get(
		j,
		"statement",
		&returns,
