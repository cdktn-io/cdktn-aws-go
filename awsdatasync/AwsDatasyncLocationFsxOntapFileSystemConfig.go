...
// Experimental.
type AwsDatasyncLocationFsxOntapFileSystemConfig struct {
	// Experimental.
	...
	// Experimental.
	Protocol *AwsDatasyncLocationFsxOntapFileSystem_ProtocolProperty `field:"required" json:"protocol" yaml:"protocol"`
