...
// Experimental.
type TfLocationAzureBlobConfig struct {
	// Experimental.
	...
	// Experimental.
	SasConfiguration *TfLocationAzureBlob_SasConfigurationProperty `field:"optional" json:"sasConfiguration" yaml:"sasConfiguration"`
