...
// Experimental.
type AwsDatasyncLocationFsxOpenzfsFileSystemConfig struct {
	// Experimental.
	...
	// Experimental.
	Protocol *AwsDatasyncLocationFsxOpenzfsFileSystem_ProtocolProperty `field:"required" json:"protocol" yaml:"protocol"`
