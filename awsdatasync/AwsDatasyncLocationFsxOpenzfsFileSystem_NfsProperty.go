...
// Experimental.
type AwsDatasyncLocationFsxOpenzfsFileSystem_NfsProperty struct {
	// mount_options block.
	//
	...
	// Experimental.
	MountOptions *AwsDatasyncLocationFsxOpenzfsFileSystem_MountOptionsProperty `field:"required" json:"mountOptions" yaml:"mountOptions"`
}
