...
// Experimental.
type AwsDatasyncTask_TaskReportConfigProperty struct {
	...
	// Experimental.
	S3Destination *AwsDatasyncTask_S3DestinationProperty `field:"required" json:"s3Destination" yaml:"s3Destination"`
	...
	// Experimental.
	ReportOverrides *AwsDatasyncTask_ReportOverridesProperty `field:"optional" json:"reportOverrides" yaml:"reportOverrides"`
