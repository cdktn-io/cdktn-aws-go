...
type AwsPool interface {
	...
	// Experimental.
	CognitoIdentityProviders() AwsPool_CognitoIdentityProvidersPropertyList
	// Experimental.
...
func (j *jsiiProxy_AwsPool) AllowClassicFlow() interface{} {
...
func (j *jsiiProxy_AwsPool) AllowClassicFlowInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsPool) AllowUnauthenticatedIdentities() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsPool) AllowUnauthenticatedIdentitiesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsPool) CognitoIdentityProviders() AwsPool_CognitoIdentityProvidersPropertyList {
	var returns AwsPool_CognitoIdentityProvidersPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsPool) CognitoIdentityProvidersInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsPool) DeveloperProviderName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsPool) DeveloperProviderNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsPool) IdentityPoolName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"identityPoolName",
...
func (j *jsiiProxy_AwsPool) IdentityPoolNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsPool) OpenidConnectProviderArns() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsPool) OpenidConnectProviderArnsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsPool) SamlProviderArns() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"samlProviderArns",
...
func (j *jsiiProxy_AwsPool) SamlProviderArnsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsPool) SupportedLoginProviders() *map[string]*string {
...
func (j *jsiiProxy_AwsPool) SupportedLoginProvidersInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
...
func NewAwsPool(scope constructs.Construct, id *string, config *AwsPoolConfig) AwsPool {
	...
	_jsii_.Create(
		"@cdktn/aws-cognito-identity.AwsPool",
...
func (j *jsiiProxy_AwsPool)SetAllowClassicFlow(val interface{}) {
...
func (j *jsiiProxy_AwsPool)SetAllowUnauthenticatedIdentities(val interface{}) {
...
func (j *jsiiProxy_AwsPool)SetDeveloperProviderName(val *string) {
...
func (j *jsiiProxy_AwsPool)SetIdentityPoolName(val *string) {
...
func (j *jsiiProxy_AwsPool)SetOpenidConnectProviderArns(val *[]*string) {
...
func (j *jsiiProxy_AwsPool)SetSamlProviderArns(val *[]*string) {
...
func (j *jsiiProxy_AwsPool)SetSupportedLoginProviders(val *map[string]*string) {
...
func (a *jsiiProxy_AwsPool) PutCognitoIdentityProviders(value interface{}) {
...
func (a *jsiiProxy_AwsPool) ResetAllowClassicFlow() {
	_jsii_.InvokeVoid(
		a,
		"resetAllowClassicFlow",
		nil, // no parameters
...
func (a *jsiiProxy_AwsPool) ResetAllowUnauthenticatedIdentities() {
	_jsii_.InvokeVoid(
		a,
		"resetAllowUnauthenticatedIdentities",
		nil, // no parameters
...
func (a *jsiiProxy_AwsPool) ResetCognitoIdentityProviders() {
	_jsii_.InvokeVoid(
		a,
		"resetCognitoIdentityProviders",
		nil, // no parameters
...
func (a *jsiiProxy_AwsPool) ResetDeveloperProviderName() {
	_jsii_.InvokeVoid(
		a,
		"resetDeveloperProviderName",
		nil, // no parameters
...
func (a *jsiiProxy_AwsPool) ResetOpenidConnectProviderArns() {
	_jsii_.InvokeVoid(
		a,
		"resetOpenidConnectProviderArns",
		nil, // no parameters
...
func (a *jsiiProxy_AwsPool) ResetSamlProviderArns() {
	_jsii_.InvokeVoid(
		a,
		"resetSamlProviderArns",
		nil, // no parameters
...
func (a *jsiiProxy_AwsPool) ResetSupportedLoginProviders() {
	_jsii_.InvokeVoid(
		a,
		"resetSupportedLoginProviders",
		nil, // no parameters
