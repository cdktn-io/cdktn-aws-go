...
type DataAwsServicequotasServiceQuota interface {
	...
	// Experimental.
	UsageMetric() DataAwsServicequotasServiceQuota_UsageMetricPropertyList
	// Experimental.
	Value() *float64
	// Experimental.
...
func (j *jsiiProxy_DataAwsServicequotasServiceQuota) UsageMetric() DataAwsServicequotasServiceQuota_UsageMetricPropertyList {
	var returns DataAwsServicequotasServiceQuota_UsageMetricPropertyList
	_jsii_.Get(
		j,
		"usageMetric",
		&returns,
