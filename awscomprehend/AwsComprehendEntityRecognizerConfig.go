...
// Experimental.
type AwsComprehendEntityRecognizerConfig struct {
	// Experimental.
	...
	// Experimental.
	InputDataConfig *AwsComprehendEntityRecognizer_InputDataConfigProperty `field:"required" json:"inputDataConfig" yaml:"inputDataConfig"`
	...
	// Experimental.
	Timeouts *AwsComprehendEntityRecognizer_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
	...
	// Experimental.
	VpcConfig *AwsComprehendEntityRecognizer_VpcConfigProperty `field:"optional" json:"vpcConfig" yaml:"vpcConfig"`
}
