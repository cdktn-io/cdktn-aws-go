...
// Experimental.
type AwsComprehendDocumentClassifierConfig struct {
	// Experimental.
	...
	// Experimental.
	InputDataConfig *AwsComprehendDocumentClassifier_InputDataConfigProperty `field:"required" json:"inputDataConfig" yaml:"inputDataConfig"`
	...
	// Experimental.
	OutputDataConfig *AwsComprehendDocumentClassifier_OutputDataConfigProperty `field:"optional" json:"outputDataConfig" yaml:"outputDataConfig"`
	...
	// Experimental.
	Timeouts *AwsComprehendDocumentClassifier_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
	...
	// Experimental.
	VpcConfig *AwsComprehendDocumentClassifier_VpcConfigProperty `field:"optional" json:"vpcConfig" yaml:"vpcConfig"`
}
