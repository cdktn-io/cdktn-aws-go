...
type AwsGroup interface {
	...
	// Experimental.
	Configuration() AwsGroup_ConfigurationPropertyList
	// Experimental.
	...
	RegionInput() *string
	// Experimental.
	ResourceQuery() AwsGroup_ResourceQueryPropertyOutputReference
	// Experimental.
	ResourceQueryInput() *AwsGroup_ResourceQueryProperty
	// Experimental.
	...
	// Experimental.
	PutResourceQuery(value *AwsGroup_ResourceQueryProperty)
	// Experimental.
...
func (j *jsiiProxy_AwsGroup) Configuration() AwsGroup_ConfigurationPropertyList {
	var returns AwsGroup_ConfigurationPropertyList
	_jsii_.Get(
		j,
		"configuration",
		&returns,
...
func (j *jsiiProxy_AwsGroup) ConfigurationInput() interface{} {
...
func (j *jsiiProxy_AwsGroup) ResourceQuery() AwsGroup_ResourceQueryPropertyOutputReference {
	var returns AwsGroup_ResourceQueryPropertyOutputReference
	_jsii_.Get(
		j,
		"resourceQuery",
		&returns,
...
func (j *jsiiProxy_AwsGroup) ResourceQueryInput() *AwsGroup_ResourceQueryProperty {
...
func (a *jsiiProxy_AwsGroup) PutConfiguration(value interface{}) {
...
func (a *jsiiProxy_AwsGroup) PutResourceQuery(value *AwsGroup_ResourceQueryProperty) {
...
func (a *jsiiProxy_AwsGroup) ResetConfiguration() {
	_jsii_.InvokeVoid(
		a,
		"resetConfiguration",
		nil, // no parameters
...
func (a *jsiiProxy_AwsGroup) ResetResourceQuery() {
	_jsii_.InvokeVoid(
		a,
		"resetResourceQuery",
		nil, // no parameters
