...
// Experimental.
type AwsS3ControlObjectLambdaAccessPointConfig struct {
	// Experimental.
	...
	// Experimental.
	Configuration *AwsS3ControlObjectLambdaAccessPoint_ConfigurationProperty `field:"required" json:"configuration" yaml:"configuration"`
