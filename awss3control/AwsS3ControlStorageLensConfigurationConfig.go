...
// Experimental.
type AwsS3ControlStorageLensConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	StorageLensConfiguration *AwsS3ControlStorageLensConfiguration_StorageLensConfigurationProperty `field:"required" json:"storageLensConfiguration" yaml:"storageLensConfiguration"`
