...
// Experimental.
type AwsS3ControlStorageLensConfiguration_StorageLensConfigurationExpandedPrefixesDataExportStorageLensTableDestinationProperty struct {
	...
	// Experimental.
	Encryption *AwsS3ControlStorageLensConfiguration_StorageLensConfigurationExpandedPrefixesDataExportStorageLensTableDestinationEncryptionProperty `field:"optional" json:"encryption" yaml:"encryption"`
}
