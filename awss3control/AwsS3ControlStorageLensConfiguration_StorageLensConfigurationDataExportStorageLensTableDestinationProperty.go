...
// Experimental.
type AwsS3ControlStorageLensConfiguration_StorageLensConfigurationDataExportStorageLensTableDestinationProperty struct {
	...
	// Experimental.
	Encryption *AwsS3ControlStorageLensConfiguration_StorageLensConfigurationDataExportStorageLensTableDestinationEncryptionProperty `field:"optional" json:"encryption" yaml:"encryption"`
}
