...
// Experimental.
type AwsS3ControlMultiRegionAccessPointPolicyConfig struct {
	// Experimental.
	...
	// Experimental.
	Details *AwsS3ControlMultiRegionAccessPointPolicy_DetailsProperty `field:"required" json:"details" yaml:"details"`
	...
	// Experimental.
	Timeouts *AwsS3ControlMultiRegionAccessPointPolicy_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
