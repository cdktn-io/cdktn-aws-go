...
// Experimental.
type TfStorageLensConfiguration_StorageLensConfigurationDataExportS3BucketDestinationProperty struct {
	...
	// Experimental.
	Encryption *TfStorageLensConfiguration_StorageLensConfigurationDataExportS3BucketDestinationEncryptionProperty `field:"optional" json:"encryption" yaml:"encryption"`
