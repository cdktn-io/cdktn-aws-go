...
func (a *jsiiProxy_AwsS3ControlStorageLensConfiguration_StorageLensConfigurationDataExportS3BucketDestinationEncryptionPropertyOutputReference) validatePutSseS3Parameters(value interface{}) error {
	...
	case *[]*AwsS3ControlStorageLensConfiguration_StorageLensConfigurationDataExportS3BucketDestinationEncryptionSseS3Property:
		value := value.(*[]*AwsS3ControlStorageLensConfiguration_StorageLensConfigurationDataExportS3BucketDestinationEncryptionSseS3Property)
	...
	case []*AwsS3ControlStorageLensConfiguration_StorageLensConfigurationDataExportS3BucketDestinationEncryptionSseS3Property:
		value_ := value.([]*AwsS3ControlStorageLensConfiguration_StorageLensConfigurationDataExportS3BucketDestinationEncryptionSseS3Property)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AwsS3ControlStorageLensConfiguration_StorageLensConfigurationDataExportS3BucketDestinationEncryptionSseS3Property; received %#v (a %T)", value, value)
		}
	}
