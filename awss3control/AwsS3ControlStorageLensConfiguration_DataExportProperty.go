...
// Experimental.
type AwsS3ControlStorageLensConfiguration_DataExportProperty struct {
	...
	// Experimental.
	CloudWatchMetrics *AwsS3ControlStorageLensConfiguration_CloudWatchMetricsProperty `field:"optional" json:"cloudWatchMetrics" yaml:"cloudWatchMetrics"`
	...
	// Experimental.
	S3BucketDestination *AwsS3ControlStorageLensConfiguration_StorageLensConfigurationDataExportS3BucketDestinationProperty `field:"optional" json:"s3BucketDestination" yaml:"s3BucketDestination"`
	...
	// Experimental.
	StorageLensTableDestination *AwsS3ControlStorageLensConfiguration_StorageLensConfigurationDataExportStorageLensTableDestinationProperty `field:"optional" json:"storageLensTableDestination" yaml:"storageLensTableDestination"`
}
