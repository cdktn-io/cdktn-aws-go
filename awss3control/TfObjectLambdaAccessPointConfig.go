...
// Experimental.
type TfObjectLambdaAccessPointConfig struct {
	// Experimental.
	...
	// Experimental.
	Configuration *TfObjectLambdaAccessPoint_ConfigurationProperty `field:"required" json:"configuration" yaml:"configuration"`
