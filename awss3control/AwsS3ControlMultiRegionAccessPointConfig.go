...
// Experimental.
type AwsS3ControlMultiRegionAccessPointConfig struct {
	// Experimental.
	...
	// Experimental.
	Details *AwsS3ControlMultiRegionAccessPoint_DetailsProperty `field:"required" json:"details" yaml:"details"`
	...
	// Experimental.
	Timeouts *AwsS3ControlMultiRegionAccessPoint_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
