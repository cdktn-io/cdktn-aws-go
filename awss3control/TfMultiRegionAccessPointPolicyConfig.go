...
// Experimental.
type TfMultiRegionAccessPointPolicyConfig struct {
	// Experimental.
	...
	// Experimental.
	Details *TfMultiRegionAccessPointPolicy_DetailsProperty `field:"required" json:"details" yaml:"details"`
	...
	// Experimental.
	Timeouts *TfMultiRegionAccessPointPolicy_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
