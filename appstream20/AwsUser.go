...
func (j *jsiiProxy_AwsUser) AuthenticationType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"authenticationType",
...
func (j *jsiiProxy_AwsUser) AuthenticationTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsUser) CreatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdTime",
...
func (j *jsiiProxy_AwsUser) Enabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabled",
...
func (j *jsiiProxy_AwsUser) EnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabledInput",
...
func (j *jsiiProxy_AwsUser) SendEmailNotification() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsUser) SendEmailNotificationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func NewAwsUser(scope constructs.Construct, id *string, config *AwsUserConfig) AwsUser {
	...
	_jsii_.Create(
		"@cdktn/aws-appstream-2-0.AwsUser",
...
func (j *jsiiProxy_AwsUser)SetAuthenticationType(val *string) {
...
func (j *jsiiProxy_AwsUser)SetEnabled(val interface{}) {
...
func (j *jsiiProxy_AwsUser)SetSendEmailNotification(val interface{}) {
...
func (a *jsiiProxy_AwsUser) ResetEnabled() {
	_jsii_.InvokeVoid(
		a,
		"resetEnabled",
		nil, // no parameters
...
func (a *jsiiProxy_AwsUser) ResetSendEmailNotification() {
	_jsii_.InvokeVoid(
		a,
		"resetSendEmailNotification",
		nil, // no parameters
