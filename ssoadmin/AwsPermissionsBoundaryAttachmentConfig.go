...
// Experimental.
type AwsPermissionsBoundaryAttachmentConfig struct {
	// Experimental.
	...
	// Experimental.
	PermissionsBoundary *AwsPermissionsBoundaryAttachment_PermissionsBoundaryProperty `field:"required" json:"permissionsBoundary" yaml:"permissionsBoundary"`
	...
	// Experimental.
	Timeouts *AwsPermissionsBoundaryAttachment_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
