...
// Experimental.
type AwsCustomerManagedPolicyAttachmentsExclusiveConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsCustomerManagedPolicyAttachmentsExclusive_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
