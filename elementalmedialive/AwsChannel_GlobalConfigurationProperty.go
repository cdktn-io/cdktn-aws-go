...
// Experimental.
type AwsChannel_GlobalConfigurationProperty struct {
	...
	// Experimental.
	InputLossBehavior *AwsChannel_InputLossBehaviorProperty `field:"optional" json:"inputLossBehavior" yaml:"inputLossBehavior"`
