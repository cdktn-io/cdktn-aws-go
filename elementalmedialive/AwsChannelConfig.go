...
type AwsChannelConfig struct {
	...
	// Experimental.
	EncoderSettings *AwsChannel_EncoderSettingsProperty `field:"required" json:"encoderSettings" yaml:"encoderSettings"`
	...
	// Experimental.
	InputSpecification *AwsChannel_InputSpecificationProperty `field:"required" json:"inputSpecification" yaml:"inputSpecification"`
	...
	// Experimental.
	CdiInputSpecification *AwsChannel_CdiInputSpecificationProperty `field:"optional" json:"cdiInputSpecification" yaml:"cdiInputSpecification"`
	...
	// Experimental.
	Maintenance *AwsChannel_MaintenanceProperty `field:"optional" json:"maintenance" yaml:"maintenance"`
	...
	// Experimental.
	Timeouts *AwsChannel_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
	// vpc block.
	//
	...
	// Experimental.
	Vpc *AwsChannel_VpcProperty `field:"optional" json:"vpc" yaml:"vpc"`
}
