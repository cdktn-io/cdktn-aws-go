...
// Experimental.
type AwsChannel_EncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettingsProperty struct {
	...
	// Experimental.
	DvbNitSettings *AwsChannel_EncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettingsDvbNitSettingsProperty `field:"optional" json:"dvbNitSettings" yaml:"dvbNitSettings"`
	...
	// Experimental.
	DvbSdtSettings *AwsChannel_EncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettingsDvbSdtSettingsProperty `field:"optional" json:"dvbSdtSettings" yaml:"dvbSdtSettings"`
	...
	// Experimental.
	DvbTdtSettings *AwsChannel_EncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettingsDvbTdtSettingsProperty `field:"optional" json:"dvbTdtSettings" yaml:"dvbTdtSettings"`
