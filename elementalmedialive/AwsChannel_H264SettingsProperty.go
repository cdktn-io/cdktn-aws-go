...
// Experimental.
type AwsChannel_H264SettingsProperty struct {
	...
	// Experimental.
	FilterSettings *AwsChannel_EncoderSettingsVideoDescriptionsCodecSettingsH264SettingsFilterSettingsProperty `field:"optional" json:"filterSettings" yaml:"filterSettings"`
