...
// Experimental.
type AwsChannel_ArchiveCdnSettingsProperty struct {
	...
	// Experimental.
	ArchiveS3Settings *AwsChannel_ArchiveS3SettingsProperty `field:"optional" json:"archiveS3Settings" yaml:"archiveS3Settings"`
}
