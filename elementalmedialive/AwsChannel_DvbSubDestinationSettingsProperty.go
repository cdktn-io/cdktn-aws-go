...
// Experimental.
type AwsChannel_DvbSubDestinationSettingsProperty struct {
	...
	// Experimental.
	Font *AwsChannel_EncoderSettingsCaptionDescriptionsDestinationSettingsDvbSubDestinationSettingsFontProperty `field:"optional" json:"font" yaml:"font"`
