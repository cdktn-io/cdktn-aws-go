...
// Experimental.
type AwsMultiplexConfig struct {
	// Experimental.
	...
	// Experimental.
	MultiplexSettings *AwsMultiplex_MultiplexSettingsProperty `field:"optional" json:"multiplexSettings" yaml:"multiplexSettings"`
	...
	// Experimental.
	Timeouts *AwsMultiplex_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
