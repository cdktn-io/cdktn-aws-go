...
type AwsInputConfig struct {
	...
	// Experimental.
	Timeouts *AwsInput_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
	// vpc block.
	//
	...
	// Experimental.
	Vpc *AwsInput_VpcProperty `field:"optional" json:"vpc" yaml:"vpc"`
}
