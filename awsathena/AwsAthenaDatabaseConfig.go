...
// Experimental.
type AwsAthenaDatabaseConfig struct {
	// Experimental.
	...
	// Experimental.
	AclConfiguration *AwsAthenaDatabase_AclConfigurationProperty `field:"optional" json:"aclConfiguration" yaml:"aclConfiguration"`
	...
	// Experimental.
	EncryptionConfiguration *AwsAthenaDatabase_EncryptionConfigurationProperty `field:"optional" json:"encryptionConfiguration" yaml:"encryptionConfiguration"`
