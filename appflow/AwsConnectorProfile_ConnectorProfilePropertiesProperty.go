...
// Experimental.
type AwsConnectorProfile_ConnectorProfilePropertiesProperty struct {
	// amplitude block.
	//
	...
	// Experimental.
	Amplitude *AwsConnectorProfile_ConnectorProfileConfigConnectorProfilePropertiesAmplitudeProperty `field:"optional" json:"amplitude" yaml:"amplitude"`
	...
	// Experimental.
	CustomConnector *AwsConnectorProfile_ConnectorProfileConfigConnectorProfilePropertiesCustomConnectorProperty `field:"optional" json:"customConnector" yaml:"customConnector"`
	// datadog block.
	//
	...
	// Experimental.
	Datadog *AwsConnectorProfile_ConnectorProfileConfigConnectorProfilePropertiesDatadogProperty `field:"optional" json:"datadog" yaml:"datadog"`
	// dynatrace block.
	//
	...
	// Experimental.
	Dynatrace *AwsConnectorProfile_ConnectorProfileConfigConnectorProfilePropertiesDynatraceProperty `field:"optional" json:"dynatrace" yaml:"dynatrace"`
	...
	// Experimental.
	GoogleAnalytics *AwsConnectorProfile_ConnectorProfileConfigConnectorProfilePropertiesGoogleAnalyticsProperty `field:"optional" json:"googleAnalytics" yaml:"googleAnalytics"`
	// honeycode block.
	//
	...
	// Experimental.
	Honeycode *AwsConnectorProfile_ConnectorProfileConfigConnectorProfilePropertiesHoneycodeProperty `field:"optional" json:"honeycode" yaml:"honeycode"`
	// infor_nexus block.
	//
	...
	// Experimental.
	InforNexus *AwsConnectorProfile_ConnectorProfileConfigConnectorProfilePropertiesInforNexusProperty `field:"optional" json:"inforNexus" yaml:"inforNexus"`
	// marketo block.
	//
	...
	// Experimental.
	Marketo *AwsConnectorProfile_ConnectorProfileConfigConnectorProfilePropertiesMarketoProperty `field:"optional" json:"marketo" yaml:"marketo"`
	// redshift block.
	//
	...
	// Experimental.
	Redshift *AwsConnectorProfile_ConnectorProfileConfigConnectorProfilePropertiesRedshiftProperty `field:"optional" json:"redshift" yaml:"redshift"`
	// salesforce block.
	//
	...
	// Experimental.
	Salesforce *AwsConnectorProfile_ConnectorProfileConfigConnectorProfilePropertiesSalesforceProperty `field:"optional" json:"salesforce" yaml:"salesforce"`
	// sapo_data block.
	//
	...
	// Experimental.
	SapoData *AwsConnectorProfile_ConnectorProfileConfigConnectorProfilePropertiesSapoDataProperty `field:"optional" json:"sapoData" yaml:"sapoData"`
	// service_now block.
	//
	...
	// Experimental.
	ServiceNow *AwsConnectorProfile_ConnectorProfileConfigConnectorProfilePropertiesServiceNowProperty `field:"optional" json:"serviceNow" yaml:"serviceNow"`
	// singular block.
	//
	...
	// Experimental.
	Singular *AwsConnectorProfile_ConnectorProfileConfigConnectorProfilePropertiesSingularProperty `field:"optional" json:"singular" yaml:"singular"`
	// slack block.
	//
	...
	// Experimental.
	Slack *AwsConnectorProfile_ConnectorProfileConfigConnectorProfilePropertiesSlackProperty `field:"optional" json:"slack" yaml:"slack"`
	// snowflake block.
	//
	...
	// Experimental.
	Snowflake *AwsConnectorProfile_ConnectorProfileConfigConnectorProfilePropertiesSnowflakeProperty `field:"optional" json:"snowflake" yaml:"snowflake"`
	// trendmicro block.
	//
	...
	// Experimental.
	Trendmicro *AwsConnectorProfile_ConnectorProfileConfigConnectorProfilePropertiesTrendmicroProperty `field:"optional" json:"trendmicro" yaml:"trendmicro"`
	// veeva block.
	//
	...
	// Experimental.
	Veeva *AwsConnectorProfile_ConnectorProfileConfigConnectorProfilePropertiesVeevaProperty `field:"optional" json:"veeva" yaml:"veeva"`
	// zendesk block.
	//
	...
	// Experimental.
	Zendesk *AwsConnectorProfile_ConnectorProfileConfigConnectorProfilePropertiesZendeskProperty `field:"optional" json:"zendesk" yaml:"zendesk"`
}
