...
// Experimental.
type AwsConnectorProfile_ConnectorProfileConfigConnectorProfileCredentialsZendeskProperty struct {
	...
	// Experimental.
	OauthRequest *AwsConnectorProfile_ConnectorProfileConfigConnectorProfileCredentialsZendeskOauthRequestProperty `field:"optional" json:"oauthRequest" yaml:"oauthRequest"`
}
