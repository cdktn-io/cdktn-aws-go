...
// Experimental.
type AwsFlow_DestinationFlowConfigDestinationConnectorPropertiesCustomConnectorProperty struct {
	...
	// Experimental.
	ErrorHandlingConfig *AwsFlow_DestinationFlowConfigDestinationConnectorPropertiesCustomConnectorErrorHandlingConfigProperty `field:"optional" json:"errorHandlingConfig" yaml:"errorHandlingConfig"`
