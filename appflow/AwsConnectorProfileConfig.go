...
// Experimental.
type AwsConnectorProfileConfig struct {
	// Experimental.
	...
	// Experimental.
	ConnectorProfileConfig *AwsConnectorProfile_ConnectorProfileConfigProperty `field:"required" json:"connectorProfileConfig" yaml:"connectorProfileConfig"`
