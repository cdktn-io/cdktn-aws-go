...
// Experimental.
type AwsConnectorProfile_ConnectorProfileConfigConnectorProfileCredentialsMarketoProperty struct {
	...
	// Experimental.
	OauthRequest *AwsConnectorProfile_ConnectorProfileConfigConnectorProfileCredentialsMarketoOauthRequestProperty `field:"optional" json:"oauthRequest" yaml:"oauthRequest"`
}
