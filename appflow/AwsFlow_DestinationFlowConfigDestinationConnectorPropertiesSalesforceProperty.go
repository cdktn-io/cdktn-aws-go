...
// Experimental.
type AwsFlow_DestinationFlowConfigDestinationConnectorPropertiesSalesforceProperty struct {
	...
	// Experimental.
	ErrorHandlingConfig *AwsFlow_DestinationFlowConfigDestinationConnectorPropertiesSalesforceErrorHandlingConfigProperty `field:"optional" json:"errorHandlingConfig" yaml:"errorHandlingConfig"`
