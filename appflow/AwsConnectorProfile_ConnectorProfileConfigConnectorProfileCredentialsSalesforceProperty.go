...
// Experimental.
type AwsConnectorProfile_ConnectorProfileConfigConnectorProfileCredentialsSalesforceProperty struct {
	...
	// Experimental.
	OauthRequest *AwsConnectorProfile_ConnectorProfileConfigConnectorProfileCredentialsSalesforceOauthRequestProperty `field:"optional" json:"oauthRequest" yaml:"oauthRequest"`
