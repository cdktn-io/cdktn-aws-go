...
// Experimental.
type AwsConnectorProfile_OauthCredentialsProperty struct {
	...
	// Experimental.
	OauthRequest *AwsConnectorProfile_ConnectorProfileConfigConnectorProfileCredentialsSapoDataOauthCredentialsOauthRequestProperty `field:"optional" json:"oauthRequest" yaml:"oauthRequest"`
