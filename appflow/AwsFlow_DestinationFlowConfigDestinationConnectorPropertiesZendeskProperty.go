...
// Experimental.
type AwsFlow_DestinationFlowConfigDestinationConnectorPropertiesZendeskProperty struct {
	...
	// Experimental.
	ErrorHandlingConfig *AwsFlow_DestinationFlowConfigDestinationConnectorPropertiesZendeskErrorHandlingConfigProperty `field:"optional" json:"errorHandlingConfig" yaml:"errorHandlingConfig"`
