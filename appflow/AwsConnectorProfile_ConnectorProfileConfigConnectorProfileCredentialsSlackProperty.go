...
// Experimental.
type AwsConnectorProfile_ConnectorProfileConfigConnectorProfileCredentialsSlackProperty struct {
	...
	// Experimental.
	OauthRequest *AwsConnectorProfile_ConnectorProfileConfigConnectorProfileCredentialsSlackOauthRequestProperty `field:"optional" json:"oauthRequest" yaml:"oauthRequest"`
}
