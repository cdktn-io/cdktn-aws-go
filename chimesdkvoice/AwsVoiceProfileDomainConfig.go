...
// Experimental.
type AwsVoiceProfileDomainConfig struct {
	// Experimental.
	...
	// Experimental.
	ServerSideEncryptionConfiguration *AwsVoiceProfileDomain_ServerSideEncryptionConfigurationProperty `field:"required" json:"serverSideEncryptionConfiguration" yaml:"serverSideEncryptionConfiguration"`
	...
	// Experimental.
	Timeouts *AwsVoiceProfileDomain_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
