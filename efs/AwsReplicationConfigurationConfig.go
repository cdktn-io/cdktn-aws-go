...
// Experimental.
type AwsReplicationConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	Destination *AwsReplicationConfiguration_DestinationProperty `field:"required" json:"destination" yaml:"destination"`
	...
	// Experimental.
	Timeouts *AwsReplicationConfiguration_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
