...
type AwsAccessPointConfig struct {
	...
	// Experimental.
	PosixUser *AwsAccessPoint_PosixUserProperty `field:"optional" json:"posixUser" yaml:"posixUser"`
	...
	// Experimental.
	RootDirectory *AwsAccessPoint_RootDirectoryProperty `field:"optional" json:"rootDirectory" yaml:"rootDirectory"`
