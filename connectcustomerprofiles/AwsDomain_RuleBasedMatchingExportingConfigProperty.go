...
// Experimental.
type AwsDomain_RuleBasedMatchingExportingConfigProperty struct {
	// s3_exporting block.
	//
	...
	// Experimental.
	S3Exporting *AwsDomain_RuleBasedMatchingExportingConfigS3ExportingProperty `field:"optional" json:"s3Exporting" yaml:"s3Exporting"`
}
