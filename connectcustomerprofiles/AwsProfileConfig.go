...
type AwsProfileConfig struct {
	...
	// Experimental.
	Address *AwsProfile_AddressProperty `field:"optional" json:"address" yaml:"address"`
	...
	// Experimental.
	BillingAddress *AwsProfile_BillingAddressProperty `field:"optional" json:"billingAddress" yaml:"billingAddress"`
	...
	// Experimental.
	MailingAddress *AwsProfile_MailingAddressProperty `field:"optional" json:"mailingAddress" yaml:"mailingAddress"`
	...
	// Experimental.
	ShippingAddress *AwsProfile_ShippingAddressProperty `field:"optional" json:"shippingAddress" yaml:"shippingAddress"`
}
