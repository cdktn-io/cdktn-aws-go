...
type AwsDomain interface {
	...
	// Experimental.
	Matching() AwsDomain_MatchingPropertyOutputReference
	// Experimental.
	MatchingInput() *AwsDomain_MatchingProperty
	// The tree node.
	// Experimental.
	...
	RegionInput() *string
	// Experimental.
	RuleBasedMatching() AwsDomain_RuleBasedMatchingPropertyOutputReference
	// Experimental.
	RuleBasedMatchingInput() *AwsDomain_RuleBasedMatchingProperty
	// Experimental.
	...
	// Experimental.
	PutMatching(value *AwsDomain_MatchingProperty)
	// Experimental.
	PutRuleBasedMatching(value *AwsDomain_RuleBasedMatchingProperty)
...
func (j *jsiiProxy_AwsDomain) DeadLetterQueueUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deadLetterQueueUrl",
...
func (j *jsiiProxy_AwsDomain) DeadLetterQueueUrlInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsDomain) DefaultEncryptionKey() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsDomain) DefaultEncryptionKeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsDomain) DefaultExpirationDays() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsDomain) DefaultExpirationDaysInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsDomain) Matching() AwsDomain_MatchingPropertyOutputReference {
	var returns AwsDomain_MatchingPropertyOutputReference
	_jsii_.Get(
		j,
		"matching",
		&returns,
...
func (j *jsiiProxy_AwsDomain) MatchingInput() *AwsDomain_MatchingProperty {
...
func (j *jsiiProxy_AwsDomain) RuleBasedMatching() AwsDomain_RuleBasedMatchingPropertyOutputReference {
	var returns AwsDomain_RuleBasedMatchingPropertyOutputReference
	_jsii_.Get(
		j,
		"ruleBasedMatching",
		&returns,
...
func (j *jsiiProxy_AwsDomain) RuleBasedMatchingInput() *AwsDomain_RuleBasedMatchingProperty {
...
func NewAwsDomain(scope constructs.Construct, id *string, config *AwsDomainConfig) AwsDomain {
	...
	_jsii_.Create(
		"@cdktn/aws-connect-customer-profiles.AwsDomain",
...
func (j *jsiiProxy_AwsDomain)SetDeadLetterQueueUrl(val *string) {
...
func (j *jsiiProxy_AwsDomain)SetDefaultEncryptionKey(val *string) {
...
func (j *jsiiProxy_AwsDomain)SetDefaultExpirationDays(val *float64) {
...
func (a *jsiiProxy_AwsDomain) PutMatching(value *AwsDomain_MatchingProperty) {
...
func (a *jsiiProxy_AwsDomain) PutRuleBasedMatching(value *AwsDomain_RuleBasedMatchingProperty) {
...
func (a *jsiiProxy_AwsDomain) ResetDeadLetterQueueUrl() {
	_jsii_.InvokeVoid(
		a,
		"resetDeadLetterQueueUrl",
		nil, // no parameters
...
func (a *jsiiProxy_AwsDomain) ResetDefaultEncryptionKey() {
	_jsii_.InvokeVoid(
		a,
		"resetDefaultEncryptionKey",
		nil, // no parameters
...
func (a *jsiiProxy_AwsDomain) ResetMatching() {
	_jsii_.InvokeVoid(
		a,
		"resetMatching",
		nil, // no parameters
...
func (a *jsiiProxy_AwsDomain) ResetRuleBasedMatching() {
	_jsii_.InvokeVoid(
		a,
		"resetRuleBasedMatching",
		nil, // no parameters
