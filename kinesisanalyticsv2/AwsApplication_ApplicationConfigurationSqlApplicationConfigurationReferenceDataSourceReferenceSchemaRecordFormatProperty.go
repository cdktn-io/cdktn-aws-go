...
// Experimental.
type AwsApplication_ApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceReferenceSchemaRecordFormatProperty struct {
	...
	// Experimental.
	MappingParameters *AwsApplication_ApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceReferenceSchemaRecordFormatMappingParametersProperty `field:"required" json:"mappingParameters" yaml:"mappingParameters"`
