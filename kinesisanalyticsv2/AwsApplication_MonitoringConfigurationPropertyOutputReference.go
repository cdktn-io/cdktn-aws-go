...
func (j *jsiiProxy_AwsApplication_MonitoringConfigurationPropertyOutputReference) ConfigurationType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"configurationType",
...
func (j *jsiiProxy_AwsApplication_MonitoringConfigurationPropertyOutputReference) ConfigurationTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsApplication_MonitoringConfigurationPropertyOutputReference) LogLevel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logLevel",
...
func (j *jsiiProxy_AwsApplication_MonitoringConfigurationPropertyOutputReference) LogLevelInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logLevelInput",
...
func (j *jsiiProxy_AwsApplication_MonitoringConfigurationPropertyOutputReference) MetricsLevel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"metricsLevel",
...
func (j *jsiiProxy_AwsApplication_MonitoringConfigurationPropertyOutputReference) MetricsLevelInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"metricsLevelInput",
...
func NewAwsApplication_MonitoringConfigurationPropertyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AwsApplication_MonitoringConfigurationPropertyOutputReference {
	...
	_jsii_.Create(
		"@cdktn/aws-kinesis-analytics-v2.AwsApplication.MonitoringConfigurationPropertyOutputReference",
...
func (j *jsiiProxy_AwsApplication_MonitoringConfigurationPropertyOutputReference)SetConfigurationType(val *string) {
...
func (j *jsiiProxy_AwsApplication_MonitoringConfigurationPropertyOutputReference)SetLogLevel(val *string) {
...
func (j *jsiiProxy_AwsApplication_MonitoringConfigurationPropertyOutputReference)SetMetricsLevel(val *string) {
...
func (a *jsiiProxy_AwsApplication_MonitoringConfigurationPropertyOutputReference) ResetLogLevel() {
	_jsii_.InvokeVoid(
		a,
		"resetLogLevel",
		nil, // no parameters
...
func (a *jsiiProxy_AwsApplication_MonitoringConfigurationPropertyOutputReference) ResetMetricsLevel() {
	_jsii_.InvokeVoid(
		a,
		"resetMetricsLevel",
		nil, // no parameters
