...
// Experimental.
type AwsApplication_InputSchemaProperty struct {
	// record_column block.
	//
	...
	// Experimental.
	RecordFormat *AwsApplication_ApplicationConfigurationSqlApplicationConfigurationInputInputSchemaRecordFormatProperty `field:"required" json:"recordFormat" yaml:"recordFormat"`
