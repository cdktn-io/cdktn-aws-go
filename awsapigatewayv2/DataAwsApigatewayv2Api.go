...
type DataAwsApigatewayv2Api interface {
	...
	// Experimental.
	CorsConfiguration() DataAwsApigatewayv2Api_CorsConfigurationPropertyList
	// Experimental.
	Count() interface{}
	// Experimental.
...
func (j *jsiiProxy_DataAwsApigatewayv2Api) CorsConfiguration() DataAwsApigatewayv2Api_CorsConfigurationPropertyList {
	var returns DataAwsApigatewayv2Api_CorsConfigurationPropertyList
	_jsii_.Get(
		j,
		"corsConfiguration",
		&returns,
