...
// Experimental.
type TfModel_PrimaryContainerImageConfigProperty struct {
	...
	// Experimental.
	RepositoryAuthConfig *TfModel_PrimaryContainerImageConfigRepositoryAuthConfigProperty `field:"optional" json:"repositoryAuthConfig" yaml:"repositoryAuthConfig"`
}
