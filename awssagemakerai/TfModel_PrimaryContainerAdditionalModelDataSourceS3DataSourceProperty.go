...
// Experimental.
type TfModel_PrimaryContainerAdditionalModelDataSourceS3DataSourceProperty struct {
	...
	// Experimental.
	ModelAccessConfig *TfModel_PrimaryContainerAdditionalModelDataSourceS3DataSourceModelAccessConfigProperty `field:"optional" json:"modelAccessConfig" yaml:"modelAccessConfig"`
}
