...
// Experimental.
type TfDomain_DefaultSpaceSettingsJupyterServerAppSettingsProperty struct {
	...
	// Experimental.
	DefaultResourceSpec *TfDomain_DefaultSpaceSettingsJupyterServerAppSettingsDefaultResourceSpecProperty `field:"optional" json:"defaultResourceSpec" yaml:"defaultResourceSpec"`
