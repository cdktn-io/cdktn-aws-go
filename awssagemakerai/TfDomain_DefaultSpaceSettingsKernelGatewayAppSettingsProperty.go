...
// Experimental.
type TfDomain_DefaultSpaceSettingsKernelGatewayAppSettingsProperty struct {
	// custom_image block.
	//
	...
	// Experimental.
	DefaultResourceSpec *TfDomain_DefaultSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpecProperty `field:"optional" json:"defaultResourceSpec" yaml:"defaultResourceSpec"`
