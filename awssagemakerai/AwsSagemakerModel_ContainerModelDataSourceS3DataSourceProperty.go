...
// Experimental.
type AwsSagemakerModel_ContainerModelDataSourceS3DataSourceProperty struct {
	...
	// Experimental.
	ModelAccessConfig *AwsSagemakerModel_ContainerModelDataSourceS3DataSourceModelAccessConfigProperty `field:"optional" json:"modelAccessConfig" yaml:"modelAccessConfig"`
}
