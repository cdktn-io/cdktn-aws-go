...
// Experimental.
type AwsSagemakerEndpointConfiguration_ShadowProductionVariantsProperty struct {
	...
	// Experimental.
	CapacityReservationConfig *AwsSagemakerEndpointConfiguration_ShadowProductionVariantsCapacityReservationConfigProperty `field:"optional" json:"capacityReservationConfig" yaml:"capacityReservationConfig"`
	...
	// Experimental.
	CoreDumpConfig *AwsSagemakerEndpointConfiguration_ShadowProductionVariantsCoreDumpConfigProperty `field:"optional" json:"coreDumpConfig" yaml:"coreDumpConfig"`
	...
	// Experimental.
	ManagedInstanceScaling *AwsSagemakerEndpointConfiguration_ShadowProductionVariantsManagedInstanceScalingProperty `field:"optional" json:"managedInstanceScaling" yaml:"managedInstanceScaling"`
	...
	// Experimental.
	ServerlessConfig *AwsSagemakerEndpointConfiguration_ShadowProductionVariantsServerlessConfigProperty `field:"optional" json:"serverlessConfig" yaml:"serverlessConfig"`
