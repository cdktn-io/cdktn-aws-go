...
// Experimental.
type TfUserProfile_JupyterLabAppSettingsProperty struct {
	...
	// Experimental.
	AppLifecycleManagement *TfUserProfile_UserSettingsJupyterLabAppSettingsAppLifecycleManagementProperty `field:"optional" json:"appLifecycleManagement" yaml:"appLifecycleManagement"`
	...
	// Experimental.
	DefaultResourceSpec *TfUserProfile_UserSettingsJupyterLabAppSettingsDefaultResourceSpecProperty `field:"optional" json:"defaultResourceSpec" yaml:"defaultResourceSpec"`
	// emr_settings block.
	//
	...
	// Experimental.
	EmrSettings *TfUserProfile_EmrSettingsProperty `field:"optional" json:"emrSettings" yaml:"emrSettings"`
