...
// Experimental.
type AwsSagemakerModel_PrimaryContainerProperty struct {
	...
	// Experimental.
	ImageConfig *AwsSagemakerModel_PrimaryContainerImageConfigProperty `field:"optional" json:"imageConfig" yaml:"imageConfig"`
	...
	// Experimental.
	ModelDataSource *AwsSagemakerModel_PrimaryContainerModelDataSourceProperty `field:"optional" json:"modelDataSource" yaml:"modelDataSource"`
	...
	// Experimental.
	MultiModelConfig *AwsSagemakerModel_PrimaryContainerMultiModelConfigProperty `field:"optional" json:"multiModelConfig" yaml:"multiModelConfig"`
}
