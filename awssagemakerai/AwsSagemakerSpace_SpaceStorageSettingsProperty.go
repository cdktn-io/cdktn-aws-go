...
// Experimental.
type AwsSagemakerSpace_SpaceStorageSettingsProperty struct {
	...
	// Experimental.
	EbsStorageSettings *AwsSagemakerSpace_EbsStorageSettingsProperty `field:"required" json:"ebsStorageSettings" yaml:"ebsStorageSettings"`
}
