...
// Experimental.
type TfModel_ContainerModelDataSourceS3DataSourceProperty struct {
	...
	// Experimental.
	ModelAccessConfig *TfModel_ContainerModelDataSourceS3DataSourceModelAccessConfigProperty `field:"optional" json:"modelAccessConfig" yaml:"modelAccessConfig"`
}
