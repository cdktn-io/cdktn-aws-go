...
// Experimental.
type AwsSagemakerDomain_DomainSettingsProperty struct {
	...
	// Experimental.
	DockerSettings *AwsSagemakerDomain_DockerSettingsProperty `field:"optional" json:"dockerSettings" yaml:"dockerSettings"`
	...
	// Experimental.
	RStudioServerProDomainSettings *AwsSagemakerDomain_RStudioServerProDomainSettingsProperty `field:"optional" json:"rStudioServerProDomainSettings" yaml:"rStudioServerProDomainSettings"`
	...
	// Experimental.
	TrustedIdentityPropagationSettings *AwsSagemakerDomain_TrustedIdentityPropagationSettingsProperty `field:"optional" json:"trustedIdentityPropagationSettings" yaml:"trustedIdentityPropagationSettings"`
}
