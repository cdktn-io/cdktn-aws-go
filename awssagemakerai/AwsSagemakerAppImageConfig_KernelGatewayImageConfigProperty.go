...
// Experimental.
type AwsSagemakerAppImageConfig_KernelGatewayImageConfigProperty struct {
	// kernel_spec block.
	//
	...
	// Experimental.
	FileSystemConfig *AwsSagemakerAppImageConfig_KernelGatewayImageConfigFileSystemConfigProperty `field:"optional" json:"fileSystemConfig" yaml:"fileSystemConfig"`
}
