...
type TfPipelineConfig struct {
	...
	// Experimental.
	ParallelismConfiguration *TfPipeline_ParallelismConfigurationProperty `field:"optional" json:"parallelismConfiguration" yaml:"parallelismConfiguration"`
	...
	// Experimental.
	PipelineDefinitionS3Location *TfPipeline_PipelineDefinitionS3LocationProperty `field:"optional" json:"pipelineDefinitionS3Location" yaml:"pipelineDefinitionS3Location"`
