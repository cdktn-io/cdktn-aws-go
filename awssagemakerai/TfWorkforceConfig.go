...
type TfWorkforceConfig struct {
	...
	// Experimental.
	CognitoConfig *TfWorkforce_CognitoConfigProperty `field:"optional" json:"cognitoConfig" yaml:"cognitoConfig"`
	...
	// Experimental.
	OidcConfig *TfWorkforce_OidcConfigProperty `field:"optional" json:"oidcConfig" yaml:"oidcConfig"`
	...
	// Experimental.
	SourceIpConfig *TfWorkforce_SourceIpConfigProperty `field:"optional" json:"sourceIpConfig" yaml:"sourceIpConfig"`
	...
	// Experimental.
	WorkforceVpcConfig *TfWorkforce_WorkforceVpcConfigProperty `field:"optional" json:"workforceVpcConfig" yaml:"workforceVpcConfig"`
}
