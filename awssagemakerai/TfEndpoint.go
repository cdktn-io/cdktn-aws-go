...
type TfEndpoint interface {
	...
	// Experimental.
	DeploymentConfig() TfEndpoint_DeploymentConfigPropertyOutputReference
	// Experimental.
	DeploymentConfigInput() *TfEndpoint_DeploymentConfigProperty
	// Experimental.
	...
	// Experimental.
	PutDeploymentConfig(value *TfEndpoint_DeploymentConfigProperty)
...
func (j *jsiiProxy_TfEndpoint) DeploymentConfig() TfEndpoint_DeploymentConfigPropertyOutputReference {
	var returns TfEndpoint_DeploymentConfigPropertyOutputReference
	_jsii_.Get(
		j,
		"deploymentConfig",
		&returns,
...
func (j *jsiiProxy_TfEndpoint) DeploymentConfigInput() *TfEndpoint_DeploymentConfigProperty {
...
func (j *jsiiProxy_TfEndpoint) EndpointConfigName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endpointConfigName",
...
func (j *jsiiProxy_TfEndpoint) EndpointConfigNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TfEndpoint)SetEndpointConfigName(val *string) {
...
func (t *jsiiProxy_TfEndpoint) PutDeploymentConfig(value *TfEndpoint_DeploymentConfigProperty) {
	if err := t.validatePutDeploymentConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		t,
...
func (t *jsiiProxy_TfEndpoint) ResetDeploymentConfig() {
	_jsii_.InvokeVoid(
		t,
		"resetDeploymentConfig",
		nil, // no parameters
...
func (t *jsiiProxy_TfEndpoint) ResetName() {
	_jsii_.InvokeVoid(
		t,
		"resetName",
		nil, // no parameters
