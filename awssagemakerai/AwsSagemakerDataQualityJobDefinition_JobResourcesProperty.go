...
// Experimental.
type AwsSagemakerDataQualityJobDefinition_JobResourcesProperty struct {
	...
	// Experimental.
	ClusterConfig *AwsSagemakerDataQualityJobDefinition_ClusterConfigProperty `field:"required" json:"clusterConfig" yaml:"clusterConfig"`
}
