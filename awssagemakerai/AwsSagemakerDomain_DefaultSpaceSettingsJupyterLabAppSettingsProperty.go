...
// Experimental.
type AwsSagemakerDomain_DefaultSpaceSettingsJupyterLabAppSettingsProperty struct {
	...
	// Experimental.
	AppLifecycleManagement *AwsSagemakerDomain_DefaultSpaceSettingsJupyterLabAppSettingsAppLifecycleManagementProperty `field:"optional" json:"appLifecycleManagement" yaml:"appLifecycleManagement"`
	...
	// Experimental.
	DefaultResourceSpec *AwsSagemakerDomain_DefaultSpaceSettingsJupyterLabAppSettingsDefaultResourceSpecProperty `field:"optional" json:"defaultResourceSpec" yaml:"defaultResourceSpec"`
	// emr_settings block.
	//
	...
	// Experimental.
	EmrSettings *AwsSagemakerDomain_DefaultSpaceSettingsJupyterLabAppSettingsEmrSettingsProperty `field:"optional" json:"emrSettings" yaml:"emrSettings"`
