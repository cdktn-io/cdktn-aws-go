...
type TfWorkteamConfig struct {
	...
	// Experimental.
	NotificationConfiguration *TfWorkteam_NotificationConfigurationProperty `field:"optional" json:"notificationConfiguration" yaml:"notificationConfiguration"`
	...
	// Experimental.
	WorkerAccessConfiguration *TfWorkteam_WorkerAccessConfigurationProperty `field:"optional" json:"workerAccessConfiguration" yaml:"workerAccessConfiguration"`
