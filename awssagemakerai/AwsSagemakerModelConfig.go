...
// Experimental.
type AwsSagemakerModelConfig struct {
	// Experimental.
	...
	// Experimental.
	InferenceExecutionConfig *AwsSagemakerModel_InferenceExecutionConfigProperty `field:"optional" json:"inferenceExecutionConfig" yaml:"inferenceExecutionConfig"`
	...
	// Experimental.
	PrimaryContainer *AwsSagemakerModel_PrimaryContainerProperty `field:"optional" json:"primaryContainer" yaml:"primaryContainer"`
	...
	// Experimental.
	VpcConfig *AwsSagemakerModel_VpcConfigProperty `field:"optional" json:"vpcConfig" yaml:"vpcConfig"`
}
