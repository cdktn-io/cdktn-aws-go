...
// Experimental.
type TfUserProfile_JupyterServerAppSettingsProperty struct {
	...
	// Experimental.
	DefaultResourceSpec *TfUserProfile_UserSettingsJupyterServerAppSettingsDefaultResourceSpecProperty `field:"optional" json:"defaultResourceSpec" yaml:"defaultResourceSpec"`
