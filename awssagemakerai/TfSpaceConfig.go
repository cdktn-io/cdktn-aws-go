...
type TfSpaceConfig struct {
	...
	// Experimental.
	OwnershipSettings *TfSpace_OwnershipSettingsProperty `field:"optional" json:"ownershipSettings" yaml:"ownershipSettings"`
	...
	// Experimental.
	SpaceSettings *TfSpace_SpaceSettingsProperty `field:"optional" json:"spaceSettings" yaml:"spaceSettings"`
	...
	// Experimental.
	SpaceSharingSettings *TfSpace_SpaceSharingSettingsProperty `field:"optional" json:"spaceSharingSettings" yaml:"spaceSharingSettings"`
