...
// Experimental.
type AwsSagemakerUserProfile_SpaceStorageSettingsProperty struct {
	...
	// Experimental.
	DefaultEbsStorageSettings *AwsSagemakerUserProfile_DefaultEbsStorageSettingsProperty `field:"optional" json:"defaultEbsStorageSettings" yaml:"defaultEbsStorageSettings"`
}
