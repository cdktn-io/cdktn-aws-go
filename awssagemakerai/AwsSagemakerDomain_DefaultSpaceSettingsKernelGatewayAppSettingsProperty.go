...
// Experimental.
type AwsSagemakerDomain_DefaultSpaceSettingsKernelGatewayAppSettingsProperty struct {
	// custom_image block.
	//
	...
	// Experimental.
	DefaultResourceSpec *AwsSagemakerDomain_DefaultSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpecProperty `field:"optional" json:"defaultResourceSpec" yaml:"defaultResourceSpec"`
