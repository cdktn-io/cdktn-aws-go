...
// Experimental.
type AwsSagemakerNotebookInstanceConfig struct {
	// Experimental.
	...
	// Experimental.
	InstanceMetadataServiceConfiguration *AwsSagemakerNotebookInstance_InstanceMetadataServiceConfigurationProperty `field:"optional" json:"instanceMetadataServiceConfiguration" yaml:"instanceMetadataServiceConfiguration"`
