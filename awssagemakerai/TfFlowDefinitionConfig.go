...
// Experimental.
type TfFlowDefinitionConfig struct {
	// Experimental.
	...
	// Experimental.
	HumanLoopConfig *TfFlowDefinition_HumanLoopConfigProperty `field:"required" json:"humanLoopConfig" yaml:"humanLoopConfig"`
	// output_config block.
	//
	...
	// Experimental.
	OutputConfig *TfFlowDefinition_OutputConfigProperty `field:"required" json:"outputConfig" yaml:"outputConfig"`
	...
	// Experimental.
	HumanLoopActivationConfig *TfFlowDefinition_HumanLoopActivationConfigProperty `field:"optional" json:"humanLoopActivationConfig" yaml:"humanLoopActivationConfig"`
	...
	// Experimental.
	HumanLoopRequestSource *TfFlowDefinition_HumanLoopRequestSourceProperty `field:"optional" json:"humanLoopRequestSource" yaml:"humanLoopRequestSource"`
