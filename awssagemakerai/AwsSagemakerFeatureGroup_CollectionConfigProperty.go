...
// Experimental.
type AwsSagemakerFeatureGroup_CollectionConfigProperty struct {
	// vector_config block.
	//
	...
	// Experimental.
	VectorConfig *AwsSagemakerFeatureGroup_VectorConfigProperty `field:"optional" json:"vectorConfig" yaml:"vectorConfig"`
}
