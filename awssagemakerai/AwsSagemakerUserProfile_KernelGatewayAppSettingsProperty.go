...
// Experimental.
type AwsSagemakerUserProfile_KernelGatewayAppSettingsProperty struct {
	// custom_image block.
	//
	...
	// Experimental.
	DefaultResourceSpec *AwsSagemakerUserProfile_UserSettingsKernelGatewayAppSettingsDefaultResourceSpecProperty `field:"optional" json:"defaultResourceSpec" yaml:"defaultResourceSpec"`
