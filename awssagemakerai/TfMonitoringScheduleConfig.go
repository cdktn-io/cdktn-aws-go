...
// Experimental.
type TfMonitoringScheduleConfig struct {
	// Experimental.
	...
	// Experimental.
	MonitoringScheduleConfig *TfMonitoringSchedule_MonitoringScheduleConfigProperty `field:"required" json:"monitoringScheduleConfig" yaml:"monitoringScheduleConfig"`
