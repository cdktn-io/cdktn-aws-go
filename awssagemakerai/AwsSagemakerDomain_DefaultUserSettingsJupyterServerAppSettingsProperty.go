...
// Experimental.
type AwsSagemakerDomain_DefaultUserSettingsJupyterServerAppSettingsProperty struct {
	...
	// Experimental.
	DefaultResourceSpec *AwsSagemakerDomain_DefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecProperty `field:"optional" json:"defaultResourceSpec" yaml:"defaultResourceSpec"`
