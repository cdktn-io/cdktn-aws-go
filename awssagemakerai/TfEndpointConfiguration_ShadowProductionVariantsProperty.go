...
// Experimental.
type TfEndpointConfiguration_ShadowProductionVariantsProperty struct {
	...
	// Experimental.
	CapacityReservationConfig *TfEndpointConfiguration_ShadowProductionVariantsCapacityReservationConfigProperty `field:"optional" json:"capacityReservationConfig" yaml:"capacityReservationConfig"`
	...
	// Experimental.
	CoreDumpConfig *TfEndpointConfiguration_ShadowProductionVariantsCoreDumpConfigProperty `field:"optional" json:"coreDumpConfig" yaml:"coreDumpConfig"`
	...
	// Experimental.
	ManagedInstanceScaling *TfEndpointConfiguration_ShadowProductionVariantsManagedInstanceScalingProperty `field:"optional" json:"managedInstanceScaling" yaml:"managedInstanceScaling"`
	...
	// Experimental.
	ServerlessConfig *TfEndpointConfiguration_ShadowProductionVariantsServerlessConfigProperty `field:"optional" json:"serverlessConfig" yaml:"serverlessConfig"`
