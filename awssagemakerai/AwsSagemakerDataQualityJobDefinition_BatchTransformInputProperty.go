...
// Experimental.
type AwsSagemakerDataQualityJobDefinition_BatchTransformInputProperty struct {
	...
	// Experimental.
	DatasetFormat *AwsSagemakerDataQualityJobDefinition_DatasetFormatProperty `field:"required" json:"datasetFormat" yaml:"datasetFormat"`
