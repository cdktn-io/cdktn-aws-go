...
type TfProjectConfig struct {
	...
	// Experimental.
	ServiceCatalogProvisioningDetails *TfProject_ServiceCatalogProvisioningDetailsProperty `field:"required" json:"serviceCatalogProvisioningDetails" yaml:"serviceCatalogProvisioningDetails"`
