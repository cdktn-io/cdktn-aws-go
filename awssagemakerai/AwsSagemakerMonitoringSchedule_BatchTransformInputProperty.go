...
// Experimental.
type AwsSagemakerMonitoringSchedule_BatchTransformInputProperty struct {
	...
	// Experimental.
	DatasetFormat *AwsSagemakerMonitoringSchedule_DatasetFormatProperty `field:"required" json:"datasetFormat" yaml:"datasetFormat"`
