...
// Experimental.
type AwsSagemakerUserProfile_JupyterServerAppSettingsProperty struct {
	...
	// Experimental.
	DefaultResourceSpec *AwsSagemakerUserProfile_UserSettingsJupyterServerAppSettingsDefaultResourceSpecProperty `field:"optional" json:"defaultResourceSpec" yaml:"defaultResourceSpec"`
