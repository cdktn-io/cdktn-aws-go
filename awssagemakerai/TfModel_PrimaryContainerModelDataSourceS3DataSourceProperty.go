...
// Experimental.
type TfModel_PrimaryContainerModelDataSourceS3DataSourceProperty struct {
	...
	// Experimental.
	ModelAccessConfig *TfModel_PrimaryContainerModelDataSourceS3DataSourceModelAccessConfigProperty `field:"optional" json:"modelAccessConfig" yaml:"modelAccessConfig"`
}
