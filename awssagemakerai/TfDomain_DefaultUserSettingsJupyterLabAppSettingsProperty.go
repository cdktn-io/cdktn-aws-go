...
// Experimental.
type TfDomain_DefaultUserSettingsJupyterLabAppSettingsProperty struct {
	...
	// Experimental.
	AppLifecycleManagement *TfDomain_DefaultUserSettingsJupyterLabAppSettingsAppLifecycleManagementProperty `field:"optional" json:"appLifecycleManagement" yaml:"appLifecycleManagement"`
	...
	// Experimental.
	DefaultResourceSpec *TfDomain_DefaultUserSettingsJupyterLabAppSettingsDefaultResourceSpecProperty `field:"optional" json:"defaultResourceSpec" yaml:"defaultResourceSpec"`
	// emr_settings block.
	//
	...
	// Experimental.
	EmrSettings *TfDomain_DefaultUserSettingsJupyterLabAppSettingsEmrSettingsProperty `field:"optional" json:"emrSettings" yaml:"emrSettings"`
