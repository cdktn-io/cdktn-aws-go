...
// Experimental.
type AwsSagemakerModel_PrimaryContainerAdditionalModelDataSourceS3DataSourceProperty struct {
	...
	// Experimental.
	ModelAccessConfig *AwsSagemakerModel_PrimaryContainerAdditionalModelDataSourceS3DataSourceModelAccessConfigProperty `field:"optional" json:"modelAccessConfig" yaml:"modelAccessConfig"`
}
