...
// Experimental.
type AwsSagemakerModel_PrimaryContainerImageConfigProperty struct {
	...
	// Experimental.
	RepositoryAuthConfig *AwsSagemakerModel_PrimaryContainerImageConfigRepositoryAuthConfigProperty `field:"optional" json:"repositoryAuthConfig" yaml:"repositoryAuthConfig"`
}
