...
func (a *jsiiProxy_AwsScheduledQuery_RecentlyFailedRunsQueryInsightsResponseQuerySpatialCoveragePropertyOutputReference) validatePutMaxParameters(value interface{}) error {
	...
	case *[]*AwsScheduledQuery_RecentlyFailedRunsQueryInsightsResponseQuerySpatialCoverageMaxProperty:
		value := value.(*[]*AwsScheduledQuery_RecentlyFailedRunsQueryInsightsResponseQuerySpatialCoverageMaxProperty)
	...
	case []*AwsScheduledQuery_RecentlyFailedRunsQueryInsightsResponseQuerySpatialCoverageMaxProperty:
		value_ := value.([]*AwsScheduledQuery_RecentlyFailedRunsQueryInsightsResponseQuerySpatialCoverageMaxProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AwsScheduledQuery_RecentlyFailedRunsQueryInsightsResponseQuerySpatialCoverageMaxProperty; received %#v (a %T)", value, value)
		}
	}
