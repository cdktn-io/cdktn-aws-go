...
// Experimental.
type TfBudget_FilterExpressionOrProperty struct {
	// and block.
	//
	...
	// Experimental.
	CostCategories *TfBudget_FilterExpressionOrCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *TfBudget_FilterExpressionOrDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// not block.
	//
	...
	// Experimental.
	Not *TfBudget_FilterExpressionOrNotProperty `field:"optional" json:"not" yaml:"not"`
	// or block.
	//
	...
	// Experimental.
	Tags *TfBudget_FilterExpressionOrTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
