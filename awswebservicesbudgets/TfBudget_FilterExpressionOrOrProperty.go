...
// Experimental.
type TfBudget_FilterExpressionOrOrProperty struct {
	...
	// Experimental.
	CostCategories *TfBudget_FilterExpressionOrOrCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *TfBudget_FilterExpressionOrOrDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// tags block.
	//
	...
	// Experimental.
	Tags *TfBudget_FilterExpressionOrOrTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
