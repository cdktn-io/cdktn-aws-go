...
// Experimental.
type TfBudget_FilterExpressionAndOrProperty struct {
	...
	// Experimental.
	CostCategories *TfBudget_FilterExpressionAndOrCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *TfBudget_FilterExpressionAndOrDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// tags block.
	//
	...
	// Experimental.
	Tags *TfBudget_FilterExpressionAndOrTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
