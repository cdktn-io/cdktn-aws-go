...
// Experimental.
type AwsBudgetsBudget_FilterExpressionNotProperty struct {
	// and block.
	//
	...
	// Experimental.
	CostCategories *AwsBudgetsBudget_FilterExpressionNotCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *AwsBudgetsBudget_FilterExpressionNotDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// not block.
	//
	...
	// Experimental.
	Not *AwsBudgetsBudget_FilterExpressionNotNotProperty `field:"optional" json:"not" yaml:"not"`
	// or block.
	//
	...
	// Experimental.
	Tags *AwsBudgetsBudget_FilterExpressionNotTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
