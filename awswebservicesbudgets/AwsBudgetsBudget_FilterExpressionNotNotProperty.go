...
// Experimental.
type AwsBudgetsBudget_FilterExpressionNotNotProperty struct {
	...
	// Experimental.
	CostCategories *AwsBudgetsBudget_FilterExpressionNotNotCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *AwsBudgetsBudget_FilterExpressionNotNotDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// tags block.
	//
	...
	// Experimental.
	Tags *AwsBudgetsBudget_FilterExpressionNotNotTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
