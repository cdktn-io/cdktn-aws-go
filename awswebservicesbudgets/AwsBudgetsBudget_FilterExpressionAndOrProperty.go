...
// Experimental.
type AwsBudgetsBudget_FilterExpressionAndOrProperty struct {
	...
	// Experimental.
	CostCategories *AwsBudgetsBudget_FilterExpressionAndOrCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *AwsBudgetsBudget_FilterExpressionAndOrDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// tags block.
	//
	...
	// Experimental.
	Tags *AwsBudgetsBudget_FilterExpressionAndOrTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
