...
// Experimental.
type TfBudget_FilterExpressionProperty struct {
	// and block.
	//
	...
	// Experimental.
	CostCategories *TfBudget_FilterExpressionCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *TfBudget_FilterExpressionDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// not block.
	//
	...
	// Experimental.
	Not *TfBudget_FilterExpressionNotProperty `field:"optional" json:"not" yaml:"not"`
	// or block.
	//
	...
	// Experimental.
	Tags *TfBudget_FilterExpressionTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
