...
// Experimental.
type TfBudget_FilterExpressionOrAndProperty struct {
	...
	// Experimental.
	CostCategories *TfBudget_FilterExpressionOrAndCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *TfBudget_FilterExpressionOrAndDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// tags block.
	//
	...
	// Experimental.
	Tags *TfBudget_FilterExpressionOrAndTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
