...
// Experimental.
type AwsBudgetsBudget_FilterExpressionOrAndProperty struct {
	...
	// Experimental.
	CostCategories *AwsBudgetsBudget_FilterExpressionOrAndCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *AwsBudgetsBudget_FilterExpressionOrAndDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// tags block.
	//
	...
	// Experimental.
	Tags *AwsBudgetsBudget_FilterExpressionOrAndTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
