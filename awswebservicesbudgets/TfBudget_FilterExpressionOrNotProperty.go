...
// Experimental.
type TfBudget_FilterExpressionOrNotProperty struct {
	...
	// Experimental.
	CostCategories *TfBudget_FilterExpressionOrNotCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *TfBudget_FilterExpressionOrNotDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// tags block.
	//
	...
	// Experimental.
	Tags *TfBudget_FilterExpressionOrNotTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
