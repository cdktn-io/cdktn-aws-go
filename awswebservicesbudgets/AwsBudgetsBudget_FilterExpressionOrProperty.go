...
// Experimental.
type AwsBudgetsBudget_FilterExpressionOrProperty struct {
	// and block.
	//
	...
	// Experimental.
	CostCategories *AwsBudgetsBudget_FilterExpressionOrCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *AwsBudgetsBudget_FilterExpressionOrDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// not block.
	//
	...
	// Experimental.
	Not *AwsBudgetsBudget_FilterExpressionOrNotProperty `field:"optional" json:"not" yaml:"not"`
	// or block.
	//
	...
	// Experimental.
	Tags *AwsBudgetsBudget_FilterExpressionOrTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
