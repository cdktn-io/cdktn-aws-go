...
// Experimental.
type TfBudget_FilterExpressionAndAndProperty struct {
	...
	// Experimental.
	CostCategories *TfBudget_FilterExpressionAndAndCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *TfBudget_FilterExpressionAndAndDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// tags block.
	//
	...
	// Experimental.
	Tags *TfBudget_FilterExpressionAndAndTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
