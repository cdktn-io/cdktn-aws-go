...
// Experimental.
type TfBudget_AutoAdjustDataProperty struct {
	...
	// Experimental.
	HistoricalOptions *TfBudget_HistoricalOptionsProperty `field:"optional" json:"historicalOptions" yaml:"historicalOptions"`
}
