...
// Experimental.
type AwsBudgetsBudget_FilterExpressionAndProperty struct {
	// and block.
	//
	...
	// Experimental.
	CostCategories *AwsBudgetsBudget_FilterExpressionAndCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *AwsBudgetsBudget_FilterExpressionAndDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// not block.
	//
	...
	// Experimental.
	Not *AwsBudgetsBudget_FilterExpressionAndNotProperty `field:"optional" json:"not" yaml:"not"`
	// or block.
	//
	...
	// Experimental.
	Tags *AwsBudgetsBudget_FilterExpressionAndTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
