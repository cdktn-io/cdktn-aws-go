...
// Experimental.
type TfBudget_FilterExpressionAndProperty struct {
	// and block.
	//
	...
	// Experimental.
	CostCategories *TfBudget_FilterExpressionAndCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *TfBudget_FilterExpressionAndDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// not block.
	//
	...
	// Experimental.
	Not *TfBudget_FilterExpressionAndNotProperty `field:"optional" json:"not" yaml:"not"`
	// or block.
	//
	...
	// Experimental.
	Tags *TfBudget_FilterExpressionAndTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
