...
// Experimental.
type AwsBudgetsBudget_FilterExpressionAndAndProperty struct {
	...
	// Experimental.
	CostCategories *AwsBudgetsBudget_FilterExpressionAndAndCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *AwsBudgetsBudget_FilterExpressionAndAndDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// tags block.
	//
	...
	// Experimental.
	Tags *AwsBudgetsBudget_FilterExpressionAndAndTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
