...
// Experimental.
type TfBudget_FilterExpressionNotOrProperty struct {
	...
	// Experimental.
	CostCategories *TfBudget_FilterExpressionNotOrCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *TfBudget_FilterExpressionNotOrDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// tags block.
	//
	...
	// Experimental.
	Tags *TfBudget_FilterExpressionNotOrTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
