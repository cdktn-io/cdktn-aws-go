...
// Experimental.
type AwsAccessanalyzerAnalyzerConfig struct {
	// Experimental.
	...
	// Experimental.
	Configuration *AwsAccessanalyzerAnalyzer_ConfigurationProperty `field:"optional" json:"configuration" yaml:"configuration"`
