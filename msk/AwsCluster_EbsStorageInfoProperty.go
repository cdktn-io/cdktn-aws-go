...
// Experimental.
type AwsCluster_EbsStorageInfoProperty struct {
	...
	// Experimental.
	ProvisionedThroughput *AwsCluster_ProvisionedThroughputProperty `field:"optional" json:"provisionedThroughput" yaml:"provisionedThroughput"`
