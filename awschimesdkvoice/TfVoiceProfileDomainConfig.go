...
// Experimental.
type TfVoiceProfileDomainConfig struct {
	// Experimental.
	...
	// Experimental.
	ServerSideEncryptionConfiguration *TfVoiceProfileDomain_ServerSideEncryptionConfigurationProperty `field:"required" json:"serverSideEncryptionConfiguration" yaml:"serverSideEncryptionConfiguration"`
	...
	// Experimental.
	Timeouts *TfVoiceProfileDomain_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
