...
// Experimental.
type AwsChimesdkvoiceGlobalSettingsConfig struct {
	// Experimental.
	...
	// Experimental.
	VoiceConnector *AwsChimesdkvoiceGlobalSettings_VoiceConnectorProperty `field:"required" json:"voiceConnector" yaml:"voiceConnector"`
