...
// Experimental.
type AwsCluster_CoreInstanceFleetProperty struct {
	...
	// Experimental.
	LaunchSpecifications *AwsCluster_CoreInstanceFleetLaunchSpecificationsProperty `field:"optional" json:"launchSpecifications" yaml:"launchSpecifications"`
