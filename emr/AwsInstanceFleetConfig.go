...
// Experimental.
type AwsInstanceFleetConfig struct {
	// Experimental.
	...
	// Experimental.
	LaunchSpecifications *AwsInstanceFleet_LaunchSpecificationsProperty `field:"optional" json:"launchSpecifications" yaml:"launchSpecifications"`
