...
type AwsDomain interface {
	...
	// Experimental.
	Records() AwsDomain_RecordsPropertyList
	// Experimental.
	Region() *string
	// Experimental.
...
func (j *jsiiProxy_AwsDomain) DkimVerificationStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsDomain) IsDefault() cdktn.IResolvable {
...
func (j *jsiiProxy_AwsDomain) IsTestDomain() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"isTestDomain",
...
func (j *jsiiProxy_AwsDomain) OrganizationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organizationId",
...
func (j *jsiiProxy_AwsDomain) OrganizationIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organizationIdInput",
...
func (j *jsiiProxy_AwsDomain) OwnershipVerificationStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsDomain) Records() AwsDomain_RecordsPropertyList {
	var returns AwsDomain_RecordsPropertyList
	_jsii_.Get(
		j,
		"records",
		&returns,
...
func (j *jsiiProxy_AwsDomain)SetOrganizationId(val *string) {
