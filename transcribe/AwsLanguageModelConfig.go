...
// Experimental.
type AwsLanguageModelConfig struct {
	// Experimental.
	...
	// Experimental.
	InputDataConfig *AwsLanguageModel_InputDataConfigProperty `field:"required" json:"inputDataConfig" yaml:"inputDataConfig"`
	...
	// Experimental.
	Timeouts *AwsLanguageModel_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
