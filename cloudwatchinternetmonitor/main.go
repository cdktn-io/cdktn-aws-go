// cdk-terrain bindings for the CloudWatch Internet Monitor group of terraform-provider-aws 6.62.0
...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/aws-cloudwatch-internet-monitor.AwsMonitor.HealthEventsConfigProperty",
		reflect.TypeOf((*AwsMonitor_HealthEventsConfigProperty)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/aws-cloudwatch-internet-monitor.AwsMonitor.HealthEventsConfigPropertyOutputReference",
		reflect.TypeOf((*AwsMonitor_HealthEventsConfigPropertyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/aws-cloudwatch-internet-monitor.AwsMonitor.InternetMeasurementsLogDeliveryProperty",
		reflect.TypeOf((*AwsMonitor_InternetMeasurementsLogDeliveryProperty)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/aws-cloudwatch-internet-monitor.AwsMonitor.InternetMeasurementsLogDeliveryPropertyOutputReference",
		reflect.TypeOf((*AwsMonitor_InternetMeasurementsLogDeliveryPropertyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/aws-cloudwatch-internet-monitor.AwsMonitor.S3ConfigProperty",
		reflect.TypeOf((*AwsMonitor_S3ConfigProperty)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/aws-cloudwatch-internet-monitor.AwsMonitor.S3ConfigPropertyOutputReference",
		reflect.TypeOf((*AwsMonitor_S3ConfigPropertyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/aws-cloudwatch-internet-monitor.AwsMonitorConfig",
