...
type AwsMonitorConfig struct {
	...
	// Experimental.
	HealthEventsConfig *AwsMonitor_HealthEventsConfigProperty `field:"optional" json:"healthEventsConfig" yaml:"healthEventsConfig"`
	...
	// Experimental.
	InternetMeasurementsLogDelivery *AwsMonitor_InternetMeasurementsLogDeliveryProperty `field:"optional" json:"internetMeasurementsLogDelivery" yaml:"internetMeasurementsLogDelivery"`
