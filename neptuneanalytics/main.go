// cdk-terrain bindings for the Neptune Analytics group of terraform-provider-aws 6.62.0
...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/aws-neptune-analytics.AwsGraph.TimeoutsProperty",
		reflect.TypeOf((*AwsGraph_TimeoutsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/aws-neptune-analytics.AwsGraph.TimeoutsPropertyOutputReference",
		reflect.TypeOf((*AwsGraph_TimeoutsPropertyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/aws-neptune-analytics.AwsGraph.VectorSearchConfigurationProperty",
		reflect.TypeOf((*AwsGraph_VectorSearchConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/aws-neptune-analytics.AwsGraph.VectorSearchConfigurationPropertyList",
		reflect.TypeOf((*AwsGraph_VectorSearchConfigurationPropertyList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AwsGraph_VectorSearchConfigurationPropertyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/aws-neptune-analytics.AwsGraphConfig",
		reflect.TypeOf((*AwsGraphConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/aws-neptune-analytics.AwsPrivateGraphEndpoint",
		reflect.TypeOf((*AwsPrivateGraphEndpoint)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/aws-neptune-analytics.AwsPrivateGraphEndpoint.TimeoutsProperty",
		reflect.TypeOf((*AwsPrivateGraphEndpoint_TimeoutsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/aws-neptune-analytics.AwsPrivateGraphEndpoint.TimeoutsPropertyOutputReference",
		reflect.TypeOf((*AwsPrivateGraphEndpoint_TimeoutsPropertyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/aws-neptune-analytics.AwsPrivateGraphEndpointConfig",
		reflect.TypeOf((*AwsPrivateGraphEndpointConfig)(nil)).Elem(),
	)
}
