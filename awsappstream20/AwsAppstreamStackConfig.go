...
// Experimental.
type AwsAppstreamStackConfig struct {
	// Experimental.
	...
	// Experimental.
	ApplicationSettings *AwsAppstreamStack_ApplicationSettingsProperty `field:"optional" json:"applicationSettings" yaml:"applicationSettings"`
	...
	// Experimental.
	StreamingExperienceSettings *AwsAppstreamStack_StreamingExperienceSettingsProperty `field:"optional" json:"streamingExperienceSettings" yaml:"streamingExperienceSettings"`
