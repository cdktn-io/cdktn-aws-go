...
func (j *jsiiProxy_TfUser) validateSetAuthenticationTypeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_TfUser) validateSetSendEmailNotificationParameters(val interface{}) error {
	return nil
}
