...
type DataAwsAppstreamImage interface {
	...
	// Experimental.
	Applications() DataAwsAppstreamImage_ApplicationsPropertyList
	// Experimental.
	...
	// Experimental.
	ImagePermissions() DataAwsAppstreamImage_ImagePermissionsPropertyList
	// Experimental.
	...
	State() *string
	// Experimental.
	StateChangeReason() DataAwsAppstreamImage_StateChangeReasonPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsAppstreamImage) Applications() DataAwsAppstreamImage_ApplicationsPropertyList {
	var returns DataAwsAppstreamImage_ApplicationsPropertyList
	_jsii_.Get(
		j,
		"applications",
		&returns,
...
func (j *jsiiProxy_DataAwsAppstreamImage) ImagePermissions() DataAwsAppstreamImage_ImagePermissionsPropertyList {
	var returns DataAwsAppstreamImage_ImagePermissionsPropertyList
	_jsii_.Get(
		j,
		"imagePermissions",
		&returns,
...
func (j *jsiiProxy_DataAwsAppstreamImage) StateChangeReason() DataAwsAppstreamImage_StateChangeReasonPropertyList {
	var returns DataAwsAppstreamImage_StateChangeReasonPropertyList
	_jsii_.Get(
		j,
		"stateChangeReason",
		&returns,
