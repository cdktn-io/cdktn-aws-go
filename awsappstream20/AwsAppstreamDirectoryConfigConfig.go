...
// Experimental.
type AwsAppstreamDirectoryConfigConfig struct {
	// Experimental.
	...
	// Experimental.
	ServiceAccountCredentials *AwsAppstreamDirectoryConfig_ServiceAccountCredentialsProperty `field:"required" json:"serviceAccountCredentials" yaml:"serviceAccountCredentials"`
	...
	// Experimental.
	CertificateBasedAuthProperties *AwsAppstreamDirectoryConfig_CertificateBasedAuthPropertiesProperty `field:"optional" json:"certificateBasedAuthProperties" yaml:"certificateBasedAuthProperties"`
