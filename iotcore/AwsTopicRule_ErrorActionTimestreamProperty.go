...
// Experimental.
type AwsTopicRule_ErrorActionTimestreamProperty struct {
	...
	// Experimental.
	Timestamp *AwsTopicRule_ErrorActionTimestreamTimestampProperty `field:"optional" json:"timestamp" yaml:"timestamp"`
}
