...
// Experimental.
type AwsTopicRuleDestinationConfig struct {
	// Experimental.
	...
	// Experimental.
	VpcConfiguration *AwsTopicRuleDestination_VpcConfigurationProperty `field:"required" json:"vpcConfiguration" yaml:"vpcConfiguration"`
	...
	// Experimental.
	Timeouts *AwsTopicRuleDestination_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
