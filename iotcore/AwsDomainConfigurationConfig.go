...
// Experimental.
type AwsDomainConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	AuthorizerConfig *AwsDomainConfiguration_AuthorizerConfigProperty `field:"optional" json:"authorizerConfig" yaml:"authorizerConfig"`
	...
	// Experimental.
	TlsConfig *AwsDomainConfiguration_TlsConfigProperty `field:"optional" json:"tlsConfig" yaml:"tlsConfig"`
