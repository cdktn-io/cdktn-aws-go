...
// Experimental.
type AwsProvisioningTemplateConfig struct {
	// Experimental.
	...
	// Experimental.
	PreProvisioningHook *AwsProvisioningTemplate_PreProvisioningHookProperty `field:"optional" json:"preProvisioningHook" yaml:"preProvisioningHook"`
