...
// Experimental.
type AwsCaCertificateConfig struct {
	// Experimental.
	...
	// Experimental.
	RegistrationConfig *AwsCaCertificate_RegistrationConfigProperty `field:"optional" json:"registrationConfig" yaml:"registrationConfig"`
