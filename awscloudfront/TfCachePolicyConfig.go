...
// Experimental.
type TfCachePolicyConfig struct {
	// Experimental.
	...
	// Experimental.
	ParametersInCacheKeyAndForwardedToOrigin *TfCachePolicy_ParametersInCacheKeyAndForwardedToOriginProperty `field:"required" json:"parametersInCacheKeyAndForwardedToOrigin" yaml:"parametersInCacheKeyAndForwardedToOrigin"`
