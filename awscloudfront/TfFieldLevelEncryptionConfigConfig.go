...
// Experimental.
type TfFieldLevelEncryptionConfigConfig struct {
	// Experimental.
	...
	// Experimental.
	ContentTypeProfileConfig *TfFieldLevelEncryptionConfig_ContentTypeProfileConfigProperty `field:"required" json:"contentTypeProfileConfig" yaml:"contentTypeProfileConfig"`
	...
	// Experimental.
	QueryArgProfileConfig *TfFieldLevelEncryptionConfig_QueryArgProfileConfigProperty `field:"required" json:"queryArgProfileConfig" yaml:"queryArgProfileConfig"`
