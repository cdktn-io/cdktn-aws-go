...
// Experimental.
type TfOriginRequestPolicyConfig struct {
	// Experimental.
	...
	// Experimental.
	CookiesConfig *TfOriginRequestPolicy_CookiesConfigProperty `field:"required" json:"cookiesConfig" yaml:"cookiesConfig"`
	...
	// Experimental.
	HeadersConfig *TfOriginRequestPolicy_HeadersConfigProperty `field:"required" json:"headersConfig" yaml:"headersConfig"`
	...
	// Experimental.
	QueryStringsConfig *TfOriginRequestPolicy_QueryStringsConfigProperty `field:"required" json:"queryStringsConfig" yaml:"queryStringsConfig"`
