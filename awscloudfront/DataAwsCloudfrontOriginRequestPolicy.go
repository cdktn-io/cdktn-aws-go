...
type DataAwsCloudfrontOriginRequestPolicy interface {
	...
	// Experimental.
	CookiesConfig() DataAwsCloudfrontOriginRequestPolicy_CookiesConfigPropertyList
	// Experimental.
	Count() interface{}
	// Experimental.
	...
	// Experimental.
	HeadersConfig() DataAwsCloudfrontOriginRequestPolicy_HeadersConfigPropertyList
	// Experimental.
	Id() *string
	// Experimental.
	SetId(val *string)
	...
	// Experimental.
	QueryStringsConfig() DataAwsCloudfrontOriginRequestPolicy_QueryStringsConfigPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy) CookiesConfig() DataAwsCloudfrontOriginRequestPolicy_CookiesConfigPropertyList {
	var returns DataAwsCloudfrontOriginRequestPolicy_CookiesConfigPropertyList
	_jsii_.Get(
		j,
		"cookiesConfig",
		&returns,
...
func (j *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy) HeadersConfig() DataAwsCloudfrontOriginRequestPolicy_HeadersConfigPropertyList {
	var returns DataAwsCloudfrontOriginRequestPolicy_HeadersConfigPropertyList
	_jsii_.Get(
		j,
		"headersConfig",
		&returns,
...
func (j *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy) QueryStringsConfig() DataAwsCloudfrontOriginRequestPolicy_QueryStringsConfigPropertyList {
	var returns DataAwsCloudfrontOriginRequestPolicy_QueryStringsConfigPropertyList
	_jsii_.Get(
		j,
		"queryStringsConfig",
		&returns,
...
func NewDataAwsCloudfrontOriginRequestPolicy(scope constructs.Construct, id *string, config *DataAwsCloudfrontOriginRequestPolicyConfig) DataAwsCloudfrontOriginRequestPolicy {
	...
	_jsii_.Create(
		"@cdktn/aws-cloudfront.DataAwsCloudfrontOriginRequestPolicy",
