...
// Experimental.
type TfDistribution_DefaultCacheBehaviorProperty struct {
	...
	// Experimental.
	ForwardedValues *TfDistribution_DefaultCacheBehaviorForwardedValuesProperty `field:"optional" json:"forwardedValues" yaml:"forwardedValues"`
	...
	// Experimental.
	GrpcConfig *TfDistribution_DefaultCacheBehaviorGrpcConfigProperty `field:"optional" json:"grpcConfig" yaml:"grpcConfig"`
