...
type DataAwsCloudfrontCachePolicy interface {
	...
	// Experimental.
	ParametersInCacheKeyAndForwardedToOrigin() DataAwsCloudfrontCachePolicy_ParametersInCacheKeyAndForwardedToOriginPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsCloudfrontCachePolicy) ParametersInCacheKeyAndForwardedToOrigin() DataAwsCloudfrontCachePolicy_ParametersInCacheKeyAndForwardedToOriginPropertyList {
	var returns DataAwsCloudfrontCachePolicy_ParametersInCacheKeyAndForwardedToOriginPropertyList
	_jsii_.Get(
		j,
...
func NewDataAwsCloudfrontCachePolicy(scope constructs.Construct, id *string, config *DataAwsCloudfrontCachePolicyConfig) DataAwsCloudfrontCachePolicy {
	...
	_jsii_.Create(
		"@cdktn/aws-cloudfront.DataAwsCloudfrontCachePolicy",
