...
// Experimental.
type TfDistribution_DefaultCacheBehaviorForwardedValuesProperty struct {
	// cookies block.
	//
	...
	// Experimental.
	Cookies *TfDistribution_DefaultCacheBehaviorForwardedValuesCookiesProperty `field:"required" json:"cookies" yaml:"cookies"`
