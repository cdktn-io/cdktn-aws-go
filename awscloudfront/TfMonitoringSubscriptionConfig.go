...
// Experimental.
type TfMonitoringSubscriptionConfig struct {
	// Experimental.
	...
	// Experimental.
	MonitoringSubscription *TfMonitoringSubscription_MonitoringSubscriptionProperty `field:"required" json:"monitoringSubscription" yaml:"monitoringSubscription"`
