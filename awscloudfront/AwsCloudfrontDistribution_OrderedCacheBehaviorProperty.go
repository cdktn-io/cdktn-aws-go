...
// Experimental.
type AwsCloudfrontDistribution_OrderedCacheBehaviorProperty struct {
	...
	// Experimental.
	ForwardedValues *AwsCloudfrontDistribution_OrderedCacheBehaviorForwardedValuesProperty `field:"optional" json:"forwardedValues" yaml:"forwardedValues"`
	...
	// Experimental.
	GrpcConfig *AwsCloudfrontDistribution_OrderedCacheBehaviorGrpcConfigProperty `field:"optional" json:"grpcConfig" yaml:"grpcConfig"`
