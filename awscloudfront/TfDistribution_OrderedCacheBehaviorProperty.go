...
// Experimental.
type TfDistribution_OrderedCacheBehaviorProperty struct {
	...
	// Experimental.
	ForwardedValues *TfDistribution_OrderedCacheBehaviorForwardedValuesProperty `field:"optional" json:"forwardedValues" yaml:"forwardedValues"`
	...
	// Experimental.
	GrpcConfig *TfDistribution_OrderedCacheBehaviorGrpcConfigProperty `field:"optional" json:"grpcConfig" yaml:"grpcConfig"`
