...
// Experimental.
type AwsCloudfrontDistribution_DefaultCacheBehaviorForwardedValuesProperty struct {
	// cookies block.
	//
	...
	// Experimental.
	Cookies *AwsCloudfrontDistribution_DefaultCacheBehaviorForwardedValuesCookiesProperty `field:"required" json:"cookies" yaml:"cookies"`
