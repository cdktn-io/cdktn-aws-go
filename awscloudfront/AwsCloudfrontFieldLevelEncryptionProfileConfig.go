...
// Experimental.
type AwsCloudfrontFieldLevelEncryptionProfileConfig struct {
	// Experimental.
	...
	// Experimental.
	EncryptionEntities *AwsCloudfrontFieldLevelEncryptionProfile_EncryptionEntitiesProperty `field:"required" json:"encryptionEntities" yaml:"encryptionEntities"`
