...
// Experimental.
type AwsCloudfrontMonitoringSubscriptionConfig struct {
	// Experimental.
	...
	// Experimental.
	MonitoringSubscription *AwsCloudfrontMonitoringSubscription_MonitoringSubscriptionProperty `field:"required" json:"monitoringSubscription" yaml:"monitoringSubscription"`
