...
// Experimental.
type TfDistribution_CustomOriginConfigProperty struct {
	...
	// Experimental.
	OriginMtlsConfig *TfDistribution_OriginMtlsConfigProperty `field:"optional" json:"originMtlsConfig" yaml:"originMtlsConfig"`
