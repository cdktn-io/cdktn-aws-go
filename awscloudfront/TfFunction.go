...
func (j *jsiiProxy_TfFunction) Comment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"comment",
...
func (j *jsiiProxy_TfFunction) CommentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"commentInput",
...
func (j *jsiiProxy_TfFunction) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_TfFunction) KeyValueStoreAssociations() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TfFunction) KeyValueStoreAssociationsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TfFunction) LiveStageEtag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"liveStageEtag",
...
func (j *jsiiProxy_TfFunction) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func NewTfFunction(scope constructs.Construct, id *string, config *TfFunctionConfig) TfFunction {
	...
	_jsii_.Create(
		"@cdktn/aws-cloudfront.TfFunction",
...
func (j *jsiiProxy_TfFunction)SetComment(val *string) {
...
func (j *jsiiProxy_TfFunction)SetKeyValueStoreAssociations(val *[]*string) {
...
func (t *jsiiProxy_TfFunction) ResetComment() {
	_jsii_.InvokeVoid(
		t,
		"resetComment",
		nil, // no parameters
...
func (t *jsiiProxy_TfFunction) ResetKeyValueStoreAssociations() {
	_jsii_.InvokeVoid(
		t,
		"resetKeyValueStoreAssociations",
		nil, // no parameters
