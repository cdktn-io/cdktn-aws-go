...
// Experimental.
type AwsDeploymentGroup_LoadBalancerInfoProperty struct {
	// elb_info block.
	//
	...
	// Experimental.
	TargetGroupPairInfo *AwsDeploymentGroup_TargetGroupPairInfoProperty `field:"optional" json:"targetGroupPairInfo" yaml:"targetGroupPairInfo"`
}
