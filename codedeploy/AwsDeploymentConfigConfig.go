...
// Experimental.
type AwsDeploymentConfigConfig struct {
	// Experimental.
	...
	// Experimental.
	MinimumHealthyHosts *AwsDeploymentConfig_MinimumHealthyHostsProperty `field:"optional" json:"minimumHealthyHosts" yaml:"minimumHealthyHosts"`
	...
	// Experimental.
	TrafficRoutingConfig *AwsDeploymentConfig_TrafficRoutingConfigProperty `field:"optional" json:"trafficRoutingConfig" yaml:"trafficRoutingConfig"`
	// zonal_config block.
	//
	...
	// Experimental.
	ZonalConfig *AwsDeploymentConfig_ZonalConfigProperty `field:"optional" json:"zonalConfig" yaml:"zonalConfig"`
}
