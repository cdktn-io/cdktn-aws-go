...
func (j *jsiiProxy_AwsApp) ComputePlatform() *string {
	var returns *string
	_jsii_.Get(
		j,
		"computePlatform",
...
func (j *jsiiProxy_AwsApp) ComputePlatformInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsApp) GithubAccountName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"githubAccountName",
...
func (j *jsiiProxy_AwsApp) LinkedToGithub() cdktn.IResolvable {
...
func (j *jsiiProxy_AwsApp)SetComputePlatform(val *string) {
...
func (a *jsiiProxy_AwsApp) ResetComputePlatform() {
	_jsii_.InvokeVoid(
		a,
		"resetComputePlatform",
		nil, // no parameters
