...
func (j *jsiiProxy_AwsGlobalReplicationGroup_TimeoutsPropertyOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *AwsGlobalReplicationGroup_TimeoutsProperty:
		val := val.(*AwsGlobalReplicationGroup_TimeoutsProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case AwsGlobalReplicationGroup_TimeoutsProperty:
		val_ := val.(AwsGlobalReplicationGroup_TimeoutsProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *AwsGlobalReplicationGroup_TimeoutsProperty; received %#v (a %T)", val, val)
		}
	}
