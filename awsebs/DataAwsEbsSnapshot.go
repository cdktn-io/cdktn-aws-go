...
type DataAwsEbsSnapshot interface {
	...
	// Experimental.
	Filter() DataAwsEbsSnapshot_FilterPropertyList
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsEbsSnapshot_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsEbsSnapshot_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsEbsSnapshot) Filter() DataAwsEbsSnapshot_FilterPropertyList {
	var returns DataAwsEbsSnapshot_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsEbsSnapshot) Timeouts() DataAwsEbsSnapshot_TimeoutsPropertyOutputReference {
	var returns DataAwsEbsSnapshot_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewDataAwsEbsSnapshot(scope constructs.Construct, id *string, config *DataAwsEbsSnapshotConfig) DataAwsEbsSnapshot {
	...
	_jsii_.Create(
		"@cdktn/aws-ebs.DataAwsEbsSnapshot",
...
func (d *jsiiProxy_DataAwsEbsSnapshot) PutTimeouts(value *DataAwsEbsSnapshot_TimeoutsProperty) {
