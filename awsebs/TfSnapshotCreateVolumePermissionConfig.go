...
// Experimental.
type TfSnapshotCreateVolumePermissionConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *TfSnapshotCreateVolumePermission_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
