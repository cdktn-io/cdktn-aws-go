...
// Experimental.
type AwsOutboundConnection_ConnectionPropertiesProperty struct {
	...
	// Experimental.
	CrossClusterSearch *AwsOutboundConnection_CrossClusterSearchProperty `field:"optional" json:"crossClusterSearch" yaml:"crossClusterSearch"`
}
