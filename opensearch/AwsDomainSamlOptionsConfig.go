...
// Experimental.
type AwsDomainSamlOptionsConfig struct {
	// Experimental.
	...
	// Experimental.
	SamlOptions *AwsDomainSamlOptions_SamlOptionsProperty `field:"optional" json:"samlOptions" yaml:"samlOptions"`
	// timeouts block.
	//
	...
	// Experimental.
	Timeouts *AwsDomainSamlOptions_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
