...
func (a *jsiiProxy_AwsKey) validatePutKeyAttributesParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*AwsKey_KeyAttributesProperty:
		value := value.(*[]*AwsKey_KeyAttributesProperty)
	...
	case []*AwsKey_KeyAttributesProperty:
		value_ := value.([]*AwsKey_KeyAttributesProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AwsKey_KeyAttributesProperty; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_AwsKey) validateSetEnabledParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_AwsKey) validateSetExportableParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_AwsKey) validateSetKeyCheckValueAlgorithmParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
