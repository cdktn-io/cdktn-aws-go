...
type AwsMqBrokerConfig struct {
	...
	// Experimental.
	Configuration *AwsMqBroker_ConfigurationProperty `field:"optional" json:"configuration" yaml:"configuration"`
	...
	// Experimental.
	EncryptionOptions *AwsMqBroker_EncryptionOptionsProperty `field:"optional" json:"encryptionOptions" yaml:"encryptionOptions"`
	...
	// Experimental.
	LdapServerMetadata *AwsMqBroker_LdapServerMetadataProperty `field:"optional" json:"ldapServerMetadata" yaml:"ldapServerMetadata"`
	// logs block.
	//
	...
	// Experimental.
	Logs *AwsMqBroker_LogsProperty `field:"optional" json:"logs" yaml:"logs"`
	...
	// Experimental.
	MaintenanceWindowStartTime *AwsMqBroker_MaintenanceWindowStartTimeProperty `field:"optional" json:"maintenanceWindowStartTime" yaml:"maintenanceWindowStartTime"`
	...
	// Experimental.
	Timeouts *AwsMqBroker_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
	// user block.
	//
