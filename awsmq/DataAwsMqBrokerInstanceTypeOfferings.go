...
type DataAwsMqBrokerInstanceTypeOfferings interface {
	...
	// Experimental.
	BrokerInstanceOptions() DataAwsMqBrokerInstanceTypeOfferings_BrokerInstanceOptionsPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsMqBrokerInstanceTypeOfferings) BrokerInstanceOptions() DataAwsMqBrokerInstanceTypeOfferings_BrokerInstanceOptionsPropertyList {
	var returns DataAwsMqBrokerInstanceTypeOfferings_BrokerInstanceOptionsPropertyList
	_jsii_.Get(
		j,
...
func NewDataAwsMqBrokerInstanceTypeOfferings(scope constructs.Construct, id *string, config *DataAwsMqBrokerInstanceTypeOfferingsConfig) DataAwsMqBrokerInstanceTypeOfferings {
	...
	_jsii_.Create(
		"@cdktn/aws-mq.DataAwsMqBrokerInstanceTypeOfferings",
