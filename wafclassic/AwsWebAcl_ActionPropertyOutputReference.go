...
func (j *jsiiProxy_AwsWebAcl_ActionPropertyOutputReference) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_AwsWebAcl_ActionPropertyOutputReference) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func (j *jsiiProxy_AwsWebAcl_ActionPropertyOutputReference)SetType(val *string) {
