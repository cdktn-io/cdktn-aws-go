...
type AwsGroup interface {
	...
	// Experimental.
	ExternalIds() AwsGroup_ExternalIdsPropertyList
	// Experimental.
...
func (j *jsiiProxy_AwsGroup) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_AwsGroup) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_AwsGroup) ExternalIds() AwsGroup_ExternalIdsPropertyList {
	var returns AwsGroup_ExternalIdsPropertyList
	_jsii_.Get(
		j,
		"externalIds",
		&returns,
...
func (j *jsiiProxy_AwsGroup) IdentityStoreId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"identityStoreId",
...
func (j *jsiiProxy_AwsGroup) IdentityStoreIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewAwsGroup(scope constructs.Construct, id *string, config *AwsGroupConfig) AwsGroup {
	...
	_jsii_.Create(
		"@cdktn/aws-sso-identity-store.AwsGroup",
...
func (j *jsiiProxy_AwsGroup)SetDisplayName(val *string) {
...
func (j *jsiiProxy_AwsGroup)SetIdentityStoreId(val *string) {
