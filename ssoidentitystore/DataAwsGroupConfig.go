...
// Experimental.
type DataAwsGroupConfig struct {
	// Experimental.
	...
	// Experimental.
	AlternateIdentifier *DataAwsGroup_AlternateIdentifierProperty `field:"optional" json:"alternateIdentifier" yaml:"alternateIdentifier"`
