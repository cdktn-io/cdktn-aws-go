...
// Experimental.
type AwsBudget_FilterExpressionProperty struct {
	// and block.
	//
	...
	// Experimental.
	CostCategories *AwsBudget_FilterExpressionCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *AwsBudget_FilterExpressionDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// not block.
	//
	...
	// Experimental.
	Not *AwsBudget_FilterExpressionNotProperty `field:"optional" json:"not" yaml:"not"`
	// or block.
	//
	...
	// Experimental.
	Tags *AwsBudget_FilterExpressionTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
