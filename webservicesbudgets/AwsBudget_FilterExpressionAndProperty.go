...
// Experimental.
type AwsBudget_FilterExpressionAndProperty struct {
	// and block.
	//
	...
	// Experimental.
	CostCategories *AwsBudget_FilterExpressionAndCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *AwsBudget_FilterExpressionAndDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// not block.
	//
	...
	// Experimental.
	Not *AwsBudget_FilterExpressionAndNotProperty `field:"optional" json:"not" yaml:"not"`
	// or block.
	//
	...
	// Experimental.
	Tags *AwsBudget_FilterExpressionAndTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
