...
// Experimental.
type AwsBudget_FilterExpressionOrNotProperty struct {
	...
	// Experimental.
	CostCategories *AwsBudget_FilterExpressionOrNotCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *AwsBudget_FilterExpressionOrNotDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// tags block.
	//
	...
	// Experimental.
	Tags *AwsBudget_FilterExpressionOrNotTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
