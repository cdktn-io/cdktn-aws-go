...
// Experimental.
type AwsBudget_FilterExpressionNotAndProperty struct {
	...
	// Experimental.
	CostCategories *AwsBudget_FilterExpressionNotAndCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *AwsBudget_FilterExpressionNotAndDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// tags block.
	//
	...
	// Experimental.
	Tags *AwsBudget_FilterExpressionNotAndTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
