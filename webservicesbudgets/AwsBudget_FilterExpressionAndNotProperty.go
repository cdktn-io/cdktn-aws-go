...
// Experimental.
type AwsBudget_FilterExpressionAndNotProperty struct {
	...
	// Experimental.
	CostCategories *AwsBudget_FilterExpressionAndNotCostCategoriesProperty `field:"optional" json:"costCategories" yaml:"costCategories"`
	// dimensions block.
	//
	...
	// Experimental.
	Dimensions *AwsBudget_FilterExpressionAndNotDimensionsProperty `field:"optional" json:"dimensions" yaml:"dimensions"`
	// tags block.
	//
	...
	// Experimental.
	Tags *AwsBudget_FilterExpressionAndNotTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
