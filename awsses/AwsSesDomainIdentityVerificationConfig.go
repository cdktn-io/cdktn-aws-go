...
// Experimental.
type AwsSesDomainIdentityVerificationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsSesDomainIdentityVerification_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
