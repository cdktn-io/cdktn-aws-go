...
// Experimental.
type AwsSesEventDestinationConfig struct {
	// Experimental.
	...
	// Experimental.
	KinesisDestination *AwsSesEventDestination_KinesisDestinationProperty `field:"optional" json:"kinesisDestination" yaml:"kinesisDestination"`
	...
	// Experimental.
	SnsDestination *AwsSesEventDestination_SnsDestinationProperty `field:"optional" json:"snsDestination" yaml:"snsDestination"`
}
