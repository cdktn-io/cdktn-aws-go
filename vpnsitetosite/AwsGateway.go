...
func (j *jsiiProxy_AwsGateway) AmazonSideAsn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"amazonSideAsn",
...
func (j *jsiiProxy_AwsGateway) AmazonSideAsnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"amazonSideAsnInput",
...
func (j *jsiiProxy_AwsGateway) AvailabilityZone() *string {
	var returns *string
	_jsii_.Get(
		j,
		"availabilityZone",
...
func (j *jsiiProxy_AwsGateway) AvailabilityZoneInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsGateway) VpcId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcId",
...
func (j *jsiiProxy_AwsGateway) VpcIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcIdInput",
...
func NewAwsGateway(scope constructs.Construct, id *string, config *AwsGatewayConfig) AwsGateway {
	...
	_jsii_.Create(
		"@cdktn/aws-vpn-site-to-site.AwsGateway",
...
func (j *jsiiProxy_AwsGateway)SetAmazonSideAsn(val *string) {
...
func (j *jsiiProxy_AwsGateway)SetAvailabilityZone(val *string) {
...
func (j *jsiiProxy_AwsGateway)SetVpcId(val *string) {
...
func (a *jsiiProxy_AwsGateway) ResetAmazonSideAsn() {
	_jsii_.InvokeVoid(
		a,
		"resetAmazonSideAsn",
		nil, // no parameters
...
func (a *jsiiProxy_AwsGateway) ResetAvailabilityZone() {
	_jsii_.InvokeVoid(
		a,
		"resetAvailabilityZone",
		nil, // no parameters
...
func (a *jsiiProxy_AwsGateway) ResetVpcId() {
	_jsii_.InvokeVoid(
		a,
		"resetVpcId",
		nil, // no parameters
