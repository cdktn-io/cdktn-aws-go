...
// Experimental.
type AwsConnection_Tunnel1LogOptionsProperty struct {
	...
	// Experimental.
	CloudwatchLogOptions *AwsConnection_Tunnel1LogOptionsCloudwatchLogOptionsProperty `field:"optional" json:"cloudwatchLogOptions" yaml:"cloudwatchLogOptions"`
}
