...
// Experimental.
type AwsSigningProfileConfig struct {
	// Experimental.
	...
	// Experimental.
	SignatureValidityPeriod *AwsSigningProfile_SignatureValidityPeriodProperty `field:"optional" json:"signatureValidityPeriod" yaml:"signatureValidityPeriod"`
	...
	// Experimental.
	SigningMaterial *AwsSigningProfile_SigningMaterialProperty `field:"optional" json:"signingMaterial" yaml:"signingMaterial"`
