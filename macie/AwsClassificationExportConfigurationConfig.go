...
// Experimental.
type AwsClassificationExportConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	S3Destination *AwsClassificationExportConfiguration_S3DestinationProperty `field:"required" json:"s3Destination" yaml:"s3Destination"`
