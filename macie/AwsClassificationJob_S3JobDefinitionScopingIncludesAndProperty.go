...
// Experimental.
type AwsClassificationJob_S3JobDefinitionScopingIncludesAndProperty struct {
	...
	// Experimental.
	SimpleScopeTerm *AwsClassificationJob_S3JobDefinitionScopingIncludesAndSimpleScopeTermProperty `field:"optional" json:"simpleScopeTerm" yaml:"simpleScopeTerm"`
	...
	// Experimental.
	TagScopeTerm *AwsClassificationJob_S3JobDefinitionScopingIncludesAndTagScopeTermProperty `field:"optional" json:"tagScopeTerm" yaml:"tagScopeTerm"`
}
