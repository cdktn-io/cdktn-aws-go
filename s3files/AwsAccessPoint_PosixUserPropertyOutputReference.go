...
func (j *jsiiProxy_AwsAccessPoint_PosixUserPropertyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
// Experimental.
func NewAwsAccessPoint_PosixUserPropertyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) AwsAccessPoint_PosixUserPropertyOutputReference {
	_init_.Initialize()

	if err := validateNewAwsAccessPoint_PosixUserPropertyOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
// Experimental.
func NewAwsAccessPoint_PosixUserPropertyOutputReference_Override(a AwsAccessPoint_PosixUserPropertyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AwsAccessPoint_PosixUserPropertyOutputReference)SetInternalValue(val interface{}) {
