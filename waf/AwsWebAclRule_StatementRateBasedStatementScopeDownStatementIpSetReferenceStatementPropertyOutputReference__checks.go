...
func (a *jsiiProxy_AwsWebAclRule_StatementRateBasedStatementScopeDownStatementIpSetReferenceStatementPropertyOutputReference) validatePutIpSetForwardedIpConfigParameters(value interface{}) error {
	...
	case *[]*AwsWebAclRule_StatementRateBasedStatementScopeDownStatementIpSetReferenceStatementIpSetForwardedIpConfigProperty:
		value := value.(*[]*AwsWebAclRule_StatementRateBasedStatementScopeDownStatementIpSetReferenceStatementIpSetForwardedIpConfigProperty)
	...
	case []*AwsWebAclRule_StatementRateBasedStatementScopeDownStatementIpSetReferenceStatementIpSetForwardedIpConfigProperty:
		value_ := value.([]*AwsWebAclRule_StatementRateBasedStatementScopeDownStatementIpSetReferenceStatementIpSetForwardedIpConfigProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AwsWebAclRule_StatementRateBasedStatementScopeDownStatementIpSetReferenceStatementIpSetForwardedIpConfigProperty; received %#v (a %T)", value, value)
		}
	}
