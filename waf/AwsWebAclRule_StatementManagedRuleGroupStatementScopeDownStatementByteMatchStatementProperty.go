...
// Experimental.
type AwsWebAclRule_StatementManagedRuleGroupStatementScopeDownStatementByteMatchStatementProperty struct {
	// Area within the portion of a web request that you want AWS WAF to search for SearchString.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/wafv2_web_acl_rule#positional_constraint AwsWebAclRule#positional_constraint}
	// Experimental.
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/wafv2_web_acl_rule#search_string AwsWebAclRule#search_string}
	// Experimental.
