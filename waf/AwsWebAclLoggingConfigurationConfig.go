...
// Experimental.
type AwsWebAclLoggingConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	LoggingFilter *AwsWebAclLoggingConfiguration_LoggingFilterProperty `field:"optional" json:"loggingFilter" yaml:"loggingFilter"`
