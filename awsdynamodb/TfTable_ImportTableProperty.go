...
// Experimental.
type TfTable_ImportTableProperty struct {
	...
	// Experimental.
	S3BucketSource *TfTable_S3BucketSourceProperty `field:"required" json:"s3BucketSource" yaml:"s3BucketSource"`
	...
	// Experimental.
	InputFormatOptions *TfTable_InputFormatOptionsProperty `field:"optional" json:"inputFormatOptions" yaml:"inputFormatOptions"`
}
