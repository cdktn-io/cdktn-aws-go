...
type DataTfTableConfig struct {
	...
	// Experimental.
	ServerSideEncryption *DataTfTable_ServerSideEncryptionProperty `field:"optional" json:"serverSideEncryption" yaml:"serverSideEncryption"`
