...
// Experimental.
type TfGlobalSecondaryIndexConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *TfGlobalSecondaryIndex_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
	...
	// Experimental.
	WarmThroughput *TfGlobalSecondaryIndex_WarmThroughputProperty `field:"optional" json:"warmThroughput" yaml:"warmThroughput"`
}
