...
// Experimental.
type AwsLambdaProvisionedConcurrencyConfigConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsLambdaProvisionedConcurrencyConfig_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
