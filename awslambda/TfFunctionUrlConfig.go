...
// Experimental.
type TfFunctionUrlConfig struct {
	// Experimental.
	...
	// Experimental.
	Cors *TfFunctionUrl_CorsProperty `field:"optional" json:"cors" yaml:"cors"`
	...
	// Experimental.
	Timeouts *TfFunctionUrl_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
