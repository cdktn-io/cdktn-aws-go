...
// Experimental.
type AwsLambdaFunctionEventInvokeConfigConfig struct {
	// Experimental.
	...
	// Experimental.
	DestinationConfig *AwsLambdaFunctionEventInvokeConfig_DestinationConfigProperty `field:"optional" json:"destinationConfig" yaml:"destinationConfig"`
