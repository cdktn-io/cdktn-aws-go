...
type DataAwsLambdaFunctionUrl interface {
	...
	// Experimental.
	Cors() DataAwsLambdaFunctionUrl_CorsPropertyList
	// Experimental.
	Count() interface{}
	// Experimental.
...
func (j *jsiiProxy_DataAwsLambdaFunctionUrl) Cors() DataAwsLambdaFunctionUrl_CorsPropertyList {
	var returns DataAwsLambdaFunctionUrl_CorsPropertyList
	_jsii_.Get(
		j,
		"cors",
		&returns,
