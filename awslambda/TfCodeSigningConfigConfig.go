...
// Experimental.
type TfCodeSigningConfigConfig struct {
	// Experimental.
	...
	// Experimental.
	AllowedPublishers *TfCodeSigningConfig_AllowedPublishersProperty `field:"required" json:"allowedPublishers" yaml:"allowedPublishers"`
	...
	// Experimental.
	Policies *TfCodeSigningConfig_PoliciesProperty `field:"optional" json:"policies" yaml:"policies"`
