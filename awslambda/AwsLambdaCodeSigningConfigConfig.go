...
// Experimental.
type AwsLambdaCodeSigningConfigConfig struct {
	// Experimental.
	...
	// Experimental.
	AllowedPublishers *AwsLambdaCodeSigningConfig_AllowedPublishersProperty `field:"required" json:"allowedPublishers" yaml:"allowedPublishers"`
	...
	// Experimental.
	Policies *AwsLambdaCodeSigningConfig_PoliciesProperty `field:"optional" json:"policies" yaml:"policies"`
