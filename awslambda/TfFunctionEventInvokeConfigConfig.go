...
// Experimental.
type TfFunctionEventInvokeConfigConfig struct {
	// Experimental.
	...
	// Experimental.
	DestinationConfig *TfFunctionEventInvokeConfig_DestinationConfigProperty `field:"optional" json:"destinationConfig" yaml:"destinationConfig"`
