...
type DataAwsLambdaCodeSigningConfig interface {
	...
	// Experimental.
	AllowedPublishers() DataAwsLambdaCodeSigningConfig_AllowedPublishersPropertyList
	// Experimental.
	Arn() *string
	// Experimental.
	SetArn(val *string)
	...
	// Experimental.
	Policies() DataAwsLambdaCodeSigningConfig_PoliciesPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsLambdaCodeSigningConfig) AllowedPublishers() DataAwsLambdaCodeSigningConfig_AllowedPublishersPropertyList {
	var returns DataAwsLambdaCodeSigningConfig_AllowedPublishersPropertyList
	_jsii_.Get(
		j,
		"allowedPublishers",
		&returns,
...
func (j *jsiiProxy_DataAwsLambdaCodeSigningConfig) Policies() DataAwsLambdaCodeSigningConfig_PoliciesPropertyList {
	var returns DataAwsLambdaCodeSigningConfig_PoliciesPropertyList
	_jsii_.Get(
		j,
		"policies",
		&returns,
