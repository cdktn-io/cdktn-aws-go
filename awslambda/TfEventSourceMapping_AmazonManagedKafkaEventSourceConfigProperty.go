...
// Experimental.
type TfEventSourceMapping_AmazonManagedKafkaEventSourceConfigProperty struct {
	...
	// Experimental.
	SchemaRegistryConfig *TfEventSourceMapping_AmazonManagedKafkaEventSourceConfigSchemaRegistryConfigProperty `field:"optional" json:"schemaRegistryConfig" yaml:"schemaRegistryConfig"`
}
