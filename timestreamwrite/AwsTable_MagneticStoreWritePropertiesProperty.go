...
// Experimental.
type AwsTable_MagneticStoreWritePropertiesProperty struct {
	...
	// Experimental.
	MagneticStoreRejectedDataLocation *AwsTable_MagneticStoreRejectedDataLocationProperty `field:"optional" json:"magneticStoreRejectedDataLocation" yaml:"magneticStoreRejectedDataLocation"`
}
