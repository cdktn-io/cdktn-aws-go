...
// Experimental.
type AwsNeptunegraphPrivateGraphEndpointConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsNeptunegraphPrivateGraphEndpoint_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
