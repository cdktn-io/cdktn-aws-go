...
// Experimental.
type AwsWafv2WebAclRuleGroupAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsWafv2WebAclRuleGroupAssociation_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
