...
// Experimental.
type TfWebAclLoggingConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	LoggingFilter *TfWebAclLoggingConfiguration_LoggingFilterProperty `field:"optional" json:"loggingFilter" yaml:"loggingFilter"`
