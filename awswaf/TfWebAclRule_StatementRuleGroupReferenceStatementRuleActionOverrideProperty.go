...
// Experimental.
type TfWebAclRule_StatementRuleGroupReferenceStatementRuleActionOverrideProperty struct {
	...
	// action_to_use block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/wafv2_web_acl_rule#action_to_use TfWebAclRule#action_to_use}
	// Experimental.
