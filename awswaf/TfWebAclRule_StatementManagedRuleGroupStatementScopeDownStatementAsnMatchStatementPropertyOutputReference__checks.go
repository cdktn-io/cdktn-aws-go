...
func (t *jsiiProxy_TfWebAclRule_StatementManagedRuleGroupStatementScopeDownStatementAsnMatchStatementPropertyOutputReference) validatePutForwardedIpConfigParameters(value interface{}) error {
	...
	case *[]*TfWebAclRule_StatementManagedRuleGroupStatementScopeDownStatementAsnMatchStatementForwardedIpConfigProperty:
		value := value.(*[]*TfWebAclRule_StatementManagedRuleGroupStatementScopeDownStatementAsnMatchStatementForwardedIpConfigProperty)
	...
	case []*TfWebAclRule_StatementManagedRuleGroupStatementScopeDownStatementAsnMatchStatementForwardedIpConfigProperty:
		value_ := value.([]*TfWebAclRule_StatementManagedRuleGroupStatementScopeDownStatementAsnMatchStatementForwardedIpConfigProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*TfWebAclRule_StatementManagedRuleGroupStatementScopeDownStatementAsnMatchStatementForwardedIpConfigProperty; received %#v (a %T)", value, value)
		}
	}
