...
type DataAwsWafv2ManagedRuleGroup interface {
	...
	// Experimental.
	AvailableLabels() DataAwsWafv2ManagedRuleGroup_AvailableLabelsPropertyList
	// Experimental.
	Capacity() *float64
	// Experimental.
	...
	// Experimental.
	ConsumedLabels() DataAwsWafv2ManagedRuleGroup_ConsumedLabelsPropertyList
	// Experimental.
	Count() interface{}
	// Experimental.
	...
	RegionInput() *string
	// Experimental.
	Rules() DataAwsWafv2ManagedRuleGroup_RulesPropertyList
	// Experimental.
	Scope() *string
	// Experimental.
	SetScope(val *string)
...
func (j *jsiiProxy_DataAwsWafv2ManagedRuleGroup) AvailableLabels() DataAwsWafv2ManagedRuleGroup_AvailableLabelsPropertyList {
	var returns DataAwsWafv2ManagedRuleGroup_AvailableLabelsPropertyList
	_jsii_.Get(
		j,
		"availableLabels",
		&returns,
...
func (j *jsiiProxy_DataAwsWafv2ManagedRuleGroup) ConsumedLabels() DataAwsWafv2ManagedRuleGroup_ConsumedLabelsPropertyList {
	var returns DataAwsWafv2ManagedRuleGroup_ConsumedLabelsPropertyList
	_jsii_.Get(
		j,
		"consumedLabels",
		&returns,
...
func (j *jsiiProxy_DataAwsWafv2ManagedRuleGroup) Rules() DataAwsWafv2ManagedRuleGroup_RulesPropertyList {
	var returns DataAwsWafv2ManagedRuleGroup_RulesPropertyList
	_jsii_.Get(
		j,
		"rules",
		&returns,
...
func NewDataAwsWafv2ManagedRuleGroup(scope constructs.Construct, id *string, config *DataAwsWafv2ManagedRuleGroupConfig) DataAwsWafv2ManagedRuleGroup {
	...
	_jsii_.Create(
		"@cdktn/aws-waf.DataAwsWafv2ManagedRuleGroup",
