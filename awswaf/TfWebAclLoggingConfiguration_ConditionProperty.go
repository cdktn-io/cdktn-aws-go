...
// Experimental.
type TfWebAclLoggingConfiguration_ConditionProperty struct {
	...
	// Experimental.
	ActionCondition *TfWebAclLoggingConfiguration_ActionConditionProperty `field:"optional" json:"actionCondition" yaml:"actionCondition"`
	...
	// Experimental.
	LabelNameCondition *TfWebAclLoggingConfiguration_LabelNameConditionProperty `field:"optional" json:"labelNameCondition" yaml:"labelNameCondition"`
}
