...
// Experimental.
type TfDomainAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	CertificateSettings *TfDomainAssociation_CertificateSettingsProperty `field:"optional" json:"certificateSettings" yaml:"certificateSettings"`
