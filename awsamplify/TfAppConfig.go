...
type TfAppConfig struct {
	...
	// Experimental.
	AutoBranchCreationConfig *TfApp_AutoBranchCreationConfigProperty `field:"optional" json:"autoBranchCreationConfig" yaml:"autoBranchCreationConfig"`
	...
	// Experimental.
	CacheConfig *TfApp_CacheConfigProperty `field:"optional" json:"cacheConfig" yaml:"cacheConfig"`
	...
	// Experimental.
	JobConfig *TfApp_JobConfigProperty `field:"optional" json:"jobConfig" yaml:"jobConfig"`
