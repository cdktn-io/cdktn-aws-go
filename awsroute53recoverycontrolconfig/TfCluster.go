...
type TfCluster interface {
	...
	// Experimental.
	ClusterEndpoints() TfCluster_ClusterEndpointsPropertyList
	// Experimental.
...
func (j *jsiiProxy_TfCluster) ClusterEndpoints() TfCluster_ClusterEndpointsPropertyList {
	var returns TfCluster_ClusterEndpointsPropertyList
	_jsii_.Get(
		j,
		"clusterEndpoints",
		&returns,
