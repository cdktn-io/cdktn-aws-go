...
// Experimental.
type AwsKendraThesaurusConfig struct {
	// Experimental.
	...
	// Experimental.
	SourceS3Path *AwsKendraThesaurus_SourceS3PathProperty `field:"required" json:"sourceS3Path" yaml:"sourceS3Path"`
	...
	// Experimental.
	Timeouts *AwsKendraThesaurus_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
