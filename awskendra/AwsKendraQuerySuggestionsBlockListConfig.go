...
// Experimental.
type AwsKendraQuerySuggestionsBlockListConfig struct {
	// Experimental.
	...
	// Experimental.
	SourceS3Path *AwsKendraQuerySuggestionsBlockList_SourceS3PathProperty `field:"required" json:"sourceS3Path" yaml:"sourceS3Path"`
	...
	// Experimental.
	Timeouts *AwsKendraQuerySuggestionsBlockList_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
