...
// Experimental.
type AwsKendraDataSource_TargetProperty struct {
	...
	// Experimental.
	TargetDocumentAttributeValue *AwsKendraDataSource_TargetDocumentAttributeValueProperty `field:"optional" json:"targetDocumentAttributeValue" yaml:"targetDocumentAttributeValue"`
