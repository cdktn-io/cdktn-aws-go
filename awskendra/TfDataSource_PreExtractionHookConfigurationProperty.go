...
// Experimental.
type TfDataSource_PreExtractionHookConfigurationProperty struct {
	...
	// Experimental.
	InvocationCondition *TfDataSource_CustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationConditionProperty `field:"optional" json:"invocationCondition" yaml:"invocationCondition"`
}
