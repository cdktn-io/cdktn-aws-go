...
// Experimental.
type AwsKendraDataSourceConfig struct {
	// Experimental.
	...
	// Experimental.
	Configuration *AwsKendraDataSource_ConfigurationProperty `field:"optional" json:"configuration" yaml:"configuration"`
	...
	// Experimental.
	CustomDocumentEnrichmentConfiguration *AwsKendraDataSource_CustomDocumentEnrichmentConfigurationProperty `field:"optional" json:"customDocumentEnrichmentConfiguration" yaml:"customDocumentEnrichmentConfiguration"`
	...
	// Experimental.
	Timeouts *AwsKendraDataSource_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
