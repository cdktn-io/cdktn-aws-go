...
// Experimental.
type AwsKendraDataSource_PreExtractionHookConfigurationProperty struct {
	...
	// Experimental.
	InvocationCondition *AwsKendraDataSource_CustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationConditionProperty `field:"optional" json:"invocationCondition" yaml:"invocationCondition"`
}
