...
type DataAwsKendraQuerySuggestionsBlockList interface {
	...
	RoleArn() *string
	// Experimental.
	SourceS3Path() DataAwsKendraQuerySuggestionsBlockList_SourceS3PathPropertyList
	// Experimental.
	Status() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsKendraQuerySuggestionsBlockList) SourceS3Path() DataAwsKendraQuerySuggestionsBlockList_SourceS3PathPropertyList {
	var returns DataAwsKendraQuerySuggestionsBlockList_SourceS3PathPropertyList
	_jsii_.Get(
		j,
		"sourceS3Path",
		&returns,
...
func NewDataAwsKendraQuerySuggestionsBlockList(scope constructs.Construct, id *string, config *DataAwsKendraQuerySuggestionsBlockListConfig) DataAwsKendraQuerySuggestionsBlockList {
	...
	_jsii_.Create(
		"@cdktn/aws-kendra.DataAwsKendraQuerySuggestionsBlockList",
