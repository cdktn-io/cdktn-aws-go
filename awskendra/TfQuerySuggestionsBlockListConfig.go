...
// Experimental.
type TfQuerySuggestionsBlockListConfig struct {
	// Experimental.
	...
	// Experimental.
	SourceS3Path *TfQuerySuggestionsBlockList_SourceS3PathProperty `field:"required" json:"sourceS3Path" yaml:"sourceS3Path"`
	...
	// Experimental.
	Timeouts *TfQuerySuggestionsBlockList_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
