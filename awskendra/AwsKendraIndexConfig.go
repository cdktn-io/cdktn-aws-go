...
// Experimental.
type AwsKendraIndexConfig struct {
	// Experimental.
	...
	// Experimental.
	CapacityUnits *AwsKendraIndex_CapacityUnitsProperty `field:"optional" json:"capacityUnits" yaml:"capacityUnits"`
	...
	// Experimental.
	ServerSideEncryptionConfiguration *AwsKendraIndex_ServerSideEncryptionConfigurationProperty `field:"optional" json:"serverSideEncryptionConfiguration" yaml:"serverSideEncryptionConfiguration"`
	...
	// Experimental.
	Timeouts *AwsKendraIndex_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
	...
	// Experimental.
	UserGroupResolutionConfiguration *AwsKendraIndex_UserGroupResolutionConfigurationProperty `field:"optional" json:"userGroupResolutionConfiguration" yaml:"userGroupResolutionConfiguration"`
	...
	// Experimental.
	UserTokenConfigurations *AwsKendraIndex_UserTokenConfigurationsProperty `field:"optional" json:"userTokenConfigurations" yaml:"userTokenConfigurations"`
}
