...
// Experimental.
type AwsKendraExperienceConfig struct {
	// Experimental.
	...
	// Experimental.
	Configuration *AwsKendraExperience_ConfigurationProperty `field:"optional" json:"configuration" yaml:"configuration"`
	...
	// Experimental.
	Timeouts *AwsKendraExperience_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
