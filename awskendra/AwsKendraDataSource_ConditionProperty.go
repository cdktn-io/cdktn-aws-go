...
// Experimental.
type AwsKendraDataSource_ConditionProperty struct {
	...
	// Experimental.
	ConditionOnValue *AwsKendraDataSource_CustomDocumentEnrichmentConfigurationInlineConfigurationsConditionConditionOnValueProperty `field:"optional" json:"conditionOnValue" yaml:"conditionOnValue"`
}
