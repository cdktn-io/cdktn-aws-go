...
// Experimental.
type AwsDashboardConfig struct {
	// Experimental.
	...
	// Experimental.
	DashboardPublishOptions *AwsDashboard_DashboardPublishOptionsProperty `field:"optional" json:"dashboardPublishOptions" yaml:"dashboardPublishOptions"`
	// definition block.
	//
	...
	// Experimental.
	Parameters *AwsDashboard_ParametersProperty `field:"optional" json:"parameters" yaml:"parameters"`
	// permissions block.
	//
	...
	// Experimental.
	SourceEntity *AwsDashboard_SourceEntityProperty `field:"optional" json:"sourceEntity" yaml:"sourceEntity"`
	...
	// Experimental.
	Timeouts *AwsDashboard_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
