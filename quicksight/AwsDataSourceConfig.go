...
type AwsDataSourceConfig struct {
	...
	// Experimental.
	Parameters *AwsDataSource_ParametersProperty `field:"required" json:"parameters" yaml:"parameters"`
	...
	// Experimental.
	Credentials *AwsDataSource_CredentialsProperty `field:"optional" json:"credentials" yaml:"credentials"`
	...
	// Experimental.
	SslProperties *AwsDataSource_SslPropertiesProperty `field:"optional" json:"sslProperties" yaml:"sslProperties"`
	...
	// Experimental.
	VpcConnectionProperties *AwsDataSource_VpcConnectionPropertiesProperty `field:"optional" json:"vpcConnectionProperties" yaml:"vpcConnectionProperties"`
}
