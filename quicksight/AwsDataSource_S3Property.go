...
// Experimental.
type AwsDataSource_S3Property struct {
	...
	// Experimental.
	ManifestFileLocation *AwsDataSource_ManifestFileLocationProperty `field:"required" json:"manifestFileLocation" yaml:"manifestFileLocation"`
