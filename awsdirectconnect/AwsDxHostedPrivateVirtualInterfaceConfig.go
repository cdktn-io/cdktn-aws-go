...
// Experimental.
type AwsDxHostedPrivateVirtualInterfaceConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsDxHostedPrivateVirtualInterface_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
