...
// Experimental.
type AwsDxHostedTransitVirtualInterfaceAccepterConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsDxHostedTransitVirtualInterfaceAccepter_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
