...
// Experimental.
type TfHostedTransitVirtualInterfaceAccepterConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *TfHostedTransitVirtualInterfaceAccepter_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
