...
// Experimental.
type AwsShieldDrtAccessRoleArnAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsShieldDrtAccessRoleArnAssociation_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
