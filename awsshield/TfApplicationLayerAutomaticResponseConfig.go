...
// Experimental.
type TfApplicationLayerAutomaticResponseConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *TfApplicationLayerAutomaticResponse_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
