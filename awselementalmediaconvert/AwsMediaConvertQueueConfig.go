...
// Experimental.
type AwsMediaConvertQueueConfig struct {
	// Experimental.
	...
	// Experimental.
	ReservationPlanSettings *AwsMediaConvertQueue_ReservationPlanSettingsProperty `field:"optional" json:"reservationPlanSettings" yaml:"reservationPlanSettings"`
