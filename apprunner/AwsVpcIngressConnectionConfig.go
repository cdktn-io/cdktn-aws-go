...
// Experimental.
type AwsVpcIngressConnectionConfig struct {
	// Experimental.
	...
	// Experimental.
	IngressVpcConfiguration *AwsVpcIngressConnection_IngressVpcConfigurationProperty `field:"required" json:"ingressVpcConfiguration" yaml:"ingressVpcConfiguration"`
