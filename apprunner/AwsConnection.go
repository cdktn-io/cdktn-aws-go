...
func (j *jsiiProxy_AwsConnection) ConnectionName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"connectionName",
...
func (j *jsiiProxy_AwsConnection) ConnectionNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"connectionNameInput",
...
func (j *jsiiProxy_AwsConnection) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_AwsConnection)SetConnectionName(val *string) {
