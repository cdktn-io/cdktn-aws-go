...
// Experimental.
type TfReportPlanConfig struct {
	// Experimental.
	...
	// Experimental.
	ReportDeliveryChannel *TfReportPlan_ReportDeliveryChannelProperty `field:"required" json:"reportDeliveryChannel" yaml:"reportDeliveryChannel"`
	...
	// Experimental.
	ReportSetting *TfReportPlan_ReportSettingProperty `field:"required" json:"reportSetting" yaml:"reportSetting"`
