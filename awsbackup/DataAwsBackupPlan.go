...
type DataAwsBackupPlan interface {
	...
	RegionInput() *string
	// Experimental.
	Rule() DataAwsBackupPlan_RulePropertyList
	// Experimental.
	ScanSetting() DataAwsBackupPlan_ScanSettingPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsBackupPlan) Rule() DataAwsBackupPlan_RulePropertyList {
	var returns DataAwsBackupPlan_RulePropertyList
	_jsii_.Get(
		j,
		"rule",
		&returns,
...
func (j *jsiiProxy_DataAwsBackupPlan) ScanSetting() DataAwsBackupPlan_ScanSettingPropertyList {
	var returns DataAwsBackupPlan_ScanSettingPropertyList
	_jsii_.Get(
		j,
		"scanSetting",
		&returns,
