...
// Experimental.
type AwsBackupReportPlanConfig struct {
	// Experimental.
	...
	// Experimental.
	ReportDeliveryChannel *AwsBackupReportPlan_ReportDeliveryChannelProperty `field:"required" json:"reportDeliveryChannel" yaml:"reportDeliveryChannel"`
	...
	// Experimental.
	ReportSetting *AwsBackupReportPlan_ReportSettingProperty `field:"required" json:"reportSetting" yaml:"reportSetting"`
