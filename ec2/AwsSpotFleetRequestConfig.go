...
// Experimental.
type AwsSpotFleetRequestConfig struct {
	// Experimental.
	...
	// Experimental.
	SpotMaintenanceStrategies *AwsSpotFleetRequest_SpotMaintenanceStrategiesProperty `field:"optional" json:"spotMaintenanceStrategies" yaml:"spotMaintenanceStrategies"`
	...
	// Experimental.
	Timeouts *AwsSpotFleetRequest_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
