...
type DataAwsAvailabilityZones interface {
	...
	// Experimental.
	Filter() DataAwsAvailabilityZones_FilterPropertyList
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsAvailabilityZones_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsAvailabilityZones_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsAvailabilityZones) Filter() DataAwsAvailabilityZones_FilterPropertyList {
	var returns DataAwsAvailabilityZones_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsAvailabilityZones) Timeouts() DataAwsAvailabilityZones_TimeoutsPropertyOutputReference {
	var returns DataAwsAvailabilityZones_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewDataAwsAvailabilityZones(scope constructs.Construct, id *string, config *DataAwsAvailabilityZonesConfig) DataAwsAvailabilityZones {
	...
	_jsii_.Create(
		"@cdktn/aws-ec2.DataAwsAvailabilityZones",
...
func (d *jsiiProxy_DataAwsAvailabilityZones) PutTimeouts(value *DataAwsAvailabilityZones_TimeoutsProperty) {
