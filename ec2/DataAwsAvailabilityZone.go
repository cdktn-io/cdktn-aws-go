...
type DataAwsAvailabilityZone interface {
	...
	// Experimental.
	Filter() DataAwsAvailabilityZone_FilterPropertyList
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsAvailabilityZone_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsAvailabilityZone_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsAvailabilityZone) Filter() DataAwsAvailabilityZone_FilterPropertyList {
	var returns DataAwsAvailabilityZone_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsAvailabilityZone) Timeouts() DataAwsAvailabilityZone_TimeoutsPropertyOutputReference {
	var returns DataAwsAvailabilityZone_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewDataAwsAvailabilityZone(scope constructs.Construct, id *string, config *DataAwsAvailabilityZoneConfig) DataAwsAvailabilityZone {
	...
	_jsii_.Create(
		"@cdktn/aws-ec2.DataAwsAvailabilityZone",
...
func (d *jsiiProxy_DataAwsAvailabilityZone) PutTimeouts(value *DataAwsAvailabilityZone_TimeoutsProperty) {
