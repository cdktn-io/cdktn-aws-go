...
// Experimental.
type TfContainerServiceConfig struct {
	// Experimental.
	...
	// Experimental.
	PrivateRegistryAccess *TfContainerService_PrivateRegistryAccessProperty `field:"optional" json:"privateRegistryAccess" yaml:"privateRegistryAccess"`
	...
	// Experimental.
	PublicDomainNames *TfContainerService_PublicDomainNamesProperty `field:"optional" json:"publicDomainNames" yaml:"publicDomainNames"`
	...
	// Experimental.
	Timeouts *TfContainerService_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
