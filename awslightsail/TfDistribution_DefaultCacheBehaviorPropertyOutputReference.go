...
func (j *jsiiProxy_TfDistribution_DefaultCacheBehaviorPropertyOutputReference) Behavior() *string {
	var returns *string
	_jsii_.Get(
		j,
		"behavior",
...
func (j *jsiiProxy_TfDistribution_DefaultCacheBehaviorPropertyOutputReference) BehaviorInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"behaviorInput",
...
func (j *jsiiProxy_TfDistribution_DefaultCacheBehaviorPropertyOutputReference)SetBehavior(val *string) {
