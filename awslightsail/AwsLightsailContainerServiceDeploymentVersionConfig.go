...
// Experimental.
type AwsLightsailContainerServiceDeploymentVersionConfig struct {
	// Experimental.
	...
	// Experimental.
	PublicEndpoint *AwsLightsailContainerServiceDeploymentVersion_PublicEndpointProperty `field:"optional" json:"publicEndpoint" yaml:"publicEndpoint"`
	...
	// Experimental.
	Timeouts *AwsLightsailContainerServiceDeploymentVersion_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
