...
// Experimental.
type TfContainerServiceDeploymentVersionConfig struct {
	// Experimental.
	...
	// Experimental.
	PublicEndpoint *TfContainerServiceDeploymentVersion_PublicEndpointProperty `field:"optional" json:"publicEndpoint" yaml:"publicEndpoint"`
	...
	// Experimental.
	Timeouts *TfContainerServiceDeploymentVersion_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
