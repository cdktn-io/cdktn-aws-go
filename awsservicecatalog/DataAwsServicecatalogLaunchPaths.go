...
type DataAwsServicecatalogLaunchPaths interface {
	...
	RegionInput() *string
	// Experimental.
	Summaries() DataAwsServicecatalogLaunchPaths_SummariesPropertyList
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsServicecatalogLaunchPaths_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsServicecatalogLaunchPaths_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsServicecatalogLaunchPaths) Summaries() DataAwsServicecatalogLaunchPaths_SummariesPropertyList {
	var returns DataAwsServicecatalogLaunchPaths_SummariesPropertyList
	_jsii_.Get(
		j,
		"summaries",
		&returns,
...
func (j *jsiiProxy_DataAwsServicecatalogLaunchPaths) Timeouts() DataAwsServicecatalogLaunchPaths_TimeoutsPropertyOutputReference {
	var returns DataAwsServicecatalogLaunchPaths_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (d *jsiiProxy_DataAwsServicecatalogLaunchPaths) PutTimeouts(value *DataAwsServicecatalogLaunchPaths_TimeoutsProperty) {
