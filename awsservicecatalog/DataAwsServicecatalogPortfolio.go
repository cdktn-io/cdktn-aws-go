...
type DataAwsServicecatalogPortfolio interface {
	...
	// Experimental.
	Timeouts() DataAwsServicecatalogPortfolio_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsServicecatalogPortfolio_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsServicecatalogPortfolio) Timeouts() DataAwsServicecatalogPortfolio_TimeoutsPropertyOutputReference {
	var returns DataAwsServicecatalogPortfolio_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (d *jsiiProxy_DataAwsServicecatalogPortfolio) PutTimeouts(value *DataAwsServicecatalogPortfolio_TimeoutsProperty) {
