...
// Experimental.
type AwsServicecatalogOrganizationsAccessConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsServicecatalogOrganizationsAccess_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
