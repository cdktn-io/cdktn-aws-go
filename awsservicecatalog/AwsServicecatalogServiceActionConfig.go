...
// Experimental.
type AwsServicecatalogServiceActionConfig struct {
	// Experimental.
	...
	// Experimental.
	Definition *AwsServicecatalogServiceAction_DefinitionProperty `field:"required" json:"definition" yaml:"definition"`
	...
	// Experimental.
	Timeouts *AwsServicecatalogServiceAction_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
