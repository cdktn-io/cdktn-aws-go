...
type DataAwsServicecatalogPortfolioConstraints interface {
	...
	// Experimental.
	Details() DataAwsServicecatalogPortfolioConstraints_DetailsPropertyList
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsServicecatalogPortfolioConstraints_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsServicecatalogPortfolioConstraints_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsServicecatalogPortfolioConstraints) Details() DataAwsServicecatalogPortfolioConstraints_DetailsPropertyList {
	var returns DataAwsServicecatalogPortfolioConstraints_DetailsPropertyList
	_jsii_.Get(
		j,
		"details",
		&returns,
...
func (j *jsiiProxy_DataAwsServicecatalogPortfolioConstraints) Timeouts() DataAwsServicecatalogPortfolioConstraints_TimeoutsPropertyOutputReference {
	var returns DataAwsServicecatalogPortfolioConstraints_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (d *jsiiProxy_DataAwsServicecatalogPortfolioConstraints) PutTimeouts(value *DataAwsServicecatalogPortfolioConstraints_TimeoutsProperty) {
