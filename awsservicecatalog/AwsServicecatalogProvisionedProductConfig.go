...
// Experimental.
type AwsServicecatalogProvisionedProductConfig struct {
	// Experimental.
	...
	// Experimental.
	StackSetProvisioningPreferences *AwsServicecatalogProvisionedProduct_StackSetProvisioningPreferencesProperty `field:"optional" json:"stackSetProvisioningPreferences" yaml:"stackSetProvisioningPreferences"`
	...
	// Experimental.
	Timeouts *AwsServicecatalogProvisionedProduct_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
