...
// Experimental.
type AwsServicecatalogBudgetResourceAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsServicecatalogBudgetResourceAssociation_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
