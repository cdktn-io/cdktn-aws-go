...
type DataAwsServicecatalogConstraint interface {
	...
	// Experimental.
	Timeouts() DataAwsServicecatalogConstraint_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsServicecatalogConstraint_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsServicecatalogConstraint) Timeouts() DataAwsServicecatalogConstraint_TimeoutsPropertyOutputReference {
	var returns DataAwsServicecatalogConstraint_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (d *jsiiProxy_DataAwsServicecatalogConstraint) PutTimeouts(value *DataAwsServicecatalogConstraint_TimeoutsProperty) {
