...
type DataAwsServicecatalogProduct interface {
	...
	// Experimental.
	Timeouts() DataAwsServicecatalogProduct_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsServicecatalogProduct_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsServicecatalogProduct) Timeouts() DataAwsServicecatalogProduct_TimeoutsPropertyOutputReference {
	var returns DataAwsServicecatalogProduct_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (d *jsiiProxy_DataAwsServicecatalogProduct) PutTimeouts(value *DataAwsServicecatalogProduct_TimeoutsProperty) {
