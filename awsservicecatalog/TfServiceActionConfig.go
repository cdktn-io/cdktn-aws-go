...
// Experimental.
type TfServiceActionConfig struct {
	// Experimental.
	...
	// Experimental.
	Definition *TfServiceAction_DefinitionProperty `field:"required" json:"definition" yaml:"definition"`
	...
	// Experimental.
	Timeouts *TfServiceAction_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
