...
// Experimental.
type AwsApprunnerObservabilityConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	TraceConfiguration *AwsApprunnerObservabilityConfiguration_TraceConfigurationProperty `field:"optional" json:"traceConfiguration" yaml:"traceConfiguration"`
}
