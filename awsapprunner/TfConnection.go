...
func (j *jsiiProxy_TfConnection) ConnectionName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"connectionName",
...
func (j *jsiiProxy_TfConnection) ConnectionNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"connectionNameInput",
...
func (j *jsiiProxy_TfConnection) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_TfConnection)SetConnectionName(val *string) {
