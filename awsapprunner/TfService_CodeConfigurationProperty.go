...
// Experimental.
type TfService_CodeConfigurationProperty struct {
	...
	// Experimental.
	CodeConfigurationValues *TfService_CodeConfigurationValuesProperty `field:"optional" json:"codeConfigurationValues" yaml:"codeConfigurationValues"`
}
