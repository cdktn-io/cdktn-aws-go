...
// Experimental.
type TfObservabilityConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	TraceConfiguration *TfObservabilityConfiguration_TraceConfigurationProperty `field:"optional" json:"traceConfiguration" yaml:"traceConfiguration"`
}
