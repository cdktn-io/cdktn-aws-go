...
// Experimental.
type TfVpcIngressConnectionConfig struct {
	// Experimental.
	...
	// Experimental.
	IngressVpcConfiguration *TfVpcIngressConnection_IngressVpcConfigurationProperty `field:"required" json:"ingressVpcConfiguration" yaml:"ingressVpcConfiguration"`
