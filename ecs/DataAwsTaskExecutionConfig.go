...
// Experimental.
type DataAwsTaskExecutionConfig struct {
	// Experimental.
	...
	// Experimental.
	NetworkConfiguration *DataAwsTaskExecution_NetworkConfigurationProperty `field:"optional" json:"networkConfiguration" yaml:"networkConfiguration"`
	// overrides block.
	//
	...
	// Experimental.
	Overrides *DataAwsTaskExecution_OverridesProperty `field:"optional" json:"overrides" yaml:"overrides"`
