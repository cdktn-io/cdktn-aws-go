...
type AwsClusterConfig struct {
	...
	// Experimental.
	Configuration *AwsCluster_ConfigurationProperty `field:"optional" json:"configuration" yaml:"configuration"`
	...
	// Experimental.
	ServiceConnectDefaults *AwsCluster_ServiceConnectDefaultsProperty `field:"optional" json:"serviceConnectDefaults" yaml:"serviceConnectDefaults"`
	// setting block.
	//
