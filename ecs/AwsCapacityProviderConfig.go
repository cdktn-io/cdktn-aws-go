...
type AwsCapacityProviderConfig struct {
	...
	// Experimental.
	AutoScalingGroupProvider *AwsCapacityProvider_AutoScalingGroupProviderProperty `field:"optional" json:"autoScalingGroupProvider" yaml:"autoScalingGroupProvider"`
	...
	// Experimental.
	ManagedInstancesProvider *AwsCapacityProvider_ManagedInstancesProviderProperty `field:"optional" json:"managedInstancesProvider" yaml:"managedInstancesProvider"`
