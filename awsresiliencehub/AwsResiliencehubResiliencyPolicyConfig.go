...
// Experimental.
type AwsResiliencehubResiliencyPolicyConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsResiliencehubResiliencyPolicy_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
