...
// Experimental.
type AwsEvidentlyProjectConfig struct {
	// Experimental.
	...
	// Experimental.
	DataDelivery *AwsEvidentlyProject_DataDeliveryProperty `field:"optional" json:"dataDelivery" yaml:"dataDelivery"`
	...
	// Experimental.
	Timeouts *AwsEvidentlyProject_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
