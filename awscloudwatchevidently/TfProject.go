...
type TfProject interface {
	...
	CreatedTime() *string
	// Experimental.
	DataDelivery() TfProject_DataDeliveryPropertyOutputReference
	// Experimental.
	DataDeliveryInput() *TfProject_DataDeliveryProperty
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
	...
	// Experimental.
	PutDataDelivery(value *TfProject_DataDeliveryProperty)
	// Experimental.
...
func (j *jsiiProxy_TfProject) ActiveExperimentCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TfProject) ActiveLaunchCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"activeLaunchCount",
...
func (j *jsiiProxy_TfProject) CreatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdTime",
...
func (j *jsiiProxy_TfProject) DataDelivery() TfProject_DataDeliveryPropertyOutputReference {
	var returns TfProject_DataDeliveryPropertyOutputReference
	_jsii_.Get(
		j,
		"dataDelivery",
		&returns,
...
func (j *jsiiProxy_TfProject) DataDeliveryInput() *TfProject_DataDeliveryProperty {
...
func (j *jsiiProxy_TfProject) ExperimentCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"experimentCount",
...
func (j *jsiiProxy_TfProject) FeatureCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"featureCount",
...
func (j *jsiiProxy_TfProject) LastUpdatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lastUpdatedTime",
...
func (j *jsiiProxy_TfProject) LaunchCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"launchCount",
...
func (j *jsiiProxy_TfProject) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (t *jsiiProxy_TfProject) PutDataDelivery(value *TfProject_DataDeliveryProperty) {
	if err := t.validatePutDataDeliveryParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		t,
...
func (t *jsiiProxy_TfProject) ResetDataDelivery() {
	_jsii_.InvokeVoid(
		t,
		"resetDataDelivery",
		nil, // no parameters
