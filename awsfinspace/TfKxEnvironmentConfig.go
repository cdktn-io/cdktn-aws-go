...
// Experimental.
type TfKxEnvironmentConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *TfKxEnvironment_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
	...
	// Experimental.
	TransitGatewayConfiguration *TfKxEnvironment_TransitGatewayConfigurationProperty `field:"optional" json:"transitGatewayConfiguration" yaml:"transitGatewayConfiguration"`
}
