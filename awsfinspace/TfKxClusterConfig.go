...
type TfKxClusterConfig struct {
	...
	// Experimental.
	VpcConfiguration *TfKxCluster_VpcConfigurationProperty `field:"required" json:"vpcConfiguration" yaml:"vpcConfiguration"`
	...
	// Experimental.
	AutoScalingConfiguration *TfKxCluster_AutoScalingConfigurationProperty `field:"optional" json:"autoScalingConfiguration" yaml:"autoScalingConfiguration"`
	...
	// Experimental.
	CapacityConfiguration *TfKxCluster_CapacityConfigurationProperty `field:"optional" json:"capacityConfiguration" yaml:"capacityConfiguration"`
	// code block.
	//
	...
	// Experimental.
	Code *TfKxCluster_CodeProperty `field:"optional" json:"code" yaml:"code"`
	...
	// Experimental.
	SavedownStorageConfiguration *TfKxCluster_SavedownStorageConfigurationProperty `field:"optional" json:"savedownStorageConfiguration" yaml:"savedownStorageConfiguration"`
	...
	// Experimental.
	ScalingGroupConfiguration *TfKxCluster_ScalingGroupConfigurationProperty `field:"optional" json:"scalingGroupConfiguration" yaml:"scalingGroupConfiguration"`
	...
	// Experimental.
	Timeouts *TfKxCluster_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
