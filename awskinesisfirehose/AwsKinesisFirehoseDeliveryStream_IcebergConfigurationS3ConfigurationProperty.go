...
// Experimental.
type AwsKinesisFirehoseDeliveryStream_IcebergConfigurationS3ConfigurationProperty struct {
	...
	// Experimental.
	CloudwatchLoggingOptions *AwsKinesisFirehoseDeliveryStream_IcebergConfigurationS3ConfigurationCloudwatchLoggingOptionsProperty `field:"optional" json:"cloudwatchLoggingOptions" yaml:"cloudwatchLoggingOptions"`
