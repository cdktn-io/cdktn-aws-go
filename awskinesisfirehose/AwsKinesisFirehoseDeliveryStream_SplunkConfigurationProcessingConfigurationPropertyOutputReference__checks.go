...
func (a *jsiiProxy_AwsKinesisFirehoseDeliveryStream_SplunkConfigurationProcessingConfigurationPropertyOutputReference) validatePutProcessorsParameters(value interface{}) error {
	...
	case *[]*AwsKinesisFirehoseDeliveryStream_SplunkConfigurationProcessingConfigurationProcessorsProperty:
		value := value.(*[]*AwsKinesisFirehoseDeliveryStream_SplunkConfigurationProcessingConfigurationProcessorsProperty)
	...
	case []*AwsKinesisFirehoseDeliveryStream_SplunkConfigurationProcessingConfigurationProcessorsProperty:
		value_ := value.([]*AwsKinesisFirehoseDeliveryStream_SplunkConfigurationProcessingConfigurationProcessorsProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AwsKinesisFirehoseDeliveryStream_SplunkConfigurationProcessingConfigurationProcessorsProperty; received %#v (a %T)", value, value)
		}
	}
