...
// Experimental.
type AwsKinesisFirehoseDeliveryStream_OpensearchConfigurationS3ConfigurationProperty struct {
	...
	// Experimental.
	CloudwatchLoggingOptions *AwsKinesisFirehoseDeliveryStream_OpensearchConfigurationS3ConfigurationCloudwatchLoggingOptionsProperty `field:"optional" json:"cloudwatchLoggingOptions" yaml:"cloudwatchLoggingOptions"`
