...
// Experimental.
type AwsKinesisFirehoseDeliveryStream_SnowflakeConfigurationS3ConfigurationProperty struct {
	...
	// Experimental.
	CloudwatchLoggingOptions *AwsKinesisFirehoseDeliveryStream_SnowflakeConfigurationS3ConfigurationCloudwatchLoggingOptionsProperty `field:"optional" json:"cloudwatchLoggingOptions" yaml:"cloudwatchLoggingOptions"`
