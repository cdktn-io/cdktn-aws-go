...
// Experimental.
type AwsKinesisFirehoseDeliveryStream_ElasticsearchConfigurationProperty struct {
	...
	// Experimental.
	S3Configuration *AwsKinesisFirehoseDeliveryStream_ElasticsearchConfigurationS3ConfigurationProperty `field:"required" json:"s3Configuration" yaml:"s3Configuration"`
	...
	// Experimental.
	CloudwatchLoggingOptions *AwsKinesisFirehoseDeliveryStream_ElasticsearchConfigurationCloudwatchLoggingOptionsProperty `field:"optional" json:"cloudwatchLoggingOptions" yaml:"cloudwatchLoggingOptions"`
	...
	// Experimental.
	ProcessingConfiguration *AwsKinesisFirehoseDeliveryStream_ElasticsearchConfigurationProcessingConfigurationProperty `field:"optional" json:"processingConfiguration" yaml:"processingConfiguration"`
	...
	// Experimental.
	VpcConfig *AwsKinesisFirehoseDeliveryStream_ElasticsearchConfigurationVpcConfigProperty `field:"optional" json:"vpcConfig" yaml:"vpcConfig"`
}
