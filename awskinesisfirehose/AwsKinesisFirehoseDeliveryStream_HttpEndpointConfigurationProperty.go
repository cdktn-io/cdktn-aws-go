...
// Experimental.
type AwsKinesisFirehoseDeliveryStream_HttpEndpointConfigurationProperty struct {
	...
	// Experimental.
	S3Configuration *AwsKinesisFirehoseDeliveryStream_HttpEndpointConfigurationS3ConfigurationProperty `field:"required" json:"s3Configuration" yaml:"s3Configuration"`
	...
	// Experimental.
	CloudwatchLoggingOptions *AwsKinesisFirehoseDeliveryStream_HttpEndpointConfigurationCloudwatchLoggingOptionsProperty `field:"optional" json:"cloudwatchLoggingOptions" yaml:"cloudwatchLoggingOptions"`
	...
	// Experimental.
	ProcessingConfiguration *AwsKinesisFirehoseDeliveryStream_HttpEndpointConfigurationProcessingConfigurationProperty `field:"optional" json:"processingConfiguration" yaml:"processingConfiguration"`
	...
	// Experimental.
	RequestConfiguration *AwsKinesisFirehoseDeliveryStream_RequestConfigurationProperty `field:"optional" json:"requestConfiguration" yaml:"requestConfiguration"`
	...
	// Experimental.
	SecretsManagerConfiguration *AwsKinesisFirehoseDeliveryStream_HttpEndpointConfigurationSecretsManagerConfigurationProperty `field:"optional" json:"secretsManagerConfiguration" yaml:"secretsManagerConfiguration"`
}
