...
// Experimental.
type TfDeliveryStream_OpensearchserverlessConfigurationS3ConfigurationProperty struct {
	...
	// Experimental.
	CloudwatchLoggingOptions *TfDeliveryStream_OpensearchserverlessConfigurationS3ConfigurationCloudwatchLoggingOptionsProperty `field:"optional" json:"cloudwatchLoggingOptions" yaml:"cloudwatchLoggingOptions"`
