...
// Experimental.
type TfDeliveryStream_OpensearchConfigurationProperty struct {
	...
	// Experimental.
	S3Configuration *TfDeliveryStream_OpensearchConfigurationS3ConfigurationProperty `field:"required" json:"s3Configuration" yaml:"s3Configuration"`
	...
	// Experimental.
	CloudwatchLoggingOptions *TfDeliveryStream_OpensearchConfigurationCloudwatchLoggingOptionsProperty `field:"optional" json:"cloudwatchLoggingOptions" yaml:"cloudwatchLoggingOptions"`
	...
	// Experimental.
	DocumentIdOptions *TfDeliveryStream_DocumentIdOptionsProperty `field:"optional" json:"documentIdOptions" yaml:"documentIdOptions"`
	...
	// Experimental.
	ProcessingConfiguration *TfDeliveryStream_OpensearchConfigurationProcessingConfigurationProperty `field:"optional" json:"processingConfiguration" yaml:"processingConfiguration"`
	...
	// Experimental.
	VpcConfig *TfDeliveryStream_OpensearchConfigurationVpcConfigProperty `field:"optional" json:"vpcConfig" yaml:"vpcConfig"`
}
