...
// Experimental.
type AwsQuickConnectConfig struct {
	// Experimental.
	...
	// Experimental.
	QuickConnectConfig *AwsQuickConnect_QuickConnectConfigProperty `field:"required" json:"quickConnectConfig" yaml:"quickConnectConfig"`
