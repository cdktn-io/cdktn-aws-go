...
// Experimental.
type AwsInstanceStorageConfigConfig struct {
	// Experimental.
	...
	// Experimental.
	StorageConfig *AwsInstanceStorageConfig_StorageConfigProperty `field:"required" json:"storageConfig" yaml:"storageConfig"`
