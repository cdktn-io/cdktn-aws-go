...
// Experimental.
type AwsInstanceStorageConfig_S3ConfigProperty struct {
	...
	// Experimental.
	EncryptionConfig *AwsInstanceStorageConfig_StorageConfigS3ConfigEncryptionConfigProperty `field:"optional" json:"encryptionConfig" yaml:"encryptionConfig"`
}
