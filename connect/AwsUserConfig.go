...
type AwsUserConfig struct {
	...
	// Experimental.
	PhoneConfig *AwsUser_PhoneConfigProperty `field:"required" json:"phoneConfig" yaml:"phoneConfig"`
	...
	// Experimental.
	IdentityInfo *AwsUser_IdentityInfoProperty `field:"optional" json:"identityInfo" yaml:"identityInfo"`
