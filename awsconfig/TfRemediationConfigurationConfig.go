...
// Experimental.
type TfRemediationConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	ExecutionControls *TfRemediationConfiguration_ExecutionControlsProperty `field:"optional" json:"executionControls" yaml:"executionControls"`
