...
// Experimental.
type TfDeliveryChannelConfig struct {
	// Experimental.
	...
	// Experimental.
	SnapshotDeliveryProperties *TfDeliveryChannel_SnapshotDeliveryPropertiesProperty `field:"optional" json:"snapshotDeliveryProperties" yaml:"snapshotDeliveryProperties"`
