...
// Experimental.
type TfConfigRuleConfig struct {
	// Experimental.
	...
	// Experimental.
	Source *TfConfigRule_SourceProperty `field:"required" json:"source" yaml:"source"`
	...
	// Experimental.
	Scope *TfConfigRule_ScopeProperty `field:"optional" json:"scope" yaml:"scope"`
