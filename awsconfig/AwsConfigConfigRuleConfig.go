...
type AwsConfigConfigRuleConfig struct {
	...
	// Experimental.
	Source *AwsConfigConfigRule_SourceProperty `field:"required" json:"source" yaml:"source"`
	...
	// Experimental.
	Scope *AwsConfigConfigRule_ScopeProperty `field:"optional" json:"scope" yaml:"scope"`
