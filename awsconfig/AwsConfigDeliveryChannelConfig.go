...
// Experimental.
type AwsConfigDeliveryChannelConfig struct {
	// Experimental.
	...
	// Experimental.
	SnapshotDeliveryProperties *AwsConfigDeliveryChannel_SnapshotDeliveryPropertiesProperty `field:"optional" json:"snapshotDeliveryProperties" yaml:"snapshotDeliveryProperties"`
