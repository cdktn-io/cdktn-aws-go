...
// Experimental.
type AwsConfigRemediationConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	ExecutionControls *AwsConfigRemediationConfiguration_ExecutionControlsProperty `field:"optional" json:"executionControls" yaml:"executionControls"`
