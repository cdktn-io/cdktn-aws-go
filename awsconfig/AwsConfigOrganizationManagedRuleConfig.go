...
// Experimental.
type AwsConfigOrganizationManagedRuleConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsConfigOrganizationManagedRule_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
