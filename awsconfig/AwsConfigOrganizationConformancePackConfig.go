...
// Experimental.
type AwsConfigOrganizationConformancePackConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsConfigOrganizationConformancePack_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
