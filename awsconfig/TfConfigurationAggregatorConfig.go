...
// Experimental.
type TfConfigurationAggregatorConfig struct {
	// Experimental.
	...
	// Experimental.
	AccountAggregationSource *TfConfigurationAggregator_AccountAggregationSourceProperty `field:"optional" json:"accountAggregationSource" yaml:"accountAggregationSource"`
	...
	// Experimental.
	OrganizationAggregationSource *TfConfigurationAggregator_OrganizationAggregationSourceProperty `field:"optional" json:"organizationAggregationSource" yaml:"organizationAggregationSource"`
