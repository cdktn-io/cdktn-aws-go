...
// Experimental.
type TfConfigurationRecorderConfig struct {
	// Experimental.
	...
	// Experimental.
	RecordingGroup *TfConfigurationRecorder_RecordingGroupProperty `field:"optional" json:"recordingGroup" yaml:"recordingGroup"`
	...
	// Experimental.
	RecordingMode *TfConfigurationRecorder_RecordingModeProperty `field:"optional" json:"recordingMode" yaml:"recordingMode"`
