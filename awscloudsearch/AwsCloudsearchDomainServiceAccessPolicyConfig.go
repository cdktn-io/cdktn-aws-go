...
// Experimental.
type AwsCloudsearchDomainServiceAccessPolicyConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsCloudsearchDomainServiceAccessPolicy_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
