...
type TfDomainConfig struct {
	...
	// Experimental.
	EndpointOptions *TfDomain_EndpointOptionsProperty `field:"optional" json:"endpointOptions" yaml:"endpointOptions"`
	...
	// Experimental.
	ScalingParameters *TfDomain_ScalingParametersProperty `field:"optional" json:"scalingParameters" yaml:"scalingParameters"`
	// timeouts block.
	//
