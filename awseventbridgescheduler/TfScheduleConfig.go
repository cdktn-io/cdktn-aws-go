...
type TfScheduleConfig struct {
	...
	// Experimental.
	FlexibleTimeWindow *TfSchedule_FlexibleTimeWindowProperty `field:"required" json:"flexibleTimeWindow" yaml:"flexibleTimeWindow"`
	...
	// Experimental.
	Target *TfSchedule_TargetProperty `field:"required" json:"target" yaml:"target"`
