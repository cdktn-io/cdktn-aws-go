...
type TfEndpoint interface {
	...
	EndpointUrl() *string
	// Experimental.
	EventBus() TfEndpoint_EventBusPropertyList
	// Experimental.
	...
	RegionInput() *string
	// Experimental.
	ReplicationConfig() TfEndpoint_ReplicationConfigPropertyOutputReference
	// Experimental.
	ReplicationConfigInput() *TfEndpoint_ReplicationConfigProperty
	// Experimental.
	RoleArn() *string
	// Experimental.
	...
	RoleArnInput() *string
	// Experimental.
	RoutingConfig() TfEndpoint_RoutingConfigPropertyOutputReference
	// Experimental.
	RoutingConfigInput() *TfEndpoint_RoutingConfigProperty
	// Experimental.
	...
	// Experimental.
	PutReplicationConfig(value *TfEndpoint_ReplicationConfigProperty)
	// Experimental.
	PutRoutingConfig(value *TfEndpoint_RoutingConfigProperty)
...
func (j *jsiiProxy_TfEndpoint) EndpointUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endpointUrl",
...
func (j *jsiiProxy_TfEndpoint) EventBus() TfEndpoint_EventBusPropertyList {
	var returns TfEndpoint_EventBusPropertyList
	_jsii_.Get(
		j,
		"eventBus",
		&returns,
...
func (j *jsiiProxy_TfEndpoint) EventBusInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"eventBusInput",
...
func (j *jsiiProxy_TfEndpoint) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_TfEndpoint) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_TfEndpoint) ReplicationConfig() TfEndpoint_ReplicationConfigPropertyOutputReference {
	var returns TfEndpoint_ReplicationConfigPropertyOutputReference
	_jsii_.Get(
		j,
		"replicationConfig",
		&returns,
...
func (j *jsiiProxy_TfEndpoint) ReplicationConfigInput() *TfEndpoint_ReplicationConfigProperty {
...
func (j *jsiiProxy_TfEndpoint) RoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleArn",
...
func (j *jsiiProxy_TfEndpoint) RoleArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleArnInput",
...
func (j *jsiiProxy_TfEndpoint) RoutingConfig() TfEndpoint_RoutingConfigPropertyOutputReference {
	var returns TfEndpoint_RoutingConfigPropertyOutputReference
	_jsii_.Get(
		j,
		"routingConfig",
		&returns,
...
func (j *jsiiProxy_TfEndpoint) RoutingConfigInput() *TfEndpoint_RoutingConfigProperty {
	var returns *TfEndpoint_RoutingConfigProperty
	_jsii_.Get(
		j,
		"routingConfigInput",
		&returns,
...
func (j *jsiiProxy_TfEndpoint)SetName(val *string) {
...
func (j *jsiiProxy_TfEndpoint)SetRoleArn(val *string) {
...
func (t *jsiiProxy_TfEndpoint) PutEventBus(value interface{}) {
	if err := t.validatePutEventBusParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		t,
...
func (t *jsiiProxy_TfEndpoint) PutReplicationConfig(value *TfEndpoint_ReplicationConfigProperty) {
	if err := t.validatePutReplicationConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		t,
...
func (t *jsiiProxy_TfEndpoint) PutRoutingConfig(value *TfEndpoint_RoutingConfigProperty) {
...
func (t *jsiiProxy_TfEndpoint) ResetReplicationConfig() {
	_jsii_.InvokeVoid(
		t,
		"resetReplicationConfig",
		nil, // no parameters
...
func (t *jsiiProxy_TfEndpoint) ResetRoleArn() {
	_jsii_.InvokeVoid(
		t,
		"resetRoleArn",
		nil, // no parameters
