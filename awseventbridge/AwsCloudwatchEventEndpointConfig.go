...
// Experimental.
type AwsCloudwatchEventEndpointConfig struct {
	// Experimental.
	...
	// Experimental.
	RoutingConfig *AwsCloudwatchEventEndpoint_RoutingConfigProperty `field:"required" json:"routingConfig" yaml:"routingConfig"`
	...
	// Experimental.
	ReplicationConfig *AwsCloudwatchEventEndpoint_ReplicationConfigProperty `field:"optional" json:"replicationConfig" yaml:"replicationConfig"`
