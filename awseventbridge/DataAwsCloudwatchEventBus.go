...
type DataAwsCloudwatchEventBus interface {
	...
	// Experimental.
	DeadLetterConfig() DataAwsCloudwatchEventBus_DeadLetterConfigPropertyList
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
	...
	// Experimental.
	LogConfig() DataAwsCloudwatchEventBus_LogConfigPropertyList
	// Experimental.
	Name() *string
	// Experimental.
	SetName(val *string)
...
func (j *jsiiProxy_DataAwsCloudwatchEventBus) DeadLetterConfig() DataAwsCloudwatchEventBus_DeadLetterConfigPropertyList {
	var returns DataAwsCloudwatchEventBus_DeadLetterConfigPropertyList
	_jsii_.Get(
		j,
		"deadLetterConfig",
		&returns,
...
func (j *jsiiProxy_DataAwsCloudwatchEventBus) LogConfig() DataAwsCloudwatchEventBus_LogConfigPropertyList {
	var returns DataAwsCloudwatchEventBus_LogConfigPropertyList
	_jsii_.Get(
		j,
		"logConfig",
		&returns,
