...
// Experimental.
type AwsCloudwatchEventConnectionConfig struct {
	// Experimental.
	...
	// Experimental.
	AuthParameters *AwsCloudwatchEventConnection_AuthParametersProperty `field:"required" json:"authParameters" yaml:"authParameters"`
	...
	// Experimental.
	InvocationConnectivityParameters *AwsCloudwatchEventConnection_InvocationConnectivityParametersProperty `field:"optional" json:"invocationConnectivityParameters" yaml:"invocationConnectivityParameters"`
