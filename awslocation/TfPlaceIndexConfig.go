...
// Experimental.
type TfPlaceIndexConfig struct {
	// Experimental.
	...
	// Experimental.
	DataSourceConfiguration *TfPlaceIndex_DataSourceConfigurationProperty `field:"optional" json:"dataSourceConfiguration" yaml:"dataSourceConfiguration"`
