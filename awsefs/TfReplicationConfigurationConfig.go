...
// Experimental.
type TfReplicationConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	Destination *TfReplicationConfiguration_DestinationProperty `field:"required" json:"destination" yaml:"destination"`
	...
	// Experimental.
	Timeouts *TfReplicationConfiguration_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
