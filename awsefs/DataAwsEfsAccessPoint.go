...
type DataAwsEfsAccessPoint interface {
	...
	OwnerId() *string
	// Experimental.
	PosixUser() DataAwsEfsAccessPoint_PosixUserPropertyList
	// Experimental.
	...
	RegionInput() *string
	// Experimental.
	RootDirectory() DataAwsEfsAccessPoint_RootDirectoryPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsEfsAccessPoint) PosixUser() DataAwsEfsAccessPoint_PosixUserPropertyList {
	var returns DataAwsEfsAccessPoint_PosixUserPropertyList
	_jsii_.Get(
		j,
		"posixUser",
		&returns,
...
func (j *jsiiProxy_DataAwsEfsAccessPoint) RootDirectory() DataAwsEfsAccessPoint_RootDirectoryPropertyList {
	var returns DataAwsEfsAccessPoint_RootDirectoryPropertyList
	_jsii_.Get(
		j,
		"rootDirectory",
		&returns,
