...
type DataAwsEfsFileSystem interface {
	...
	// Experimental.
	LifecyclePolicy() DataAwsEfsFileSystem_LifecyclePolicyPropertyList
	// Experimental.
	Name() *string
	// The tree node.
	// Experimental.
	...
	// Experimental.
	Protection() DataAwsEfsFileSystem_ProtectionPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsEfsFileSystem) LifecyclePolicy() DataAwsEfsFileSystem_LifecyclePolicyPropertyList {
	var returns DataAwsEfsFileSystem_LifecyclePolicyPropertyList
	_jsii_.Get(
		j,
		"lifecyclePolicy",
		&returns,
...
func (j *jsiiProxy_DataAwsEfsFileSystem) Protection() DataAwsEfsFileSystem_ProtectionPropertyList {
	var returns DataAwsEfsFileSystem_ProtectionPropertyList
	_jsii_.Get(
		j,
		"protection",
		&returns,
