...
type TfAccessPointConfig struct {
	...
	// Experimental.
	PosixUser *TfAccessPoint_PosixUserProperty `field:"optional" json:"posixUser" yaml:"posixUser"`
	...
	// Experimental.
	RootDirectory *TfAccessPoint_RootDirectoryProperty `field:"optional" json:"rootDirectory" yaml:"rootDirectory"`
