...
type TfGroup interface {
	...
	// Experimental.
	ExternalIds() TfGroup_ExternalIdsPropertyList
	// Experimental.
...
func (j *jsiiProxy_TfGroup) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_TfGroup) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_TfGroup) ExternalIds() TfGroup_ExternalIdsPropertyList {
	var returns TfGroup_ExternalIdsPropertyList
	_jsii_.Get(
		j,
		"externalIds",
		&returns,
...
func (j *jsiiProxy_TfGroup) IdentityStoreId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"identityStoreId",
...
func (j *jsiiProxy_TfGroup) IdentityStoreIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewTfGroup(scope constructs.Construct, id *string, config *TfGroupConfig) TfGroup {
	...
	_jsii_.Create(
		"@cdktn/aws-sso-identity-store.TfGroup",
...
func (j *jsiiProxy_TfGroup)SetDisplayName(val *string) {
...
func (j *jsiiProxy_TfGroup)SetIdentityStoreId(val *string) {
