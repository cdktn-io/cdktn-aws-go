...
type DataAwsIdentitystoreGroup interface {
	...
	// Experimental.
	AlternateIdentifier() DataAwsIdentitystoreGroup_AlternateIdentifierPropertyOutputReference
	// Experimental.
	AlternateIdentifierInput() *DataAwsIdentitystoreGroup_AlternateIdentifierProperty
	// Experimental.
	...
	DisplayName() *string
	// Experimental.
	ExternalIds() DataAwsIdentitystoreGroup_ExternalIdsPropertyList
	// Experimental.
	...
	// Experimental.
	PutAlternateIdentifier(value *DataAwsIdentitystoreGroup_AlternateIdentifierProperty)
...
func (j *jsiiProxy_DataAwsIdentitystoreGroup) AlternateIdentifier() DataAwsIdentitystoreGroup_AlternateIdentifierPropertyOutputReference {
	var returns DataAwsIdentitystoreGroup_AlternateIdentifierPropertyOutputReference
	_jsii_.Get(
		j,
		"alternateIdentifier",
		&returns,
...
func (j *jsiiProxy_DataAwsIdentitystoreGroup) AlternateIdentifierInput() *DataAwsIdentitystoreGroup_AlternateIdentifierProperty {
...
func (j *jsiiProxy_DataAwsIdentitystoreGroup) ExternalIds() DataAwsIdentitystoreGroup_ExternalIdsPropertyList {
	var returns DataAwsIdentitystoreGroup_ExternalIdsPropertyList
	_jsii_.Get(
		j,
		"externalIds",
		&returns,
...
func NewDataAwsIdentitystoreGroup(scope constructs.Construct, id *string, config *DataAwsIdentitystoreGroupConfig) DataAwsIdentitystoreGroup {
	...
	_jsii_.Create(
		"@cdktn/aws-sso-identity-store.DataAwsIdentitystoreGroup",
...
func (d *jsiiProxy_DataAwsIdentitystoreGroup) PutAlternateIdentifier(value *DataAwsIdentitystoreGroup_AlternateIdentifierProperty) {
