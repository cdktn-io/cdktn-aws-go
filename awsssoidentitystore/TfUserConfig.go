...
type TfUserConfig struct {
	...
	// Experimental.
	Name *TfUser_NameProperty `field:"required" json:"name" yaml:"name"`
	...
	// Experimental.
	Addresses *TfUser_AddressesProperty `field:"optional" json:"addresses" yaml:"addresses"`
	// emails block.
	//
	...
	// Experimental.
	Emails *TfUser_EmailsProperty `field:"optional" json:"emails" yaml:"emails"`
	...
	// Experimental.
	PhoneNumbers *TfUser_PhoneNumbersProperty `field:"optional" json:"phoneNumbers" yaml:"phoneNumbers"`
