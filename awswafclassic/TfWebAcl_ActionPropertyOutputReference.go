...
func (j *jsiiProxy_TfWebAcl_ActionPropertyOutputReference) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_TfWebAcl_ActionPropertyOutputReference) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func (j *jsiiProxy_TfWebAcl_ActionPropertyOutputReference)SetType(val *string) {
