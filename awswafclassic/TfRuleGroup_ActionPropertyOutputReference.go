...
func (j *jsiiProxy_TfRuleGroup_ActionPropertyOutputReference) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_TfRuleGroup_ActionPropertyOutputReference) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func (j *jsiiProxy_TfRuleGroup_ActionPropertyOutputReference)SetType(val *string) {
