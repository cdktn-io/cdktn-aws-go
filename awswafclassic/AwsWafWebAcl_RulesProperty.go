...
// Experimental.
type AwsWafWebAcl_RulesProperty struct {
	...
	// Experimental.
	Action *AwsWafWebAcl_ActionProperty `field:"optional" json:"action" yaml:"action"`
	...
	// Experimental.
	OverrideAction *AwsWafWebAcl_OverrideActionProperty `field:"optional" json:"overrideAction" yaml:"overrideAction"`
