...
// Experimental.
type AwsInspector2OrganizationConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	AutoEnable *AwsInspector2OrganizationConfiguration_AutoEnableProperty `field:"required" json:"autoEnable" yaml:"autoEnable"`
	...
	// Experimental.
	Timeouts *AwsInspector2OrganizationConfiguration_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
