...
// Experimental.
type AwsDbInstanceAutomatedBackupsReplicationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsDbInstanceAutomatedBackupsReplication_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
