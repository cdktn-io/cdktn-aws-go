...
func (j *jsiiProxy_AwsCluster_RestoreToPointInTimePropertyOutputReference) SourceClusterResourceId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsCluster_RestoreToPointInTimePropertyOutputReference) SourceClusterResourceIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsCluster_RestoreToPointInTimePropertyOutputReference)SetSourceClusterResourceId(val *string) {
...
func (a *jsiiProxy_AwsCluster_RestoreToPointInTimePropertyOutputReference) ResetSourceClusterIdentifier() {
	_jsii_.InvokeVoid(
		a,
		"resetSourceClusterIdentifier",
		nil, // no parameters
...
func (a *jsiiProxy_AwsCluster_RestoreToPointInTimePropertyOutputReference) ResetSourceClusterResourceId() {
	_jsii_.InvokeVoid(
		a,
		"resetSourceClusterResourceId",
		nil, // no parameters
