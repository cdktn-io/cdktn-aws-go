...
// Experimental.
type AwsDbProxyDefaultTargetGroupConfig struct {
	// Experimental.
	...
	// Experimental.
	ConnectionPoolConfig *AwsDbProxyDefaultTargetGroup_ConnectionPoolConfigProperty `field:"optional" json:"connectionPoolConfig" yaml:"connectionPoolConfig"`
	...
	// Experimental.
	Timeouts *AwsDbProxyDefaultTargetGroup_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
