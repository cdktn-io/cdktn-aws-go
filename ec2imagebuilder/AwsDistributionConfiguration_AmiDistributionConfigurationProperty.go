...
// Experimental.
type AwsDistributionConfiguration_AmiDistributionConfigurationProperty struct {
	...
	// Experimental.
	LaunchPermission *AwsDistributionConfiguration_LaunchPermissionProperty `field:"optional" json:"launchPermission" yaml:"launchPermission"`
