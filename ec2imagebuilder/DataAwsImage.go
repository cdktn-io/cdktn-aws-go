...
type DataAwsImage interface {
	...
	// Experimental.
	ImageScanningConfiguration() DataAwsImage_ImageScanningConfigurationPropertyList
	// Experimental.
	ImageTestsConfiguration() DataAwsImage_ImageTestsConfigurationPropertyList
	// Experimental.
	...
	OsVersion() *string
	// Experimental.
	OutputResources() DataAwsImage_OutputResourcesPropertyList
	// Experimental.
	Platform() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsImage) BuildVersionArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"buildVersionArn",
...
func (j *jsiiProxy_DataAwsImage) ContainerRecipeArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"containerRecipeArn",
...
func (j *jsiiProxy_DataAwsImage) DateCreated() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dateCreated",
...
func (j *jsiiProxy_DataAwsImage) DistributionConfigurationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsImage) EnhancedImageMetadataEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsImage) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataAwsImage) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsImage) ImageRecipeArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"imageRecipeArn",
...
func (j *jsiiProxy_DataAwsImage) ImageScanningConfiguration() DataAwsImage_ImageScanningConfigurationPropertyList {
	var returns DataAwsImage_ImageScanningConfigurationPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsImage) ImageTestsConfiguration() DataAwsImage_ImageTestsConfigurationPropertyList {
	var returns DataAwsImage_ImageTestsConfigurationPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsImage) InfrastructureConfigurationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsImage) OsVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"osVersion",
...
func (j *jsiiProxy_DataAwsImage) OutputResources() DataAwsImage_OutputResourcesPropertyList {
	var returns DataAwsImage_OutputResourcesPropertyList
	_jsii_.Get(
		j,
		"outputResources",
		&returns,
...
func (j *jsiiProxy_DataAwsImage) Tags() *map[string]*string {
...
func (j *jsiiProxy_DataAwsImage) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_DataAwsImage) Version() *string {
	var returns *string
	_jsii_.Get(
		j,
		"version",
...
func NewDataAwsImage(scope constructs.Construct, id *string, config *DataAwsImageConfig) DataAwsImage {
	...
	_jsii_.Create(
		"@cdktn/aws-ec2-image-builder.DataAwsImage",
...
func (j *jsiiProxy_DataAwsImage)SetId(val *string) {
...
func (j *jsiiProxy_DataAwsImage)SetTags(val *map[string]*string) {
...
func (d *jsiiProxy_DataAwsImage) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsImage) ResetTags() {
	_jsii_.InvokeVoid(
		d,
		"resetTags",
		nil, // no parameters
