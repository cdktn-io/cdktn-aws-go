...
// Experimental.
type AwsRedshiftScheduledActionConfig struct {
	// Experimental.
	...
	// Experimental.
	TargetAction *AwsRedshiftScheduledAction_TargetActionProperty `field:"required" json:"targetAction" yaml:"targetAction"`
