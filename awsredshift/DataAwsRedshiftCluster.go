...
type DataAwsRedshiftCluster interface {
	...
	// Experimental.
	ClusterNodes() DataAwsRedshiftCluster_ClusterNodesPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsRedshiftCluster) ClusterNodes() DataAwsRedshiftCluster_ClusterNodesPropertyList {
	var returns DataAwsRedshiftCluster_ClusterNodesPropertyList
	_jsii_.Get(
		j,
		"clusterNodes",
		&returns,
