...
// Experimental.
type AwsConfiguredTableConfig struct {
	// Experimental.
	...
	// Experimental.
	TableReference *AwsConfiguredTable_TableReferenceProperty `field:"required" json:"tableReference" yaml:"tableReference"`
	...
	// Experimental.
	Timeouts *AwsConfiguredTable_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
