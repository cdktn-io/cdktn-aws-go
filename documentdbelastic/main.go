// cdk-terrain bindings for the DocumentDB Elastic group of terraform-provider-aws 6.62.0
...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/aws-documentdb-elastic.AwsCluster.TimeoutsProperty",
	...
	_jsii_.RegisterStruct(
		"@cdktn/aws-documentdb-elastic.AwsClusterConfig",
