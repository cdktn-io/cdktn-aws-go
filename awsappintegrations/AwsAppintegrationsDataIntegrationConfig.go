...
// Experimental.
type AwsAppintegrationsDataIntegrationConfig struct {
	// Experimental.
	...
	// Experimental.
	ScheduleConfig *AwsAppintegrationsDataIntegration_ScheduleConfigProperty `field:"required" json:"scheduleConfig" yaml:"scheduleConfig"`
