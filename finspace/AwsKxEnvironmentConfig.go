...
// Experimental.
type AwsKxEnvironmentConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsKxEnvironment_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
	...
	// Experimental.
	TransitGatewayConfiguration *AwsKxEnvironment_TransitGatewayConfigurationProperty `field:"optional" json:"transitGatewayConfiguration" yaml:"transitGatewayConfiguration"`
}
