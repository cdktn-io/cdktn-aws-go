...
// Experimental.
type TfReplicatorConfig struct {
	// Experimental.
	...
	// Experimental.
	ReplicationInfoList *TfReplicator_ReplicationInfoListProperty `field:"required" json:"replicationInfoList" yaml:"replicationInfoList"`
	...
	// Experimental.
	LogDelivery *TfReplicator_LogDeliveryProperty `field:"optional" json:"logDelivery" yaml:"logDelivery"`
	...
	// Experimental.
	Timeouts *TfReplicator_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
