...
// Experimental.
type TfServerlessClusterConfig struct {
	// Experimental.
	...
	// Experimental.
	ClientAuthentication *TfServerlessCluster_ClientAuthenticationProperty `field:"required" json:"clientAuthentication" yaml:"clientAuthentication"`
	...
	// Experimental.
	Timeouts *TfServerlessCluster_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
