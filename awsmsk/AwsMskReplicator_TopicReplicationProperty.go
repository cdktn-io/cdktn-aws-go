...
// Experimental.
type AwsMskReplicator_TopicReplicationProperty struct {
	...
	// Experimental.
	StartingPosition *AwsMskReplicator_StartingPositionProperty `field:"optional" json:"startingPosition" yaml:"startingPosition"`
	...
	// Experimental.
	TopicNameConfiguration *AwsMskReplicator_TopicNameConfigurationProperty `field:"optional" json:"topicNameConfiguration" yaml:"topicNameConfiguration"`
