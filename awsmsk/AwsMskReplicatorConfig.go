...
// Experimental.
type AwsMskReplicatorConfig struct {
	// Experimental.
	...
	// Experimental.
	ReplicationInfoList *AwsMskReplicator_ReplicationInfoListProperty `field:"required" json:"replicationInfoList" yaml:"replicationInfoList"`
	...
	// Experimental.
	LogDelivery *AwsMskReplicator_LogDeliveryProperty `field:"optional" json:"logDelivery" yaml:"logDelivery"`
	...
	// Experimental.
	Timeouts *AwsMskReplicator_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
