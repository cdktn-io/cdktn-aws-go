...
type DataAwsMskCluster interface {
	...
	// Experimental.
	BrokerNodeGroupInfo() DataAwsMskCluster_BrokerNodeGroupInfoPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsMskCluster) BrokerNodeGroupInfo() DataAwsMskCluster_BrokerNodeGroupInfoPropertyList {
	var returns DataAwsMskCluster_BrokerNodeGroupInfoPropertyList
	_jsii_.Get(
		j,
		"brokerNodeGroupInfo",
		&returns,
