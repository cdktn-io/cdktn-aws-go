...
type TfClusterConfig struct {
	...
	// Experimental.
	BrokerNodeGroupInfo *TfCluster_BrokerNodeGroupInfoProperty `field:"required" json:"brokerNodeGroupInfo" yaml:"brokerNodeGroupInfo"`
	...
	// Experimental.
	ClientAuthentication *TfCluster_ClientAuthenticationProperty `field:"optional" json:"clientAuthentication" yaml:"clientAuthentication"`
	...
	// Experimental.
	ConfigurationInfo *TfCluster_ConfigurationInfoProperty `field:"optional" json:"configurationInfo" yaml:"configurationInfo"`
	...
	// Experimental.
	EncryptionInfo *TfCluster_EncryptionInfoProperty `field:"optional" json:"encryptionInfo" yaml:"encryptionInfo"`
	...
	// Experimental.
	LoggingInfo *TfCluster_LoggingInfoProperty `field:"optional" json:"loggingInfo" yaml:"loggingInfo"`
	...
	// Experimental.
	OpenMonitoring *TfCluster_OpenMonitoringProperty `field:"optional" json:"openMonitoring" yaml:"openMonitoring"`
	// rebalancing block.
	//
	...
	// Experimental.
	Rebalancing *TfCluster_RebalancingProperty `field:"optional" json:"rebalancing" yaml:"rebalancing"`
