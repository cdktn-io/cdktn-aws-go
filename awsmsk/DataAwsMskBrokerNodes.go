...
type DataAwsMskBrokerNodes interface {
	...
	// Experimental.
	NodeInfoList() DataAwsMskBrokerNodes_NodeInfoListPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsMskBrokerNodes) NodeInfoList() DataAwsMskBrokerNodes_NodeInfoListPropertyList {
	var returns DataAwsMskBrokerNodes_NodeInfoListPropertyList
	_jsii_.Get(
		j,
		"nodeInfoList",
		&returns,
