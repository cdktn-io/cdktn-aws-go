...
// Experimental.
type AwsEcsServiceConfig struct {
	// Experimental.
	...
	// Experimental.
	Alarms *AwsEcsService_AlarmsProperty `field:"optional" json:"alarms" yaml:"alarms"`
	...
	// Experimental.
	DeploymentCircuitBreaker *AwsEcsService_DeploymentCircuitBreakerProperty `field:"optional" json:"deploymentCircuitBreaker" yaml:"deploymentCircuitBreaker"`
	...
	// Experimental.
	DeploymentConfiguration *AwsEcsService_DeploymentConfigurationProperty `field:"optional" json:"deploymentConfiguration" yaml:"deploymentConfiguration"`
	...
	// Experimental.
	DeploymentController *AwsEcsService_DeploymentControllerProperty `field:"optional" json:"deploymentController" yaml:"deploymentController"`
	...
	// Experimental.
	NetworkConfiguration *AwsEcsService_NetworkConfigurationProperty `field:"optional" json:"networkConfiguration" yaml:"networkConfiguration"`
	...
	// Experimental.
	ServiceConnectConfiguration *AwsEcsService_ServiceConnectConfigurationProperty `field:"optional" json:"serviceConnectConfiguration" yaml:"serviceConnectConfiguration"`
	...
	// Experimental.
	ServiceRegistries *AwsEcsService_ServiceRegistriesProperty `field:"optional" json:"serviceRegistries" yaml:"serviceRegistries"`
	...
	// Experimental.
	Timeouts *AwsEcsService_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
	...
	// Experimental.
	VolumeConfiguration *AwsEcsService_VolumeConfigurationProperty `field:"optional" json:"volumeConfiguration" yaml:"volumeConfiguration"`
