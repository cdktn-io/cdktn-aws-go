...
// Experimental.
type TfCapacityProvider_InstanceLaunchTemplateProperty struct {
	...
	// Experimental.
	NetworkConfiguration *TfCapacityProvider_NetworkConfigurationProperty `field:"required" json:"networkConfiguration" yaml:"networkConfiguration"`
	...
	// Experimental.
	CapacityReservations *TfCapacityProvider_CapacityReservationsProperty `field:"optional" json:"capacityReservations" yaml:"capacityReservations"`
	...
	// Experimental.
	InstanceRequirements *TfCapacityProvider_InstanceRequirementsProperty `field:"optional" json:"instanceRequirements" yaml:"instanceRequirements"`
	...
	// Experimental.
	LocalStorageConfiguration *TfCapacityProvider_LocalStorageConfigurationProperty `field:"optional" json:"localStorageConfiguration" yaml:"localStorageConfiguration"`
	...
	// Experimental.
	StorageConfiguration *TfCapacityProvider_StorageConfigurationProperty `field:"optional" json:"storageConfiguration" yaml:"storageConfiguration"`
}
