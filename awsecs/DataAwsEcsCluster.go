...
type DataAwsEcsCluster interface {
	...
	// Experimental.
	ServiceConnectDefaults() DataAwsEcsCluster_ServiceConnectDefaultsPropertyList
	// Experimental.
	Setting() DataAwsEcsCluster_SettingPropertyList
	// Experimental.
	Status() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsEcsCluster) ServiceConnectDefaults() DataAwsEcsCluster_ServiceConnectDefaultsPropertyList {
	var returns DataAwsEcsCluster_ServiceConnectDefaultsPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsEcsCluster) Setting() DataAwsEcsCluster_SettingPropertyList {
	var returns DataAwsEcsCluster_SettingPropertyList
	_jsii_.Get(
		j,
		"setting",
		&returns,
...
func NewDataAwsEcsCluster(scope constructs.Construct, id *string, config *DataAwsEcsClusterConfig) DataAwsEcsCluster {
	...
	_jsii_.Create(
		"@cdktn/aws-ecs.DataAwsEcsCluster",
