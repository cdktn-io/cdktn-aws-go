...
// Experimental.
type TfService_ServiceProperty struct {
	...
	// Experimental.
	ClientAlias *TfService_ClientAliasProperty `field:"optional" json:"clientAlias" yaml:"clientAlias"`
	...
	// Experimental.
	Timeout *TfService_TimeoutProperty `field:"optional" json:"timeout" yaml:"timeout"`
	// tls block.
	//
	...
	// Experimental.
	Tls *TfService_TlsProperty `field:"optional" json:"tls" yaml:"tls"`
}
