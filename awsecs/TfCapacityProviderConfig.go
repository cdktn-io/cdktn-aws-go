...
// Experimental.
type TfCapacityProviderConfig struct {
	// Experimental.
	...
	// Experimental.
	AutoScalingGroupProvider *TfCapacityProvider_AutoScalingGroupProviderProperty `field:"optional" json:"autoScalingGroupProvider" yaml:"autoScalingGroupProvider"`
	...
	// Experimental.
	ManagedInstancesProvider *TfCapacityProvider_ManagedInstancesProviderProperty `field:"optional" json:"managedInstancesProvider" yaml:"managedInstancesProvider"`
