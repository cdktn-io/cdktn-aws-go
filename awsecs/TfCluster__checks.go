...
func (t *jsiiProxy_TfCluster) validatePutConfigurationParameters(value *TfCluster_ConfigurationProperty) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (t *jsiiProxy_TfCluster) validatePutServiceConnectDefaultsParameters(value *TfCluster_ServiceConnectDefaultsProperty) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (t *jsiiProxy_TfCluster) validatePutSettingParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*TfCluster_SettingProperty:
		value := value.(*[]*TfCluster_SettingProperty)
	...
	case []*TfCluster_SettingProperty:
		value_ := value.([]*TfCluster_SettingProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*TfCluster_SettingProperty; received %#v (a %T)", value, value)
		}
	}
