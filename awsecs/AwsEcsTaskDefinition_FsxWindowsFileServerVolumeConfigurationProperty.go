...
// Experimental.
type AwsEcsTaskDefinition_FsxWindowsFileServerVolumeConfigurationProperty struct {
	...
	// Experimental.
	AuthorizationConfig *AwsEcsTaskDefinition_VolumeFsxWindowsFileServerVolumeConfigurationAuthorizationConfigProperty `field:"required" json:"authorizationConfig" yaml:"authorizationConfig"`
