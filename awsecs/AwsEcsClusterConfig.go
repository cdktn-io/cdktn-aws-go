...
// Experimental.
type AwsEcsClusterConfig struct {
	// Experimental.
	...
	// Experimental.
	Configuration *AwsEcsCluster_ConfigurationProperty `field:"optional" json:"configuration" yaml:"configuration"`
	...
	// Experimental.
	ServiceConnectDefaults *AwsEcsCluster_ServiceConnectDefaultsProperty `field:"optional" json:"serviceConnectDefaults" yaml:"serviceConnectDefaults"`
	// setting block.
	//
