...
// Experimental.
type TfTaskDefinition_FsxWindowsFileServerVolumeConfigurationProperty struct {
	...
	// Experimental.
	AuthorizationConfig *TfTaskDefinition_VolumeFsxWindowsFileServerVolumeConfigurationAuthorizationConfigProperty `field:"required" json:"authorizationConfig" yaml:"authorizationConfig"`
