...
type DataAwsEcsTaskDefinition interface {
	...
	// Experimental.
	EphemeralStorage() DataAwsEcsTaskDefinition_EphemeralStoragePropertyList
	// Experimental.
	...
	PidMode() *string
	// Experimental.
	PlacementConstraints() DataAwsEcsTaskDefinition_PlacementConstraintsPropertyList
	// Experimental.
	Provider() cdktn.TerraformProvider
	// Experimental.
	SetProvider(val cdktn.TerraformProvider)
	// Experimental.
	ProxyConfiguration() DataAwsEcsTaskDefinition_ProxyConfigurationPropertyList
	// Experimental.
	...
	Revision() *float64
	// Experimental.
	RuntimePlatform() DataAwsEcsTaskDefinition_RuntimePlatformPropertyList
	// Experimental.
	Status() *string
	// Experimental.
	...
	// Experimental.
	Volume() DataAwsEcsTaskDefinition_VolumePropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsEcsTaskDefinition) EphemeralStorage() DataAwsEcsTaskDefinition_EphemeralStoragePropertyList {
	var returns DataAwsEcsTaskDefinition_EphemeralStoragePropertyList
	_jsii_.Get(
		j,
		"ephemeralStorage",
		&returns,
...
func (j *jsiiProxy_DataAwsEcsTaskDefinition) PlacementConstraints() DataAwsEcsTaskDefinition_PlacementConstraintsPropertyList {
	var returns DataAwsEcsTaskDefinition_PlacementConstraintsPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsEcsTaskDefinition) ProxyConfiguration() DataAwsEcsTaskDefinition_ProxyConfigurationPropertyList {
	var returns DataAwsEcsTaskDefinition_ProxyConfigurationPropertyList
	_jsii_.Get(
		j,
		"proxyConfiguration",
		&returns,
...
func (j *jsiiProxy_DataAwsEcsTaskDefinition) RuntimePlatform() DataAwsEcsTaskDefinition_RuntimePlatformPropertyList {
	var returns DataAwsEcsTaskDefinition_RuntimePlatformPropertyList
	_jsii_.Get(
		j,
		"runtimePlatform",
		&returns,
...
func (j *jsiiProxy_DataAwsEcsTaskDefinition) Volume() DataAwsEcsTaskDefinition_VolumePropertyList {
	var returns DataAwsEcsTaskDefinition_VolumePropertyList
	_jsii_.Get(
		j,
		"volume",
		&returns,
...
func NewDataAwsEcsTaskDefinition(scope constructs.Construct, id *string, config *DataAwsEcsTaskDefinitionConfig) DataAwsEcsTaskDefinition {
	...
	_jsii_.Create(
		"@cdktn/aws-ecs.DataAwsEcsTaskDefinition",
