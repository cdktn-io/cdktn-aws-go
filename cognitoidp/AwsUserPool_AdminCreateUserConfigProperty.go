...
// Experimental.
type AwsUserPool_AdminCreateUserConfigProperty struct {
	...
	// Experimental.
	InviteMessageTemplate *AwsUserPool_InviteMessageTemplateProperty `field:"optional" json:"inviteMessageTemplate" yaml:"inviteMessageTemplate"`
}
