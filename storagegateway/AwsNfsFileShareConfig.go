...
// Experimental.
type AwsNfsFileShareConfig struct {
	// Experimental.
	...
	// Experimental.
	CacheAttributes *AwsNfsFileShare_CacheAttributesProperty `field:"optional" json:"cacheAttributes" yaml:"cacheAttributes"`
	...
	// Experimental.
	NfsFileShareDefaults *AwsNfsFileShare_NfsFileShareDefaultsProperty `field:"optional" json:"nfsFileShareDefaults" yaml:"nfsFileShareDefaults"`
	...
	// Experimental.
	Timeouts *AwsNfsFileShare_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
