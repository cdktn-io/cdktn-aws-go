...
type AwsGatewayConfig struct {
	...
	// Experimental.
	MaintenanceStartTime *AwsGateway_MaintenanceStartTimeProperty `field:"optional" json:"maintenanceStartTime" yaml:"maintenanceStartTime"`
	...
	// Experimental.
	SmbActiveDirectorySettings *AwsGateway_SmbActiveDirectorySettingsProperty `field:"optional" json:"smbActiveDirectorySettings" yaml:"smbActiveDirectorySettings"`
