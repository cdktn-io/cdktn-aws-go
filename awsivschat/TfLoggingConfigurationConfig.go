...
type TfLoggingConfigurationConfig struct {
	...
	// Experimental.
	DestinationConfiguration *TfLoggingConfiguration_DestinationConfigurationProperty `field:"optional" json:"destinationConfiguration" yaml:"destinationConfiguration"`
	...
	// Experimental.
	Timeouts *TfLoggingConfiguration_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
