...
// Experimental.
type AwsIvschatLoggingConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	DestinationConfiguration *AwsIvschatLoggingConfiguration_DestinationConfigurationProperty `field:"optional" json:"destinationConfiguration" yaml:"destinationConfiguration"`
	...
	// Experimental.
	Timeouts *AwsIvschatLoggingConfiguration_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
