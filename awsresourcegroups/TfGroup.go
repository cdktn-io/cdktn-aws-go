...
type TfGroup interface {
	...
	// Experimental.
	Configuration() TfGroup_ConfigurationPropertyList
	// Experimental.
	...
	RegionInput() *string
	// Experimental.
	ResourceQuery() TfGroup_ResourceQueryPropertyOutputReference
	// Experimental.
	ResourceQueryInput() *TfGroup_ResourceQueryProperty
	// Experimental.
	...
	// Experimental.
	PutResourceQuery(value *TfGroup_ResourceQueryProperty)
	// Experimental.
...
func (j *jsiiProxy_TfGroup) Configuration() TfGroup_ConfigurationPropertyList {
	var returns TfGroup_ConfigurationPropertyList
	_jsii_.Get(
		j,
		"configuration",
		&returns,
...
func (j *jsiiProxy_TfGroup) ConfigurationInput() interface{} {
...
func (j *jsiiProxy_TfGroup) ResourceQuery() TfGroup_ResourceQueryPropertyOutputReference {
	var returns TfGroup_ResourceQueryPropertyOutputReference
	_jsii_.Get(
		j,
		"resourceQuery",
		&returns,
...
func (j *jsiiProxy_TfGroup) ResourceQueryInput() *TfGroup_ResourceQueryProperty {
...
func NewTfGroup(scope constructs.Construct, id *string, config *TfGroupConfig) TfGroup {
	...
	_jsii_.Create(
		"@cdktn/aws-resource-groups.TfGroup",
...
func (t *jsiiProxy_TfGroup) PutConfiguration(value interface{}) {
...
func (t *jsiiProxy_TfGroup) PutResourceQuery(value *TfGroup_ResourceQueryProperty) {
	if err := t.validatePutResourceQueryParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		t,
...
func (t *jsiiProxy_TfGroup) ResetConfiguration() {
	_jsii_.InvokeVoid(
		t,
		"resetConfiguration",
		nil, // no parameters
...
func (t *jsiiProxy_TfGroup) ResetResourceQuery() {
	_jsii_.InvokeVoid(
		t,
		"resetResourceQuery",
		nil, // no parameters
