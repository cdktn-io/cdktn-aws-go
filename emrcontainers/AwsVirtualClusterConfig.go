...
// Experimental.
type AwsVirtualClusterConfig struct {
	// Experimental.
	...
	// Experimental.
	ContainerProvider *AwsVirtualCluster_ContainerProviderProperty `field:"required" json:"containerProvider" yaml:"containerProvider"`
	...
	// Experimental.
	Timeouts *AwsVirtualCluster_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
