...
// Experimental.
type AwsJobTemplateConfig struct {
	// Experimental.
	...
	// Experimental.
	JobTemplateData *AwsJobTemplate_JobTemplateDataProperty `field:"required" json:"jobTemplateData" yaml:"jobTemplateData"`
	...
	// Experimental.
	Timeouts *AwsJobTemplate_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
