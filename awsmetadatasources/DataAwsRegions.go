...
type DataAwsRegions interface {
	...
	// Experimental.
	Filter() DataAwsRegions_FilterPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsRegions) Filter() DataAwsRegions_FilterPropertyList {
	var returns DataAwsRegions_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
