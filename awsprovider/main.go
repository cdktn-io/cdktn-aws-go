// cdk-terrain bindings for the AWS Provider group of terraform-provider-aws 6.62.0
package awsprovider
...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/aws-provider.AwsProvider.AssumeRoleProperty",
		reflect.TypeOf((*AwsProvider_AssumeRoleProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/aws-provider.AwsProvider.AssumeRoleWithWebIdentityProperty",
		reflect.TypeOf((*AwsProvider_AssumeRoleWithWebIdentityProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/aws-provider.AwsProvider.DefaultTagsProperty",
		reflect.TypeOf((*AwsProvider_DefaultTagsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/aws-provider.AwsProvider.EndpointsProperty",
		reflect.TypeOf((*AwsProvider_EndpointsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/aws-provider.AwsProvider.IgnoreTagsProperty",
		reflect.TypeOf((*AwsProvider_IgnoreTagsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/aws-provider.AwsProviderConfig",
