...
type AwsAppConfig struct {
	...
	// Experimental.
	CampaignHook *AwsApp_CampaignHookProperty `field:"optional" json:"campaignHook" yaml:"campaignHook"`
	...
	// Experimental.
	Limits *AwsApp_LimitsProperty `field:"optional" json:"limits" yaml:"limits"`
	...
	// Experimental.
	QuietTime *AwsApp_QuietTimeProperty `field:"optional" json:"quietTime" yaml:"quietTime"`
