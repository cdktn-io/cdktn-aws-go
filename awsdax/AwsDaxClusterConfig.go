...
// Experimental.
type AwsDaxClusterConfig struct {
	// Experimental.
	...
	// Experimental.
	ServerSideEncryption *AwsDaxCluster_ServerSideEncryptionProperty `field:"optional" json:"serverSideEncryption" yaml:"serverSideEncryption"`
	...
	// Experimental.
	Timeouts *AwsDaxCluster_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
