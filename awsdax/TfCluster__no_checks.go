...
func (t *jsiiProxy_TfCluster) validatePutServerSideEncryptionParameters(value *TfCluster_ServerSideEncryptionProperty) error {
	return nil
}
...
func (j *jsiiProxy_TfCluster) validateSetClusterEndpointEncryptionTypeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_TfCluster) validateSetIamRoleArnParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_TfCluster) validateSetNotificationTopicArnParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_TfCluster) validateSetReplicationFactorParameters(val *float64) error {
	return nil
}
