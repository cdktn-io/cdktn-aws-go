...
type TfDomain_ClusterConfigPropertyOutputReference interface {
	...
	// Experimental.
	NodeOptions() TfDomain_NodeOptionsPropertyList
	// Experimental.
...
func (j *jsiiProxy_TfDomain_ClusterConfigPropertyOutputReference) MultiAzWithStandbyEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TfDomain_ClusterConfigPropertyOutputReference) MultiAzWithStandbyEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TfDomain_ClusterConfigPropertyOutputReference) NodeOptions() TfDomain_NodeOptionsPropertyList {
	var returns TfDomain_NodeOptionsPropertyList
	_jsii_.Get(
		j,
		"nodeOptions",
		&returns,
...
func (j *jsiiProxy_TfDomain_ClusterConfigPropertyOutputReference) NodeOptionsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"nodeOptionsInput",
...
func NewTfDomain_ClusterConfigPropertyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) TfDomain_ClusterConfigPropertyOutputReference {
	...
	_jsii_.Create(
		"@cdktn/aws-opensearch.TfDomain.ClusterConfigPropertyOutputReference",
...
func (j *jsiiProxy_TfDomain_ClusterConfigPropertyOutputReference)SetMultiAzWithStandbyEnabled(val interface{}) {
...
func (t *jsiiProxy_TfDomain_ClusterConfigPropertyOutputReference) PutNodeOptions(value interface{}) {
	if err := t.validatePutNodeOptionsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		t,
...
func (t *jsiiProxy_TfDomain_ClusterConfigPropertyOutputReference) ResetMultiAzWithStandbyEnabled() {
	_jsii_.InvokeVoid(
		t,
		"resetMultiAzWithStandbyEnabled",
		nil, // no parameters
...
func (t *jsiiProxy_TfDomain_ClusterConfigPropertyOutputReference) ResetNodeOptions() {
	_jsii_.InvokeVoid(
		t,
		"resetNodeOptions",
		nil, // no parameters
