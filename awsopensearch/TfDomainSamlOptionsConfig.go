...
// Experimental.
type TfDomainSamlOptionsConfig struct {
	// Experimental.
	...
	// Experimental.
	SamlOptions *TfDomainSamlOptions_SamlOptionsProperty `field:"optional" json:"samlOptions" yaml:"samlOptions"`
	// timeouts block.
	//
	...
	// Experimental.
	Timeouts *TfDomainSamlOptions_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
