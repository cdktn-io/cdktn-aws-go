...
type TfPipelineConfig struct {
	...
	// Experimental.
	ContentConfig *TfPipeline_ContentConfigProperty `field:"optional" json:"contentConfig" yaml:"contentConfig"`
	...
	// Experimental.
	Notifications *TfPipeline_NotificationsProperty `field:"optional" json:"notifications" yaml:"notifications"`
	...
	// Experimental.
	ThumbnailConfig *TfPipeline_ThumbnailConfigProperty `field:"optional" json:"thumbnailConfig" yaml:"thumbnailConfig"`
