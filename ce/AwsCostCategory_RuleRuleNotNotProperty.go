...
// Experimental.
type AwsCostCategory_RuleRuleNotNotProperty struct {
	// cost_category block.
	//
	...
	// Experimental.
	CostCategory *AwsCostCategory_RuleRuleNotNotCostCategoryProperty `field:"optional" json:"costCategory" yaml:"costCategory"`
	// dimension block.
	//
	...
	// Experimental.
	Dimension *AwsCostCategory_RuleRuleNotNotDimensionProperty `field:"optional" json:"dimension" yaml:"dimension"`
	// tags block.
	//
	...
	// Experimental.
	Tags *AwsCostCategory_RuleRuleNotNotTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
