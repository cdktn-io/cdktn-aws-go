...
type DataAwsTagsConfig struct {
	...
	// Experimental.
	TimePeriod *DataAwsTags_TimePeriodProperty `field:"required" json:"timePeriod" yaml:"timePeriod"`
	// filter block.
	//
	...
	// Experimental.
	Filter *DataAwsTags_FilterProperty `field:"optional" json:"filter" yaml:"filter"`
