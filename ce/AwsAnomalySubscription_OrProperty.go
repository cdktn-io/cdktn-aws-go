...
// Experimental.
type AwsAnomalySubscription_OrProperty struct {
	// cost_category block.
	//
	...
	// Experimental.
	CostCategory *AwsAnomalySubscription_ThresholdExpressionOrCostCategoryProperty `field:"optional" json:"costCategory" yaml:"costCategory"`
	// dimension block.
	//
	...
	// Experimental.
	Dimension *AwsAnomalySubscription_ThresholdExpressionOrDimensionProperty `field:"optional" json:"dimension" yaml:"dimension"`
	// tags block.
	//
	...
	// Experimental.
	Tags *AwsAnomalySubscription_ThresholdExpressionOrTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
