...
// Experimental.
type AwsCostCategory_RuleRuleNotOrProperty struct {
	// cost_category block.
	//
	...
	// Experimental.
	CostCategory *AwsCostCategory_RuleRuleNotOrCostCategoryProperty `field:"optional" json:"costCategory" yaml:"costCategory"`
	// dimension block.
	//
	...
	// Experimental.
	Dimension *AwsCostCategory_RuleRuleNotOrDimensionProperty `field:"optional" json:"dimension" yaml:"dimension"`
	// tags block.
	//
	...
	// Experimental.
	Tags *AwsCostCategory_RuleRuleNotOrTagsProperty `field:"optional" json:"tags" yaml:"tags"`
}
