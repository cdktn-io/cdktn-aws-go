...
// Experimental.
type AwsAnomalySubscriptionConfig struct {
	// Experimental.
	...
	// Experimental.
	ThresholdExpression *AwsAnomalySubscription_ThresholdExpressionProperty `field:"optional" json:"thresholdExpression" yaml:"thresholdExpression"`
}
