...
// Experimental.
type AwsAppmeshRoute_SpecHttpRouteTimeoutProperty struct {
	// idle block.
	//
	...
	// Experimental.
	Idle *AwsAppmeshRoute_SpecHttpRouteTimeoutIdleProperty `field:"optional" json:"idle" yaml:"idle"`
	// per_request block.
	//
	...
	// Experimental.
	PerRequest *AwsAppmeshRoute_SpecHttpRouteTimeoutPerRequestProperty `field:"optional" json:"perRequest" yaml:"perRequest"`
}
