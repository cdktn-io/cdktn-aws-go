...
// Experimental.
type AwsAppmeshRoute_SpecHttpRouteMatchHeaderProperty struct {
	...
	// Experimental.
	Match *AwsAppmeshRoute_SpecHttpRouteMatchHeaderMatchProperty `field:"optional" json:"match" yaml:"match"`
}
