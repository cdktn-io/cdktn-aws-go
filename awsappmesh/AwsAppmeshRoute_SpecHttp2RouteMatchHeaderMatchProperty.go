...
// Experimental.
type AwsAppmeshRoute_SpecHttp2RouteMatchHeaderMatchProperty struct {
	...
	// Experimental.
	Range *AwsAppmeshRoute_SpecHttp2RouteMatchHeaderMatchRangeProperty `field:"optional" json:"range" yaml:"range"`
