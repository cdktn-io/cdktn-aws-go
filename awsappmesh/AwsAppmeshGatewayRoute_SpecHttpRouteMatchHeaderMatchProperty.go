...
// Experimental.
type AwsAppmeshGatewayRoute_SpecHttpRouteMatchHeaderMatchProperty struct {
	...
	// Experimental.
	Range *AwsAppmeshGatewayRoute_SpecHttpRouteMatchHeaderMatchRangeProperty `field:"optional" json:"range" yaml:"range"`
