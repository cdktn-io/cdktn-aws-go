...
// Experimental.
type TfVirtualNode_SpecBackendVirtualServiceClientPolicyTlsProperty struct {
	// validation block.
	//
	...
	// Experimental.
	Validation *TfVirtualNode_SpecBackendVirtualServiceClientPolicyTlsValidationProperty `field:"required" json:"validation" yaml:"validation"`
	// certificate block.
	//
	...
	// Experimental.
	Certificate *TfVirtualNode_SpecBackendVirtualServiceClientPolicyTlsCertificateProperty `field:"optional" json:"certificate" yaml:"certificate"`
