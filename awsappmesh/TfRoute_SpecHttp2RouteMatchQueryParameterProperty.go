...
// Experimental.
type TfRoute_SpecHttp2RouteMatchQueryParameterProperty struct {
	...
	// Experimental.
	Match *TfRoute_SpecHttp2RouteMatchQueryParameterMatchProperty `field:"optional" json:"match" yaml:"match"`
}
