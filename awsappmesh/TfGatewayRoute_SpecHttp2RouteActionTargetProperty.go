...
// Experimental.
type TfGatewayRoute_SpecHttp2RouteActionTargetProperty struct {
	...
	// Experimental.
	VirtualService *TfGatewayRoute_SpecHttp2RouteActionTargetVirtualServiceProperty `field:"required" json:"virtualService" yaml:"virtualService"`
