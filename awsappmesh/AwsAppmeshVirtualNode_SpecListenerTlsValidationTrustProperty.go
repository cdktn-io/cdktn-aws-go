...
// Experimental.
type AwsAppmeshVirtualNode_SpecListenerTlsValidationTrustProperty struct {
	// file block.
	//
	...
	// Experimental.
	File *AwsAppmeshVirtualNode_SpecListenerTlsValidationTrustFileProperty `field:"optional" json:"file" yaml:"file"`
	// sds block.
	//
	...
	// Experimental.
	Sds *AwsAppmeshVirtualNode_SpecListenerTlsValidationTrustSdsProperty `field:"optional" json:"sds" yaml:"sds"`
}
