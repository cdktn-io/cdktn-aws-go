...
// Experimental.
type AwsAppmeshRoute_SpecHttp2RouteTimeoutProperty struct {
	// idle block.
	//
	...
	// Experimental.
	Idle *AwsAppmeshRoute_SpecHttp2RouteTimeoutIdleProperty `field:"optional" json:"idle" yaml:"idle"`
	// per_request block.
	//
	...
	// Experimental.
	PerRequest *AwsAppmeshRoute_SpecHttp2RouteTimeoutPerRequestProperty `field:"optional" json:"perRequest" yaml:"perRequest"`
}
