...
// Experimental.
type TfRoute_SpecHttpRouteRetryPolicyProperty struct {
	...
	// Experimental.
	PerRetryTimeout *TfRoute_SpecHttpRouteRetryPolicyPerRetryTimeoutProperty `field:"required" json:"perRetryTimeout" yaml:"perRetryTimeout"`
