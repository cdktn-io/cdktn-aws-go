...
// Experimental.
type AwsAppmeshRoute_SpecHttp2RouteMatchQueryParameterProperty struct {
	...
	// Experimental.
	Match *AwsAppmeshRoute_SpecHttp2RouteMatchQueryParameterMatchProperty `field:"optional" json:"match" yaml:"match"`
}
