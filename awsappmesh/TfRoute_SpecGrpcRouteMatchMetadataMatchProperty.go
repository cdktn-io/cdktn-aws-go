...
// Experimental.
type TfRoute_SpecGrpcRouteMatchMetadataMatchProperty struct {
	...
	// Experimental.
	Range *TfRoute_SpecGrpcRouteMatchMetadataMatchRangeProperty `field:"optional" json:"range" yaml:"range"`
