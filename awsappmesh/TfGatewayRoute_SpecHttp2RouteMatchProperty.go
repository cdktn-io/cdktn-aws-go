...
// Experimental.
type TfGatewayRoute_SpecHttp2RouteMatchProperty struct {
	// header block.
	//
	...
	// Experimental.
	Hostname *TfGatewayRoute_SpecHttp2RouteMatchHostnameProperty `field:"optional" json:"hostname" yaml:"hostname"`
	// path block.
	//
	...
	// Experimental.
	Path *TfGatewayRoute_SpecHttp2RouteMatchPathProperty `field:"optional" json:"path" yaml:"path"`
