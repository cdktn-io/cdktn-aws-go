...
// Experimental.
type TfRoute_SpecHttp2RouteRetryPolicyProperty struct {
	...
	// Experimental.
	PerRetryTimeout *TfRoute_SpecHttp2RouteRetryPolicyPerRetryTimeoutProperty `field:"required" json:"perRetryTimeout" yaml:"perRetryTimeout"`
