...
// Experimental.
type AwsAppmeshRoute_SpecGrpcRouteRetryPolicyProperty struct {
	...
	// Experimental.
	PerRetryTimeout *AwsAppmeshRoute_SpecGrpcRouteRetryPolicyPerRetryTimeoutProperty `field:"required" json:"perRetryTimeout" yaml:"perRetryTimeout"`
