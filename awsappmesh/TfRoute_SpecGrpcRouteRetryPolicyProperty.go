...
// Experimental.
type TfRoute_SpecGrpcRouteRetryPolicyProperty struct {
	...
	// Experimental.
	PerRetryTimeout *TfRoute_SpecGrpcRouteRetryPolicyPerRetryTimeoutProperty `field:"required" json:"perRetryTimeout" yaml:"perRetryTimeout"`
