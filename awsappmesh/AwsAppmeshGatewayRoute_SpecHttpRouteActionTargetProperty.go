...
// Experimental.
type AwsAppmeshGatewayRoute_SpecHttpRouteActionTargetProperty struct {
	...
	// Experimental.
	VirtualService *AwsAppmeshGatewayRoute_SpecHttpRouteActionTargetVirtualServiceProperty `field:"required" json:"virtualService" yaml:"virtualService"`
