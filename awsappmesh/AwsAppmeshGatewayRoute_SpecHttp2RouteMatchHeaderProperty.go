...
// Experimental.
type AwsAppmeshGatewayRoute_SpecHttp2RouteMatchHeaderProperty struct {
	...
	// Experimental.
	Match *AwsAppmeshGatewayRoute_SpecHttp2RouteMatchHeaderMatchProperty `field:"optional" json:"match" yaml:"match"`
}
