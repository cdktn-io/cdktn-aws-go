...
// Experimental.
type TfGatewayRoute_SpecHttpRouteMatchHeaderMatchProperty struct {
	...
	// Experimental.
	Range *TfGatewayRoute_SpecHttpRouteMatchHeaderMatchRangeProperty `field:"optional" json:"range" yaml:"range"`
