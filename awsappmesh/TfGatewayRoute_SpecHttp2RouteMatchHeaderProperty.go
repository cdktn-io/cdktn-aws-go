...
// Experimental.
type TfGatewayRoute_SpecHttp2RouteMatchHeaderProperty struct {
	...
	// Experimental.
	Match *TfGatewayRoute_SpecHttp2RouteMatchHeaderMatchProperty `field:"optional" json:"match" yaml:"match"`
}
