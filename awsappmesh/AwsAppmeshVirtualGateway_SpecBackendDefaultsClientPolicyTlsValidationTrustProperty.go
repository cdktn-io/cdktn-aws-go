...
// Experimental.
type AwsAppmeshVirtualGateway_SpecBackendDefaultsClientPolicyTlsValidationTrustProperty struct {
	// acm block.
	//
	...
	// Experimental.
	Acm *AwsAppmeshVirtualGateway_SpecBackendDefaultsClientPolicyTlsValidationTrustAcmProperty `field:"optional" json:"acm" yaml:"acm"`
	// file block.
	//
	...
	// Experimental.
	File *AwsAppmeshVirtualGateway_SpecBackendDefaultsClientPolicyTlsValidationTrustFileProperty `field:"optional" json:"file" yaml:"file"`
	// sds block.
	//
	...
	// Experimental.
	Sds *AwsAppmeshVirtualGateway_SpecBackendDefaultsClientPolicyTlsValidationTrustSdsProperty `field:"optional" json:"sds" yaml:"sds"`
}
