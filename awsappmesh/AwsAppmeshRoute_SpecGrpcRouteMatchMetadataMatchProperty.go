...
// Experimental.
type AwsAppmeshRoute_SpecGrpcRouteMatchMetadataMatchProperty struct {
	...
	// Experimental.
	Range *AwsAppmeshRoute_SpecGrpcRouteMatchMetadataMatchRangeProperty `field:"optional" json:"range" yaml:"range"`
