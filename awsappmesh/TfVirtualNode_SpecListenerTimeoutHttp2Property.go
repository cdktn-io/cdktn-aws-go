...
// Experimental.
type TfVirtualNode_SpecListenerTimeoutHttp2Property struct {
	// idle block.
	//
	...
	// Experimental.
	Idle *TfVirtualNode_SpecListenerTimeoutHttp2IdleProperty `field:"optional" json:"idle" yaml:"idle"`
	// per_request block.
	//
	...
	// Experimental.
	PerRequest *TfVirtualNode_SpecListenerTimeoutHttp2PerRequestProperty `field:"optional" json:"perRequest" yaml:"perRequest"`
}
