...
// Experimental.
type AwsAppmeshVirtualNode_SpecBackendDefaultsClientPolicyTlsProperty struct {
	// validation block.
	//
	...
	// Experimental.
	Validation *AwsAppmeshVirtualNode_SpecBackendDefaultsClientPolicyTlsValidationProperty `field:"required" json:"validation" yaml:"validation"`
	// certificate block.
	//
	...
	// Experimental.
	Certificate *AwsAppmeshVirtualNode_SpecBackendDefaultsClientPolicyTlsCertificateProperty `field:"optional" json:"certificate" yaml:"certificate"`
