...
// Experimental.
type TfRoute_SpecHttpRouteMatchHeaderMatchProperty struct {
	...
	// Experimental.
	Range *TfRoute_SpecHttpRouteMatchHeaderMatchRangeProperty `field:"optional" json:"range" yaml:"range"`
