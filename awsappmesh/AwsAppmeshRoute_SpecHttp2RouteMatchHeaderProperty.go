...
// Experimental.
type AwsAppmeshRoute_SpecHttp2RouteMatchHeaderProperty struct {
	...
	// Experimental.
	Match *AwsAppmeshRoute_SpecHttp2RouteMatchHeaderMatchProperty `field:"optional" json:"match" yaml:"match"`
}
