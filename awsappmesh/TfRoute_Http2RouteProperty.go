...
// Experimental.
type TfRoute_Http2RouteProperty struct {
	// action block.
	//
	...
	// Experimental.
	Action *TfRoute_SpecHttp2RouteActionProperty `field:"required" json:"action" yaml:"action"`
	// match block.
	//
	...
	// Experimental.
	Match *TfRoute_SpecHttp2RouteMatchProperty `field:"required" json:"match" yaml:"match"`
	// retry_policy block.
	//
	...
	// Experimental.
	RetryPolicy *TfRoute_SpecHttp2RouteRetryPolicyProperty `field:"optional" json:"retryPolicy" yaml:"retryPolicy"`
	// timeout block.
	//
	...
	// Experimental.
	Timeout *TfRoute_SpecHttp2RouteTimeoutProperty `field:"optional" json:"timeout" yaml:"timeout"`
}
