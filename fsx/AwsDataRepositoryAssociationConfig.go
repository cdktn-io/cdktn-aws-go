...
// Experimental.
type AwsDataRepositoryAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	S3 *AwsDataRepositoryAssociation_S3Property `field:"optional" json:"s3" yaml:"s3"`
	...
	// Experimental.
	Timeouts *AwsDataRepositoryAssociation_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
