...
// Experimental.
type AwsOntapStorageVirtualMachineConfig struct {
	// Experimental.
	...
	// Experimental.
	ActiveDirectoryConfiguration *AwsOntapStorageVirtualMachine_ActiveDirectoryConfigurationProperty `field:"optional" json:"activeDirectoryConfiguration" yaml:"activeDirectoryConfiguration"`
	...
	// Experimental.
	Timeouts *AwsOntapStorageVirtualMachine_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
