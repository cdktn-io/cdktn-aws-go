...
// Experimental.
type AwsOpenzfsFileSystemConfig struct {
	// Experimental.
	...
	// Experimental.
	DiskIopsConfiguration *AwsOpenzfsFileSystem_DiskIopsConfigurationProperty `field:"optional" json:"diskIopsConfiguration" yaml:"diskIopsConfiguration"`
	...
	// Experimental.
	ReadCacheConfiguration *AwsOpenzfsFileSystem_ReadCacheConfigurationProperty `field:"optional" json:"readCacheConfiguration" yaml:"readCacheConfiguration"`
	...
	// Experimental.
	RootVolumeConfiguration *AwsOpenzfsFileSystem_RootVolumeConfigurationProperty `field:"optional" json:"rootVolumeConfiguration" yaml:"rootVolumeConfiguration"`
	...
	// Experimental.
	Timeouts *AwsOpenzfsFileSystem_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
