...
type DataAwsEc2TransitGatewayConnectPeer interface {
	...
	// Experimental.
	Filter() DataAwsEc2TransitGatewayConnectPeer_FilterPropertyList
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsEc2TransitGatewayConnectPeer_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsEc2TransitGatewayConnectPeer_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayConnectPeer) Filter() DataAwsEc2TransitGatewayConnectPeer_FilterPropertyList {
	var returns DataAwsEc2TransitGatewayConnectPeer_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayConnectPeer) Timeouts() DataAwsEc2TransitGatewayConnectPeer_TimeoutsPropertyOutputReference {
	var returns DataAwsEc2TransitGatewayConnectPeer_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (d *jsiiProxy_DataAwsEc2TransitGatewayConnectPeer) PutTimeouts(value *DataAwsEc2TransitGatewayConnectPeer_TimeoutsProperty) {
