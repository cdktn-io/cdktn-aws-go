...
type DataAwsEc2TransitGatewayDxGatewayAttachment interface {
	...
	// Experimental.
	Filter() DataAwsEc2TransitGatewayDxGatewayAttachment_FilterPropertyList
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsEc2TransitGatewayDxGatewayAttachment_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsEc2TransitGatewayDxGatewayAttachment_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayDxGatewayAttachment) Filter() DataAwsEc2TransitGatewayDxGatewayAttachment_FilterPropertyList {
	var returns DataAwsEc2TransitGatewayDxGatewayAttachment_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayDxGatewayAttachment) Timeouts() DataAwsEc2TransitGatewayDxGatewayAttachment_TimeoutsPropertyOutputReference {
	var returns DataAwsEc2TransitGatewayDxGatewayAttachment_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (d *jsiiProxy_DataAwsEc2TransitGatewayDxGatewayAttachment) PutTimeouts(value *DataAwsEc2TransitGatewayDxGatewayAttachment_TimeoutsProperty) {
