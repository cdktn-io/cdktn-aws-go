...
// Experimental.
type AwsEc2TransitGatewayMulticastDomainConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsEc2TransitGatewayMulticastDomain_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
