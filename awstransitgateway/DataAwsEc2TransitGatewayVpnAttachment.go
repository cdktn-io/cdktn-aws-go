...
type DataAwsEc2TransitGatewayVpnAttachment interface {
	...
	// Experimental.
	Filter() DataAwsEc2TransitGatewayVpnAttachment_FilterPropertyList
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsEc2TransitGatewayVpnAttachment_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsEc2TransitGatewayVpnAttachment_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayVpnAttachment) Filter() DataAwsEc2TransitGatewayVpnAttachment_FilterPropertyList {
	var returns DataAwsEc2TransitGatewayVpnAttachment_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayVpnAttachment) Timeouts() DataAwsEc2TransitGatewayVpnAttachment_TimeoutsPropertyOutputReference {
	var returns DataAwsEc2TransitGatewayVpnAttachment_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (d *jsiiProxy_DataAwsEc2TransitGatewayVpnAttachment) PutTimeouts(value *DataAwsEc2TransitGatewayVpnAttachment_TimeoutsProperty) {
