...
// Experimental.
type AwsJobDefinition_InitContainersProperty struct {
	...
	// Experimental.
	Resources *AwsJobDefinition_EksPropertiesPodPropertiesInitContainersResourcesProperty `field:"optional" json:"resources" yaml:"resources"`
	...
	// Experimental.
	SecurityContext *AwsJobDefinition_EksPropertiesPodPropertiesInitContainersSecurityContextProperty `field:"optional" json:"securityContext" yaml:"securityContext"`
	// volume_mounts block.
	//
