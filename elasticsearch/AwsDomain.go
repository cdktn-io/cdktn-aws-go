...
func (j *jsiiProxy_AwsDomain) ElasticsearchVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsDomain) ElasticsearchVersionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsDomain) KibanaEndpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kibanaEndpoint",
...
func NewAwsDomain(scope constructs.Construct, id *string, config *AwsDomainConfig) AwsDomain {
	...
	_jsii_.Create(
		"@cdktn/aws-elasticsearch.AwsDomain",
...
func (j *jsiiProxy_AwsDomain)SetElasticsearchVersion(val *string) {
...
func (a *jsiiProxy_AwsDomain) ResetElasticsearchVersion() {
	_jsii_.InvokeVoid(
		a,
		"resetElasticsearchVersion",
		nil, // no parameters
