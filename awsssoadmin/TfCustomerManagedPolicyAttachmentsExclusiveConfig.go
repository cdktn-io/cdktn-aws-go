...
// Experimental.
type TfCustomerManagedPolicyAttachmentsExclusiveConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *TfCustomerManagedPolicyAttachmentsExclusive_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
