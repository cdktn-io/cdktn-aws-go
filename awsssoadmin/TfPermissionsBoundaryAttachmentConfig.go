...
// Experimental.
type TfPermissionsBoundaryAttachmentConfig struct {
	// Experimental.
	...
	// Experimental.
	PermissionsBoundary *TfPermissionsBoundaryAttachment_PermissionsBoundaryProperty `field:"required" json:"permissionsBoundary" yaml:"permissionsBoundary"`
	...
	// Experimental.
	Timeouts *TfPermissionsBoundaryAttachment_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
