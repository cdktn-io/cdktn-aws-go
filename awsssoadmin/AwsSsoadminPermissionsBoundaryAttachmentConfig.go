...
// Experimental.
type AwsSsoadminPermissionsBoundaryAttachmentConfig struct {
	// Experimental.
	...
	// Experimental.
	PermissionsBoundary *AwsSsoadminPermissionsBoundaryAttachment_PermissionsBoundaryProperty `field:"required" json:"permissionsBoundary" yaml:"permissionsBoundary"`
	...
	// Experimental.
	Timeouts *AwsSsoadminPermissionsBoundaryAttachment_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
