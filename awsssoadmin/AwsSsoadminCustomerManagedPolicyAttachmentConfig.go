...
// Experimental.
type AwsSsoadminCustomerManagedPolicyAttachmentConfig struct {
	// Experimental.
	...
	// Experimental.
	CustomerManagedPolicyReference *AwsSsoadminCustomerManagedPolicyAttachment_CustomerManagedPolicyReferenceProperty `field:"required" json:"customerManagedPolicyReference" yaml:"customerManagedPolicyReference"`
	...
	// Experimental.
	Timeouts *AwsSsoadminCustomerManagedPolicyAttachment_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
