...
type DataAwsSsoadminPrincipalApplicationAssignments interface {
	...
	// Experimental.
	ApplicationAssignments() DataAwsSsoadminPrincipalApplicationAssignments_ApplicationAssignmentsPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsSsoadminPrincipalApplicationAssignments) ApplicationAssignments() DataAwsSsoadminPrincipalApplicationAssignments_ApplicationAssignmentsPropertyList {
	var returns DataAwsSsoadminPrincipalApplicationAssignments_ApplicationAssignmentsPropertyList
	_jsii_.Get(
		j,
