...
func (t *jsiiProxy_TfApplication) validatePutPortalOptionsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*TfApplication_PortalOptionsProperty:
		value := value.(*[]*TfApplication_PortalOptionsProperty)
	...
	case []*TfApplication_PortalOptionsProperty:
		value_ := value.([]*TfApplication_PortalOptionsProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*TfApplication_PortalOptionsProperty; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_TfApplication) validateSetApplicationProviderArnParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_TfApplication) validateSetClientTokenParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_TfApplication) validateSetInstanceArnParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_TfApplication) validateSetStatusParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
