...
// Experimental.
type AwsSnapshotCreateVolumePermissionConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsSnapshotCreateVolumePermission_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
