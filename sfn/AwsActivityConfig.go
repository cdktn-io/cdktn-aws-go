...
type AwsActivityConfig struct {
	...
	// Experimental.
	EncryptionConfiguration *AwsActivity_EncryptionConfigurationProperty `field:"optional" json:"encryptionConfiguration" yaml:"encryptionConfiguration"`
