...
// Experimental.
type AwsVerifiedaccessTrustProviderConfig struct {
	// Experimental.
	...
	// Experimental.
	DeviceOptions *AwsVerifiedaccessTrustProvider_DeviceOptionsProperty `field:"optional" json:"deviceOptions" yaml:"deviceOptions"`
	...
	// Experimental.
	NativeApplicationOidcOptions *AwsVerifiedaccessTrustProvider_NativeApplicationOidcOptionsProperty `field:"optional" json:"nativeApplicationOidcOptions" yaml:"nativeApplicationOidcOptions"`
	// oidc_options block.
	//
	...
	// Experimental.
	OidcOptions *AwsVerifiedaccessTrustProvider_OidcOptionsProperty `field:"optional" json:"oidcOptions" yaml:"oidcOptions"`
	...
	// Experimental.
	SseSpecification *AwsVerifiedaccessTrustProvider_SseSpecificationProperty `field:"optional" json:"sseSpecification" yaml:"sseSpecification"`
	...
	// Experimental.
	Timeouts *AwsVerifiedaccessTrustProvider_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
