...
// Experimental.
type AwsVerifiedaccessGroupConfig struct {
	// Experimental.
	...
	// Experimental.
	SseConfiguration *AwsVerifiedaccessGroup_SseConfigurationProperty `field:"optional" json:"sseConfiguration" yaml:"sseConfiguration"`
