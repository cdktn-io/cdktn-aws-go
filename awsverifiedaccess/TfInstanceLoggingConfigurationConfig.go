...
// Experimental.
type TfInstanceLoggingConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	AccessLogs *TfInstanceLoggingConfiguration_AccessLogsProperty `field:"required" json:"accessLogs" yaml:"accessLogs"`
