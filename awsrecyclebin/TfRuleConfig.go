...
type TfRuleConfig struct {
	...
	// Experimental.
	RetentionPeriod *TfRule_RetentionPeriodProperty `field:"required" json:"retentionPeriod" yaml:"retentionPeriod"`
	...
	// Experimental.
	LockConfiguration *TfRule_LockConfigurationProperty `field:"optional" json:"lockConfiguration" yaml:"lockConfiguration"`
	...
	// Experimental.
	Timeouts *TfRule_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
