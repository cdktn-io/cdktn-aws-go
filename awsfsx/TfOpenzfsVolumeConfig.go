...
// Experimental.
type TfOpenzfsVolumeConfig struct {
	// Experimental.
	...
	// Experimental.
	NfsExports *TfOpenzfsVolume_NfsExportsProperty `field:"optional" json:"nfsExports" yaml:"nfsExports"`
	...
	// Experimental.
	OriginSnapshot *TfOpenzfsVolume_OriginSnapshotProperty `field:"optional" json:"originSnapshot" yaml:"originSnapshot"`
	...
	// Experimental.
	Timeouts *TfOpenzfsVolume_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
