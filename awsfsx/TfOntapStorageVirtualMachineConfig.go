...
// Experimental.
type TfOntapStorageVirtualMachineConfig struct {
	// Experimental.
	...
	// Experimental.
	ActiveDirectoryConfiguration *TfOntapStorageVirtualMachine_ActiveDirectoryConfigurationProperty `field:"optional" json:"activeDirectoryConfiguration" yaml:"activeDirectoryConfiguration"`
	...
	// Experimental.
	Timeouts *TfOntapStorageVirtualMachine_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
