...
// Experimental.
type AwsFsxOntapFileSystemConfig struct {
	// Experimental.
	...
	// Experimental.
	DiskIopsConfiguration *AwsFsxOntapFileSystem_DiskIopsConfigurationProperty `field:"optional" json:"diskIopsConfiguration" yaml:"diskIopsConfiguration"`
	...
	// Experimental.
	Timeouts *AwsFsxOntapFileSystem_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
