...
// Experimental.
type AwsFsxDataRepositoryAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	S3 *AwsFsxDataRepositoryAssociation_S3Property `field:"optional" json:"s3" yaml:"s3"`
	...
	// Experimental.
	Timeouts *AwsFsxDataRepositoryAssociation_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
