...
// Experimental.
type AwsFsxOntapVolume_RetentionPeriodProperty struct {
	...
	// Experimental.
	DefaultRetention *AwsFsxOntapVolume_DefaultRetentionProperty `field:"optional" json:"defaultRetention" yaml:"defaultRetention"`
	...
	// Experimental.
	MaximumRetention *AwsFsxOntapVolume_MaximumRetentionProperty `field:"optional" json:"maximumRetention" yaml:"maximumRetention"`
	...
	// Experimental.
	MinimumRetention *AwsFsxOntapVolume_MinimumRetentionProperty `field:"optional" json:"minimumRetention" yaml:"minimumRetention"`
}
