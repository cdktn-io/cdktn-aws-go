...
// Experimental.
type TfOntapFileSystemConfig struct {
	// Experimental.
	...
	// Experimental.
	DiskIopsConfiguration *TfOntapFileSystem_DiskIopsConfigurationProperty `field:"optional" json:"diskIopsConfiguration" yaml:"diskIopsConfiguration"`
	...
	// Experimental.
	Timeouts *TfOntapFileSystem_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
