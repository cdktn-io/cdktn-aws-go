...
// Experimental.
type TfDataRepositoryAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	S3 *TfDataRepositoryAssociation_S3Property `field:"optional" json:"s3" yaml:"s3"`
	...
	// Experimental.
	Timeouts *TfDataRepositoryAssociation_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
