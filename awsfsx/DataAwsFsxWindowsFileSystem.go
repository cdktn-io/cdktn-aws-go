...
type DataAwsFsxWindowsFileSystem interface {
	...
	Arn() *string
	// Experimental.
	AuditLogConfiguration() DataAwsFsxWindowsFileSystem_AuditLogConfigurationPropertyList
	// Experimental.
	...
	// Experimental.
	DiskIopsConfiguration() DataAwsFsxWindowsFileSystem_DiskIopsConfigurationPropertyList
	// Experimental.
	DnsName() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsFsxWindowsFileSystem) AuditLogConfiguration() DataAwsFsxWindowsFileSystem_AuditLogConfigurationPropertyList {
	var returns DataAwsFsxWindowsFileSystem_AuditLogConfigurationPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsFsxWindowsFileSystem) DiskIopsConfiguration() DataAwsFsxWindowsFileSystem_DiskIopsConfigurationPropertyList {
	var returns DataAwsFsxWindowsFileSystem_DiskIopsConfigurationPropertyList
	_jsii_.Get(
		j,
