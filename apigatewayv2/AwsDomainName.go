...
type AwsDomainName interface {
	...
	// Experimental.
	DomainNameConfiguration() AwsDomainName_DomainNameConfigurationPropertyOutputReference
	// Experimental.
	DomainNameConfigurationInput() *AwsDomainName_DomainNameConfigurationProperty
	// Experimental.
	...
	// Experimental.
	PutDomainNameConfiguration(value *AwsDomainName_DomainNameConfigurationProperty)
	// Experimental.
...
func (j *jsiiProxy_AwsDomainName) ApiMappingSelectionExpression() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsDomainName) DomainNameConfiguration() AwsDomainName_DomainNameConfigurationPropertyOutputReference {
	var returns AwsDomainName_DomainNameConfigurationPropertyOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsDomainName) DomainNameConfigurationInput() *AwsDomainName_DomainNameConfigurationProperty {
...
func (a *jsiiProxy_AwsDomainName) PutDomainNameConfiguration(value *AwsDomainName_DomainNameConfigurationProperty) {
