...
// Experimental.
type AwsAuthorizerConfig struct {
	// Experimental.
	...
	// Experimental.
	JwtConfiguration *AwsAuthorizer_JwtConfigurationProperty `field:"optional" json:"jwtConfiguration" yaml:"jwtConfiguration"`
	...
	// Experimental.
	Timeouts *AwsAuthorizer_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
