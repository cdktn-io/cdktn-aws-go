...
// Experimental.
type AwsTrustProviderConfig struct {
	// Experimental.
	...
	// Experimental.
	DeviceOptions *AwsTrustProvider_DeviceOptionsProperty `field:"optional" json:"deviceOptions" yaml:"deviceOptions"`
	...
	// Experimental.
	NativeApplicationOidcOptions *AwsTrustProvider_NativeApplicationOidcOptionsProperty `field:"optional" json:"nativeApplicationOidcOptions" yaml:"nativeApplicationOidcOptions"`
	// oidc_options block.
	//
	...
	// Experimental.
	OidcOptions *AwsTrustProvider_OidcOptionsProperty `field:"optional" json:"oidcOptions" yaml:"oidcOptions"`
	...
	// Experimental.
	SseSpecification *AwsTrustProvider_SseSpecificationProperty `field:"optional" json:"sseSpecification" yaml:"sseSpecification"`
	...
	// Experimental.
	Timeouts *AwsTrustProvider_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
