...
// Experimental.
type AwsInstanceLoggingConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	AccessLogs *AwsInstanceLoggingConfiguration_AccessLogsProperty `field:"required" json:"accessLogs" yaml:"accessLogs"`
