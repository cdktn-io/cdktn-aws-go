...
func (j *jsiiProxy_AwsFunction) Comment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"comment",
...
func (j *jsiiProxy_AwsFunction) CommentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"commentInput",
...
func (j *jsiiProxy_AwsFunction) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_AwsFunction) KeyValueStoreAssociations() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsFunction) KeyValueStoreAssociationsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsFunction) LiveStageEtag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"liveStageEtag",
...
func (j *jsiiProxy_AwsFunction) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func NewAwsFunction(scope constructs.Construct, id *string, config *AwsFunctionConfig) AwsFunction {
	...
	_jsii_.Create(
		"@cdktn/aws-cloudfront.AwsFunction",
...
func (j *jsiiProxy_AwsFunction)SetComment(val *string) {
...
func (j *jsiiProxy_AwsFunction)SetKeyValueStoreAssociations(val *[]*string) {
...
func (a *jsiiProxy_AwsFunction) ResetComment() {
	_jsii_.InvokeVoid(
		a,
		"resetComment",
		nil, // no parameters
...
func (a *jsiiProxy_AwsFunction) ResetKeyValueStoreAssociations() {
	_jsii_.InvokeVoid(
		a,
		"resetKeyValueStoreAssociations",
		nil, // no parameters
