...
// Experimental.
type AwsDistribution_OrderedCacheBehaviorProperty struct {
	...
	// Experimental.
	ForwardedValues *AwsDistribution_OrderedCacheBehaviorForwardedValuesProperty `field:"optional" json:"forwardedValues" yaml:"forwardedValues"`
	...
	// Experimental.
	GrpcConfig *AwsDistribution_OrderedCacheBehaviorGrpcConfigProperty `field:"optional" json:"grpcConfig" yaml:"grpcConfig"`
