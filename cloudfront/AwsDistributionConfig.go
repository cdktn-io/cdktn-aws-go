...
type AwsDistributionConfig struct {
	...
	// Experimental.
	Restrictions *AwsDistribution_RestrictionsProperty `field:"required" json:"restrictions" yaml:"restrictions"`
	...
	// Experimental.
	ViewerCertificate *AwsDistribution_ViewerCertificateProperty `field:"required" json:"viewerCertificate" yaml:"viewerCertificate"`
	...
	// Experimental.
	CacheTagConfig *AwsDistribution_CacheTagConfigProperty `field:"optional" json:"cacheTagConfig" yaml:"cacheTagConfig"`
	...
	// Experimental.
	ConnectionFunctionAssociation *AwsDistribution_ConnectionFunctionAssociationProperty `field:"optional" json:"connectionFunctionAssociation" yaml:"connectionFunctionAssociation"`
	...
	// Experimental.
	LoggingConfig *AwsDistribution_LoggingConfigProperty `field:"optional" json:"loggingConfig" yaml:"loggingConfig"`
	...
	// Experimental.
	ViewerMtlsConfig *AwsDistribution_ViewerMtlsConfigProperty `field:"optional" json:"viewerMtlsConfig" yaml:"viewerMtlsConfig"`
