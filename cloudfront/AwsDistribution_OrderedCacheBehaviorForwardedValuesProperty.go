...
// Experimental.
type AwsDistribution_OrderedCacheBehaviorForwardedValuesProperty struct {
	// cookies block.
	//
	...
	// Experimental.
	Cookies *AwsDistribution_OrderedCacheBehaviorForwardedValuesCookiesProperty `field:"required" json:"cookies" yaml:"cookies"`
