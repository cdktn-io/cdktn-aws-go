...
// Experimental.
type AwsDistribution_RestrictionsProperty struct {
	...
	// Experimental.
	GeoRestriction *AwsDistribution_GeoRestrictionProperty `field:"required" json:"geoRestriction" yaml:"geoRestriction"`
}
