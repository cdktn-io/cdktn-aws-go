...
// Experimental.
type AwsMonitoringSubscriptionConfig struct {
	// Experimental.
	...
	// Experimental.
	MonitoringSubscription *AwsMonitoringSubscription_MonitoringSubscriptionProperty `field:"required" json:"monitoringSubscription" yaml:"monitoringSubscription"`
