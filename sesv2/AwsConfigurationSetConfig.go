...
// Experimental.
type AwsConfigurationSetConfig struct {
	// Experimental.
	...
	// Experimental.
	DeliveryOptions *AwsConfigurationSet_DeliveryOptionsProperty `field:"optional" json:"deliveryOptions" yaml:"deliveryOptions"`
	...
	// Experimental.
	ReputationOptions *AwsConfigurationSet_ReputationOptionsProperty `field:"optional" json:"reputationOptions" yaml:"reputationOptions"`
	...
	// Experimental.
	SendingOptions *AwsConfigurationSet_SendingOptionsProperty `field:"optional" json:"sendingOptions" yaml:"sendingOptions"`
	...
	// Experimental.
	SuppressionOptions *AwsConfigurationSet_SuppressionOptionsProperty `field:"optional" json:"suppressionOptions" yaml:"suppressionOptions"`
	...
	// Experimental.
	TrackingOptions *AwsConfigurationSet_TrackingOptionsProperty `field:"optional" json:"trackingOptions" yaml:"trackingOptions"`
	// vdm_options block.
	//
	...
	// Experimental.
	VdmOptions *AwsConfigurationSet_VdmOptionsProperty `field:"optional" json:"vdmOptions" yaml:"vdmOptions"`
}
