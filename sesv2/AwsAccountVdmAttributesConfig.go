...
// Experimental.
type AwsAccountVdmAttributesConfig struct {
	// Experimental.
	...
	// Experimental.
	DashboardAttributes *AwsAccountVdmAttributes_DashboardAttributesProperty `field:"optional" json:"dashboardAttributes" yaml:"dashboardAttributes"`
	...
	// Experimental.
	GuardianAttributes *AwsAccountVdmAttributes_GuardianAttributesProperty `field:"optional" json:"guardianAttributes" yaml:"guardianAttributes"`
