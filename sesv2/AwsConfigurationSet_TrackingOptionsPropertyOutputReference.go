...
func (j *jsiiProxy_AwsConfigurationSet_TrackingOptionsPropertyOutputReference) HttpsPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"httpsPolicy",
...
func (j *jsiiProxy_AwsConfigurationSet_TrackingOptionsPropertyOutputReference) HttpsPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"httpsPolicyInput",
...
func (j *jsiiProxy_AwsConfigurationSet_TrackingOptionsPropertyOutputReference)SetHttpsPolicy(val *string) {
...
func (a *jsiiProxy_AwsConfigurationSet_TrackingOptionsPropertyOutputReference) ResetHttpsPolicy() {
	_jsii_.InvokeVoid(
		a,
		"resetHttpsPolicy",
		nil, // no parameters
