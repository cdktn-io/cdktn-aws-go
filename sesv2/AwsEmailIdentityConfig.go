...
// Experimental.
type AwsEmailIdentityConfig struct {
	// Experimental.
	...
	// Experimental.
	DkimSigningAttributes *AwsEmailIdentity_DkimSigningAttributesProperty `field:"optional" json:"dkimSigningAttributes" yaml:"dkimSigningAttributes"`
