...
// Experimental.
type TfDbProxyDefaultTargetGroupConfig struct {
	// Experimental.
	...
	// Experimental.
	ConnectionPoolConfig *TfDbProxyDefaultTargetGroup_ConnectionPoolConfigProperty `field:"optional" json:"connectionPoolConfig" yaml:"connectionPoolConfig"`
	...
	// Experimental.
	Timeouts *TfDbProxyDefaultTargetGroup_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
