...
// Experimental.
type TfDbInstanceAutomatedBackupsReplicationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *TfDbInstanceAutomatedBackupsReplication_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
