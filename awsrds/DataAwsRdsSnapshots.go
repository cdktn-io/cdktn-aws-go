...
type DataAwsRdsSnapshots interface {
	...
	// Experimental.
	Filter() DataAwsRdsSnapshots_FilterPropertyList
	// Experimental.
	...
	RegionInput() *string
	// Experimental.
	Snapshots() DataAwsRdsSnapshots_SnapshotsPropertyList
	// Experimental.
	SnapshotType() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsRdsSnapshots) Filter() DataAwsRdsSnapshots_FilterPropertyList {
	var returns DataAwsRdsSnapshots_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsRdsSnapshots) Snapshots() DataAwsRdsSnapshots_SnapshotsPropertyList {
	var returns DataAwsRdsSnapshots_SnapshotsPropertyList
	_jsii_.Get(
		j,
		"snapshots",
		&returns,
...
func NewDataAwsRdsSnapshots(scope constructs.Construct, id *string, config *DataAwsRdsSnapshotsConfig) DataAwsRdsSnapshots {
	...
	_jsii_.Create(
		"@cdktn/aws-rds.DataAwsRdsSnapshots",
