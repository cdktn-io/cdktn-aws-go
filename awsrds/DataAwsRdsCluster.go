...
type DataAwsRdsCluster interface {
	...
	// Experimental.
	MasterUserSecret() DataAwsRdsCluster_MasterUserSecretPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsRdsCluster) MasterUserSecret() DataAwsRdsCluster_MasterUserSecretPropertyList {
	var returns DataAwsRdsCluster_MasterUserSecretPropertyList
	_jsii_.Get(
		j,
		"masterUserSecret",
		&returns,
...
func NewDataAwsRdsCluster(scope constructs.Construct, id *string, config *DataAwsRdsClusterConfig) DataAwsRdsCluster {
	...
	_jsii_.Create(
		"@cdktn/aws-rds.DataAwsRdsCluster",
