...
type DataAwsRdsEngineVersion interface {
	...
	// Experimental.
	Filter() DataAwsRdsEngineVersion_FilterPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsRdsEngineVersion) Filter() DataAwsRdsEngineVersion_FilterPropertyList {
	var returns DataAwsRdsEngineVersion_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func NewDataAwsRdsEngineVersion(scope constructs.Construct, id *string, config *DataAwsRdsEngineVersionConfig) DataAwsRdsEngineVersion {
	...
	_jsii_.Create(
		"@cdktn/aws-rds.DataAwsRdsEngineVersion",
