...
type DataAwsDbInstance interface {
	...
	// Experimental.
	MasterUserSecret() DataAwsDbInstance_MasterUserSecretPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsDbInstance) MasterUserSecret() DataAwsDbInstance_MasterUserSecretPropertyList {
	var returns DataAwsDbInstance_MasterUserSecretPropertyList
	_jsii_.Get(
		j,
		"masterUserSecret",
		&returns,
