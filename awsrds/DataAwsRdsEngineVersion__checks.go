...
func (d *jsiiProxy_DataAwsRdsEngineVersion) validatePutFilterParameters(value interface{}) error {
	...
	case *[]*DataAwsRdsEngineVersion_FilterProperty:
		value := value.(*[]*DataAwsRdsEngineVersion_FilterProperty)
	...
	case []*DataAwsRdsEngineVersion_FilterProperty:
		value_ := value.([]*DataAwsRdsEngineVersion_FilterProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DataAwsRdsEngineVersion_FilterProperty; received %#v (a %T)", value, value)
		}
	}
