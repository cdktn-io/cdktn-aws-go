...
type DataAwsSavingsplansOfferings interface {
	...
	// Experimental.
	Filter() DataAwsSavingsplansOfferings_FilterPropertyList
	// Experimental.
	...
	// Experimental.
	Offerings() DataAwsSavingsplansOfferings_OfferingsPropertyList
	// Experimental.
	Operations() *[]*string
	// Experimental.
...
func (j *jsiiProxy_DataAwsSavingsplansOfferings) Filter() DataAwsSavingsplansOfferings_FilterPropertyList {
	var returns DataAwsSavingsplansOfferings_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsSavingsplansOfferings) Offerings() DataAwsSavingsplansOfferings_OfferingsPropertyList {
	var returns DataAwsSavingsplansOfferings_OfferingsPropertyList
	_jsii_.Get(
		j,
		"offerings",
		&returns,
...
func NewDataAwsSavingsplansOfferings(scope constructs.Construct, id *string, config *DataAwsSavingsplansOfferingsConfig) DataAwsSavingsplansOfferings {
	...
	_jsii_.Create(
		"@cdktn/aws-savings-plans.DataAwsSavingsplansOfferings",
