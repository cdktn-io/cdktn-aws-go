...
// Experimental.
type AwsCodedeployDeploymentConfigConfig struct {
	// Experimental.
	...
	// Experimental.
	MinimumHealthyHosts *AwsCodedeployDeploymentConfig_MinimumHealthyHostsProperty `field:"optional" json:"minimumHealthyHosts" yaml:"minimumHealthyHosts"`
	...
	// Experimental.
	TrafficRoutingConfig *AwsCodedeployDeploymentConfig_TrafficRoutingConfigProperty `field:"optional" json:"trafficRoutingConfig" yaml:"trafficRoutingConfig"`
	// zonal_config block.
	//
	...
	// Experimental.
	ZonalConfig *AwsCodedeployDeploymentConfig_ZonalConfigProperty `field:"optional" json:"zonalConfig" yaml:"zonalConfig"`
}
