...
// Experimental.
type TfDeploymentGroup_LoadBalancerInfoProperty struct {
	// elb_info block.
	//
	...
	// Experimental.
	TargetGroupPairInfo *TfDeploymentGroup_TargetGroupPairInfoProperty `field:"optional" json:"targetGroupPairInfo" yaml:"targetGroupPairInfo"`
}
