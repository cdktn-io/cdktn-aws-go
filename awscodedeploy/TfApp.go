...
func (j *jsiiProxy_TfApp) ApplicationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationId",
...
func (j *jsiiProxy_TfApp) ComputePlatform() *string {
	var returns *string
	_jsii_.Get(
		j,
		"computePlatform",
...
func (j *jsiiProxy_TfApp) ComputePlatformInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TfApp) GithubAccountName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"githubAccountName",
...
func (j *jsiiProxy_TfApp) LinkedToGithub() cdktn.IResolvable {
...
func (j *jsiiProxy_TfApp)SetComputePlatform(val *string) {
...
func (t *jsiiProxy_TfApp) ResetComputePlatform() {
	_jsii_.InvokeVoid(
		t,
		"resetComputePlatform",
		nil, // no parameters
