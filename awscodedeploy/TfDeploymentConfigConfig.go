...
// Experimental.
type TfDeploymentConfigConfig struct {
	// Experimental.
	...
	// Experimental.
	MinimumHealthyHosts *TfDeploymentConfig_MinimumHealthyHostsProperty `field:"optional" json:"minimumHealthyHosts" yaml:"minimumHealthyHosts"`
	...
	// Experimental.
	TrafficRoutingConfig *TfDeploymentConfig_TrafficRoutingConfigProperty `field:"optional" json:"trafficRoutingConfig" yaml:"trafficRoutingConfig"`
	// zonal_config block.
	//
	...
	// Experimental.
	ZonalConfig *TfDeploymentConfig_ZonalConfigProperty `field:"optional" json:"zonalConfig" yaml:"zonalConfig"`
}
