...
// Experimental.
type AwsApplicationLayerAutomaticResponseConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsApplicationLayerAutomaticResponse_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
