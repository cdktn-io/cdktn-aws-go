...
func (t *jsiiProxy_TfCluster) validatePutMultiRegionPropertiesParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*TfCluster_MultiRegionPropertiesProperty:
		value := value.(*[]*TfCluster_MultiRegionPropertiesProperty)
	...
	case []*TfCluster_MultiRegionPropertiesProperty:
		value_ := value.([]*TfCluster_MultiRegionPropertiesProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*TfCluster_MultiRegionPropertiesProperty; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_TfCluster) validateSetDeletionProtectionEnabledParameters(val interface{}) error {
	if val == nil {
...
func (j *jsiiProxy_TfCluster) validateSetForceDestroyParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_TfCluster) validateSetKmsEncryptionKeyParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
