...
// Experimental.
type AwsGameliftFleetConfig struct {
	// Experimental.
	...
	// Experimental.
	CertificateConfiguration *AwsGameliftFleet_CertificateConfigurationProperty `field:"optional" json:"certificateConfiguration" yaml:"certificateConfiguration"`
	...
	// Experimental.
	ResourceCreationLimitPolicy *AwsGameliftFleet_ResourceCreationLimitPolicyProperty `field:"optional" json:"resourceCreationLimitPolicy" yaml:"resourceCreationLimitPolicy"`
	...
	// Experimental.
	RuntimeConfiguration *AwsGameliftFleet_RuntimeConfigurationProperty `field:"optional" json:"runtimeConfiguration" yaml:"runtimeConfiguration"`
	...
	// Experimental.
	Timeouts *AwsGameliftFleet_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
