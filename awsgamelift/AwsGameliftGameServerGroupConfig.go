...
// Experimental.
type AwsGameliftGameServerGroupConfig struct {
	// Experimental.
	...
	// Experimental.
	LaunchTemplate *AwsGameliftGameServerGroup_LaunchTemplateProperty `field:"required" json:"launchTemplate" yaml:"launchTemplate"`
	...
	// Experimental.
	AutoScalingPolicy *AwsGameliftGameServerGroup_AutoScalingPolicyProperty `field:"optional" json:"autoScalingPolicy" yaml:"autoScalingPolicy"`
	...
	// Experimental.
	Timeouts *AwsGameliftGameServerGroup_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
