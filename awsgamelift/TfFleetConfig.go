...
type TfFleetConfig struct {
	...
	// Experimental.
	CertificateConfiguration *TfFleet_CertificateConfigurationProperty `field:"optional" json:"certificateConfiguration" yaml:"certificateConfiguration"`
	...
	// Experimental.
	ResourceCreationLimitPolicy *TfFleet_ResourceCreationLimitPolicyProperty `field:"optional" json:"resourceCreationLimitPolicy" yaml:"resourceCreationLimitPolicy"`
	...
	// Experimental.
	RuntimeConfiguration *TfFleet_RuntimeConfigurationProperty `field:"optional" json:"runtimeConfiguration" yaml:"runtimeConfiguration"`
	...
	// Experimental.
	Timeouts *TfFleet_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
