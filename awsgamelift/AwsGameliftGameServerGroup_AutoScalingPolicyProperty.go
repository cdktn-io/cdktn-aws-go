...
// Experimental.
type AwsGameliftGameServerGroup_AutoScalingPolicyProperty struct {
	...
	// Experimental.
	TargetTrackingConfiguration *AwsGameliftGameServerGroup_TargetTrackingConfigurationProperty `field:"required" json:"targetTrackingConfiguration" yaml:"targetTrackingConfiguration"`
