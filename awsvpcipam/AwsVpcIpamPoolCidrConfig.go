...
// Experimental.
type AwsVpcIpamPoolCidrConfig struct {
	// Experimental.
	...
	// Experimental.
	CidrAuthorizationContext *AwsVpcIpamPoolCidr_CidrAuthorizationContextProperty `field:"optional" json:"cidrAuthorizationContext" yaml:"cidrAuthorizationContext"`
	...
	// Experimental.
	Timeouts *AwsVpcIpamPoolCidr_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
