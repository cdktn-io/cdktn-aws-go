...
type DataAwsVpcIpamPreviewNextCidr interface {
	...
	// Experimental.
	Timeouts() DataAwsVpcIpamPreviewNextCidr_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsVpcIpamPreviewNextCidr_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsVpcIpamPreviewNextCidr) Timeouts() DataAwsVpcIpamPreviewNextCidr_TimeoutsPropertyOutputReference {
	var returns DataAwsVpcIpamPreviewNextCidr_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (d *jsiiProxy_DataAwsVpcIpamPreviewNextCidr) PutTimeouts(value *DataAwsVpcIpamPreviewNextCidr_TimeoutsProperty) {
