...
type TfPoolCidrConfig struct {
	...
	// Experimental.
	CidrAuthorizationContext *TfPoolCidr_CidrAuthorizationContextProperty `field:"optional" json:"cidrAuthorizationContext" yaml:"cidrAuthorizationContext"`
	...
	// Experimental.
	Timeouts *TfPoolCidr_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
