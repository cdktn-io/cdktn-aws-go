...
type DataAwsVpcIpamPool interface {
	...
	Description() *string
	// Experimental.
	Filter() DataAwsVpcIpamPool_FilterPropertyList
	// Experimental.
	...
	// Experimental.
	SourceResource() DataAwsVpcIpamPool_SourceResourcePropertyList
	// Experimental.
	State() *string
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsVpcIpamPool_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsVpcIpamPool_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsVpcIpamPool) Filter() DataAwsVpcIpamPool_FilterPropertyList {
	var returns DataAwsVpcIpamPool_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsVpcIpamPool) SourceResource() DataAwsVpcIpamPool_SourceResourcePropertyList {
	var returns DataAwsVpcIpamPool_SourceResourcePropertyList
	_jsii_.Get(
		j,
		"sourceResource",
		&returns,
...
func (j *jsiiProxy_DataAwsVpcIpamPool) Timeouts() DataAwsVpcIpamPool_TimeoutsPropertyOutputReference {
	var returns DataAwsVpcIpamPool_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (d *jsiiProxy_DataAwsVpcIpamPool) PutTimeouts(value *DataAwsVpcIpamPool_TimeoutsProperty) {
