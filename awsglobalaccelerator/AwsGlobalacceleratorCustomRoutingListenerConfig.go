...
// Experimental.
type AwsGlobalacceleratorCustomRoutingListenerConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsGlobalacceleratorCustomRoutingListener_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
