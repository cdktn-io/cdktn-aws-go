...
type TfListener interface {
	...
	// Experimental.
	PortRange() TfListener_PortRangePropertyList
	// Experimental.
...
func (j *jsiiProxy_TfListener) AcceleratorArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"acceleratorArn",
...
func (j *jsiiProxy_TfListener) AcceleratorArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"acceleratorArnInput",
...
func (j *jsiiProxy_TfListener) ClientAffinity() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clientAffinity",
...
func (j *jsiiProxy_TfListener) ClientAffinityInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clientAffinityInput",
...
func (j *jsiiProxy_TfListener) PortRange() TfListener_PortRangePropertyList {
	var returns TfListener_PortRangePropertyList
	_jsii_.Get(
		j,
		"portRange",
		&returns,
...
func (j *jsiiProxy_TfListener) PortRangeInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"portRangeInput",
...
func (j *jsiiProxy_TfListener)SetAcceleratorArn(val *string) {
...
func (j *jsiiProxy_TfListener)SetClientAffinity(val *string) {
...
func (t *jsiiProxy_TfListener) PutPortRange(value interface{}) {
...
func (t *jsiiProxy_TfListener) ResetClientAffinity() {
	_jsii_.InvokeVoid(
		t,
		"resetClientAffinity",
		nil, // no parameters
