...
type DataAwsGlobalacceleratorAccelerator interface {
	...
	ArnInput() *string
	// Experimental.
	Attributes() DataAwsGlobalacceleratorAccelerator_AttributesPropertyList
	// Experimental.
	...
	// Experimental.
	IpSets() DataAwsGlobalacceleratorAccelerator_IpSetsPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsGlobalacceleratorAccelerator) Attributes() DataAwsGlobalacceleratorAccelerator_AttributesPropertyList {
	var returns DataAwsGlobalacceleratorAccelerator_AttributesPropertyList
	_jsii_.Get(
		j,
		"attributes",
		&returns,
...
func (j *jsiiProxy_DataAwsGlobalacceleratorAccelerator) IpSets() DataAwsGlobalacceleratorAccelerator_IpSetsPropertyList {
	var returns DataAwsGlobalacceleratorAccelerator_IpSetsPropertyList
	_jsii_.Get(
		j,
		"ipSets",
		&returns,
