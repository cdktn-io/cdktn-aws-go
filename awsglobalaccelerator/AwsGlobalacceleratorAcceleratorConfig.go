...
// Experimental.
type AwsGlobalacceleratorAcceleratorConfig struct {
	// Experimental.
	...
	// Experimental.
	Attributes *AwsGlobalacceleratorAccelerator_AttributesProperty `field:"optional" json:"attributes" yaml:"attributes"`
	...
	// Experimental.
	Timeouts *AwsGlobalacceleratorAccelerator_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
