...
// Experimental.
type AwsGlobalacceleratorCustomRoutingEndpointGroupConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsGlobalacceleratorCustomRoutingEndpointGroup_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
