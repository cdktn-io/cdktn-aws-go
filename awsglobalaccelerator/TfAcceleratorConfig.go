...
// Experimental.
type TfAcceleratorConfig struct {
	// Experimental.
	...
	// Experimental.
	Attributes *TfAccelerator_AttributesProperty `field:"optional" json:"attributes" yaml:"attributes"`
	...
	// Experimental.
	Timeouts *TfAccelerator_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
