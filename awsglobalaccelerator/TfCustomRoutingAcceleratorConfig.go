...
// Experimental.
type TfCustomRoutingAcceleratorConfig struct {
	// Experimental.
	...
	// Experimental.
	Attributes *TfCustomRoutingAccelerator_AttributesProperty `field:"optional" json:"attributes" yaml:"attributes"`
	...
	// Experimental.
	Timeouts *TfCustomRoutingAccelerator_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
