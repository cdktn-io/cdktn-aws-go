...
type DataAwsRamResourceShare interface {
	...
	// Experimental.
	Filter() DataAwsRamResourceShare_FilterPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsRamResourceShare) Filter() DataAwsRamResourceShare_FilterPropertyList {
	var returns DataAwsRamResourceShare_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
