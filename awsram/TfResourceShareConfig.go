...
// Experimental.
type TfResourceShareConfig struct {
	// Experimental.
	...
	// Experimental.
	ResourceShareConfiguration *TfResourceShare_ResourceShareConfigurationProperty `field:"optional" json:"resourceShareConfiguration" yaml:"resourceShareConfiguration"`
	...
	// Experimental.
	Timeouts *TfResourceShare_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
