...
// Experimental.
type AwsRamResourceShareConfig struct {
	// Experimental.
	...
	// Experimental.
	ResourceShareConfiguration *AwsRamResourceShare_ResourceShareConfigurationProperty `field:"optional" json:"resourceShareConfiguration" yaml:"resourceShareConfiguration"`
	...
	// Experimental.
	Timeouts *AwsRamResourceShare_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
