...
// Experimental.
type AwsSsmquicksetupConfigurationManagerConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsSsmquicksetupConfigurationManager_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
