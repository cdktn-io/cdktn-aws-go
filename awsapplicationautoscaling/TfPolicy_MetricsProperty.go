...
// Experimental.
type TfPolicy_MetricsProperty struct {
	...
	// Experimental.
	MetricStat *TfPolicy_TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecificationMetricsMetricStatProperty `field:"optional" json:"metricStat" yaml:"metricStat"`
