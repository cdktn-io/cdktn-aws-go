...
// Experimental.
type TfScheduledActionConfig struct {
	// Experimental.
	...
	// Experimental.
	ScalableTargetAction *TfScheduledAction_ScalableTargetActionProperty `field:"required" json:"scalableTargetAction" yaml:"scalableTargetAction"`
