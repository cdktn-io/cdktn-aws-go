...
func (j *jsiiProxy_TfPolicy_MetricSpecificationPropertyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_TfPolicy_MetricSpecificationPropertyOutputReference) TargetValue() *string {
	var returns *string
	_jsii_.Get(
		j,
		"targetValue",
...
func (j *jsiiProxy_TfPolicy_MetricSpecificationPropertyOutputReference) TargetValueInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"targetValueInput",
...
// Experimental.
func NewTfPolicy_MetricSpecificationPropertyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) TfPolicy_MetricSpecificationPropertyOutputReference {
	_init_.Initialize()

	if err := validateNewTfPolicy_MetricSpecificationPropertyOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_TfPolicy_MetricSpecificationPropertyOutputReference{}

	_jsii_.Create(
		"@cdktn/aws-application-auto-scaling.TfPolicy.MetricSpecificationPropertyOutputReference",
...
// Experimental.
func NewTfPolicy_MetricSpecificationPropertyOutputReference_Override(t TfPolicy_MetricSpecificationPropertyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_TfPolicy_MetricSpecificationPropertyOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_TfPolicy_MetricSpecificationPropertyOutputReference)SetTargetValue(val *string) {
