...
// Experimental.
type AwsAppautoscalingPolicy_TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecificationMetricsMetricStatProperty struct {
	// metric block.
	//
	...
	// Experimental.
	Metric *AwsAppautoscalingPolicy_TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecificationMetricsMetricStatMetricProperty `field:"required" json:"metric" yaml:"metric"`
