...
type TfTarget interface {
	...
	// Experimental.
	SuspendedState() TfTarget_SuspendedStatePropertyOutputReference
	// Experimental.
	SuspendedStateInput() *TfTarget_SuspendedStateProperty
	// Experimental.
	...
	// Experimental.
	PutSuspendedState(value *TfTarget_SuspendedStateProperty)
...
func (j *jsiiProxy_TfTarget) MaxCapacity() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"maxCapacity",
...
func (j *jsiiProxy_TfTarget) MaxCapacityInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"maxCapacityInput",
...
func (j *jsiiProxy_TfTarget) MinCapacity() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"minCapacity",
...
func (j *jsiiProxy_TfTarget) MinCapacityInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"minCapacityInput",
...
func (j *jsiiProxy_TfTarget) ResourceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceId",
...
func (j *jsiiProxy_TfTarget) ResourceIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceIdInput",
...
func (j *jsiiProxy_TfTarget) ScalableDimension() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scalableDimension",
...
func (j *jsiiProxy_TfTarget) ScalableDimensionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TfTarget) ServiceNamespace() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceNamespace",
...
func (j *jsiiProxy_TfTarget) ServiceNamespaceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TfTarget) SuspendedState() TfTarget_SuspendedStatePropertyOutputReference {
	var returns TfTarget_SuspendedStatePropertyOutputReference
	_jsii_.Get(
		j,
		"suspendedState",
		&returns,
...
func (j *jsiiProxy_TfTarget) SuspendedStateInput() *TfTarget_SuspendedStateProperty {
...
func (j *jsiiProxy_TfTarget) Tags() *map[string]*string {
...
func (j *jsiiProxy_TfTarget) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_TfTarget) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_TfTarget) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func NewTfTarget(scope constructs.Construct, id *string, config *TfTargetConfig) TfTarget {
	...
	_jsii_.Create(
		"@cdktn/aws-application-auto-scaling.TfTarget",
...
func (j *jsiiProxy_TfTarget)SetMaxCapacity(val *float64) {
...
func (j *jsiiProxy_TfTarget)SetMinCapacity(val *float64) {
...
func (j *jsiiProxy_TfTarget)SetResourceId(val *string) {
...
func (j *jsiiProxy_TfTarget)SetScalableDimension(val *string) {
...
func (j *jsiiProxy_TfTarget)SetServiceNamespace(val *string) {
...
func (j *jsiiProxy_TfTarget)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_TfTarget)SetTagsAll(val *map[string]*string) {
...
func (t *jsiiProxy_TfTarget) PutSuspendedState(value *TfTarget_SuspendedStateProperty) {
	if err := t.validatePutSuspendedStateParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		t,
...
func (t *jsiiProxy_TfTarget) ResetSuspendedState() {
	_jsii_.InvokeVoid(
		t,
		"resetSuspendedState",
		nil, // no parameters
...
func (t *jsiiProxy_TfTarget) ResetTags() {
	_jsii_.InvokeVoid(
		t,
		"resetTags",
		nil, // no parameters
...
func (t *jsiiProxy_TfTarget) ResetTagsAll() {
	_jsii_.InvokeVoid(
		t,
		"resetTagsAll",
		nil, // no parameters
