...
func (j *jsiiProxy_AwsWebAcl_RulePropertyOutputReference) RuleId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ruleId",
...
func (j *jsiiProxy_AwsWebAcl_RulePropertyOutputReference) RuleIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ruleIdInput",
...
func (j *jsiiProxy_AwsWebAcl_RulePropertyOutputReference) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_AwsWebAcl_RulePropertyOutputReference) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func (j *jsiiProxy_AwsWebAcl_RulePropertyOutputReference)SetRuleId(val *string) {
...
func (j *jsiiProxy_AwsWebAcl_RulePropertyOutputReference)SetType(val *string) {
...
func (a *jsiiProxy_AwsWebAcl_RulePropertyOutputReference) ResetType() {
	_jsii_.InvokeVoid(
		a,
		"resetType",
		nil, // no parameters
