...
// Experimental.
type TfStackSetInstanceConfig struct {
	// Experimental.
	...
	// Experimental.
	DeploymentTargets *TfStackSetInstance_DeploymentTargetsProperty `field:"optional" json:"deploymentTargets" yaml:"deploymentTargets"`
	...
	// Experimental.
	OperationPreferences *TfStackSetInstance_OperationPreferencesProperty `field:"optional" json:"operationPreferences" yaml:"operationPreferences"`
	...
	// Experimental.
	Timeouts *TfStackSetInstance_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
