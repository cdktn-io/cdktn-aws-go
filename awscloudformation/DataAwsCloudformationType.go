...
type DataAwsCloudformationType interface {
	...
	// Experimental.
	LoggingConfig() DataAwsCloudformationType_LoggingConfigPropertyList
	// The tree node.
	// Experimental.
...
func (j *jsiiProxy_DataAwsCloudformationType) LoggingConfig() DataAwsCloudformationType_LoggingConfigPropertyList {
	var returns DataAwsCloudformationType_LoggingConfigPropertyList
	_jsii_.Get(
		j,
		"loggingConfig",
		&returns,
