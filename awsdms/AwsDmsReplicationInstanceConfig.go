...
// Experimental.
type AwsDmsReplicationInstanceConfig struct {
	// Experimental.
	...
	// Experimental.
	KerberosAuthenticationSettings *AwsDmsReplicationInstance_KerberosAuthenticationSettingsProperty `field:"optional" json:"kerberosAuthenticationSettings" yaml:"kerberosAuthenticationSettings"`
	...
	// Experimental.
	Timeouts *AwsDmsReplicationInstance_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
