...
// Experimental.
type TfRegisteredDomainConfig struct {
	// Experimental.
	...
	// Experimental.
	AdminContact *TfRegisteredDomain_AdminContactProperty `field:"optional" json:"adminContact" yaml:"adminContact"`
	...
	// Experimental.
	BillingContact *TfRegisteredDomain_BillingContactProperty `field:"optional" json:"billingContact" yaml:"billingContact"`
	...
	// Experimental.
	RegistrantContact *TfRegisteredDomain_RegistrantContactProperty `field:"optional" json:"registrantContact" yaml:"registrantContact"`
	...
	// Experimental.
	TechContact *TfRegisteredDomain_TechContactProperty `field:"optional" json:"techContact" yaml:"techContact"`
	...
	// Experimental.
	Timeouts *TfRegisteredDomain_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
