...
// Experimental.
type AwsRoute53DomainsDelegationSignerRecordConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsRoute53DomainsDelegationSignerRecord_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
