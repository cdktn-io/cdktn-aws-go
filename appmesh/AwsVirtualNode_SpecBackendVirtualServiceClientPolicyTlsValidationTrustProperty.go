...
// Experimental.
type AwsVirtualNode_SpecBackendVirtualServiceClientPolicyTlsValidationTrustProperty struct {
	// acm block.
	//
	...
	// Experimental.
	Acm *AwsVirtualNode_SpecBackendVirtualServiceClientPolicyTlsValidationTrustAcmProperty `field:"optional" json:"acm" yaml:"acm"`
	// file block.
	//
	...
	// Experimental.
	File *AwsVirtualNode_SpecBackendVirtualServiceClientPolicyTlsValidationTrustFileProperty `field:"optional" json:"file" yaml:"file"`
	// sds block.
	//
	...
	// Experimental.
	Sds *AwsVirtualNode_SpecBackendVirtualServiceClientPolicyTlsValidationTrustSdsProperty `field:"optional" json:"sds" yaml:"sds"`
}
