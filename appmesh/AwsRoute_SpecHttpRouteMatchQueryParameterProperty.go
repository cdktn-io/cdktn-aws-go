...
// Experimental.
type AwsRoute_SpecHttpRouteMatchQueryParameterProperty struct {
	...
	// Experimental.
	Match *AwsRoute_SpecHttpRouteMatchQueryParameterMatchProperty `field:"optional" json:"match" yaml:"match"`
}
