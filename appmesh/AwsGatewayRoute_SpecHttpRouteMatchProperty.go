...
// Experimental.
type AwsGatewayRoute_SpecHttpRouteMatchProperty struct {
	// header block.
	//
	...
	// Experimental.
	Hostname *AwsGatewayRoute_SpecHttpRouteMatchHostnameProperty `field:"optional" json:"hostname" yaml:"hostname"`
	// path block.
	//
	...
	// Experimental.
	Path *AwsGatewayRoute_SpecHttpRouteMatchPathProperty `field:"optional" json:"path" yaml:"path"`
