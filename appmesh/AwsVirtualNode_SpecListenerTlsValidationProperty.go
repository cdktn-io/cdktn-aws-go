...
// Experimental.
type AwsVirtualNode_SpecListenerTlsValidationProperty struct {
	// trust block.
	//
	...
	// Experimental.
	Trust *AwsVirtualNode_SpecListenerTlsValidationTrustProperty `field:"required" json:"trust" yaml:"trust"`
	...
	// Experimental.
	SubjectAlternativeNames *AwsVirtualNode_SpecListenerTlsValidationSubjectAlternativeNamesProperty `field:"optional" json:"subjectAlternativeNames" yaml:"subjectAlternativeNames"`
}
