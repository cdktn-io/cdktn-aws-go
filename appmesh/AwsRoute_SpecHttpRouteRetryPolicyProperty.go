...
// Experimental.
type AwsRoute_SpecHttpRouteRetryPolicyProperty struct {
	...
	// Experimental.
	PerRetryTimeout *AwsRoute_SpecHttpRouteRetryPolicyPerRetryTimeoutProperty `field:"required" json:"perRetryTimeout" yaml:"perRetryTimeout"`
