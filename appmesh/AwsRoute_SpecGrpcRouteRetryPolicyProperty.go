...
// Experimental.
type AwsRoute_SpecGrpcRouteRetryPolicyProperty struct {
	...
	// Experimental.
	PerRetryTimeout *AwsRoute_SpecGrpcRouteRetryPolicyPerRetryTimeoutProperty `field:"required" json:"perRetryTimeout" yaml:"perRetryTimeout"`
