...
// Experimental.
type AwsGatewayRoute_SpecHttpRouteMatchHeaderProperty struct {
	...
	// Experimental.
	Match *AwsGatewayRoute_SpecHttpRouteMatchHeaderMatchProperty `field:"optional" json:"match" yaml:"match"`
}
