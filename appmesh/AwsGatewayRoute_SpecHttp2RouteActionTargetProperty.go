...
// Experimental.
type AwsGatewayRoute_SpecHttp2RouteActionTargetProperty struct {
	...
	// Experimental.
	VirtualService *AwsGatewayRoute_SpecHttp2RouteActionTargetVirtualServiceProperty `field:"required" json:"virtualService" yaml:"virtualService"`
