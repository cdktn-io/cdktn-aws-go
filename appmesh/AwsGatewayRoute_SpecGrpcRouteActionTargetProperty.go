...
// Experimental.
type AwsGatewayRoute_SpecGrpcRouteActionTargetProperty struct {
	...
	// Experimental.
	VirtualService *AwsGatewayRoute_SpecGrpcRouteActionTargetVirtualServiceProperty `field:"required" json:"virtualService" yaml:"virtualService"`
