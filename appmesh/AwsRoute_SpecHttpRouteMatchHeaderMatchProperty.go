...
// Experimental.
type AwsRoute_SpecHttpRouteMatchHeaderMatchProperty struct {
	...
	// Experimental.
	Range *AwsRoute_SpecHttpRouteMatchHeaderMatchRangeProperty `field:"optional" json:"range" yaml:"range"`
