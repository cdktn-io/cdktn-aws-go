...
// Experimental.
type AwsGatewayRoute_SpecHttpRouteMatchHeaderMatchProperty struct {
	...
	// Experimental.
	Range *AwsGatewayRoute_SpecHttpRouteMatchHeaderMatchRangeProperty `field:"optional" json:"range" yaml:"range"`
