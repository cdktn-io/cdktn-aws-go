...
// Experimental.
type AwsRoute_SpecHttp2RouteMatchHeaderMatchProperty struct {
	...
	// Experimental.
	Range *AwsRoute_SpecHttp2RouteMatchHeaderMatchRangeProperty `field:"optional" json:"range" yaml:"range"`
