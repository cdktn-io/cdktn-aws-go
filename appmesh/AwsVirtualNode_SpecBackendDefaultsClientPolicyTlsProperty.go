...
// Experimental.
type AwsVirtualNode_SpecBackendDefaultsClientPolicyTlsProperty struct {
	// validation block.
	//
	...
	// Experimental.
	Validation *AwsVirtualNode_SpecBackendDefaultsClientPolicyTlsValidationProperty `field:"required" json:"validation" yaml:"validation"`
	// certificate block.
	//
	...
	// Experimental.
	Certificate *AwsVirtualNode_SpecBackendDefaultsClientPolicyTlsCertificateProperty `field:"optional" json:"certificate" yaml:"certificate"`
