...
// Experimental.
type AwsVirtualGateway_SpecBackendDefaultsClientPolicyTlsCertificateProperty struct {
	// file block.
	//
	...
	// Experimental.
	File *AwsVirtualGateway_SpecBackendDefaultsClientPolicyTlsCertificateFileProperty `field:"optional" json:"file" yaml:"file"`
	// sds block.
	//
	...
	// Experimental.
	Sds *AwsVirtualGateway_SpecBackendDefaultsClientPolicyTlsCertificateSdsProperty `field:"optional" json:"sds" yaml:"sds"`
}
