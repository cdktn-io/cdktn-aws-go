...
// Experimental.
type AwsGatewayRoute_SpecHttpRouteActionTargetProperty struct {
	...
	// Experimental.
	VirtualService *AwsGatewayRoute_SpecHttpRouteActionTargetVirtualServiceProperty `field:"required" json:"virtualService" yaml:"virtualService"`
