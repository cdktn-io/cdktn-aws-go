...
// Experimental.
type AwsMesh_SpecProperty struct {
	// egress_filter block.
	//
	...
	// Experimental.
	EgressFilter *AwsMesh_EgressFilterProperty `field:"optional" json:"egressFilter" yaml:"egressFilter"`
	...
	// Experimental.
	ServiceDiscovery *AwsMesh_ServiceDiscoveryProperty `field:"optional" json:"serviceDiscovery" yaml:"serviceDiscovery"`
}
