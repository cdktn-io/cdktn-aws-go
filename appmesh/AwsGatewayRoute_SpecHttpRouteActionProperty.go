...
// Experimental.
type AwsGatewayRoute_SpecHttpRouteActionProperty struct {
	// target block.
	//
	...
	// Experimental.
	Target *AwsGatewayRoute_SpecHttpRouteActionTargetProperty `field:"required" json:"target" yaml:"target"`
	// rewrite block.
	//
	...
	// Experimental.
	Rewrite *AwsGatewayRoute_SpecHttpRouteActionRewriteProperty `field:"optional" json:"rewrite" yaml:"rewrite"`
}
