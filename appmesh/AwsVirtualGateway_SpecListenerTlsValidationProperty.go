...
// Experimental.
type AwsVirtualGateway_SpecListenerTlsValidationProperty struct {
	// trust block.
	//
	...
	// Experimental.
	Trust *AwsVirtualGateway_SpecListenerTlsValidationTrustProperty `field:"required" json:"trust" yaml:"trust"`
	...
	// Experimental.
	SubjectAlternativeNames *AwsVirtualGateway_SpecListenerTlsValidationSubjectAlternativeNamesProperty `field:"optional" json:"subjectAlternativeNames" yaml:"subjectAlternativeNames"`
}
