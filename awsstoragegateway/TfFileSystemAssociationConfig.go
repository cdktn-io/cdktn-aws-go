...
// Experimental.
type TfFileSystemAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	CacheAttributes *TfFileSystemAssociation_CacheAttributesProperty `field:"optional" json:"cacheAttributes" yaml:"cacheAttributes"`
	...
	// Experimental.
	Timeouts *TfFileSystemAssociation_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
