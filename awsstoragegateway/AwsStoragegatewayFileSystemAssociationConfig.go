...
// Experimental.
type AwsStoragegatewayFileSystemAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	CacheAttributes *AwsStoragegatewayFileSystemAssociation_CacheAttributesProperty `field:"optional" json:"cacheAttributes" yaml:"cacheAttributes"`
	...
	// Experimental.
	Timeouts *AwsStoragegatewayFileSystemAssociation_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
