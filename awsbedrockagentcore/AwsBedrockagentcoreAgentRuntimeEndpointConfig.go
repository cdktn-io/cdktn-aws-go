...
// Experimental.
type AwsBedrockagentcoreAgentRuntimeEndpointConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsBedrockagentcoreAgentRuntimeEndpoint_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
