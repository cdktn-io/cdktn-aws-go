...
// Experimental.
type AwsBedrockagentcoreCodeInterpreterConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsBedrockagentcoreCodeInterpreter_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
