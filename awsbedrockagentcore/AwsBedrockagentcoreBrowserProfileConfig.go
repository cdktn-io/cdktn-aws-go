...
// Experimental.
type AwsBedrockagentcoreBrowserProfileConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsBedrockagentcoreBrowserProfile_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
