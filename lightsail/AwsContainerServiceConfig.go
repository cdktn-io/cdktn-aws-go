...
// Experimental.
type AwsContainerServiceConfig struct {
	// Experimental.
	...
	// Experimental.
	PrivateRegistryAccess *AwsContainerService_PrivateRegistryAccessProperty `field:"optional" json:"privateRegistryAccess" yaml:"privateRegistryAccess"`
	...
	// Experimental.
	PublicDomainNames *AwsContainerService_PublicDomainNamesProperty `field:"optional" json:"publicDomainNames" yaml:"publicDomainNames"`
	...
	// Experimental.
	Timeouts *AwsContainerService_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
