...
func (j *jsiiProxy_AwsDistribution_DefaultCacheBehaviorPropertyOutputReference) Behavior() *string {
	var returns *string
	_jsii_.Get(
		j,
		"behavior",
...
func (j *jsiiProxy_AwsDistribution_DefaultCacheBehaviorPropertyOutputReference) BehaviorInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"behaviorInput",
...
func (j *jsiiProxy_AwsDistribution_DefaultCacheBehaviorPropertyOutputReference)SetBehavior(val *string) {
