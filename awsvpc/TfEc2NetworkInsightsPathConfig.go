...
// Experimental.
type TfEc2NetworkInsightsPathConfig struct {
	// Experimental.
	...
	// Experimental.
	FilterAtDestination *TfEc2NetworkInsightsPath_FilterAtDestinationProperty `field:"optional" json:"filterAtDestination" yaml:"filterAtDestination"`
	...
	// Experimental.
	FilterAtSource *TfEc2NetworkInsightsPath_FilterAtSourceProperty `field:"optional" json:"filterAtSource" yaml:"filterAtSource"`
