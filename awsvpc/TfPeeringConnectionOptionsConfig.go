...
// Experimental.
type TfPeeringConnectionOptionsConfig struct {
	// Experimental.
	...
	// Experimental.
	Accepter *TfPeeringConnectionOptions_AccepterProperty `field:"optional" json:"accepter" yaml:"accepter"`
	...
	// Experimental.
	Requester *TfPeeringConnectionOptions_RequesterProperty `field:"optional" json:"requester" yaml:"requester"`
}
