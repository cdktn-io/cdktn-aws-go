...
// Experimental.
type TfEndpointServicePrivateDnsVerificationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *TfEndpointServicePrivateDnsVerification_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
