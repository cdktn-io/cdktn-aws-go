...
// Experimental.
type TfEc2NetworkInsightsPath_FilterAtDestinationProperty struct {
	...
	// Experimental.
	DestinationPortRange *TfEc2NetworkInsightsPath_FilterAtDestinationDestinationPortRangeProperty `field:"optional" json:"destinationPortRange" yaml:"destinationPortRange"`
	...
	// Experimental.
	SourcePortRange *TfEc2NetworkInsightsPath_FilterAtDestinationSourcePortRangeProperty `field:"optional" json:"sourcePortRange" yaml:"sourcePortRange"`
}
