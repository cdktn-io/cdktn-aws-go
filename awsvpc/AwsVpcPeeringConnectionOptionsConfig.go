...
// Experimental.
type AwsVpcPeeringConnectionOptionsConfig struct {
	// Experimental.
	...
	// Experimental.
	Accepter *AwsVpcPeeringConnectionOptions_AccepterProperty `field:"optional" json:"accepter" yaml:"accepter"`
	...
	// Experimental.
	Requester *AwsVpcPeeringConnectionOptions_RequesterProperty `field:"optional" json:"requester" yaml:"requester"`
}
