...
type DataAwsPrefixList interface {
	...
	// Experimental.
	Filter() DataAwsPrefixList_FilterPropertyList
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsPrefixList_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsPrefixList_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsPrefixList) Filter() DataAwsPrefixList_FilterPropertyList {
	var returns DataAwsPrefixList_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsPrefixList) Timeouts() DataAwsPrefixList_TimeoutsPropertyOutputReference {
	var returns DataAwsPrefixList_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewDataAwsPrefixList(scope constructs.Construct, id *string, config *DataAwsPrefixListConfig) DataAwsPrefixList {
	...
	_jsii_.Create(
		"@cdktn/aws-vpc.DataAwsPrefixList",
...
func (d *jsiiProxy_DataAwsPrefixList) PutTimeouts(value *DataAwsPrefixList_TimeoutsProperty) {
