...
// Experimental.
type AwsVpcSecurityGroupVpcAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsVpcSecurityGroupVpcAssociation_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
