...
func (d *jsiiProxy_DataAwsRouteTable) validatePutFilterParameters(value interface{}) error {
	...
	case *[]*DataAwsRouteTable_FilterProperty:
		value := value.(*[]*DataAwsRouteTable_FilterProperty)
	...
	case []*DataAwsRouteTable_FilterProperty:
		value_ := value.([]*DataAwsRouteTable_FilterProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DataAwsRouteTable_FilterProperty; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DataAwsRouteTable) validatePutTimeoutsParameters(value *DataAwsRouteTable_TimeoutsProperty) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
