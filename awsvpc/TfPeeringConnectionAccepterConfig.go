...
// Experimental.
type TfPeeringConnectionAccepterConfig struct {
	// Experimental.
	...
	// Experimental.
	Accepter *TfPeeringConnectionAccepter_AccepterProperty `field:"optional" json:"accepter" yaml:"accepter"`
	...
	// Experimental.
	Requester *TfPeeringConnectionAccepter_RequesterProperty `field:"optional" json:"requester" yaml:"requester"`
	...
	// Experimental.
	Timeouts *TfPeeringConnectionAccepter_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
