...
type DataAwsVpcPeeringConnection interface {
	...
	// Experimental.
	CidrBlockSet() DataAwsVpcPeeringConnection_CidrBlockSetPropertyList
	// Experimental.
	...
	// Experimental.
	Filter() DataAwsVpcPeeringConnection_FilterPropertyList
	// Experimental.
	...
	IdInput() *string
	// Experimental.
	Ipv6CidrBlockSet() DataAwsVpcPeeringConnection_Ipv6CidrBlockSetPropertyList
	// Experimental.
	...
	// Experimental.
	PeerCidrBlockSet() DataAwsVpcPeeringConnection_PeerCidrBlockSetPropertyList
	// Experimental.
	PeerIpv6CidrBlockSet() DataAwsVpcPeeringConnection_PeerIpv6CidrBlockSetPropertyList
	// Experimental.
	PeerOwnerId() *string
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsVpcPeeringConnection_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsVpcPeeringConnection_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsVpcPeeringConnection) CidrBlockSet() DataAwsVpcPeeringConnection_CidrBlockSetPropertyList {
	var returns DataAwsVpcPeeringConnection_CidrBlockSetPropertyList
	_jsii_.Get(
		j,
		"cidrBlockSet",
		&returns,
...
func (j *jsiiProxy_DataAwsVpcPeeringConnection) Filter() DataAwsVpcPeeringConnection_FilterPropertyList {
	var returns DataAwsVpcPeeringConnection_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsVpcPeeringConnection) Ipv6CidrBlockSet() DataAwsVpcPeeringConnection_Ipv6CidrBlockSetPropertyList {
	var returns DataAwsVpcPeeringConnection_Ipv6CidrBlockSetPropertyList
	_jsii_.Get(
		j,
		"ipv6CidrBlockSet",
		&returns,
...
func (j *jsiiProxy_DataAwsVpcPeeringConnection) PeerCidrBlockSet() DataAwsVpcPeeringConnection_PeerCidrBlockSetPropertyList {
	var returns DataAwsVpcPeeringConnection_PeerCidrBlockSetPropertyList
	_jsii_.Get(
		j,
		"peerCidrBlockSet",
		&returns,
...
func (j *jsiiProxy_DataAwsVpcPeeringConnection) PeerIpv6CidrBlockSet() DataAwsVpcPeeringConnection_PeerIpv6CidrBlockSetPropertyList {
	var returns DataAwsVpcPeeringConnection_PeerIpv6CidrBlockSetPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsVpcPeeringConnection) Timeouts() DataAwsVpcPeeringConnection_TimeoutsPropertyOutputReference {
	var returns DataAwsVpcPeeringConnection_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewDataAwsVpcPeeringConnection(scope constructs.Construct, id *string, config *DataAwsVpcPeeringConnectionConfig) DataAwsVpcPeeringConnection {
	...
	_jsii_.Create(
		"@cdktn/aws-vpc.DataAwsVpcPeeringConnection",
...
func (d *jsiiProxy_DataAwsVpcPeeringConnection) PutTimeouts(value *DataAwsVpcPeeringConnection_TimeoutsProperty) {
