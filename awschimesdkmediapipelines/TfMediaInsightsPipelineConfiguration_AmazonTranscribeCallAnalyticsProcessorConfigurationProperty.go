...
// Experimental.
type TfMediaInsightsPipelineConfiguration_AmazonTranscribeCallAnalyticsProcessorConfigurationProperty struct {
	...
	// Experimental.
	PostCallAnalyticsSettings *TfMediaInsightsPipelineConfiguration_PostCallAnalyticsSettingsProperty `field:"optional" json:"postCallAnalyticsSettings" yaml:"postCallAnalyticsSettings"`
