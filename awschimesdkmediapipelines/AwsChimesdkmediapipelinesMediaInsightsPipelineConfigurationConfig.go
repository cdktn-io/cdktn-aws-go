...
// Experimental.
type AwsChimesdkmediapipelinesMediaInsightsPipelineConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	RealTimeAlertConfiguration *AwsChimesdkmediapipelinesMediaInsightsPipelineConfiguration_RealTimeAlertConfigurationProperty `field:"optional" json:"realTimeAlertConfiguration" yaml:"realTimeAlertConfiguration"`
	...
	// Experimental.
	Timeouts *AwsChimesdkmediapipelinesMediaInsightsPipelineConfiguration_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
