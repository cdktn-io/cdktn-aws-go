...
// Experimental.
type AwsPinpointAppConfig struct {
	// Experimental.
	...
	// Experimental.
	CampaignHook *AwsPinpointApp_CampaignHookProperty `field:"optional" json:"campaignHook" yaml:"campaignHook"`
	...
	// Experimental.
	Limits *AwsPinpointApp_LimitsProperty `field:"optional" json:"limits" yaml:"limits"`
	...
	// Experimental.
	QuietTime *AwsPinpointApp_QuietTimeProperty `field:"optional" json:"quietTime" yaml:"quietTime"`
