...
type DataAwsOdbCloudAutonomousVmCluster interface {
	...
	// Experimental.
	MaintenanceWindow() DataAwsOdbCloudAutonomousVmCluster_MaintenanceWindowPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsOdbCloudAutonomousVmCluster) MaintenanceWindow() DataAwsOdbCloudAutonomousVmCluster_MaintenanceWindowPropertyList {
	var returns DataAwsOdbCloudAutonomousVmCluster_MaintenanceWindowPropertyList
	_jsii_.Get(
		j,
		"maintenanceWindow",
		&returns,
...
func NewDataAwsOdbCloudAutonomousVmCluster(scope constructs.Construct, id *string, config *DataAwsOdbCloudAutonomousVmClusterConfig) DataAwsOdbCloudAutonomousVmCluster {
	...
	_jsii_.Create(
		"@cdktn/aws-oracle-database-aws.DataAwsOdbCloudAutonomousVmCluster",
