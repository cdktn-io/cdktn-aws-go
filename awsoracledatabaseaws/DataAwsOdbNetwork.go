...
type DataAwsOdbNetwork interface {
	...
	// Experimental.
	ManagedServices() DataAwsOdbNetwork_ManagedServicesPropertyList
	// The tree node.
	// Experimental.
	Node() constructs.Node
	// Experimental.
	OciDnsForwardingConfigs() DataAwsOdbNetwork_OciDnsForwardingConfigsPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsOdbNetwork) ManagedServices() DataAwsOdbNetwork_ManagedServicesPropertyList {
	var returns DataAwsOdbNetwork_ManagedServicesPropertyList
	_jsii_.Get(
		j,
		"managedServices",
		&returns,
...
func (j *jsiiProxy_DataAwsOdbNetwork) OciDnsForwardingConfigs() DataAwsOdbNetwork_OciDnsForwardingConfigsPropertyList {
	var returns DataAwsOdbNetwork_OciDnsForwardingConfigsPropertyList
	_jsii_.Get(
		j,
...
func NewDataAwsOdbNetwork(scope constructs.Construct, id *string, config *DataAwsOdbNetworkConfig) DataAwsOdbNetwork {
	...
	_jsii_.Create(
		"@cdktn/aws-oracle-database-aws.DataAwsOdbNetwork",
