...
// Experimental.
type AwsOdbCloudExadataInfrastructureConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsOdbCloudExadataInfrastructure_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
