...
type DataAwsOdbCloudExadataInfrastructure interface {
	...
	CreatedAt() *string
	// Experimental.
	CustomerContactsToSendToOci() DataAwsOdbCloudExadataInfrastructure_CustomerContactsToSendToOciPropertyList
	// Experimental.
	...
	// Experimental.
	MaintenanceWindow() DataAwsOdbCloudExadataInfrastructure_MaintenanceWindowPropertyList
	// Experimental.
	MaxCpuCount() *float64
	// Experimental.
...
func (j *jsiiProxy_DataAwsOdbCloudExadataInfrastructure) CustomerContactsToSendToOci() DataAwsOdbCloudExadataInfrastructure_CustomerContactsToSendToOciPropertyList {
	var returns DataAwsOdbCloudExadataInfrastructure_CustomerContactsToSendToOciPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsOdbCloudExadataInfrastructure) MaintenanceWindow() DataAwsOdbCloudExadataInfrastructure_MaintenanceWindowPropertyList {
	var returns DataAwsOdbCloudExadataInfrastructure_MaintenanceWindowPropertyList
	_jsii_.Get(
		j,
		"maintenanceWindow",
		&returns,
...
func NewDataAwsOdbCloudExadataInfrastructure(scope constructs.Construct, id *string, config *DataAwsOdbCloudExadataInfrastructureConfig) DataAwsOdbCloudExadataInfrastructure {
	...
	_jsii_.Create(
		"@cdktn/aws-oracle-database-aws.DataAwsOdbCloudExadataInfrastructure",
