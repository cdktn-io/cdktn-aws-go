...
type DataAwsOrganizationsDelegatedServices interface {
	...
	// Experimental.
	DelegatedServices() DataAwsOrganizationsDelegatedServices_DelegatedServicesPropertyList
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
...
func (j *jsiiProxy_DataAwsOrganizationsDelegatedServices) DelegatedServices() DataAwsOrganizationsDelegatedServices_DelegatedServicesPropertyList {
	var returns DataAwsOrganizationsDelegatedServices_DelegatedServicesPropertyList
	_jsii_.Get(
		j,
		"delegatedServices",
		&returns,
