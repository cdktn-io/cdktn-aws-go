...
type DataAwsOrganizationsOrganizationalUnitDescendantAccounts interface {
	...
	// Experimental.
	Accounts() DataAwsOrganizationsOrganizationalUnitDescendantAccounts_AccountsPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsOrganizationsOrganizationalUnitDescendantAccounts) Accounts() DataAwsOrganizationsOrganizationalUnitDescendantAccounts_AccountsPropertyList {
	var returns DataAwsOrganizationsOrganizationalUnitDescendantAccounts_AccountsPropertyList
	_jsii_.Get(
		j,
		"accounts",
		&returns,
