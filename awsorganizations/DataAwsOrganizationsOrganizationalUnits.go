...
type DataAwsOrganizationsOrganizationalUnits interface {
	...
	// Experimental.
	Children() DataAwsOrganizationsOrganizationalUnits_ChildrenPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsOrganizationsOrganizationalUnits) Children() DataAwsOrganizationsOrganizationalUnits_ChildrenPropertyList {
	var returns DataAwsOrganizationsOrganizationalUnits_ChildrenPropertyList
	_jsii_.Get(
		j,
		"children",
		&returns,
