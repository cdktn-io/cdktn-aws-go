...
type DataAwsOrganizationsDelegatedAdministrators interface {
	...
	// Experimental.
	DelegatedAdministrators() DataAwsOrganizationsDelegatedAdministrators_DelegatedAdministratorsPropertyList
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
...
func (j *jsiiProxy_DataAwsOrganizationsDelegatedAdministrators) DelegatedAdministrators() DataAwsOrganizationsDelegatedAdministrators_DelegatedAdministratorsPropertyList {
	var returns DataAwsOrganizationsDelegatedAdministrators_DelegatedAdministratorsPropertyList
	_jsii_.Get(
		j,
