...
// Experimental.
type AwsBucketReplicationConfiguration_RuleProperty struct {
	// destination block.
	//
	...
	// Experimental.
	Destination *AwsBucketReplicationConfiguration_DestinationProperty `field:"required" json:"destination" yaml:"destination"`
	...
	// Experimental.
	DeleteMarkerReplication *AwsBucketReplicationConfiguration_DeleteMarkerReplicationProperty `field:"optional" json:"deleteMarkerReplication" yaml:"deleteMarkerReplication"`
	...
	// Experimental.
	ExistingObjectReplication *AwsBucketReplicationConfiguration_ExistingObjectReplicationProperty `field:"optional" json:"existingObjectReplication" yaml:"existingObjectReplication"`
	// filter block.
	//
	...
	// Experimental.
	Filter *AwsBucketReplicationConfiguration_FilterProperty `field:"optional" json:"filter" yaml:"filter"`
	...
	// Experimental.
	SourceSelectionCriteria *AwsBucketReplicationConfiguration_SourceSelectionCriteriaProperty `field:"optional" json:"sourceSelectionCriteria" yaml:"sourceSelectionCriteria"`
}
