...
// Experimental.
type AwsBucketAclConfig struct {
	// Experimental.
	...
	// Experimental.
	AccessControlPolicy *AwsBucketAcl_AccessControlPolicyProperty `field:"optional" json:"accessControlPolicy" yaml:"accessControlPolicy"`
