...
// Experimental.
type AwsBucketVersioningConfig struct {
	// Experimental.
	...
	// Experimental.
	VersioningConfiguration *AwsBucketVersioning_VersioningConfigurationProperty `field:"required" json:"versioningConfiguration" yaml:"versioningConfiguration"`
