...
type AwsBucketConfig struct {
	...
	// Experimental.
	Logging *AwsBucket_LoggingProperty `field:"optional" json:"logging" yaml:"logging"`
	...
	// Experimental.
	ObjectLockConfiguration *AwsBucket_ObjectLockConfigurationProperty `field:"optional" json:"objectLockConfiguration" yaml:"objectLockConfiguration"`
	...
	// Experimental.
	ReplicationConfiguration *AwsBucket_ReplicationConfigurationProperty `field:"optional" json:"replicationConfiguration" yaml:"replicationConfiguration"`
	...
	// Experimental.
	ServerSideEncryptionConfiguration *AwsBucket_ServerSideEncryptionConfigurationProperty `field:"optional" json:"serverSideEncryptionConfiguration" yaml:"serverSideEncryptionConfiguration"`
	...
	// Experimental.
	Timeouts *AwsBucket_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
	// versioning block.
	//
	...
	// Experimental.
	Versioning *AwsBucket_VersioningProperty `field:"optional" json:"versioning" yaml:"versioning"`
	// website block.
	//
	...
	// Experimental.
	Website *AwsBucket_WebsiteProperty `field:"optional" json:"website" yaml:"website"`
}
