...
// Experimental.
type AwsBucketIntelligentTieringConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	Filter *AwsBucketIntelligentTieringConfiguration_FilterProperty `field:"optional" json:"filter" yaml:"filter"`
