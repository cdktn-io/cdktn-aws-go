...
// Experimental.
type AwsBucketWebsiteConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	ErrorDocument *AwsBucketWebsiteConfiguration_ErrorDocumentProperty `field:"optional" json:"errorDocument" yaml:"errorDocument"`
	...
	// Experimental.
	IndexDocument *AwsBucketWebsiteConfiguration_IndexDocumentProperty `field:"optional" json:"indexDocument" yaml:"indexDocument"`
	...
	// Experimental.
	RedirectAllRequestsTo *AwsBucketWebsiteConfiguration_RedirectAllRequestsToProperty `field:"optional" json:"redirectAllRequestsTo" yaml:"redirectAllRequestsTo"`
