...
// Experimental.
type AwsBucketAnalyticsConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	Filter *AwsBucketAnalyticsConfiguration_FilterProperty `field:"optional" json:"filter" yaml:"filter"`
	...
	// Experimental.
	StorageClassAnalysis *AwsBucketAnalyticsConfiguration_StorageClassAnalysisProperty `field:"optional" json:"storageClassAnalysis" yaml:"storageClassAnalysis"`
}
