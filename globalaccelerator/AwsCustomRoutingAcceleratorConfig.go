...
// Experimental.
type AwsCustomRoutingAcceleratorConfig struct {
	// Experimental.
	...
	// Experimental.
	Attributes *AwsCustomRoutingAccelerator_AttributesProperty `field:"optional" json:"attributes" yaml:"attributes"`
	...
	// Experimental.
	Timeouts *AwsCustomRoutingAccelerator_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
