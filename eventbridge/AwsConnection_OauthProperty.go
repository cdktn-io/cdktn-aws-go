...
// Experimental.
type AwsConnection_OauthProperty struct {
	...
	// Experimental.
	OauthHttpParameters *AwsConnection_OauthHttpParametersProperty `field:"required" json:"oauthHttpParameters" yaml:"oauthHttpParameters"`
	...
	// Experimental.
	ClientParameters *AwsConnection_ClientParametersProperty `field:"optional" json:"clientParameters" yaml:"clientParameters"`
}
