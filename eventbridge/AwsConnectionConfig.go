...
type AwsConnectionConfig struct {
	...
	// Experimental.
	AuthParameters *AwsConnection_AuthParametersProperty `field:"required" json:"authParameters" yaml:"authParameters"`
	...
	// Experimental.
	InvocationConnectivityParameters *AwsConnection_InvocationConnectivityParametersProperty `field:"optional" json:"invocationConnectivityParameters" yaml:"invocationConnectivityParameters"`
