...
type AwsBusConfig struct {
	...
	// Experimental.
	DeadLetterConfig *AwsBus_DeadLetterConfigProperty `field:"optional" json:"deadLetterConfig" yaml:"deadLetterConfig"`
	...
	// Experimental.
	LogConfig *AwsBus_LogConfigProperty `field:"optional" json:"logConfig" yaml:"logConfig"`
