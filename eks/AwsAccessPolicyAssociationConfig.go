...
// Experimental.
type AwsAccessPolicyAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	AccessScope *AwsAccessPolicyAssociation_AccessScopeProperty `field:"required" json:"accessScope" yaml:"accessScope"`
	...
	// Experimental.
	Timeouts *AwsAccessPolicyAssociation_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
