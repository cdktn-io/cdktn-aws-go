...
// Experimental.
type AwsCluster_KubernetesNetworkConfigProperty struct {
	...
	// Experimental.
	ElasticLoadBalancing *AwsCluster_ElasticLoadBalancingProperty `field:"optional" json:"elasticLoadBalancing" yaml:"elasticLoadBalancing"`
