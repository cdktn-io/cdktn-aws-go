...
// Experimental.
type AwsCentralizationRuleForOrganizationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsCentralizationRuleForOrganization_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
