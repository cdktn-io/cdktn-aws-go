...
// Experimental.
type AwsTelemetryEvaluationForOrganizationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsTelemetryEvaluationForOrganization_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
