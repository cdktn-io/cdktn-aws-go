...
type AwsListener_DefaultActionPropertyOutputReference interface {
	...
	// Experimental.
	Forward() AwsListener_ForwardPropertyList
	// Experimental.
	ForwardInput() interface{}
	// Experimental.
	Fqn() *string
	// Experimental.
	InternalValue() *AwsListener_DefaultActionProperty
	// Experimental.
	SetInternalValue(val *AwsListener_DefaultActionProperty)
	// Experimental.
...
func (j *jsiiProxy_AwsListener_DefaultActionPropertyOutputReference) Forward() AwsListener_ForwardPropertyList {
	var returns AwsListener_ForwardPropertyList
	_jsii_.Get(
		j,
		"forward",
		&returns,
...
func (j *jsiiProxy_AwsListener_DefaultActionPropertyOutputReference) ForwardInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"forwardInput",
...
func (j *jsiiProxy_AwsListener_DefaultActionPropertyOutputReference) InternalValue() *AwsListener_DefaultActionProperty {
...
// Experimental.
func NewAwsListener_DefaultActionPropertyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AwsListener_DefaultActionPropertyOutputReference {
	_init_.Initialize()

	if err := validateNewAwsListener_DefaultActionPropertyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
// Experimental.
func NewAwsListener_DefaultActionPropertyOutputReference_Override(a AwsListener_DefaultActionPropertyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AwsListener_DefaultActionPropertyOutputReference)SetInternalValue(val *AwsListener_DefaultActionProperty) {
...
func (a *jsiiProxy_AwsListener_DefaultActionPropertyOutputReference) PutForward(value interface{}) {
