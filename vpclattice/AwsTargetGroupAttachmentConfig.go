...
// Experimental.
type AwsTargetGroupAttachmentConfig struct {
	// Experimental.
	...
	// Experimental.
	Target *AwsTargetGroupAttachment_TargetProperty `field:"required" json:"target" yaml:"target"`
	...
	// Experimental.
	Timeouts *AwsTargetGroupAttachment_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
