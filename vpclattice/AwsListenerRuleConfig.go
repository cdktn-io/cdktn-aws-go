...
// Experimental.
type AwsListenerRuleConfig struct {
	// Experimental.
	...
	// Experimental.
	Action *AwsListenerRule_ActionProperty `field:"required" json:"action" yaml:"action"`
	...
	// Experimental.
	Match *AwsListenerRule_MatchProperty `field:"required" json:"match" yaml:"match"`
	...
	// Experimental.
	Timeouts *AwsListenerRule_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
