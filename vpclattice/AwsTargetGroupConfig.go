...
type AwsTargetGroupConfig struct {
	...
	// Experimental.
	Config *AwsTargetGroup_ConfigProperty `field:"optional" json:"config" yaml:"config"`
	...
	// Experimental.
	Timeouts *AwsTargetGroup_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
