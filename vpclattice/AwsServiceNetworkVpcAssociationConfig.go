...
// Experimental.
type AwsServiceNetworkVpcAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	DnsOptions *AwsServiceNetworkVpcAssociation_DnsOptionsProperty `field:"optional" json:"dnsOptions" yaml:"dnsOptions"`
	...
	// Experimental.
	Timeouts *AwsServiceNetworkVpcAssociation_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
