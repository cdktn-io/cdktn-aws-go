...
type AwsListenerRule_ActionPropertyOutputReference interface {
	...
	Fqn() *string
	// Experimental.
	InternalValue() *AwsListenerRule_ActionProperty
	// Experimental.
	SetInternalValue(val *AwsListenerRule_ActionProperty)
	// Experimental.
...
func (j *jsiiProxy_AwsListenerRule_ActionPropertyOutputReference) InternalValue() *AwsListenerRule_ActionProperty {
...
// Experimental.
func NewAwsListenerRule_ActionPropertyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AwsListenerRule_ActionPropertyOutputReference {
	_init_.Initialize()

	if err := validateNewAwsListenerRule_ActionPropertyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
// Experimental.
func NewAwsListenerRule_ActionPropertyOutputReference_Override(a AwsListenerRule_ActionPropertyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AwsListenerRule_ActionPropertyOutputReference)SetInternalValue(val *AwsListenerRule_ActionProperty) {
