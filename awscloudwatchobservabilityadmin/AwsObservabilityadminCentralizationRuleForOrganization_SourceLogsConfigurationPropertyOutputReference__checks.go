...
func (j *jsiiProxy_AwsObservabilityadminCentralizationRuleForOrganization_SourceLogsConfigurationPropertyOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case *AwsObservabilityadminCentralizationRuleForOrganization_SourceLogsConfigurationProperty:
		val := val.(*AwsObservabilityadminCentralizationRuleForOrganization_SourceLogsConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case AwsObservabilityadminCentralizationRuleForOrganization_SourceLogsConfigurationProperty:
		val_ := val.(AwsObservabilityadminCentralizationRuleForOrganization_SourceLogsConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *AwsObservabilityadminCentralizationRuleForOrganization_SourceLogsConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
