...
// Experimental.
type AwsObservabilityadminCentralizationRuleForOrganizationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsObservabilityadminCentralizationRuleForOrganization_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
