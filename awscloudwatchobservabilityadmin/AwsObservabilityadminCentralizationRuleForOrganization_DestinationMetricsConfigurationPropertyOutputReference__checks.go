...
func (a *jsiiProxy_AwsObservabilityadminCentralizationRuleForOrganization_DestinationMetricsConfigurationPropertyOutputReference) validatePutBackupConfigurationParameters(value interface{}) error {
	...
	case *[]*AwsObservabilityadminCentralizationRuleForOrganization_RuleDestinationDestinationMetricsConfigurationBackupConfigurationProperty:
		value := value.(*[]*AwsObservabilityadminCentralizationRuleForOrganization_RuleDestinationDestinationMetricsConfigurationBackupConfigurationProperty)
	...
	case []*AwsObservabilityadminCentralizationRuleForOrganization_RuleDestinationDestinationMetricsConfigurationBackupConfigurationProperty:
		value_ := value.([]*AwsObservabilityadminCentralizationRuleForOrganization_RuleDestinationDestinationMetricsConfigurationBackupConfigurationProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AwsObservabilityadminCentralizationRuleForOrganization_RuleDestinationDestinationMetricsConfigurationBackupConfigurationProperty; received %#v (a %T)", value, value)
		}
	}
