...
// Experimental.
type AwsObservabilityadminS3TableIntegrationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsObservabilityadminS3TableIntegration_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
