...
// Experimental.
type AwsCatalogTableConfig struct {
	// Experimental.
	...
	// Experimental.
	OpenTableFormatInput *AwsCatalogTable_OpenTableFormatInputProperty `field:"optional" json:"openTableFormatInput" yaml:"openTableFormatInput"`
	...
	// Experimental.
	StorageDescriptor *AwsCatalogTable_StorageDescriptorProperty `field:"optional" json:"storageDescriptor" yaml:"storageDescriptor"`
	...
	// Experimental.
	TargetTable *AwsCatalogTable_TargetTableProperty `field:"optional" json:"targetTable" yaml:"targetTable"`
	...
	// Experimental.
	ViewDefinition *AwsCatalogTable_ViewDefinitionProperty `field:"optional" json:"viewDefinition" yaml:"viewDefinition"`
