...
// Experimental.
type AwsClassifierConfig struct {
	// Experimental.
	...
	// Experimental.
	CsvClassifier *AwsClassifier_CsvClassifierProperty `field:"optional" json:"csvClassifier" yaml:"csvClassifier"`
	...
	// Experimental.
	GrokClassifier *AwsClassifier_GrokClassifierProperty `field:"optional" json:"grokClassifier" yaml:"grokClassifier"`
	...
	// Experimental.
	JsonClassifier *AwsClassifier_JsonClassifierProperty `field:"optional" json:"jsonClassifier" yaml:"jsonClassifier"`
	...
	// Experimental.
	XmlClassifier *AwsClassifier_XmlClassifierProperty `field:"optional" json:"xmlClassifier" yaml:"xmlClassifier"`
}
