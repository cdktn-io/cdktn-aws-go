...
// Experimental.
type AwsCatalogTable_IcebergTableInputProperty struct {
	...
	// Experimental.
	Schema *AwsCatalogTable_SchemaProperty `field:"required" json:"schema" yaml:"schema"`
	...
	// Experimental.
	PartitionSpec *AwsCatalogTable_PartitionSpecProperty `field:"optional" json:"partitionSpec" yaml:"partitionSpec"`
	...
	// Experimental.
	SortOrder *AwsCatalogTable_SortOrderProperty `field:"optional" json:"sortOrder" yaml:"sortOrder"`
}
