...
// Experimental.
type AwsDataCatalogEncryptionSettingsConfig struct {
	// Experimental.
	...
	// Experimental.
	DataCatalogEncryptionSettings *AwsDataCatalogEncryptionSettings_DataCatalogEncryptionSettingsProperty `field:"required" json:"dataCatalogEncryptionSettings" yaml:"dataCatalogEncryptionSettings"`
