...
// Experimental.
type AwsPartitionIndexConfig struct {
	// Experimental.
	...
	// Experimental.
	PartitionIndex *AwsPartitionIndex_PartitionIndexProperty `field:"required" json:"partitionIndex" yaml:"partitionIndex"`
	...
	// Experimental.
	Timeouts *AwsPartitionIndex_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
