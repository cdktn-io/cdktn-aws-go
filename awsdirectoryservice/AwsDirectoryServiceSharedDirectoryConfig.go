...
// Experimental.
type AwsDirectoryServiceSharedDirectoryConfig struct {
	// Experimental.
	...
	// Experimental.
	Target *AwsDirectoryServiceSharedDirectory_TargetProperty `field:"required" json:"target" yaml:"target"`
	...
	// Experimental.
	Timeouts *AwsDirectoryServiceSharedDirectory_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
