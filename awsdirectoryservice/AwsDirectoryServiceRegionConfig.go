...
// Experimental.
type AwsDirectoryServiceRegionConfig struct {
	// Experimental.
	...
	// Experimental.
	VpcSettings *AwsDirectoryServiceRegion_VpcSettingsProperty `field:"required" json:"vpcSettings" yaml:"vpcSettings"`
	...
	// Experimental.
	Timeouts *AwsDirectoryServiceRegion_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
