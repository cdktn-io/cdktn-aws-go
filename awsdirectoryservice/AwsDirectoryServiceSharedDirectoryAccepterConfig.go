...
// Experimental.
type AwsDirectoryServiceSharedDirectoryAccepterConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsDirectoryServiceSharedDirectoryAccepter_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
