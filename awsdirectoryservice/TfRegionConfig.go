...
type TfRegionConfig struct {
	...
	// Experimental.
	VpcSettings *TfRegion_VpcSettingsProperty `field:"required" json:"vpcSettings" yaml:"vpcSettings"`
	...
	// Experimental.
	Timeouts *TfRegion_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
