...
// Experimental.
type AwsDirectoryServiceRadiusSettingsConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsDirectoryServiceRadiusSettings_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
