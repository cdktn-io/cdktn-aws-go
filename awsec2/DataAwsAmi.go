...
type DataAwsAmi interface {
	...
	Arn() *string
	// Experimental.
	BlockDeviceMappings() DataAwsAmi_BlockDeviceMappingsPropertyList
	// Experimental.
	BootMode() *string
	// Experimental.
	...
	// Experimental.
	Filter() DataAwsAmi_FilterPropertyList
	// Experimental.
	...
	// Experimental.
	ProductCodes() DataAwsAmi_ProductCodesPropertyList
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsAmi_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsAmi_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsAmi) BlockDeviceMappings() DataAwsAmi_BlockDeviceMappingsPropertyList {
	var returns DataAwsAmi_BlockDeviceMappingsPropertyList
	_jsii_.Get(
		j,
		"blockDeviceMappings",
		&returns,
...
func (j *jsiiProxy_DataAwsAmi) Filter() DataAwsAmi_FilterPropertyList {
	var returns DataAwsAmi_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsAmi) ProductCodes() DataAwsAmi_ProductCodesPropertyList {
	var returns DataAwsAmi_ProductCodesPropertyList
	_jsii_.Get(
		j,
		"productCodes",
		&returns,
...
func (j *jsiiProxy_DataAwsAmi) Timeouts() DataAwsAmi_TimeoutsPropertyOutputReference {
	var returns DataAwsAmi_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (d *jsiiProxy_DataAwsAmi) PutTimeouts(value *DataAwsAmi_TimeoutsProperty) {
