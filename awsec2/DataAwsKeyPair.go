...
type DataAwsKeyPair interface {
	...
	// Experimental.
	Filter() DataAwsKeyPair_FilterPropertyList
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsKeyPair_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsKeyPair_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsKeyPair) Filter() DataAwsKeyPair_FilterPropertyList {
	var returns DataAwsKeyPair_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsKeyPair) Timeouts() DataAwsKeyPair_TimeoutsPropertyOutputReference {
	var returns DataAwsKeyPair_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (d *jsiiProxy_DataAwsKeyPair) PutTimeouts(value *DataAwsKeyPair_TimeoutsProperty) {
