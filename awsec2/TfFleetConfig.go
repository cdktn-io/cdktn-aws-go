...
type TfFleetConfig struct {
	...
	// Experimental.
	TargetCapacitySpecification *TfFleet_TargetCapacitySpecificationProperty `field:"required" json:"targetCapacitySpecification" yaml:"targetCapacitySpecification"`
	...
	// Experimental.
	OnDemandOptions *TfFleet_OnDemandOptionsProperty `field:"optional" json:"onDemandOptions" yaml:"onDemandOptions"`
	...
	// Experimental.
	SpotOptions *TfFleet_SpotOptionsProperty `field:"optional" json:"spotOptions" yaml:"spotOptions"`
