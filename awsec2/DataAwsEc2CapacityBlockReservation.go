...
type DataAwsEc2CapacityBlockReservation interface {
	...
	// Experimental.
	CommitmentInfo() DataAwsEc2CapacityBlockReservation_CommitmentInfoPropertyOutputReference
	// Experimental.
	...
	EndDateType() *string
	// Experimental.
	Filter() DataAwsEc2CapacityBlockReservation_FilterPropertyList
	// Experimental.
	...
	InstanceType() *string
	// Experimental.
	InterruptibleCapacityAllocation() DataAwsEc2CapacityBlockReservation_InterruptibleCapacityAllocationPropertyOutputReference
	// Experimental.
	InterruptionInfo() DataAwsEc2CapacityBlockReservation_InterruptionInfoPropertyOutputReference
	// Experimental.
...
func (j *jsiiProxy_DataAwsEc2CapacityBlockReservation) CommitmentInfo() DataAwsEc2CapacityBlockReservation_CommitmentInfoPropertyOutputReference {
	var returns DataAwsEc2CapacityBlockReservation_CommitmentInfoPropertyOutputReference
	_jsii_.Get(
		j,
		"commitmentInfo",
		&returns,
...
func (j *jsiiProxy_DataAwsEc2CapacityBlockReservation) Filter() DataAwsEc2CapacityBlockReservation_FilterPropertyList {
	var returns DataAwsEc2CapacityBlockReservation_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsEc2CapacityBlockReservation) InterruptibleCapacityAllocation() DataAwsEc2CapacityBlockReservation_InterruptibleCapacityAllocationPropertyOutputReference {
	var returns DataAwsEc2CapacityBlockReservation_InterruptibleCapacityAllocationPropertyOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsEc2CapacityBlockReservation) InterruptionInfo() DataAwsEc2CapacityBlockReservation_InterruptionInfoPropertyOutputReference {
	var returns DataAwsEc2CapacityBlockReservation_InterruptionInfoPropertyOutputReference
	_jsii_.Get(
		j,
		"interruptionInfo",
		&returns,
...
func NewDataAwsEc2CapacityBlockReservation(scope constructs.Construct, id *string, config *DataAwsEc2CapacityBlockReservationConfig) DataAwsEc2CapacityBlockReservation {
	...
	_jsii_.Create(
		"@cdktn/aws-ec2.DataAwsEc2CapacityBlockReservation",
