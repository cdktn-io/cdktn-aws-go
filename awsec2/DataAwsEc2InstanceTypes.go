...
type DataAwsEc2InstanceTypes interface {
	...
	// Experimental.
	Filter() DataAwsEc2InstanceTypes_FilterPropertyList
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsEc2InstanceTypes_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsEc2InstanceTypes_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsEc2InstanceTypes) Filter() DataAwsEc2InstanceTypes_FilterPropertyList {
	var returns DataAwsEc2InstanceTypes_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsEc2InstanceTypes) Timeouts() DataAwsEc2InstanceTypes_TimeoutsPropertyOutputReference {
	var returns DataAwsEc2InstanceTypes_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewDataAwsEc2InstanceTypes(scope constructs.Construct, id *string, config *DataAwsEc2InstanceTypesConfig) DataAwsEc2InstanceTypes {
	...
	_jsii_.Create(
		"@cdktn/aws-ec2.DataAwsEc2InstanceTypes",
...
func (d *jsiiProxy_DataAwsEc2InstanceTypes) PutTimeouts(value *DataAwsEc2InstanceTypes_TimeoutsProperty) {
