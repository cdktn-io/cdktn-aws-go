...
// Experimental.
type AwsEc2DefaultCreditSpecificationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsEc2DefaultCreditSpecification_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
