...
// Experimental.
type AwsPlaceIndexConfig struct {
	// Experimental.
	...
	// Experimental.
	DataSourceConfiguration *AwsPlaceIndex_DataSourceConfigurationProperty `field:"optional" json:"dataSourceConfiguration" yaml:"dataSourceConfiguration"`
