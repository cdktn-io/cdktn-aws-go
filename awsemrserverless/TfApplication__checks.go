...
func (t *jsiiProxy_TfApplication) validatePutInitialCapacityParameters(value interface{}) error {
	...
	case *[]*TfApplication_InitialCapacityProperty:
		value := value.(*[]*TfApplication_InitialCapacityProperty)
	...
	case []*TfApplication_InitialCapacityProperty:
		value_ := value.([]*TfApplication_InitialCapacityProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*TfApplication_InitialCapacityProperty; received %#v (a %T)", value, value)
		}
	}
...
func (t *jsiiProxy_TfApplication) validatePutRuntimeConfigurationParameters(value interface{}) error {
	...
	case *[]*TfApplication_RuntimeConfigurationProperty:
		value := value.(*[]*TfApplication_RuntimeConfigurationProperty)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*TfApplication_RuntimeConfigurationProperty:
		value_ := value.([]*TfApplication_RuntimeConfigurationProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*TfApplication_RuntimeConfigurationProperty; received %#v (a %T)", value, value)
		}
	}
