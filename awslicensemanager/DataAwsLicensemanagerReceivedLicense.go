...
type DataAwsLicensemanagerReceivedLicense interface {
	...
	// Experimental.
	ConsumptionConfiguration() DataAwsLicensemanagerReceivedLicense_ConsumptionConfigurationPropertyList
	// Experimental.
	Count() interface{}
	// Experimental.
	...
	// Experimental.
	Entitlements() DataAwsLicensemanagerReceivedLicense_EntitlementsPropertyList
	// Experimental.
	...
	IdInput() *string
	// Experimental.
	Issuer() DataAwsLicensemanagerReceivedLicense_IssuerPropertyList
	// Experimental.
	LicenseArn() *string
	// Experimental.
	...
	// Experimental.
	LicenseMetadata() DataAwsLicensemanagerReceivedLicense_LicenseMetadataPropertyList
	// Experimental.
	LicenseName() *string
	// Experimental.
	...
	// Experimental.
	ReceivedMetadata() DataAwsLicensemanagerReceivedLicense_ReceivedMetadataPropertyList
	// Experimental.
	Region() *string
	// Experimental.
	...
	// Experimental.
	Validity() DataAwsLicensemanagerReceivedLicense_ValidityPropertyList
	// Experimental.
	Version() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicense) ConsumptionConfiguration() DataAwsLicensemanagerReceivedLicense_ConsumptionConfigurationPropertyList {
	var returns DataAwsLicensemanagerReceivedLicense_ConsumptionConfigurationPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicense) Entitlements() DataAwsLicensemanagerReceivedLicense_EntitlementsPropertyList {
	var returns DataAwsLicensemanagerReceivedLicense_EntitlementsPropertyList
	_jsii_.Get(
		j,
		"entitlements",
		&returns,
...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicense) Issuer() DataAwsLicensemanagerReceivedLicense_IssuerPropertyList {
	var returns DataAwsLicensemanagerReceivedLicense_IssuerPropertyList
	_jsii_.Get(
		j,
		"issuer",
		&returns,
...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicense) LicenseMetadata() DataAwsLicensemanagerReceivedLicense_LicenseMetadataPropertyList {
	var returns DataAwsLicensemanagerReceivedLicense_LicenseMetadataPropertyList
	_jsii_.Get(
		j,
		"licenseMetadata",
		&returns,
...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicense) ReceivedMetadata() DataAwsLicensemanagerReceivedLicense_ReceivedMetadataPropertyList {
	var returns DataAwsLicensemanagerReceivedLicense_ReceivedMetadataPropertyList
	_jsii_.Get(
		j,
		"receivedMetadata",
		&returns,
...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicense) Validity() DataAwsLicensemanagerReceivedLicense_ValidityPropertyList {
	var returns DataAwsLicensemanagerReceivedLicense_ValidityPropertyList
	_jsii_.Get(
		j,
		"validity",
		&returns,
...
func NewDataAwsLicensemanagerReceivedLicense(scope constructs.Construct, id *string, config *DataAwsLicensemanagerReceivedLicenseConfig) DataAwsLicensemanagerReceivedLicense {
	...
	_jsii_.Create(
		"@cdktn/aws-license-manager.DataAwsLicensemanagerReceivedLicense",
