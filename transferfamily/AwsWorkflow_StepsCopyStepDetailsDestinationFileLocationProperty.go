...
// Experimental.
type AwsWorkflow_StepsCopyStepDetailsDestinationFileLocationProperty struct {
	...
	// Experimental.
	EfsFileLocation *AwsWorkflow_StepsCopyStepDetailsDestinationFileLocationEfsFileLocationProperty `field:"optional" json:"efsFileLocation" yaml:"efsFileLocation"`
	...
	// Experimental.
	S3FileLocation *AwsWorkflow_StepsCopyStepDetailsDestinationFileLocationS3FileLocationProperty `field:"optional" json:"s3FileLocation" yaml:"s3FileLocation"`
}
