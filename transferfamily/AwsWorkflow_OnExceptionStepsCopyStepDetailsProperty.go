...
// Experimental.
type AwsWorkflow_OnExceptionStepsCopyStepDetailsProperty struct {
	...
	// Experimental.
	DestinationFileLocation *AwsWorkflow_OnExceptionStepsCopyStepDetailsDestinationFileLocationProperty `field:"optional" json:"destinationFileLocation" yaml:"destinationFileLocation"`
