...
// Experimental.
type AwsWorkflow_OnExceptionStepsDecryptStepDetailsProperty struct {
	...
	// Experimental.
	DestinationFileLocation *AwsWorkflow_OnExceptionStepsDecryptStepDetailsDestinationFileLocationProperty `field:"optional" json:"destinationFileLocation" yaml:"destinationFileLocation"`
