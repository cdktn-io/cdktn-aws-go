...
// Experimental.
type AwsWorkflow_OnExceptionStepsCopyStepDetailsDestinationFileLocationProperty struct {
	...
	// Experimental.
	EfsFileLocation *AwsWorkflow_OnExceptionStepsCopyStepDetailsDestinationFileLocationEfsFileLocationProperty `field:"optional" json:"efsFileLocation" yaml:"efsFileLocation"`
	...
	// Experimental.
	S3FileLocation *AwsWorkflow_OnExceptionStepsCopyStepDetailsDestinationFileLocationS3FileLocationProperty `field:"optional" json:"s3FileLocation" yaml:"s3FileLocation"`
}
