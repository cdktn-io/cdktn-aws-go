...
// Experimental.
type AwsWorkflow_StepsDecryptStepDetailsProperty struct {
	...
	// Experimental.
	DestinationFileLocation *AwsWorkflow_StepsDecryptStepDetailsDestinationFileLocationProperty `field:"optional" json:"destinationFileLocation" yaml:"destinationFileLocation"`
