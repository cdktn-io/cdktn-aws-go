...
// Experimental.
type AwsPolicy_MetricsProperty struct {
	...
	// Experimental.
	MetricStat *AwsPolicy_TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecificationMetricsMetricStatProperty `field:"optional" json:"metricStat" yaml:"metricStat"`
