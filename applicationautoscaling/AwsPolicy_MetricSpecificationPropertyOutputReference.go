...
func (j *jsiiProxy_AwsPolicy_MetricSpecificationPropertyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AwsPolicy_MetricSpecificationPropertyOutputReference) TargetValue() *string {
	var returns *string
	_jsii_.Get(
		j,
		"targetValue",
...
func (j *jsiiProxy_AwsPolicy_MetricSpecificationPropertyOutputReference) TargetValueInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"targetValueInput",
...
// Experimental.
func NewAwsPolicy_MetricSpecificationPropertyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) AwsPolicy_MetricSpecificationPropertyOutputReference {
	_init_.Initialize()

	if err := validateNewAwsPolicy_MetricSpecificationPropertyOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_AwsPolicy_MetricSpecificationPropertyOutputReference{}

	_jsii_.Create(
		"@cdktn/aws-application-auto-scaling.AwsPolicy.MetricSpecificationPropertyOutputReference",
...
// Experimental.
func NewAwsPolicy_MetricSpecificationPropertyOutputReference_Override(a AwsPolicy_MetricSpecificationPropertyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AwsPolicy_MetricSpecificationPropertyOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_AwsPolicy_MetricSpecificationPropertyOutputReference)SetTargetValue(val *string) {
