...
type AwsPolicy_CustomizedMetricSpecificationPropertyOutputReference interface {
	...
	// Experimental.
	Dimensions() AwsPolicy_TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecificationDimensionsPropertyList
	// Experimental.
...
func (j *jsiiProxy_AwsPolicy_CustomizedMetricSpecificationPropertyOutputReference) Dimensions() AwsPolicy_TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecificationDimensionsPropertyList {
	var returns AwsPolicy_TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecificationDimensionsPropertyList
	_jsii_.Get(
		j,
		"dimensions",
		&returns,
...
func (j *jsiiProxy_AwsPolicy_CustomizedMetricSpecificationPropertyOutputReference) DimensionsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dimensionsInput",
...
func NewAwsPolicy_CustomizedMetricSpecificationPropertyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AwsPolicy_CustomizedMetricSpecificationPropertyOutputReference {
	...
	_jsii_.Create(
		"@cdktn/aws-application-auto-scaling.AwsPolicy.CustomizedMetricSpecificationPropertyOutputReference",
...
func (a *jsiiProxy_AwsPolicy_CustomizedMetricSpecificationPropertyOutputReference) PutDimensions(value interface{}) {
...
func (a *jsiiProxy_AwsPolicy_CustomizedMetricSpecificationPropertyOutputReference) ResetDimensions() {
	_jsii_.InvokeVoid(
		a,
		"resetDimensions",
		nil, // no parameters
