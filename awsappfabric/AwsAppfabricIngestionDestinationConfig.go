...
// Experimental.
type AwsAppfabricIngestionDestinationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsAppfabricIngestionDestination_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
