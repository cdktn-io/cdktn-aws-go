...
// Experimental.
type AwsPipesPipe_SelfManagedKafkaParametersProperty struct {
	...
	// Experimental.
	Credentials *AwsPipesPipe_SourceParametersSelfManagedKafkaParametersCredentialsProperty `field:"optional" json:"credentials" yaml:"credentials"`
	...
	// Experimental.
	Vpc *AwsPipesPipe_VpcProperty `field:"optional" json:"vpc" yaml:"vpc"`
}
