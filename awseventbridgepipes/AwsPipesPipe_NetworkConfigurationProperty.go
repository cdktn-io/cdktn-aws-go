...
// Experimental.
type AwsPipesPipe_NetworkConfigurationProperty struct {
	...
	// Experimental.
	AwsVpcConfiguration *AwsPipesPipe_AwsVpcConfigurationProperty `field:"optional" json:"awsVpcConfiguration" yaml:"awsVpcConfiguration"`
}
