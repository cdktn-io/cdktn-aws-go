...
// Experimental.
type AwsPipesPipe_SourceParametersKinesisStreamParametersProperty struct {
	...
	// Experimental.
	DeadLetterConfig *AwsPipesPipe_SourceParametersKinesisStreamParametersDeadLetterConfigProperty `field:"optional" json:"deadLetterConfig" yaml:"deadLetterConfig"`
