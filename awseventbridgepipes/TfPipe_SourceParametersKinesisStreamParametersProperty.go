...
// Experimental.
type TfPipe_SourceParametersKinesisStreamParametersProperty struct {
	...
	// Experimental.
	DeadLetterConfig *TfPipe_SourceParametersKinesisStreamParametersDeadLetterConfigProperty `field:"optional" json:"deadLetterConfig" yaml:"deadLetterConfig"`
