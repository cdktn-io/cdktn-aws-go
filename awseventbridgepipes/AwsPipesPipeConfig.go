...
// Experimental.
type AwsPipesPipeConfig struct {
	// Experimental.
	...
	// Experimental.
	EnrichmentParameters *AwsPipesPipe_EnrichmentParametersProperty `field:"optional" json:"enrichmentParameters" yaml:"enrichmentParameters"`
	...
	// Experimental.
	LogConfiguration *AwsPipesPipe_LogConfigurationProperty `field:"optional" json:"logConfiguration" yaml:"logConfiguration"`
	...
	// Experimental.
	SourceParameters *AwsPipesPipe_SourceParametersProperty `field:"optional" json:"sourceParameters" yaml:"sourceParameters"`
	...
	// Experimental.
	TargetParameters *AwsPipesPipe_TargetParametersProperty `field:"optional" json:"targetParameters" yaml:"targetParameters"`
	// timeouts block.
	//
	...
	// Experimental.
	Timeouts *AwsPipesPipe_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
