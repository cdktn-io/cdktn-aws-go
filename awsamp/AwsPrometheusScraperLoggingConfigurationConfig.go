...
// Experimental.
type AwsPrometheusScraperLoggingConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsPrometheusScraperLoggingConfiguration_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
