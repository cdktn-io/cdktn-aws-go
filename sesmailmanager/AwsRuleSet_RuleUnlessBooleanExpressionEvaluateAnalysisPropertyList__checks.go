...
func (j *jsiiProxy_AwsRuleSet_RuleUnlessBooleanExpressionEvaluateAnalysisPropertyList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*AwsRuleSet_RuleUnlessBooleanExpressionEvaluateAnalysisProperty:
		val := val.(*[]*AwsRuleSet_RuleUnlessBooleanExpressionEvaluateAnalysisProperty)
	...
	case []*AwsRuleSet_RuleUnlessBooleanExpressionEvaluateAnalysisProperty:
		val_ := val.([]*AwsRuleSet_RuleUnlessBooleanExpressionEvaluateAnalysisProperty)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*AwsRuleSet_RuleUnlessBooleanExpressionEvaluateAnalysisProperty; received %#v (a %T)", val, val)
		}
	}
