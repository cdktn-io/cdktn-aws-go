...
func (j *jsiiProxy_AwsKey) validateSetKeyParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_AwsKey) validateSetKeyValueStoreArnParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_AwsKey) validateSetValueParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
