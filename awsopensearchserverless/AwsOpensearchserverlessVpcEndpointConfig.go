...
// Experimental.
type AwsOpensearchserverlessVpcEndpointConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsOpensearchserverlessVpcEndpoint_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
