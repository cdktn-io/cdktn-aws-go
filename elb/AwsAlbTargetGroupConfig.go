...
// Experimental.
type AwsAlbTargetGroupConfig struct {
	// Experimental.
	...
	// Experimental.
	HealthCheck *AwsAlbTargetGroup_HealthCheckProperty `field:"optional" json:"healthCheck" yaml:"healthCheck"`
	...
	// Experimental.
	Stickiness *AwsAlbTargetGroup_StickinessProperty `field:"optional" json:"stickiness" yaml:"stickiness"`
	...
	// Experimental.
	TargetGroupHealth *AwsAlbTargetGroup_TargetGroupHealthProperty `field:"optional" json:"targetGroupHealth" yaml:"targetGroupHealth"`
