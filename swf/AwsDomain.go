...
import (
	...
	_init_ "github.com/cdktn-io/cdktn-aws-go/swf/jsii"

	"github.com/aws/constructs-go/constructs/v10"
	"github.com/cdktn-io/cdktn-aws-go/swf/internal"
...
func (j *jsiiProxy_AwsDomain) NamePrefix() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namePrefix",
...
func (j *jsiiProxy_AwsDomain) NamePrefixInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namePrefixInput",
...
func (j *jsiiProxy_AwsDomain) WorkflowExecutionRetentionPeriodInDays() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsDomain) WorkflowExecutionRetentionPeriodInDaysInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsDomain)SetNamePrefix(val *string) {
...
func (j *jsiiProxy_AwsDomain)SetWorkflowExecutionRetentionPeriodInDays(val *string) {
...
func (a *jsiiProxy_AwsDomain) ResetName() {
	_jsii_.InvokeVoid(
		a,
		"resetName",
		nil, // no parameters
...
func (a *jsiiProxy_AwsDomain) ResetNamePrefix() {
	_jsii_.InvokeVoid(
		a,
		"resetNamePrefix",
		nil, // no parameters
