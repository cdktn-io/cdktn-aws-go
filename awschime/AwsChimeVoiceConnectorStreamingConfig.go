...
// Experimental.
type AwsChimeVoiceConnectorStreamingConfig struct {
	// Experimental.
	...
	// Experimental.
	MediaInsightsConfiguration *AwsChimeVoiceConnectorStreaming_MediaInsightsConfigurationProperty `field:"optional" json:"mediaInsightsConfiguration" yaml:"mediaInsightsConfiguration"`
