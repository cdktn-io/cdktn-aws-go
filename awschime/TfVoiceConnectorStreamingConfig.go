...
// Experimental.
type TfVoiceConnectorStreamingConfig struct {
	// Experimental.
	...
	// Experimental.
	MediaInsightsConfiguration *TfVoiceConnectorStreaming_MediaInsightsConfigurationProperty `field:"optional" json:"mediaInsightsConfiguration" yaml:"mediaInsightsConfiguration"`
