...
// Experimental.
type AwsAppMonitorConfig struct {
	// Experimental.
	...
	// Experimental.
	AppMonitorConfiguration *AwsAppMonitor_AppMonitorConfigurationProperty `field:"optional" json:"appMonitorConfiguration" yaml:"appMonitorConfiguration"`
	// custom_events block.
	//
	...
	// Experimental.
	CustomEvents *AwsAppMonitor_CustomEventsProperty `field:"optional" json:"customEvents" yaml:"customEvents"`
