...
type TfFunctionConfig struct {
	...
	// Experimental.
	Runtime *TfFunction_RuntimeProperty `field:"optional" json:"runtime" yaml:"runtime"`
	// sync_config block.
	//
	...
	// Experimental.
	SyncConfig *TfFunction_SyncConfigProperty `field:"optional" json:"syncConfig" yaml:"syncConfig"`
}
