...
// Experimental.
type TfGraphqlApiConfig struct {
	// Experimental.
	...
	// Experimental.
	EnhancedMetricsConfig *TfGraphqlApi_EnhancedMetricsConfigProperty `field:"optional" json:"enhancedMetricsConfig" yaml:"enhancedMetricsConfig"`
	...
	// Experimental.
	LambdaAuthorizerConfig *TfGraphqlApi_LambdaAuthorizerConfigProperty `field:"optional" json:"lambdaAuthorizerConfig" yaml:"lambdaAuthorizerConfig"`
	// log_config block.
	//
	...
	// Experimental.
	LogConfig *TfGraphqlApi_LogConfigProperty `field:"optional" json:"logConfig" yaml:"logConfig"`
	...
	// Experimental.
	OpenidConnectConfig *TfGraphqlApi_OpenidConnectConfigProperty `field:"optional" json:"openidConnectConfig" yaml:"openidConnectConfig"`
	...
	// Experimental.
	UserPoolConfig *TfGraphqlApi_UserPoolConfigProperty `field:"optional" json:"userPoolConfig" yaml:"userPoolConfig"`
