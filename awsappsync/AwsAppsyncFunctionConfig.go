...
// Experimental.
type AwsAppsyncFunctionConfig struct {
	// Experimental.
	...
	// Experimental.
	Runtime *AwsAppsyncFunction_RuntimeProperty `field:"optional" json:"runtime" yaml:"runtime"`
	// sync_config block.
	//
	...
	// Experimental.
	SyncConfig *AwsAppsyncFunction_SyncConfigProperty `field:"optional" json:"syncConfig" yaml:"syncConfig"`
}
