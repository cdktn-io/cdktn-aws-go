...
type AwsKeyspaceConfig struct {
	...
	// Experimental.
	ReplicationSpecification *AwsKeyspace_ReplicationSpecificationProperty `field:"optional" json:"replicationSpecification" yaml:"replicationSpecification"`
	...
	// Experimental.
	Timeouts *AwsKeyspace_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
