...
type DataAwsEc2LocalGatewayRouteTable interface {
	...
	// Experimental.
	Filter() DataAwsEc2LocalGatewayRouteTable_FilterPropertyList
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsEc2LocalGatewayRouteTable_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsEc2LocalGatewayRouteTable_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayRouteTable) Filter() DataAwsEc2LocalGatewayRouteTable_FilterPropertyList {
	var returns DataAwsEc2LocalGatewayRouteTable_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayRouteTable) Timeouts() DataAwsEc2LocalGatewayRouteTable_TimeoutsPropertyOutputReference {
	var returns DataAwsEc2LocalGatewayRouteTable_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (d *jsiiProxy_DataAwsEc2LocalGatewayRouteTable) PutTimeouts(value *DataAwsEc2LocalGatewayRouteTable_TimeoutsProperty) {
