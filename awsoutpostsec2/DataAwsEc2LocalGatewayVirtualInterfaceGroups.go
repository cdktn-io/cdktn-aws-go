...
type DataAwsEc2LocalGatewayVirtualInterfaceGroups interface {
	...
	// Experimental.
	Filter() DataAwsEc2LocalGatewayVirtualInterfaceGroups_FilterPropertyList
	// Experimental.
	...
	// Experimental.
	Timeouts() DataAwsEc2LocalGatewayVirtualInterfaceGroups_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *DataAwsEc2LocalGatewayVirtualInterfaceGroups_TimeoutsProperty)
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroups) Filter() DataAwsEc2LocalGatewayVirtualInterfaceGroups_FilterPropertyList {
	var returns DataAwsEc2LocalGatewayVirtualInterfaceGroups_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroups) Timeouts() DataAwsEc2LocalGatewayVirtualInterfaceGroups_TimeoutsPropertyOutputReference {
	var returns DataAwsEc2LocalGatewayVirtualInterfaceGroups_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (d *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroups) PutTimeouts(value *DataAwsEc2LocalGatewayVirtualInterfaceGroups_TimeoutsProperty) {
