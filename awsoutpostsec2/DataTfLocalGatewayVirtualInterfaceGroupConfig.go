...
// Experimental.
type DataTfLocalGatewayVirtualInterfaceGroupConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *DataTfLocalGatewayVirtualInterfaceGroup_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
