// cdk-terrain bindings for the S3 on Outposts group of terraform-provider-aws 6.62.0
...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/aws-s3-on-outposts.AwsEndpoint.NetworkInterfacesProperty",
		reflect.TypeOf((*AwsEndpoint_NetworkInterfacesProperty)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/aws-s3-on-outposts.AwsEndpoint.NetworkInterfacesPropertyList",
		reflect.TypeOf((*AwsEndpoint_NetworkInterfacesPropertyList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AwsEndpoint_NetworkInterfacesPropertyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/aws-s3-on-outposts.AwsEndpointConfig",
