...
type AwsPolicyConfig struct {
	...
	// Experimental.
	SecurityServicePolicyData *AwsPolicy_SecurityServicePolicyDataProperty `field:"required" json:"securityServicePolicyData" yaml:"securityServicePolicyData"`
	...
	// Experimental.
	ExcludeMap *AwsPolicy_ExcludeMapProperty `field:"optional" json:"excludeMap" yaml:"excludeMap"`
	...
	// Experimental.
	IncludeMap *AwsPolicy_IncludeMapProperty `field:"optional" json:"includeMap" yaml:"includeMap"`
