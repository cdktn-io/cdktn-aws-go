...
func (j *jsiiProxy_AwsAssociation) LicenseConfigurationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsAssociation) LicenseConfigurationArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsAssociation) ResourceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceArn",
...
func (j *jsiiProxy_AwsAssociation) ResourceArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceArnInput",
...
func NewAwsAssociation(scope constructs.Construct, id *string, config *AwsAssociationConfig) AwsAssociation {
	...
	_jsii_.Create(
		"@cdktn/aws-license-manager.AwsAssociation",
...
func (j *jsiiProxy_AwsAssociation)SetLicenseConfigurationArn(val *string) {
...
func (j *jsiiProxy_AwsAssociation)SetResourceArn(val *string) {
