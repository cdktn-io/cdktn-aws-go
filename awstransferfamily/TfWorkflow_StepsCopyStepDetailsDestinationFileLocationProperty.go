...
// Experimental.
type TfWorkflow_StepsCopyStepDetailsDestinationFileLocationProperty struct {
	...
	// Experimental.
	EfsFileLocation *TfWorkflow_StepsCopyStepDetailsDestinationFileLocationEfsFileLocationProperty `field:"optional" json:"efsFileLocation" yaml:"efsFileLocation"`
	...
	// Experimental.
	S3FileLocation *TfWorkflow_StepsCopyStepDetailsDestinationFileLocationS3FileLocationProperty `field:"optional" json:"s3FileLocation" yaml:"s3FileLocation"`
}
