...
// Experimental.
type AwsTransferWorkflow_StepsDecryptStepDetailsProperty struct {
	...
	// Experimental.
	DestinationFileLocation *AwsTransferWorkflow_StepsDecryptStepDetailsDestinationFileLocationProperty `field:"optional" json:"destinationFileLocation" yaml:"destinationFileLocation"`
