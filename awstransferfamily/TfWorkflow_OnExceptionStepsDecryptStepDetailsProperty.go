...
// Experimental.
type TfWorkflow_OnExceptionStepsDecryptStepDetailsProperty struct {
	...
	// Experimental.
	DestinationFileLocation *TfWorkflow_OnExceptionStepsDecryptStepDetailsDestinationFileLocationProperty `field:"optional" json:"destinationFileLocation" yaml:"destinationFileLocation"`
