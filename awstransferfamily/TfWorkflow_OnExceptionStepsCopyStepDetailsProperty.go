...
// Experimental.
type TfWorkflow_OnExceptionStepsCopyStepDetailsProperty struct {
	...
	// Experimental.
	DestinationFileLocation *TfWorkflow_OnExceptionStepsCopyStepDetailsDestinationFileLocationProperty `field:"optional" json:"destinationFileLocation" yaml:"destinationFileLocation"`
