...
// Experimental.
type AwsTransferWorkflow_StepsCopyStepDetailsProperty struct {
	...
	// Experimental.
	DestinationFileLocation *AwsTransferWorkflow_StepsCopyStepDetailsDestinationFileLocationProperty `field:"optional" json:"destinationFileLocation" yaml:"destinationFileLocation"`
