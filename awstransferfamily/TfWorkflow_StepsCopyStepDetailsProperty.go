...
// Experimental.
type TfWorkflow_StepsCopyStepDetailsProperty struct {
	...
	// Experimental.
	DestinationFileLocation *TfWorkflow_StepsCopyStepDetailsDestinationFileLocationProperty `field:"optional" json:"destinationFileLocation" yaml:"destinationFileLocation"`
