...
// Experimental.
type AwsTransferUserConfig struct {
	// Experimental.
	...
	// Experimental.
	PosixProfile *AwsTransferUser_PosixProfileProperty `field:"optional" json:"posixProfile" yaml:"posixProfile"`
	...
	// Experimental.
	Timeouts *AwsTransferUser_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
