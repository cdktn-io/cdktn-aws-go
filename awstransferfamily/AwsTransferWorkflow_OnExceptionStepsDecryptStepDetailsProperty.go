...
// Experimental.
type AwsTransferWorkflow_OnExceptionStepsDecryptStepDetailsProperty struct {
	...
	// Experimental.
	DestinationFileLocation *AwsTransferWorkflow_OnExceptionStepsDecryptStepDetailsDestinationFileLocationProperty `field:"optional" json:"destinationFileLocation" yaml:"destinationFileLocation"`
