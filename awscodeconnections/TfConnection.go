...
func (j *jsiiProxy_TfConnection) ConnectionStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"connectionStatus",
...
func (j *jsiiProxy_TfConnection) HostArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostArn",
...
func (j *jsiiProxy_TfConnection) HostArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostArnInput",
...
func (j *jsiiProxy_TfConnection) ProviderType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"providerType",
...
func (j *jsiiProxy_TfConnection) ProviderTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"providerTypeInput",
...
func (j *jsiiProxy_TfConnection) TagsAll() cdktn.StringMap {
...
func (j *jsiiProxy_TfConnection)SetHostArn(val *string) {
...
func (j *jsiiProxy_TfConnection)SetProviderType(val *string) {
...
func (t *jsiiProxy_TfConnection) ResetHostArn() {
	_jsii_.InvokeVoid(
		t,
		"resetHostArn",
		nil, // no parameters
...
func (t *jsiiProxy_TfConnection) ResetProviderType() {
	_jsii_.InvokeVoid(
		t,
		"resetProviderType",
		nil, // no parameters
