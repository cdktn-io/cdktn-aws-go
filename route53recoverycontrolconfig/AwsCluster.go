...
type AwsCluster interface {
	...
	// Experimental.
	ClusterEndpoints() AwsCluster_ClusterEndpointsPropertyList
	// Experimental.
...
func (j *jsiiProxy_AwsCluster) ClusterEndpoints() AwsCluster_ClusterEndpointsPropertyList {
	var returns AwsCluster_ClusterEndpointsPropertyList
	_jsii_.Get(
		j,
		"clusterEndpoints",
		&returns,
