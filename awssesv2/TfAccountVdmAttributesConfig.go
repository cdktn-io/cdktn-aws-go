...
// Experimental.
type TfAccountVdmAttributesConfig struct {
	// Experimental.
	...
	// Experimental.
	DashboardAttributes *TfAccountVdmAttributes_DashboardAttributesProperty `field:"optional" json:"dashboardAttributes" yaml:"dashboardAttributes"`
	...
	// Experimental.
	GuardianAttributes *TfAccountVdmAttributes_GuardianAttributesProperty `field:"optional" json:"guardianAttributes" yaml:"guardianAttributes"`
