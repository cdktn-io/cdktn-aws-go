...
// Experimental.
type AwsSesv2EmailIdentityConfig struct {
	// Experimental.
	...
	// Experimental.
	DkimSigningAttributes *AwsSesv2EmailIdentity_DkimSigningAttributesProperty `field:"optional" json:"dkimSigningAttributes" yaml:"dkimSigningAttributes"`
