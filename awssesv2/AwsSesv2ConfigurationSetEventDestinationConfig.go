...
// Experimental.
type AwsSesv2ConfigurationSetEventDestinationConfig struct {
	// Experimental.
	...
	// Experimental.
	EventDestination *AwsSesv2ConfigurationSetEventDestination_EventDestinationProperty `field:"required" json:"eventDestination" yaml:"eventDestination"`
