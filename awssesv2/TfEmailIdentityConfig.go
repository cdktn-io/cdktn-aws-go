...
// Experimental.
type TfEmailIdentityConfig struct {
	// Experimental.
	...
	// Experimental.
	DkimSigningAttributes *TfEmailIdentity_DkimSigningAttributesProperty `field:"optional" json:"dkimSigningAttributes" yaml:"dkimSigningAttributes"`
