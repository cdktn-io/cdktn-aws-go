...
type DataAwsAcmpcaCertificateAuthority interface {
	...
	RegionInput() *string
	// Experimental.
	RevocationConfiguration() DataAwsAcmpcaCertificateAuthority_RevocationConfigurationPropertyList
	// Experimental.
	Serial() *string
	// Experimental.
	Status() *string
...
func (j *jsiiProxy_DataAwsAcmpcaCertificateAuthority) RevocationConfiguration() DataAwsAcmpcaCertificateAuthority_RevocationConfigurationPropertyList {
	var returns DataAwsAcmpcaCertificateAuthority_RevocationConfigurationPropertyList
	_jsii_.Get(
		j,
...
func NewDataAwsAcmpcaCertificateAuthority(scope constructs.Construct, id *string, config *DataAwsAcmpcaCertificateAuthorityConfig) DataAwsAcmpcaCertificateAuthority {
	...
	_jsii_.Create(
		"@cdktn/aws-acm-pca.DataAwsAcmpcaCertificateAuthority",
