...
// Experimental.
type TfCertificateAuthorityConfig struct {
	// Experimental.
	...
	// Experimental.
	CertificateAuthorityConfiguration *TfCertificateAuthority_CertificateAuthorityConfigurationProperty `field:"required" json:"certificateAuthorityConfiguration" yaml:"certificateAuthorityConfiguration"`
	...
	// Experimental.
	RevocationConfiguration *TfCertificateAuthority_RevocationConfigurationProperty `field:"optional" json:"revocationConfiguration" yaml:"revocationConfiguration"`
	...
	// Experimental.
	Timeouts *TfCertificateAuthority_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
