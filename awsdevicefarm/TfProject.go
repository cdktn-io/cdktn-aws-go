...
func (j *jsiiProxy_TfProject) DefaultJobTimeoutMinutes() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TfProject) DefaultJobTimeoutMinutesInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TfProject)SetDefaultJobTimeoutMinutes(val *float64) {
...
func (t *jsiiProxy_TfProject) ResetDefaultJobTimeoutMinutes() {
	_jsii_.InvokeVoid(
		t,
		"resetDefaultJobTimeoutMinutes",
		nil, // no parameters
