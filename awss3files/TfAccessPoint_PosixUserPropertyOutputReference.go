...
func (j *jsiiProxy_TfAccessPoint_PosixUserPropertyOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
// Experimental.
func NewTfAccessPoint_PosixUserPropertyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) TfAccessPoint_PosixUserPropertyOutputReference {
	_init_.Initialize()

	if err := validateNewTfAccessPoint_PosixUserPropertyOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
// Experimental.
func NewTfAccessPoint_PosixUserPropertyOutputReference_Override(t TfAccessPoint_PosixUserPropertyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_TfAccessPoint_PosixUserPropertyOutputReference)SetInternalValue(val interface{}) {
