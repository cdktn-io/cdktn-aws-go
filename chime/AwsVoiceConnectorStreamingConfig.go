...
// Experimental.
type AwsVoiceConnectorStreamingConfig struct {
	// Experimental.
	...
	// Experimental.
	MediaInsightsConfiguration *AwsVoiceConnectorStreaming_MediaInsightsConfigurationProperty `field:"optional" json:"mediaInsightsConfiguration" yaml:"mediaInsightsConfiguration"`
