...
type AwsAccessPointConfig struct {
	...
	// Experimental.
	PublicAccessBlockConfiguration *AwsAccessPoint_PublicAccessBlockConfigurationProperty `field:"optional" json:"publicAccessBlockConfiguration" yaml:"publicAccessBlockConfiguration"`
	...
	// Experimental.
	VpcConfiguration *AwsAccessPoint_VpcConfigurationProperty `field:"optional" json:"vpcConfiguration" yaml:"vpcConfiguration"`
}
