...
// Experimental.
type AwsMultiRegionAccessPointPolicyConfig struct {
	// Experimental.
	...
	// Experimental.
	Details *AwsMultiRegionAccessPointPolicy_DetailsProperty `field:"required" json:"details" yaml:"details"`
	...
	// Experimental.
	Timeouts *AwsMultiRegionAccessPointPolicy_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
