...
type AwsBucketLifecycleConfiguration_FilterPropertyOutputReference interface {
	...
	Fqn() *string
	// Experimental.
	InternalValue() *AwsBucketLifecycleConfiguration_FilterProperty
	// Experimental.
	SetInternalValue(val *AwsBucketLifecycleConfiguration_FilterProperty)
	// Experimental.
	Prefix() *string
	// Experimental.
...
func (j *jsiiProxy_AwsBucketLifecycleConfiguration_FilterPropertyOutputReference) InternalValue() *AwsBucketLifecycleConfiguration_FilterProperty {
...
func (j *jsiiProxy_AwsBucketLifecycleConfiguration_FilterPropertyOutputReference) Tags() *map[string]*string {
...
func (j *jsiiProxy_AwsBucketLifecycleConfiguration_FilterPropertyOutputReference) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Experimental.
func NewAwsBucketLifecycleConfiguration_FilterPropertyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AwsBucketLifecycleConfiguration_FilterPropertyOutputReference {
	_init_.Initialize()

	if err := validateNewAwsBucketLifecycleConfiguration_FilterPropertyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
// Experimental.
func NewAwsBucketLifecycleConfiguration_FilterPropertyOutputReference_Override(a AwsBucketLifecycleConfiguration_FilterPropertyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AwsBucketLifecycleConfiguration_FilterPropertyOutputReference)SetInternalValue(val *AwsBucketLifecycleConfiguration_FilterProperty) {
...
func (j *jsiiProxy_AwsBucketLifecycleConfiguration_FilterPropertyOutputReference)SetTags(val *map[string]*string) {
...
func (a *jsiiProxy_AwsBucketLifecycleConfiguration_FilterPropertyOutputReference) ResetTags() {
	_jsii_.InvokeVoid(
		a,
		"resetTags",
		nil, // no parameters
