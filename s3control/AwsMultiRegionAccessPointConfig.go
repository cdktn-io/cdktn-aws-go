...
// Experimental.
type AwsMultiRegionAccessPointConfig struct {
	// Experimental.
	...
	// Experimental.
	Details *AwsMultiRegionAccessPoint_DetailsProperty `field:"required" json:"details" yaml:"details"`
	...
	// Experimental.
	Timeouts *AwsMultiRegionAccessPoint_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
