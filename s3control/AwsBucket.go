...
func (j *jsiiProxy_AwsBucket) CreationDate() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creationDate",
...
func (j *jsiiProxy_AwsBucket) OutpostId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"outpostId",
...
func (j *jsiiProxy_AwsBucket) OutpostIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"outpostIdInput",
...
func (j *jsiiProxy_AwsBucket) PublicAccessBlockEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_AwsBucket)SetOutpostId(val *string) {
