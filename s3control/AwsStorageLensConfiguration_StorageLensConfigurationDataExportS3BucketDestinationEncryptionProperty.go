...
// Experimental.
type AwsStorageLensConfiguration_StorageLensConfigurationDataExportS3BucketDestinationEncryptionProperty struct {
	// sse_kms block.
	//
	...
	// Experimental.
	SseKms *AwsStorageLensConfiguration_StorageLensConfigurationDataExportS3BucketDestinationEncryptionSseKmsProperty `field:"optional" json:"sseKms" yaml:"sseKms"`
	// sse_s3 block.
	//
