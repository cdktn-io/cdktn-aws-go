...
func (j *jsiiProxy_DataAwsImage) ImageId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"imageId",
...
func (j *jsiiProxy_DataAwsImage) ImageIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"imageIdInput",
...
func (j *jsiiProxy_DataAwsImage) OperatingSystemType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"operatingSystemType",
...
func (j *jsiiProxy_DataAwsImage) RequiredTenancy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"requiredTenancy",
...
func (j *jsiiProxy_DataAwsImage)SetImageId(val *string) {
