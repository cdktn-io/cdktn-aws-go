...
// Experimental.
type AwsCodecatalystDevEnvironmentConfig struct {
	// Experimental.
	...
	// Experimental.
	Ides *AwsCodecatalystDevEnvironment_IdesProperty `field:"required" json:"ides" yaml:"ides"`
	...
	// Experimental.
	PersistentStorage *AwsCodecatalystDevEnvironment_PersistentStorageProperty `field:"required" json:"persistentStorage" yaml:"persistentStorage"`
	...
	// Experimental.
	Timeouts *AwsCodecatalystDevEnvironment_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
