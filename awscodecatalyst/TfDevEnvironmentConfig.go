...
// Experimental.
type TfDevEnvironmentConfig struct {
	// Experimental.
	...
	// Experimental.
	Ides *TfDevEnvironment_IdesProperty `field:"required" json:"ides" yaml:"ides"`
	...
	// Experimental.
	PersistentStorage *TfDevEnvironment_PersistentStorageProperty `field:"required" json:"persistentStorage" yaml:"persistentStorage"`
	...
	// Experimental.
	Timeouts *TfDevEnvironment_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
