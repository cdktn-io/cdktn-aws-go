...
type DataAwsCodecatalystDevEnvironment interface {
	...
	SetId(val *string)
	// Experimental.
	Ides() DataAwsCodecatalystDevEnvironment_IdesPropertyList
	// Experimental.
	IdInput() *string
	// Experimental.
	...
	// Experimental.
	PersistentStorage() DataAwsCodecatalystDevEnvironment_PersistentStoragePropertyList
	// Experimental.
	ProjectName() *string
	// Experimental.
	...
	RegionInput() *string
	// Experimental.
	Repositories() DataAwsCodecatalystDevEnvironment_RepositoriesPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsCodecatalystDevEnvironment) Ides() DataAwsCodecatalystDevEnvironment_IdesPropertyList {
	var returns DataAwsCodecatalystDevEnvironment_IdesPropertyList
	_jsii_.Get(
		j,
		"ides",
		&returns,
...
func (j *jsiiProxy_DataAwsCodecatalystDevEnvironment) PersistentStorage() DataAwsCodecatalystDevEnvironment_PersistentStoragePropertyList {
	var returns DataAwsCodecatalystDevEnvironment_PersistentStoragePropertyList
	_jsii_.Get(
		j,
		"persistentStorage",
		&returns,
...
func (j *jsiiProxy_DataAwsCodecatalystDevEnvironment) Repositories() DataAwsCodecatalystDevEnvironment_RepositoriesPropertyList {
	var returns DataAwsCodecatalystDevEnvironment_RepositoriesPropertyList
	_jsii_.Get(
		j,
		"repositories",
		&returns,
