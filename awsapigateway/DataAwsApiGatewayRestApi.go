...
type DataAwsApiGatewayRestApi interface {
	...
	// Experimental.
	EndpointConfiguration() DataAwsApiGatewayRestApi_EndpointConfigurationPropertyList
	// Experimental.
	ExecutionArn() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsApiGatewayRestApi) EndpointConfiguration() DataAwsApiGatewayRestApi_EndpointConfigurationPropertyList {
	var returns DataAwsApiGatewayRestApi_EndpointConfigurationPropertyList
	_jsii_.Get(
		j,
...
func NewDataAwsApiGatewayRestApi(scope constructs.Construct, id *string, config *DataAwsApiGatewayRestApiConfig) DataAwsApiGatewayRestApi {
	...
	_jsii_.Create(
		"@cdktn/aws-api-gateway.DataAwsApiGatewayRestApi",
