...
type DataAwsApiGatewayDomainName interface {
	...
	// Experimental.
	EndpointConfiguration() DataAwsApiGatewayDomainName_EndpointConfigurationPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsApiGatewayDomainName) EndpointConfiguration() DataAwsApiGatewayDomainName_EndpointConfigurationPropertyList {
	var returns DataAwsApiGatewayDomainName_EndpointConfigurationPropertyList
	_jsii_.Get(
		j,
...
func NewDataAwsApiGatewayDomainName(scope constructs.Construct, id *string, config *DataAwsApiGatewayDomainNameConfig) DataAwsApiGatewayDomainName {
	...
	_jsii_.Create(
		"@cdktn/aws-api-gateway.DataAwsApiGatewayDomainName",
