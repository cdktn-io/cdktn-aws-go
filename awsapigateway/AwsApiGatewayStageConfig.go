...
// Experimental.
type AwsApiGatewayStageConfig struct {
	// Experimental.
	...
	// Experimental.
	AccessLogSettings *AwsApiGatewayStage_AccessLogSettingsProperty `field:"optional" json:"accessLogSettings" yaml:"accessLogSettings"`
	...
	// Experimental.
	CanarySettings *AwsApiGatewayStage_CanarySettingsProperty `field:"optional" json:"canarySettings" yaml:"canarySettings"`
