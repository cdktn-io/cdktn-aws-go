...
type TfUsagePlanConfig struct {
	...
	// Experimental.
	QuotaSettings *TfUsagePlan_QuotaSettingsProperty `field:"optional" json:"quotaSettings" yaml:"quotaSettings"`
	...
	// Experimental.
	ThrottleSettings *TfUsagePlan_ThrottleSettingsProperty `field:"optional" json:"throttleSettings" yaml:"throttleSettings"`
}
