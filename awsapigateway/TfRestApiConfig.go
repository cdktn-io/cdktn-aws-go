...
type TfRestApiConfig struct {
	...
	// Experimental.
	EndpointConfiguration *TfRestApi_EndpointConfigurationProperty `field:"optional" json:"endpointConfiguration" yaml:"endpointConfiguration"`
	...
	// Experimental.
	Timeouts *TfRestApi_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
