...
// Experimental.
type TfCodepipeline_StageOnSuccessConditionRuleProperty struct {
	...
	// Experimental.
	RuleTypeId *TfCodepipeline_StageOnSuccessConditionRuleRuleTypeIdProperty `field:"required" json:"ruleTypeId" yaml:"ruleTypeId"`
