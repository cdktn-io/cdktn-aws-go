...
// Experimental.
type TfCodepipeline_StageOnFailureConditionRuleProperty struct {
	...
	// Experimental.
	RuleTypeId *TfCodepipeline_StageOnFailureConditionRuleRuleTypeIdProperty `field:"required" json:"ruleTypeId" yaml:"ruleTypeId"`
