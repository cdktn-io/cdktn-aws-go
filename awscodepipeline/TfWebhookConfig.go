...
type TfWebhookConfig struct {
	...
	// Experimental.
	AuthenticationConfiguration *TfWebhook_AuthenticationConfigurationProperty `field:"optional" json:"authenticationConfiguration" yaml:"authenticationConfiguration"`
