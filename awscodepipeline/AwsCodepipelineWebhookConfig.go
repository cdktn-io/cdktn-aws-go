...
// Experimental.
type AwsCodepipelineWebhookConfig struct {
	// Experimental.
	...
	// Experimental.
	AuthenticationConfiguration *AwsCodepipelineWebhook_AuthenticationConfigurationProperty `field:"optional" json:"authenticationConfiguration" yaml:"authenticationConfiguration"`
