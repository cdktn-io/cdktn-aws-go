...
// Experimental.
type AwsCodepipeline_StageOnSuccessConditionRuleProperty struct {
	...
	// Experimental.
	RuleTypeId *AwsCodepipeline_StageOnSuccessConditionRuleRuleTypeIdProperty `field:"required" json:"ruleTypeId" yaml:"ruleTypeId"`
