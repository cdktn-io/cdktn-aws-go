...
// Experimental.
type AwsCodepipeline_StageBeforeEntryConditionRuleProperty struct {
	...
	// Experimental.
	RuleTypeId *AwsCodepipeline_StageBeforeEntryConditionRuleRuleTypeIdProperty `field:"required" json:"ruleTypeId" yaml:"ruleTypeId"`
