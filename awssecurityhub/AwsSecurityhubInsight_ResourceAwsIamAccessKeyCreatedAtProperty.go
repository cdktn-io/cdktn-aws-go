...
// Experimental.
type AwsSecurityhubInsight_ResourceAwsIamAccessKeyCreatedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *AwsSecurityhubInsight_FiltersResourceAwsIamAccessKeyCreatedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
