...
// Experimental.
type TfInsight_ResourceContainerLaunchedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *TfInsight_FiltersResourceContainerLaunchedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
