...
// Experimental.
type TfInsight_ResourceAwsEc2InstanceLaunchedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *TfInsight_FiltersResourceAwsEc2InstanceLaunchedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
