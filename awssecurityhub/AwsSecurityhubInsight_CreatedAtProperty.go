...
// Experimental.
type AwsSecurityhubInsight_CreatedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *AwsSecurityhubInsight_FiltersCreatedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
