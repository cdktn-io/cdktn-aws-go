...
// Experimental.
type TfInsight_ResourceAwsIamAccessKeyCreatedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *TfInsight_FiltersResourceAwsIamAccessKeyCreatedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
