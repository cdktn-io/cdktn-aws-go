...
// Experimental.
type AwsSecurityhubInsight_UpdatedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *AwsSecurityhubInsight_FiltersUpdatedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
