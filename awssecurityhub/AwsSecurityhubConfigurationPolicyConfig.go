...
// Experimental.
type AwsSecurityhubConfigurationPolicyConfig struct {
	// Experimental.
	...
	// Experimental.
	ConfigurationPolicy *AwsSecurityhubConfigurationPolicy_ConfigurationPolicyProperty `field:"required" json:"configurationPolicy" yaml:"configurationPolicy"`
