...
// Experimental.
type AwsSecurityhubInsight_FirstObservedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *AwsSecurityhubInsight_FiltersFirstObservedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
