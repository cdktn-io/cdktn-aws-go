...
// Experimental.
type AwsSecurityhubOrganizationConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	OrganizationConfiguration *AwsSecurityhubOrganizationConfiguration_OrganizationConfigurationProperty `field:"optional" json:"organizationConfiguration" yaml:"organizationConfiguration"`
	...
	// Experimental.
	Timeouts *AwsSecurityhubOrganizationConfiguration_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
