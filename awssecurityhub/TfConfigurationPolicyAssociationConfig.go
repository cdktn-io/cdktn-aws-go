...
// Experimental.
type TfConfigurationPolicyAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *TfConfigurationPolicyAssociation_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
