...
// Experimental.
type AwsSecurityhubInsight_ThreatIntelIndicatorLastObservedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *AwsSecurityhubInsight_FiltersThreatIntelIndicatorLastObservedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
