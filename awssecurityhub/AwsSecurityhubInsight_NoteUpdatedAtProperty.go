...
// Experimental.
type AwsSecurityhubInsight_NoteUpdatedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *AwsSecurityhubInsight_FiltersNoteUpdatedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
