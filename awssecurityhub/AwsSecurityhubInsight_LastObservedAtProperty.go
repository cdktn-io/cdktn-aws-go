...
// Experimental.
type AwsSecurityhubInsight_LastObservedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *AwsSecurityhubInsight_FiltersLastObservedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
