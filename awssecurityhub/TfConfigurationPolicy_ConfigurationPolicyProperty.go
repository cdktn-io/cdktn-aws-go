...
// Experimental.
type TfConfigurationPolicy_ConfigurationPolicyProperty struct {
	...
	// Experimental.
	SecurityControlsConfiguration *TfConfigurationPolicy_SecurityControlsConfigurationProperty `field:"optional" json:"securityControlsConfiguration" yaml:"securityControlsConfiguration"`
}
