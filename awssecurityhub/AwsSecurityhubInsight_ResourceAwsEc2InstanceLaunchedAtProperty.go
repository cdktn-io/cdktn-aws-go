...
// Experimental.
type AwsSecurityhubInsight_ResourceAwsEc2InstanceLaunchedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *AwsSecurityhubInsight_FiltersResourceAwsEc2InstanceLaunchedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
