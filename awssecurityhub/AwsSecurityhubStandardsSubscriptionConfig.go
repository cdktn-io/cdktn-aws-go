...
// Experimental.
type AwsSecurityhubStandardsSubscriptionConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsSecurityhubStandardsSubscription_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
