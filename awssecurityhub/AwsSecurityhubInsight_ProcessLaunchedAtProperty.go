...
// Experimental.
type AwsSecurityhubInsight_ProcessLaunchedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *AwsSecurityhubInsight_FiltersProcessLaunchedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
