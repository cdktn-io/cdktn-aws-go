...
// Experimental.
type TfInsight_ProcessLaunchedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *TfInsight_FiltersProcessLaunchedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
