...
// Experimental.
type TfInsight_ThreatIntelIndicatorLastObservedAtProperty struct {
	// date_range block.
	//
	...
	// Experimental.
	DateRange *TfInsight_FiltersThreatIntelIndicatorLastObservedAtDateRangeProperty `field:"optional" json:"dateRange" yaml:"dateRange"`
