...
// Experimental.
type TfConfigurationPolicyConfig struct {
	// Experimental.
	...
	// Experimental.
	ConfigurationPolicy *TfConfigurationPolicy_ConfigurationPolicyProperty `field:"required" json:"configurationPolicy" yaml:"configurationPolicy"`
