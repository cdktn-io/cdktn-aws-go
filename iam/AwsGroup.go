...
func (j *jsiiProxy_AwsGroup) Path() *string {
	var returns *string
	_jsii_.Get(
		j,
		"path",
...
func (j *jsiiProxy_AwsGroup) PathInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pathInput",
...
func (j *jsiiProxy_AwsGroup) UniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uniqueId",
...
func (j *jsiiProxy_AwsGroup)SetPath(val *string) {
...
func (a *jsiiProxy_AwsGroup) ResetPath() {
	_jsii_.InvokeVoid(
		a,
		"resetPath",
		nil, // no parameters
