...
type DataAwsWorkspacesWorkspace interface {
	...
	// Experimental.
	WorkspaceProperties() DataAwsWorkspacesWorkspace_WorkspacePropertiesPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsWorkspacesWorkspace) WorkspaceProperties() DataAwsWorkspacesWorkspace_WorkspacePropertiesPropertyList {
	var returns DataAwsWorkspacesWorkspace_WorkspacePropertiesPropertyList
	_jsii_.Get(
		j,
		"workspaceProperties",
		&returns,
...
func NewDataAwsWorkspacesWorkspace(scope constructs.Construct, id *string, config *DataAwsWorkspacesWorkspaceConfig) DataAwsWorkspacesWorkspace {
	...
	_jsii_.Create(
		"@cdktn/aws-workspaces.DataAwsWorkspacesWorkspace",
