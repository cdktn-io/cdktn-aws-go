...
type DataAwsWorkspacesBundle interface {
	...
	// Experimental.
	ComputeType() DataAwsWorkspacesBundle_ComputeTypePropertyList
	// Experimental.
	...
	RegionInput() *string
	// Experimental.
	RootStorage() DataAwsWorkspacesBundle_RootStoragePropertyList
	// Experimental.
	...
	// Experimental.
	UserStorage() DataAwsWorkspacesBundle_UserStoragePropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsWorkspacesBundle) ComputeType() DataAwsWorkspacesBundle_ComputeTypePropertyList {
	var returns DataAwsWorkspacesBundle_ComputeTypePropertyList
	_jsii_.Get(
		j,
		"computeType",
		&returns,
...
func (j *jsiiProxy_DataAwsWorkspacesBundle) RootStorage() DataAwsWorkspacesBundle_RootStoragePropertyList {
	var returns DataAwsWorkspacesBundle_RootStoragePropertyList
	_jsii_.Get(
		j,
		"rootStorage",
		&returns,
...
func (j *jsiiProxy_DataAwsWorkspacesBundle) UserStorage() DataAwsWorkspacesBundle_UserStoragePropertyList {
	var returns DataAwsWorkspacesBundle_UserStoragePropertyList
	_jsii_.Get(
		j,
		"userStorage",
		&returns,
...
func NewDataAwsWorkspacesBundle(scope constructs.Construct, id *string, config *DataAwsWorkspacesBundleConfig) DataAwsWorkspacesBundle {
	...
	_jsii_.Create(
		"@cdktn/aws-workspaces.DataAwsWorkspacesBundle",
