...
type TfProfile interface {
	...
	// Experimental.
	Timeouts() TfProfile_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *TfProfile_TimeoutsProperty)
...
func (j *jsiiProxy_TfProfile) OwnerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ownerId",
...
func (j *jsiiProxy_TfProfile) ShareStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"shareStatus",
...
func (j *jsiiProxy_TfProfile) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_TfProfile) StatusMessage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"statusMessage",
...
func (j *jsiiProxy_TfProfile) TagsAll() cdktn.StringMap {
...
func (j *jsiiProxy_TfProfile) Timeouts() TfProfile_TimeoutsPropertyOutputReference {
	var returns TfProfile_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_TfProfile) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
func (t *jsiiProxy_TfProfile) PutTimeouts(value *TfProfile_TimeoutsProperty) {
...
func (t *jsiiProxy_TfProfile) ResetTimeouts() {
	_jsii_.InvokeVoid(
		t,
		"resetTimeouts",
		nil, // no parameters
