...
type DataAwsCloudhsmV2Cluster interface {
	...
	// Experimental.
	ClusterCertificates() DataAwsCloudhsmV2Cluster_ClusterCertificatesPropertyList
	// Experimental.
	ClusterId() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsCloudhsmV2Cluster) ClusterCertificates() DataAwsCloudhsmV2Cluster_ClusterCertificatesPropertyList {
	var returns DataAwsCloudhsmV2Cluster_ClusterCertificatesPropertyList
	_jsii_.Get(
		j,
		"clusterCertificates",
		&returns,
...
func NewDataAwsCloudhsmV2Cluster(scope constructs.Construct, id *string, config *DataAwsCloudhsmV2ClusterConfig) DataAwsCloudhsmV2Cluster {
	...
	_jsii_.Create(
		"@cdktn/aws-cloudhsm.DataAwsCloudhsmV2Cluster",
