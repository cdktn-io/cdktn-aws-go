...
func (j *jsiiProxy_TfCluster) validateSetHsmTypeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_TfCluster) validateSetModeParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_TfCluster) validateSetSourceBackupIdentifierParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
