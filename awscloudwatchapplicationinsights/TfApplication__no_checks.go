...
func (j *jsiiProxy_TfApplication) validateSetAutoConfigEnabledParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_TfApplication) validateSetAutoCreateParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_TfApplication) validateSetCweMonitorEnabledParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_TfApplication) validateSetGroupingTypeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_TfApplication) validateSetOpsCenterEnabledParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_TfApplication) validateSetOpsItemSnsTopicArnParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_TfApplication) validateSetResourceGroupNameParameters(val *string) error {
	return nil
}
