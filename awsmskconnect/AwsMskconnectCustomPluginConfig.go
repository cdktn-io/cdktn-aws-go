...
// Experimental.
type AwsMskconnectCustomPluginConfig struct {
	// Experimental.
	...
	// Experimental.
	Location *AwsMskconnectCustomPlugin_LocationProperty `field:"required" json:"location" yaml:"location"`
	...
	// Experimental.
	Timeouts *AwsMskconnectCustomPlugin_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
