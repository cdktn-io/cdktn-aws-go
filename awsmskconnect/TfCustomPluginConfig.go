...
// Experimental.
type TfCustomPluginConfig struct {
	// Experimental.
	...
	// Experimental.
	Location *TfCustomPlugin_LocationProperty `field:"required" json:"location" yaml:"location"`
	...
	// Experimental.
	Timeouts *TfCustomPlugin_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
