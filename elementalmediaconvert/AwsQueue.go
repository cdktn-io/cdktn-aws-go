...
type AwsQueue interface {
	...
	RegionInput() *string
	// Experimental.
	ReservationPlanSettings() AwsQueue_ReservationPlanSettingsPropertyOutputReference
	// Experimental.
	ReservationPlanSettingsInput() *AwsQueue_ReservationPlanSettingsProperty
	// Experimental.
	Status() *string
	// Experimental.
	...
	// Experimental.
	PutReservationPlanSettings(value *AwsQueue_ReservationPlanSettingsProperty)
...
func (j *jsiiProxy_AwsQueue) ConcurrentJobs() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"concurrentJobs",
...
func (j *jsiiProxy_AwsQueue) ConcurrentJobsInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"concurrentJobsInput",
...
func (j *jsiiProxy_AwsQueue) PricingPlan() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pricingPlan",
...
func (j *jsiiProxy_AwsQueue) PricingPlanInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pricingPlanInput",
...
func (j *jsiiProxy_AwsQueue) ReservationPlanSettings() AwsQueue_ReservationPlanSettingsPropertyOutputReference {
	var returns AwsQueue_ReservationPlanSettingsPropertyOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsQueue) ReservationPlanSettingsInput() *AwsQueue_ReservationPlanSettingsProperty {
...
func NewAwsQueue(scope constructs.Construct, id *string, config *AwsQueueConfig) AwsQueue {
	...
	_jsii_.Create(
		"@cdktn/aws-elemental-mediaconvert.AwsQueue",
...
func (j *jsiiProxy_AwsQueue)SetConcurrentJobs(val *float64) {
...
func (j *jsiiProxy_AwsQueue)SetPricingPlan(val *string) {
...
func (a *jsiiProxy_AwsQueue) PutReservationPlanSettings(value *AwsQueue_ReservationPlanSettingsProperty) {
...
func (a *jsiiProxy_AwsQueue) ResetConcurrentJobs() {
	_jsii_.InvokeVoid(
		a,
		"resetConcurrentJobs",
		nil, // no parameters
...
func (a *jsiiProxy_AwsQueue) ResetPricingPlan() {
	_jsii_.InvokeVoid(
		a,
		"resetPricingPlan",
		nil, // no parameters
...
func (a *jsiiProxy_AwsQueue) ResetReservationPlanSettings() {
	_jsii_.InvokeVoid(
		a,
		"resetReservationPlanSettings",
		nil, // no parameters
