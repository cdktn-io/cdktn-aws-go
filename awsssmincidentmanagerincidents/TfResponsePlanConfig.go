...
// Experimental.
type TfResponsePlanConfig struct {
	// Experimental.
	...
	// Experimental.
	IncidentTemplate *TfResponsePlan_IncidentTemplateProperty `field:"required" json:"incidentTemplate" yaml:"incidentTemplate"`
	...
	// Experimental.
	Action *TfResponsePlan_ActionProperty `field:"optional" json:"action" yaml:"action"`
	...
	// Experimental.
	Integration *TfResponsePlan_IntegrationProperty `field:"optional" json:"integration" yaml:"integration"`
