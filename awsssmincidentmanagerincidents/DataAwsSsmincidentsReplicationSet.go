...
type DataAwsSsmincidentsReplicationSet interface {
	...
	// Experimental.
	Region() DataAwsSsmincidentsReplicationSet_RegionPropertyList
	// Experimental.
	Regions() DataAwsSsmincidentsReplicationSet_RegionsPropertyList
	// Experimental.
	Status() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsSsmincidentsReplicationSet) Region() DataAwsSsmincidentsReplicationSet_RegionPropertyList {
	var returns DataAwsSsmincidentsReplicationSet_RegionPropertyList
	_jsii_.Get(
		j,
		"region",
		&returns,
...
func (j *jsiiProxy_DataAwsSsmincidentsReplicationSet) Regions() DataAwsSsmincidentsReplicationSet_RegionsPropertyList {
	var returns DataAwsSsmincidentsReplicationSet_RegionsPropertyList
	_jsii_.Get(
		j,
		"regions",
		&returns,
