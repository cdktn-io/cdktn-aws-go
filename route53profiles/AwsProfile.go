...
type AwsProfile interface {
	...
	// Experimental.
	Timeouts() AwsProfile_TimeoutsPropertyOutputReference
	// Experimental.
	...
	// Experimental.
	PutTimeouts(value *AwsProfile_TimeoutsProperty)
...
func (j *jsiiProxy_AwsProfile) OwnerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ownerId",
...
func (j *jsiiProxy_AwsProfile) ShareStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"shareStatus",
...
func (j *jsiiProxy_AwsProfile) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_AwsProfile) StatusMessage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"statusMessage",
...
func (j *jsiiProxy_AwsProfile) TagsAll() cdktn.StringMap {
...
func (j *jsiiProxy_AwsProfile) Timeouts() AwsProfile_TimeoutsPropertyOutputReference {
	var returns AwsProfile_TimeoutsPropertyOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_AwsProfile) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
func (a *jsiiProxy_AwsProfile) PutTimeouts(value *AwsProfile_TimeoutsProperty) {
...
func (a *jsiiProxy_AwsProfile) ResetTimeouts() {
	_jsii_.InvokeVoid(
		a,
		"resetTimeouts",
		nil, // no parameters
