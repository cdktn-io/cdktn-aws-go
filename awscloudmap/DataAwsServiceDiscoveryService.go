...
type DataAwsServiceDiscoveryService interface {
	...
	Description() *string
	// Experimental.
	DnsConfig() DataAwsServiceDiscoveryService_DnsConfigPropertyList
	// Experimental.
	...
	// Experimental.
	HealthCheckConfig() DataAwsServiceDiscoveryService_HealthCheckConfigPropertyList
	// Experimental.
	HealthCheckCustomConfig() DataAwsServiceDiscoveryService_HealthCheckCustomConfigPropertyList
	// Experimental.
	Id() *string
	// Experimental.
	SetId(val *string)
...
func (j *jsiiProxy_DataAwsServiceDiscoveryService) DnsConfig() DataAwsServiceDiscoveryService_DnsConfigPropertyList {
	var returns DataAwsServiceDiscoveryService_DnsConfigPropertyList
	_jsii_.Get(
		j,
		"dnsConfig",
		&returns,
...
func (j *jsiiProxy_DataAwsServiceDiscoveryService) HealthCheckConfig() DataAwsServiceDiscoveryService_HealthCheckConfigPropertyList {
	var returns DataAwsServiceDiscoveryService_HealthCheckConfigPropertyList
	_jsii_.Get(
		j,
		"healthCheckConfig",
		&returns,
...
func (j *jsiiProxy_DataAwsServiceDiscoveryService) HealthCheckCustomConfig() DataAwsServiceDiscoveryService_HealthCheckCustomConfigPropertyList {
	var returns DataAwsServiceDiscoveryService_HealthCheckCustomConfigPropertyList
	_jsii_.Get(
		j,
...
func NewDataAwsServiceDiscoveryService(scope constructs.Construct, id *string, config *DataAwsServiceDiscoveryServiceConfig) DataAwsServiceDiscoveryService {
	...
	_jsii_.Create(
		"@cdktn/aws-cloud-map.DataAwsServiceDiscoveryService",
