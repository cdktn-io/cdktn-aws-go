...
// Experimental.
type AwsTableBucketConfig struct {
	// Experimental.
	...
	// Experimental.
	EncryptionConfiguration *AwsTableBucket_EncryptionConfigurationProperty `field:"optional" json:"encryptionConfiguration" yaml:"encryptionConfiguration"`
	...
	// Experimental.
	MaintenanceConfiguration *AwsTableBucket_MaintenanceConfigurationProperty `field:"optional" json:"maintenanceConfiguration" yaml:"maintenanceConfiguration"`
