...
type AwsTableConfig struct {
	...
	// Experimental.
	EncryptionConfiguration *AwsTable_EncryptionConfigurationProperty `field:"optional" json:"encryptionConfiguration" yaml:"encryptionConfiguration"`
	...
	// Experimental.
	MaintenanceConfiguration *AwsTable_MaintenanceConfigurationProperty `field:"optional" json:"maintenanceConfiguration" yaml:"maintenanceConfiguration"`
	// metadata block.
	//
