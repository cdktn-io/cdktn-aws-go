...
// Experimental.
type AwsAutoscalingplansScalingPlanConfig struct {
	// Experimental.
	...
	// Experimental.
	ApplicationSource *AwsAutoscalingplansScalingPlan_ApplicationSourceProperty `field:"required" json:"applicationSource" yaml:"applicationSource"`
