...
type DataAwsSecretsmanagerSecretRotation interface {
	...
	// Experimental.
	ExternalSecretRotationMetadata() DataAwsSecretsmanagerSecretRotation_ExternalSecretRotationMetadataPropertyList
	// Experimental.
	...
	// Experimental.
	RotationRules() DataAwsSecretsmanagerSecretRotation_RotationRulesPropertyList
	// Experimental.
	SecretId() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretRotation) ExternalSecretRotationMetadata() DataAwsSecretsmanagerSecretRotation_ExternalSecretRotationMetadataPropertyList {
	var returns DataAwsSecretsmanagerSecretRotation_ExternalSecretRotationMetadataPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecretRotation) RotationRules() DataAwsSecretsmanagerSecretRotation_RotationRulesPropertyList {
	var returns DataAwsSecretsmanagerSecretRotation_RotationRulesPropertyList
	_jsii_.Get(
		j,
		"rotationRules",
		&returns,
