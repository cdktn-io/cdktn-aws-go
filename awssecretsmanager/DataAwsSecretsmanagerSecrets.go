...
type DataAwsSecretsmanagerSecrets interface {
	...
	// Experimental.
	Filter() DataAwsSecretsmanagerSecrets_FilterPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsSecretsmanagerSecrets) Filter() DataAwsSecretsmanagerSecrets_FilterPropertyList {
	var returns DataAwsSecretsmanagerSecrets_FilterPropertyList
	_jsii_.Get(
		j,
		"filter",
		&returns,
