...
// Experimental.
type AwsSecretsmanagerSecretRotationConfig struct {
	// Experimental.
	...
	// Experimental.
	RotationRules *AwsSecretsmanagerSecretRotation_RotationRulesProperty `field:"optional" json:"rotationRules" yaml:"rotationRules"`
}
