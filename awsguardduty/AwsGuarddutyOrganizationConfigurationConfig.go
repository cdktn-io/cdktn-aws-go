...
// Experimental.
type AwsGuarddutyOrganizationConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	Datasources *AwsGuarddutyOrganizationConfiguration_DatasourcesProperty `field:"optional" json:"datasources" yaml:"datasources"`
