...
type DataAwsGuarddutyDetector interface {
	...
	// Experimental.
	Features() DataAwsGuarddutyDetector_FeaturesPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsGuarddutyDetector) Features() DataAwsGuarddutyDetector_FeaturesPropertyList {
	var returns DataAwsGuarddutyDetector_FeaturesPropertyList
	_jsii_.Get(
		j,
		"features",
		&returns,
