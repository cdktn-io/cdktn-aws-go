...
// Experimental.
type AwsGuarddutyFilterConfig struct {
	// Experimental.
	...
	// Experimental.
	FindingCriteria *AwsGuarddutyFilter_FindingCriteriaProperty `field:"required" json:"findingCriteria" yaml:"findingCriteria"`
