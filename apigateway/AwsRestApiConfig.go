...
type AwsRestApiConfig struct {
	...
	// Experimental.
	EndpointConfiguration *AwsRestApi_EndpointConfigurationProperty `field:"optional" json:"endpointConfiguration" yaml:"endpointConfiguration"`
	...
	// Experimental.
	Timeouts *AwsRestApi_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
