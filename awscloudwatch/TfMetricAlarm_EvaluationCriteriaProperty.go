...
// Experimental.
type TfMetricAlarm_EvaluationCriteriaProperty struct {
	...
	// Experimental.
	PromqlCriteria *TfMetricAlarm_PromqlCriteriaProperty `field:"required" json:"promqlCriteria" yaml:"promqlCriteria"`
}
