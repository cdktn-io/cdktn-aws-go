...
// Experimental.
type AwsCloudwatchMetricAlarmConfig struct {
	// Experimental.
	...
	// Experimental.
	EvaluationCriteria *AwsCloudwatchMetricAlarm_EvaluationCriteriaProperty `field:"optional" json:"evaluationCriteria" yaml:"evaluationCriteria"`
