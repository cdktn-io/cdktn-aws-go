...
// Experimental.
type AwsPolicy_PredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationMetricDataQueriesProperty struct {
	...
	// Experimental.
	MetricStat *AwsPolicy_PredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationMetricDataQueriesMetricStatProperty `field:"optional" json:"metricStat" yaml:"metricStat"`
