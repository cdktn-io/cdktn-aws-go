...
type DataAwsLaunchConfiguration interface {
	...
	// Experimental.
	EbsBlockDevice() DataAwsLaunchConfiguration_EbsBlockDevicePropertyList
	// Experimental.
	EbsOptimized() cdktn.IResolvable
	// Experimental.
	EnableMonitoring() cdktn.IResolvable
	// Experimental.
	EphemeralBlockDevice() DataAwsLaunchConfiguration_EphemeralBlockDevicePropertyList
	// Experimental.
	...
	// Experimental.
	MetadataOptions() DataAwsLaunchConfiguration_MetadataOptionsPropertyList
	// Experimental.
	Name() *string
	// Experimental.
	SetName(val *string)
	...
	RegionInput() *string
	// Experimental.
	RootBlockDevice() DataAwsLaunchConfiguration_RootBlockDevicePropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsLaunchConfiguration) EbsBlockDevice() DataAwsLaunchConfiguration_EbsBlockDevicePropertyList {
	var returns DataAwsLaunchConfiguration_EbsBlockDevicePropertyList
	_jsii_.Get(
		j,
		"ebsBlockDevice",
		&returns,
...
func (j *jsiiProxy_DataAwsLaunchConfiguration) EphemeralBlockDevice() DataAwsLaunchConfiguration_EphemeralBlockDevicePropertyList {
	var returns DataAwsLaunchConfiguration_EphemeralBlockDevicePropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsLaunchConfiguration) MetadataOptions() DataAwsLaunchConfiguration_MetadataOptionsPropertyList {
	var returns DataAwsLaunchConfiguration_MetadataOptionsPropertyList
	_jsii_.Get(
		j,
		"metadataOptions",
		&returns,
...
func (j *jsiiProxy_DataAwsLaunchConfiguration) RootBlockDevice() DataAwsLaunchConfiguration_RootBlockDevicePropertyList {
	var returns DataAwsLaunchConfiguration_RootBlockDevicePropertyList
	_jsii_.Get(
		j,
		"rootBlockDevice",
		&returns,
...
func NewDataAwsLaunchConfiguration(scope constructs.Construct, id *string, config *DataAwsLaunchConfigurationConfig) DataAwsLaunchConfiguration {
	...
	_jsii_.Create(
		"@cdktn/aws-auto-scaling.DataAwsLaunchConfiguration",
