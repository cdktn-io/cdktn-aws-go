...
// Experimental.
type AwsTrafficSourceAttachmentConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsTrafficSourceAttachment_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
	...
	// Experimental.
	TrafficSource *AwsTrafficSourceAttachment_TrafficSourceProperty `field:"optional" json:"trafficSource" yaml:"trafficSource"`
}
