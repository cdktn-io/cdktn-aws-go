...
// Experimental.
type AwsGroup_CapacityReservationSpecificationProperty struct {
	...
	// Experimental.
	CapacityReservationTarget *AwsGroup_CapacityReservationTargetProperty `field:"optional" json:"capacityReservationTarget" yaml:"capacityReservationTarget"`
}
