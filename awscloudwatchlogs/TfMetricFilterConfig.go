...
// Experimental.
type TfMetricFilterConfig struct {
	// Experimental.
	...
	// Experimental.
	MetricTransformation *TfMetricFilter_MetricTransformationProperty `field:"required" json:"metricTransformation" yaml:"metricTransformation"`
