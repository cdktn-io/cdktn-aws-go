...
// Experimental.
type DataTfDataProtectionPolicyDocumentConfig struct {
	// Experimental.
	...
	// Experimental.
	Configuration *DataTfDataProtectionPolicyDocument_ConfigurationProperty `field:"optional" json:"configuration" yaml:"configuration"`
