...
// Experimental.
type AwsCloudwatchLogMetricFilterConfig struct {
	// Experimental.
	...
	// Experimental.
	MetricTransformation *AwsCloudwatchLogMetricFilter_MetricTransformationProperty `field:"required" json:"metricTransformation" yaml:"metricTransformation"`
