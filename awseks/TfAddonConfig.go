...
type TfAddonConfig struct {
	...
	// Experimental.
	NamespaceConfig *TfAddon_NamespaceConfigProperty `field:"optional" json:"namespaceConfig" yaml:"namespaceConfig"`
	...
	// Experimental.
	Timeouts *TfAddon_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
