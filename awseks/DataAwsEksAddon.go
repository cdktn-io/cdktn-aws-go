...
type DataAwsEksAddon interface {
	...
	// Experimental.
	PodIdentityAssociation() DataAwsEksAddon_PodIdentityAssociationPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsEksAddon) PodIdentityAssociation() DataAwsEksAddon_PodIdentityAssociationPropertyList {
	var returns DataAwsEksAddon_PodIdentityAssociationPropertyList
	_jsii_.Get(
		j,
