...
type DataAwsEksClusterVersions interface {
	...
	// Experimental.
	ClusterVersions() DataAwsEksClusterVersions_ClusterVersionsPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsEksClusterVersions) ClusterVersions() DataAwsEksClusterVersions_ClusterVersionsPropertyList {
	var returns DataAwsEksClusterVersions_ClusterVersionsPropertyList
	_jsii_.Get(
		j,
		"clusterVersions",
		&returns,
...
func NewDataAwsEksClusterVersions(scope constructs.Construct, id *string, config *DataAwsEksClusterVersionsConfig) DataAwsEksClusterVersions {
	...
	_jsii_.Create(
		"@cdktn/aws-eks.DataAwsEksClusterVersions",
