...
type DataAwsEksNodeGroup interface {
	...
	// Experimental.
	LaunchTemplate() DataAwsEksNodeGroup_LaunchTemplatePropertyList
	// Experimental.
	...
	// Experimental.
	RemoteAccess() DataAwsEksNodeGroup_RemoteAccessPropertyList
	// Experimental.
	Resources() DataAwsEksNodeGroup_ResourcesPropertyList
	// Experimental.
	ScalingConfig() DataAwsEksNodeGroup_ScalingConfigPropertyList
	// Experimental.
	Status() *string
	// Experimental.
	SubnetIds() *[]*string
	...
	// Experimental.
	Taints() DataAwsEksNodeGroup_TaintsPropertyList
	// Experimental.
	...
	// Experimental.
	UpdateConfig() DataAwsEksNodeGroup_UpdateConfigPropertyList
	// Experimental.
	Version() *string
	// Experimental.
	WarmPoolConfig() DataAwsEksNodeGroup_WarmPoolConfigPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsEksNodeGroup) LaunchTemplate() DataAwsEksNodeGroup_LaunchTemplatePropertyList {
	var returns DataAwsEksNodeGroup_LaunchTemplatePropertyList
	_jsii_.Get(
		j,
		"launchTemplate",
		&returns,
...
func (j *jsiiProxy_DataAwsEksNodeGroup) RemoteAccess() DataAwsEksNodeGroup_RemoteAccessPropertyList {
	var returns DataAwsEksNodeGroup_RemoteAccessPropertyList
	_jsii_.Get(
		j,
		"remoteAccess",
		&returns,
...
func (j *jsiiProxy_DataAwsEksNodeGroup) Resources() DataAwsEksNodeGroup_ResourcesPropertyList {
	var returns DataAwsEksNodeGroup_ResourcesPropertyList
	_jsii_.Get(
		j,
		"resources",
		&returns,
...
func (j *jsiiProxy_DataAwsEksNodeGroup) ScalingConfig() DataAwsEksNodeGroup_ScalingConfigPropertyList {
	var returns DataAwsEksNodeGroup_ScalingConfigPropertyList
	_jsii_.Get(
		j,
		"scalingConfig",
		&returns,
...
func (j *jsiiProxy_DataAwsEksNodeGroup) Taints() DataAwsEksNodeGroup_TaintsPropertyList {
	var returns DataAwsEksNodeGroup_TaintsPropertyList
	_jsii_.Get(
		j,
		"taints",
		&returns,
...
func (j *jsiiProxy_DataAwsEksNodeGroup) UpdateConfig() DataAwsEksNodeGroup_UpdateConfigPropertyList {
	var returns DataAwsEksNodeGroup_UpdateConfigPropertyList
	_jsii_.Get(
		j,
		"updateConfig",
		&returns,
...
func (j *jsiiProxy_DataAwsEksNodeGroup) WarmPoolConfig() DataAwsEksNodeGroup_WarmPoolConfigPropertyList {
	var returns DataAwsEksNodeGroup_WarmPoolConfigPropertyList
	_jsii_.Get(
		j,
		"warmPoolConfig",
		&returns,
...
func NewDataAwsEksNodeGroup(scope constructs.Construct, id *string, config *DataAwsEksNodeGroupConfig) DataAwsEksNodeGroup {
	...
	_jsii_.Create(
		"@cdktn/aws-eks.DataAwsEksNodeGroup",
