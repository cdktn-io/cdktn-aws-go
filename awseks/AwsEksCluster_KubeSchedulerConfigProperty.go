...
// Experimental.
type AwsEksCluster_KubeSchedulerConfigProperty struct {
	...
	// Experimental.
	NodeResourcesFit *AwsEksCluster_NodeResourcesFitProperty `field:"optional" json:"nodeResourcesFit" yaml:"nodeResourcesFit"`
}
