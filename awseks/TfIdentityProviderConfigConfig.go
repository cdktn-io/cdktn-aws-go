...
// Experimental.
type TfIdentityProviderConfigConfig struct {
	// Experimental.
	...
	// Experimental.
	Oidc *TfIdentityProviderConfig_OidcProperty `field:"required" json:"oidc" yaml:"oidc"`
	...
	// Experimental.
	Timeouts *TfIdentityProviderConfig_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
