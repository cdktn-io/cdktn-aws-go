...
// Experimental.
type AwsEksIdentityProviderConfigConfig struct {
	// Experimental.
	...
	// Experimental.
	Oidc *AwsEksIdentityProviderConfig_OidcProperty `field:"required" json:"oidc" yaml:"oidc"`
	...
	// Experimental.
	Timeouts *AwsEksIdentityProviderConfig_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
