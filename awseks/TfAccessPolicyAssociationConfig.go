...
// Experimental.
type TfAccessPolicyAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	AccessScope *TfAccessPolicyAssociation_AccessScopeProperty `field:"required" json:"accessScope" yaml:"accessScope"`
	...
	// Experimental.
	Timeouts *TfAccessPolicyAssociation_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
