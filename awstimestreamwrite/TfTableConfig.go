...
type TfTableConfig struct {
	...
	// Experimental.
	MagneticStoreWriteProperties *TfTable_MagneticStoreWritePropertiesProperty `field:"optional" json:"magneticStoreWriteProperties" yaml:"magneticStoreWriteProperties"`
	...
	// Experimental.
	RetentionProperties *TfTable_RetentionPropertiesProperty `field:"optional" json:"retentionProperties" yaml:"retentionProperties"`
	// schema block.
	//
	...
	// Experimental.
	Schema *TfTable_SchemaProperty `field:"optional" json:"schema" yaml:"schema"`
