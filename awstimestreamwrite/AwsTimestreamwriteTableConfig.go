...
// Experimental.
type AwsTimestreamwriteTableConfig struct {
	// Experimental.
	...
	// Experimental.
	MagneticStoreWriteProperties *AwsTimestreamwriteTable_MagneticStoreWritePropertiesProperty `field:"optional" json:"magneticStoreWriteProperties" yaml:"magneticStoreWriteProperties"`
	...
	// Experimental.
	RetentionProperties *AwsTimestreamwriteTable_RetentionPropertiesProperty `field:"optional" json:"retentionProperties" yaml:"retentionProperties"`
	// schema block.
	//
	...
	// Experimental.
	Schema *AwsTimestreamwriteTable_SchemaProperty `field:"optional" json:"schema" yaml:"schema"`
