...
type TfGroup interface {
	...
	IdInput() *string
	// Experimental.
	InsightsConfiguration() TfGroup_InsightsConfigurationPropertyOutputReference
	// Experimental.
	InsightsConfigurationInput() *TfGroup_InsightsConfigurationProperty
	// Experimental.
	...
	// Experimental.
	PutInsightsConfiguration(value *TfGroup_InsightsConfigurationProperty)
...
func (j *jsiiProxy_TfGroup) FilterExpression() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filterExpression",
...
func (j *jsiiProxy_TfGroup) FilterExpressionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TfGroup) GroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupName",
...
func (j *jsiiProxy_TfGroup) GroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupNameInput",
...
func (j *jsiiProxy_TfGroup) InsightsConfiguration() TfGroup_InsightsConfigurationPropertyOutputReference {
	var returns TfGroup_InsightsConfigurationPropertyOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TfGroup) InsightsConfigurationInput() *TfGroup_InsightsConfigurationProperty {
...
func (j *jsiiProxy_TfGroup)SetFilterExpression(val *string) {
...
func (j *jsiiProxy_TfGroup)SetGroupName(val *string) {
...
func (t *jsiiProxy_TfGroup) PutInsightsConfiguration(value *TfGroup_InsightsConfigurationProperty) {
	if err := t.validatePutInsightsConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		t,
...
func (t *jsiiProxy_TfGroup) ResetInsightsConfiguration() {
	_jsii_.InvokeVoid(
		t,
		"resetInsightsConfiguration",
		nil, // no parameters
