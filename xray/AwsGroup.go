...
type AwsGroup interface {
	...
	IdInput() *string
	// Experimental.
	InsightsConfiguration() AwsGroup_InsightsConfigurationPropertyOutputReference
	// Experimental.
	InsightsConfigurationInput() *AwsGroup_InsightsConfigurationProperty
	// Experimental.
	...
	// Experimental.
	PutInsightsConfiguration(value *AwsGroup_InsightsConfigurationProperty)
...
func (j *jsiiProxy_AwsGroup) FilterExpression() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filterExpression",
...
func (j *jsiiProxy_AwsGroup) FilterExpressionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsGroup) GroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupName",
...
func (j *jsiiProxy_AwsGroup) GroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupNameInput",
...
func (j *jsiiProxy_AwsGroup) InsightsConfiguration() AwsGroup_InsightsConfigurationPropertyOutputReference {
	var returns AwsGroup_InsightsConfigurationPropertyOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsGroup) InsightsConfigurationInput() *AwsGroup_InsightsConfigurationProperty {
...
func (j *jsiiProxy_AwsGroup)SetFilterExpression(val *string) {
...
func (j *jsiiProxy_AwsGroup)SetGroupName(val *string) {
...
func (a *jsiiProxy_AwsGroup) PutInsightsConfiguration(value *AwsGroup_InsightsConfigurationProperty) {
...
func (a *jsiiProxy_AwsGroup) ResetInsightsConfiguration() {
	_jsii_.InvokeVoid(
		a,
		"resetInsightsConfiguration",
		nil, // no parameters
