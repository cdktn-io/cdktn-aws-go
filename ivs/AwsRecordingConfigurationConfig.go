...
// Experimental.
type AwsRecordingConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	DestinationConfiguration *AwsRecordingConfiguration_DestinationConfigurationProperty `field:"required" json:"destinationConfiguration" yaml:"destinationConfiguration"`
	...
	// Experimental.
	ThumbnailConfiguration *AwsRecordingConfiguration_ThumbnailConfigurationProperty `field:"optional" json:"thumbnailConfiguration" yaml:"thumbnailConfiguration"`
	// timeouts block.
	//
	...
	// Experimental.
	Timeouts *AwsRecordingConfiguration_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
