...
type DataAwsElasticBeanstalkApplication interface {
	...
	// Experimental.
	AppversionLifecycle() DataAwsElasticBeanstalkApplication_AppversionLifecyclePropertyList
	// Experimental.
	Arn() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsElasticBeanstalkApplication) AppversionLifecycle() DataAwsElasticBeanstalkApplication_AppversionLifecyclePropertyList {
	var returns DataAwsElasticBeanstalkApplication_AppversionLifecyclePropertyList
	_jsii_.Get(
		j,
		"appversionLifecycle",
		&returns,
