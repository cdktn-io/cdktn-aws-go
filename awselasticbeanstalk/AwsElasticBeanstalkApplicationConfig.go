...
// Experimental.
type AwsElasticBeanstalkApplicationConfig struct {
	// Experimental.
	...
	// Experimental.
	AppversionLifecycle *AwsElasticBeanstalkApplication_AppversionLifecycleProperty `field:"optional" json:"appversionLifecycle" yaml:"appversionLifecycle"`
