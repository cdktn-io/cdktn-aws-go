...
type AwsApplicationConfig struct {
	...
	// Experimental.
	AutoStartConfiguration *AwsApplication_AutoStartConfigurationProperty `field:"optional" json:"autoStartConfiguration" yaml:"autoStartConfiguration"`
	...
	// Experimental.
	AutoStopConfiguration *AwsApplication_AutoStopConfigurationProperty `field:"optional" json:"autoStopConfiguration" yaml:"autoStopConfiguration"`
	...
	// Experimental.
	ImageConfiguration *AwsApplication_ImageConfigurationProperty `field:"optional" json:"imageConfiguration" yaml:"imageConfiguration"`
	...
	// Experimental.
	InteractiveConfiguration *AwsApplication_InteractiveConfigurationProperty `field:"optional" json:"interactiveConfiguration" yaml:"interactiveConfiguration"`
	...
	// Experimental.
	JobLevelCostAllocationConfiguration *AwsApplication_JobLevelCostAllocationConfigurationProperty `field:"optional" json:"jobLevelCostAllocationConfiguration" yaml:"jobLevelCostAllocationConfiguration"`
	...
	// Experimental.
	MaximumCapacity *AwsApplication_MaximumCapacityProperty `field:"optional" json:"maximumCapacity" yaml:"maximumCapacity"`
	...
	// Experimental.
	NetworkConfiguration *AwsApplication_NetworkConfigurationProperty `field:"optional" json:"networkConfiguration" yaml:"networkConfiguration"`
	...
	// Experimental.
	SchedulerConfiguration *AwsApplication_SchedulerConfigurationProperty `field:"optional" json:"schedulerConfiguration" yaml:"schedulerConfiguration"`
