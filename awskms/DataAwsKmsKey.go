...
type DataAwsKmsKey interface {
	...
	// Experimental.
	MultiRegionConfiguration() DataAwsKmsKey_MultiRegionConfigurationPropertyList
	// The tree node.
	// Experimental.
	...
	ValidTo() *string
	// Experimental.
	XksKeyConfiguration() DataAwsKmsKey_XksKeyConfigurationPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsKmsKey) MultiRegionConfiguration() DataAwsKmsKey_MultiRegionConfigurationPropertyList {
	var returns DataAwsKmsKey_MultiRegionConfigurationPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsKmsKey) XksKeyConfiguration() DataAwsKmsKey_XksKeyConfigurationPropertyList {
	var returns DataAwsKmsKey_XksKeyConfigurationPropertyList
	_jsii_.Get(
		j,
		"xksKeyConfiguration",
		&returns,
