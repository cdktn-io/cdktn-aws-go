...
// Experimental.
type TfCustomKeyStoreConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *TfCustomKeyStore_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
	...
	// Experimental.
	XksProxyAuthenticationCredential *TfCustomKeyStore_XksProxyAuthenticationCredentialProperty `field:"optional" json:"xksProxyAuthenticationCredential" yaml:"xksProxyAuthenticationCredential"`
