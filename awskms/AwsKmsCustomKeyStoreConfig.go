...
// Experimental.
type AwsKmsCustomKeyStoreConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsKmsCustomKeyStore_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
	...
	// Experimental.
	XksProxyAuthenticationCredential *AwsKmsCustomKeyStore_XksProxyAuthenticationCredentialProperty `field:"optional" json:"xksProxyAuthenticationCredential" yaml:"xksProxyAuthenticationCredential"`
