...
type DataAwsKmsSecrets interface {
	...
	RegionInput() *string
	// Experimental.
	Secret() DataAwsKmsSecrets_SecretPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsKmsSecrets) Secret() DataAwsKmsSecrets_SecretPropertyList {
	var returns DataAwsKmsSecrets_SecretPropertyList
	_jsii_.Get(
		j,
		"secret",
		&returns,
