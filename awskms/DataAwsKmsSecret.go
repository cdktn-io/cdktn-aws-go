...
type DataAwsKmsSecret interface {
	...
	RegionInput() *string
	// Experimental.
	Secret() DataAwsKmsSecret_SecretPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsKmsSecret) Secret() DataAwsKmsSecret_SecretPropertyList {
	var returns DataAwsKmsSecret_SecretPropertyList
	_jsii_.Get(
		j,
		"secret",
		&returns,
