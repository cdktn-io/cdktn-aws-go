...
type AwsLaunchConfig struct {
	...
	// Experimental.
	ScheduledSplitsConfig *AwsLaunch_ScheduledSplitsConfigProperty `field:"optional" json:"scheduledSplitsConfig" yaml:"scheduledSplitsConfig"`
	...
	// Experimental.
	Timeouts *AwsLaunch_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
