...
// Experimental.
type AwsBatchJobDefinition_ContainersProperty struct {
	...
	// Experimental.
	Resources *AwsBatchJobDefinition_EksPropertiesPodPropertiesContainersResourcesProperty `field:"optional" json:"resources" yaml:"resources"`
	...
	// Experimental.
	SecurityContext *AwsBatchJobDefinition_EksPropertiesPodPropertiesContainersSecurityContextProperty `field:"optional" json:"securityContext" yaml:"securityContext"`
	// volume_mounts block.
	//
