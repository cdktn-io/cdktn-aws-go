...
type DataAwsBatchSchedulingPolicy interface {
	...
	// Experimental.
	FairSharePolicy() DataAwsBatchSchedulingPolicy_FairSharePolicyPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsBatchSchedulingPolicy) FairSharePolicy() DataAwsBatchSchedulingPolicy_FairSharePolicyPropertyList {
	var returns DataAwsBatchSchedulingPolicy_FairSharePolicyPropertyList
	_jsii_.Get(
		j,
		"fairSharePolicy",
		&returns,
...
func NewDataAwsBatchSchedulingPolicy(scope constructs.Construct, id *string, config *DataAwsBatchSchedulingPolicyConfig) DataAwsBatchSchedulingPolicy {
	...
	_jsii_.Create(
		"@cdktn/aws-batch.DataAwsBatchSchedulingPolicy",
