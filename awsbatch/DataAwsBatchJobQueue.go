...
type DataAwsBatchJobQueue interface {
	...
	// Experimental.
	ComputeEnvironmentOrder() DataAwsBatchJobQueue_ComputeEnvironmentOrderPropertyList
	// Experimental.
	...
	IdInput() *string
	// Experimental.
	JobStateTimeLimitAction() DataAwsBatchJobQueue_JobStateTimeLimitActionPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsBatchJobQueue) ComputeEnvironmentOrder() DataAwsBatchJobQueue_ComputeEnvironmentOrderPropertyList {
	var returns DataAwsBatchJobQueue_ComputeEnvironmentOrderPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsBatchJobQueue) JobStateTimeLimitAction() DataAwsBatchJobQueue_JobStateTimeLimitActionPropertyList {
	var returns DataAwsBatchJobQueue_JobStateTimeLimitActionPropertyList
	_jsii_.Get(
		j,
...
func NewDataAwsBatchJobQueue(scope constructs.Construct, id *string, config *DataAwsBatchJobQueueConfig) DataAwsBatchJobQueue {
	...
	_jsii_.Create(
		"@cdktn/aws-batch.DataAwsBatchJobQueue",
