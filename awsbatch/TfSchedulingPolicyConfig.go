...
// Experimental.
type TfSchedulingPolicyConfig struct {
	// Experimental.
	...
	// Experimental.
	FairSharePolicy *TfSchedulingPolicy_FairSharePolicyProperty `field:"optional" json:"fairSharePolicy" yaml:"fairSharePolicy"`
