...
// Experimental.
type TfJobDefinition_InitContainersProperty struct {
	...
	// Experimental.
	Resources *TfJobDefinition_EksPropertiesPodPropertiesInitContainersResourcesProperty `field:"optional" json:"resources" yaml:"resources"`
	...
	// Experimental.
	SecurityContext *TfJobDefinition_EksPropertiesPodPropertiesInitContainersSecurityContextProperty `field:"optional" json:"securityContext" yaml:"securityContext"`
	// volume_mounts block.
	//
