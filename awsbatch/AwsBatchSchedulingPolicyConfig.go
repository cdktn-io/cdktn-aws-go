...
// Experimental.
type AwsBatchSchedulingPolicyConfig struct {
	// Experimental.
	...
	// Experimental.
	FairSharePolicy *AwsBatchSchedulingPolicy_FairSharePolicyProperty `field:"optional" json:"fairSharePolicy" yaml:"fairSharePolicy"`
