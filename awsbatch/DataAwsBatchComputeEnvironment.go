...
type DataAwsBatchComputeEnvironment interface {
	...
	Type() *string
	// Experimental.
	UpdatePolicy() DataAwsBatchComputeEnvironment_UpdatePolicyPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsBatchComputeEnvironment) UpdatePolicy() DataAwsBatchComputeEnvironment_UpdatePolicyPropertyList {
	var returns DataAwsBatchComputeEnvironment_UpdatePolicyPropertyList
	_jsii_.Get(
		j,
		"updatePolicy",
		&returns,
...
func NewDataAwsBatchComputeEnvironment(scope constructs.Construct, id *string, config *DataAwsBatchComputeEnvironmentConfig) DataAwsBatchComputeEnvironment {
	...
	_jsii_.Create(
		"@cdktn/aws-batch.DataAwsBatchComputeEnvironment",
