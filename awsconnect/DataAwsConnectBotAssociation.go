...
type DataAwsConnectBotAssociation interface {
	...
	// Experimental.
	LexBot() DataAwsConnectBotAssociation_LexBotPropertyOutputReference
	// Experimental.
	LexBotInput() *DataAwsConnectBotAssociation_LexBotProperty
	// Experimental.
	...
	// Experimental.
	PutLexBot(value *DataAwsConnectBotAssociation_LexBotProperty)
...
func (j *jsiiProxy_DataAwsConnectBotAssociation) LexBot() DataAwsConnectBotAssociation_LexBotPropertyOutputReference {
	var returns DataAwsConnectBotAssociation_LexBotPropertyOutputReference
	_jsii_.Get(
		j,
		"lexBot",
		&returns,
...
func (j *jsiiProxy_DataAwsConnectBotAssociation) LexBotInput() *DataAwsConnectBotAssociation_LexBotProperty {
...
func (d *jsiiProxy_DataAwsConnectBotAssociation) PutLexBot(value *DataAwsConnectBotAssociation_LexBotProperty) {
