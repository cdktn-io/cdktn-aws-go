...
// Experimental.
type AwsConnectQuickConnectConfig struct {
	// Experimental.
	...
	// Experimental.
	QuickConnectConfig *AwsConnectQuickConnect_QuickConnectConfigProperty `field:"required" json:"quickConnectConfig" yaml:"quickConnectConfig"`
