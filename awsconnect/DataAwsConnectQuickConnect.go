...
type DataAwsConnectQuickConnect interface {
	...
	// Experimental.
	QuickConnectConfig() DataAwsConnectQuickConnect_QuickConnectConfigPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsConnectQuickConnect) QuickConnectConfig() DataAwsConnectQuickConnect_QuickConnectConfigPropertyList {
	var returns DataAwsConnectQuickConnect_QuickConnectConfigPropertyList
	_jsii_.Get(
		j,
		"quickConnectConfig",
		&returns,
