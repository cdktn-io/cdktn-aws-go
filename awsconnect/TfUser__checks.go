...
func (t *jsiiProxy_TfUser) validatePutIdentityInfoParameters(value *TfUser_IdentityInfoProperty) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (t *jsiiProxy_TfUser) validatePutPhoneConfigParameters(value *TfUser_PhoneConfigProperty) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (j *jsiiProxy_TfUser) validateSetDirectoryUserIdParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_TfUser) validateSetHierarchyGroupIdParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_TfUser) validateSetInstanceIdParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_TfUser) validateSetRoutingProfileIdParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_TfUser) validateSetSecurityProfileIdsParameters(val *[]*string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
