...
// Experimental.
type TfInstanceStorageConfigConfig struct {
	// Experimental.
	...
	// Experimental.
	StorageConfig *TfInstanceStorageConfig_StorageConfigProperty `field:"required" json:"storageConfig" yaml:"storageConfig"`
