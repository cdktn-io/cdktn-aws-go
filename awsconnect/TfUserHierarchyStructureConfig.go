...
// Experimental.
type TfUserHierarchyStructureConfig struct {
	// Experimental.
	...
	// Experimental.
	HierarchyStructure *TfUserHierarchyStructure_HierarchyStructureProperty `field:"required" json:"hierarchyStructure" yaml:"hierarchyStructure"`
