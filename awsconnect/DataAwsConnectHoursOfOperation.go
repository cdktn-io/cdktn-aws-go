...
type DataAwsConnectHoursOfOperation interface {
	...
	// Experimental.
	Config() DataAwsConnectHoursOfOperation_ConfigPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperation) Config() DataAwsConnectHoursOfOperation_ConfigPropertyList {
	var returns DataAwsConnectHoursOfOperation_ConfigPropertyList
	_jsii_.Get(
		j,
		"config",
		&returns,
