...
// Experimental.
type TfQuickConnectConfig struct {
	// Experimental.
	...
	// Experimental.
	QuickConnectConfig *TfQuickConnect_QuickConnectConfigProperty `field:"required" json:"quickConnectConfig" yaml:"quickConnectConfig"`
