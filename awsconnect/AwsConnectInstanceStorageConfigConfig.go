...
// Experimental.
type AwsConnectInstanceStorageConfigConfig struct {
	// Experimental.
	...
	// Experimental.
	StorageConfig *AwsConnectInstanceStorageConfig_StorageConfigProperty `field:"required" json:"storageConfig" yaml:"storageConfig"`
