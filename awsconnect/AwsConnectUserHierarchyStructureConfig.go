...
// Experimental.
type AwsConnectUserHierarchyStructureConfig struct {
	// Experimental.
	...
	// Experimental.
	HierarchyStructure *AwsConnectUserHierarchyStructure_HierarchyStructureProperty `field:"required" json:"hierarchyStructure" yaml:"hierarchyStructure"`
