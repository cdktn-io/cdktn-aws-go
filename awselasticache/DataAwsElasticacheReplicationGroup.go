...
type DataAwsElasticacheReplicationGroup interface {
	...
	// Experimental.
	LogDeliveryConfiguration() DataAwsElasticacheReplicationGroup_LogDeliveryConfigurationPropertyList
	// Experimental.
	...
	// Experimental.
	NodeGroupConfiguration() DataAwsElasticacheReplicationGroup_NodeGroupConfigurationPropertyList
	// Experimental.
	NodeType() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsElasticacheReplicationGroup) LogDeliveryConfiguration() DataAwsElasticacheReplicationGroup_LogDeliveryConfigurationPropertyList {
	var returns DataAwsElasticacheReplicationGroup_LogDeliveryConfigurationPropertyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsElasticacheReplicationGroup) NodeGroupConfiguration() DataAwsElasticacheReplicationGroup_NodeGroupConfigurationPropertyList {
	var returns DataAwsElasticacheReplicationGroup_NodeGroupConfigurationPropertyList
	_jsii_.Get(
		j,
