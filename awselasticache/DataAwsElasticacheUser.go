...
type DataAwsElasticacheUser interface {
	...
	// Experimental.
	AuthenticationMode() DataAwsElasticacheUser_AuthenticationModePropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsElasticacheUser) AuthenticationMode() DataAwsElasticacheUser_AuthenticationModePropertyList {
	var returns DataAwsElasticacheUser_AuthenticationModePropertyList
	_jsii_.Get(
		j,
		"authenticationMode",
		&returns,
