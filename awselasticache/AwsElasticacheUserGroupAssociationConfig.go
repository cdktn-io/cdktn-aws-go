...
// Experimental.
type AwsElasticacheUserGroupAssociationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsElasticacheUserGroupAssociation_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
