...
type DataAwsElasticacheCluster interface {
	...
	// Experimental.
	CacheNodes() DataAwsElasticacheCluster_CacheNodesPropertyList
	// Experimental.
	...
	// Experimental.
	LogDeliveryConfiguration() DataAwsElasticacheCluster_LogDeliveryConfigurationPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsElasticacheCluster) CacheNodes() DataAwsElasticacheCluster_CacheNodesPropertyList {
	var returns DataAwsElasticacheCluster_CacheNodesPropertyList
	_jsii_.Get(
		j,
		"cacheNodes",
		&returns,
...
func (j *jsiiProxy_DataAwsElasticacheCluster) LogDeliveryConfiguration() DataAwsElasticacheCluster_LogDeliveryConfigurationPropertyList {
	var returns DataAwsElasticacheCluster_LogDeliveryConfigurationPropertyList
	_jsii_.Get(
		j,
