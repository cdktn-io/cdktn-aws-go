...
func (t *jsiiProxy_TfUser) validatePutAuthenticationModeParameters(value *TfUser_AuthenticationModeProperty) error {
	return nil
}
...
func (j *jsiiProxy_TfUser) validateSetAccessStringParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_TfUser) validateSetEngineParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_TfUser) validateSetNoPasswordRequiredParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_TfUser) validateSetPasswordsParameters(val *[]*string) error {
	return nil
}

func (j *jsiiProxy_TfUser) validateSetPasswordsWoParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_TfUser) validateSetPasswordsWoVersionParameters(val *float64) error {
	return nil
}
...
func (j *jsiiProxy_TfUser) validateSetUserIdParameters(val *string) error {
	return nil
}
