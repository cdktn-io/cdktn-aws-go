...
// Experimental.
type AwsS3BucketMetadataConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	Timeouts *AwsS3BucketMetadataConfiguration_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
