...
// Experimental.
type TfBucketAnalyticsConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	Filter *TfBucketAnalyticsConfiguration_FilterProperty `field:"optional" json:"filter" yaml:"filter"`
	...
	// Experimental.
	StorageClassAnalysis *TfBucketAnalyticsConfiguration_StorageClassAnalysisProperty `field:"optional" json:"storageClassAnalysis" yaml:"storageClassAnalysis"`
}
