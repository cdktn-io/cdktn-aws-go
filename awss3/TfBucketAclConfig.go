...
type TfBucketAclConfig struct {
	...
	// Experimental.
	AccessControlPolicy *TfBucketAcl_AccessControlPolicyProperty `field:"optional" json:"accessControlPolicy" yaml:"accessControlPolicy"`
