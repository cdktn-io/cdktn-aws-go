...
type AwsS3BucketConfig struct {
	...
	// Experimental.
	Logging *AwsS3Bucket_LoggingProperty `field:"optional" json:"logging" yaml:"logging"`
	...
	// Experimental.
	ObjectLockConfiguration *AwsS3Bucket_ObjectLockConfigurationProperty `field:"optional" json:"objectLockConfiguration" yaml:"objectLockConfiguration"`
	...
	// Experimental.
	ReplicationConfiguration *AwsS3Bucket_ReplicationConfigurationProperty `field:"optional" json:"replicationConfiguration" yaml:"replicationConfiguration"`
	...
	// Experimental.
	ServerSideEncryptionConfiguration *AwsS3Bucket_ServerSideEncryptionConfigurationProperty `field:"optional" json:"serverSideEncryptionConfiguration" yaml:"serverSideEncryptionConfiguration"`
	...
	// Experimental.
	Timeouts *AwsS3Bucket_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
	// versioning block.
	//
	...
	// Experimental.
	Versioning *AwsS3Bucket_VersioningProperty `field:"optional" json:"versioning" yaml:"versioning"`
	// website block.
	//
	...
	// Experimental.
	Website *AwsS3Bucket_WebsiteProperty `field:"optional" json:"website" yaml:"website"`
}
