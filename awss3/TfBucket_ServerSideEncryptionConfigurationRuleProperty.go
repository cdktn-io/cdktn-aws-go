...
// Experimental.
type TfBucket_ServerSideEncryptionConfigurationRuleProperty struct {
	...
	// Experimental.
	ApplyServerSideEncryptionByDefault *TfBucket_ApplyServerSideEncryptionByDefaultProperty `field:"required" json:"applyServerSideEncryptionByDefault" yaml:"applyServerSideEncryptionByDefault"`
