...
// Experimental.
type TfBucket_LifecycleRuleProperty struct {
	...
	// Experimental.
	Expiration *TfBucket_ExpirationProperty `field:"optional" json:"expiration" yaml:"expiration"`
	...
	// Experimental.
	NoncurrentVersionExpiration *TfBucket_NoncurrentVersionExpirationProperty `field:"optional" json:"noncurrentVersionExpiration" yaml:"noncurrentVersionExpiration"`
