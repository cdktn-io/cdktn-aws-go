...
// Experimental.
type TfBucketInventoryConfig struct {
	// Experimental.
	...
	// Experimental.
	Destination *TfBucketInventory_DestinationProperty `field:"required" json:"destination" yaml:"destination"`
	...
	// Experimental.
	Schedule *TfBucketInventory_ScheduleProperty `field:"required" json:"schedule" yaml:"schedule"`
	...
	// Experimental.
	Filter *TfBucketInventory_FilterProperty `field:"optional" json:"filter" yaml:"filter"`
