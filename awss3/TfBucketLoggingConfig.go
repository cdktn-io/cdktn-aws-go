...
// Experimental.
type TfBucketLoggingConfig struct {
	// Experimental.
	...
	// Experimental.
	TargetObjectKeyFormat *TfBucketLogging_TargetObjectKeyFormatProperty `field:"optional" json:"targetObjectKeyFormat" yaml:"targetObjectKeyFormat"`
}
