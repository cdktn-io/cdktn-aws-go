...
// Experimental.
type AwsS3BucketAnalyticsConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	Filter *AwsS3BucketAnalyticsConfiguration_FilterProperty `field:"optional" json:"filter" yaml:"filter"`
	...
	// Experimental.
	StorageClassAnalysis *AwsS3BucketAnalyticsConfiguration_StorageClassAnalysisProperty `field:"optional" json:"storageClassAnalysis" yaml:"storageClassAnalysis"`
}
