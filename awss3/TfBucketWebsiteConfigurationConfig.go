...
// Experimental.
type TfBucketWebsiteConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	ErrorDocument *TfBucketWebsiteConfiguration_ErrorDocumentProperty `field:"optional" json:"errorDocument" yaml:"errorDocument"`
	...
	// Experimental.
	IndexDocument *TfBucketWebsiteConfiguration_IndexDocumentProperty `field:"optional" json:"indexDocument" yaml:"indexDocument"`
	...
	// Experimental.
	RedirectAllRequestsTo *TfBucketWebsiteConfiguration_RedirectAllRequestsToProperty `field:"optional" json:"redirectAllRequestsTo" yaml:"redirectAllRequestsTo"`
