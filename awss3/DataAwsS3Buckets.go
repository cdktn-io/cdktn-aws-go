...
type DataAwsS3Buckets interface {
	...
	// Experimental.
	Buckets() DataAwsS3Buckets_BucketsPropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsS3Buckets) Buckets() DataAwsS3Buckets_BucketsPropertyList {
	var returns DataAwsS3Buckets_BucketsPropertyList
	_jsii_.Get(
		j,
		"buckets",
		&returns,
