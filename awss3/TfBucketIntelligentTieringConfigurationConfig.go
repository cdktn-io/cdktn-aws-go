...
// Experimental.
type TfBucketIntelligentTieringConfigurationConfig struct {
	// Experimental.
	...
	// Experimental.
	Filter *TfBucketIntelligentTieringConfiguration_FilterProperty `field:"optional" json:"filter" yaml:"filter"`
