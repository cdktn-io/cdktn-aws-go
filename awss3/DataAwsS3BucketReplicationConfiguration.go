...
type DataAwsS3BucketReplicationConfiguration interface {
	...
	Role() *string
	// Experimental.
	Rule() DataAwsS3BucketReplicationConfiguration_RulePropertyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsS3BucketReplicationConfiguration) Rule() DataAwsS3BucketReplicationConfiguration_RulePropertyList {
	var returns DataAwsS3BucketReplicationConfiguration_RulePropertyList
	_jsii_.Get(
		j,
		"rule",
		&returns,
