...
// Experimental.
type TfJobTemplateConfig struct {
	// Experimental.
	...
	// Experimental.
	JobTemplateData *TfJobTemplate_JobTemplateDataProperty `field:"required" json:"jobTemplateData" yaml:"jobTemplateData"`
	...
	// Experimental.
	Timeouts *TfJobTemplate_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
