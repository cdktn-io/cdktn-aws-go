...
// Experimental.
type TfConnectorProfile_ConnectorProfileConfigConnectorProfileCredentialsMarketoProperty struct {
	...
	// Experimental.
	OauthRequest *TfConnectorProfile_ConnectorProfileConfigConnectorProfileCredentialsMarketoOauthRequestProperty `field:"optional" json:"oauthRequest" yaml:"oauthRequest"`
}
