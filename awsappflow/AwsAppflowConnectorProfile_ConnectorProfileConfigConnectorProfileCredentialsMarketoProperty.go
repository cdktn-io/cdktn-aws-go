...
// Experimental.
type AwsAppflowConnectorProfile_ConnectorProfileConfigConnectorProfileCredentialsMarketoProperty struct {
	...
	// Experimental.
	OauthRequest *AwsAppflowConnectorProfile_ConnectorProfileConfigConnectorProfileCredentialsMarketoOauthRequestProperty `field:"optional" json:"oauthRequest" yaml:"oauthRequest"`
}
