...
// Experimental.
type TfConnectorProfile_ConnectorProfileConfigProperty struct {
	...
	// Experimental.
	ConnectorProfileCredentials *TfConnectorProfile_ConnectorProfileCredentialsProperty `field:"required" json:"connectorProfileCredentials" yaml:"connectorProfileCredentials"`
	...
	// Experimental.
	ConnectorProfileProperties *TfConnectorProfile_ConnectorProfilePropertiesProperty `field:"required" json:"connectorProfileProperties" yaml:"connectorProfileProperties"`
}
