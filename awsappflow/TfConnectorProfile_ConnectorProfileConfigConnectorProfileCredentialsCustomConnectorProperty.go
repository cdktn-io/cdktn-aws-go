...
// Experimental.
type TfConnectorProfile_ConnectorProfileConfigConnectorProfileCredentialsCustomConnectorProperty struct {
	...
	// Experimental.
	ApiKey *TfConnectorProfile_ApiKeyProperty `field:"optional" json:"apiKey" yaml:"apiKey"`
	// basic block.
	//
	...
	// Experimental.
	Basic *TfConnectorProfile_BasicProperty `field:"optional" json:"basic" yaml:"basic"`
	// custom block.
	//
	...
	// Experimental.
	Custom *TfConnectorProfile_CustomProperty `field:"optional" json:"custom" yaml:"custom"`
	// oauth2 block.
	//
	...
	// Experimental.
	Oauth2 *TfConnectorProfile_Oauth2Property `field:"optional" json:"oauth2" yaml:"oauth2"`
}
