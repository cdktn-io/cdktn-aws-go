...
// Experimental.
type AwsAppflowFlow_UpsolverProperty struct {
	...
	// Experimental.
	S3OutputFormatConfig *AwsAppflowFlow_DestinationFlowConfigDestinationConnectorPropertiesUpsolverS3OutputFormatConfigProperty `field:"required" json:"s3OutputFormatConfig" yaml:"s3OutputFormatConfig"`
