...
// Experimental.
type AwsAppflowConnectorProfile_ConnectorProfileConfigConnectorProfileCredentialsSlackProperty struct {
	...
	// Experimental.
	OauthRequest *AwsAppflowConnectorProfile_ConnectorProfileConfigConnectorProfileCredentialsSlackOauthRequestProperty `field:"optional" json:"oauthRequest" yaml:"oauthRequest"`
}
