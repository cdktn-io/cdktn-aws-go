...
// Experimental.
type TfConnectorProfileConfig struct {
	// Experimental.
	...
	// Experimental.
	ConnectorProfileConfig *TfConnectorProfile_ConnectorProfileConfigProperty `field:"required" json:"connectorProfileConfig" yaml:"connectorProfileConfig"`
