...
// Experimental.
type TfConnectorProfile_OauthCredentialsProperty struct {
	...
	// Experimental.
	OauthRequest *TfConnectorProfile_ConnectorProfileConfigConnectorProfileCredentialsSapoDataOauthCredentialsOauthRequestProperty `field:"optional" json:"oauthRequest" yaml:"oauthRequest"`
