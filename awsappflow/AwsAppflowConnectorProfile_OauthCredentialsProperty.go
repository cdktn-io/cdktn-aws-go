...
// Experimental.
type AwsAppflowConnectorProfile_OauthCredentialsProperty struct {
	...
	// Experimental.
	OauthRequest *AwsAppflowConnectorProfile_ConnectorProfileConfigConnectorProfileCredentialsSapoDataOauthCredentialsOauthRequestProperty `field:"optional" json:"oauthRequest" yaml:"oauthRequest"`
