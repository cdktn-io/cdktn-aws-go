...
// Experimental.
type TfFlow_UpsolverProperty struct {
	...
	// Experimental.
	S3OutputFormatConfig *TfFlow_DestinationFlowConfigDestinationConnectorPropertiesUpsolverS3OutputFormatConfigProperty `field:"required" json:"s3OutputFormatConfig" yaml:"s3OutputFormatConfig"`
