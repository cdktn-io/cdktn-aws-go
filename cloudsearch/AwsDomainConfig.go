...
type AwsDomainConfig struct {
	...
	// Experimental.
	EndpointOptions *AwsDomain_EndpointOptionsProperty `field:"optional" json:"endpointOptions" yaml:"endpointOptions"`
	...
	// Experimental.
	ScalingParameters *AwsDomain_ScalingParametersProperty `field:"optional" json:"scalingParameters" yaml:"scalingParameters"`
	// timeouts block.
	//
