...
// Experimental.
type AwsElasticsearchDomainSamlOptionsConfig struct {
	// Experimental.
	...
	// Experimental.
	SamlOptions *AwsElasticsearchDomainSamlOptions_SamlOptionsProperty `field:"optional" json:"samlOptions" yaml:"samlOptions"`
	// timeouts block.
	//
	...
	// Experimental.
	Timeouts *AwsElasticsearchDomainSamlOptions_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
