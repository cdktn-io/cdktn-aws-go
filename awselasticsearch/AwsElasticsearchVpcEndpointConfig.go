...
// Experimental.
type AwsElasticsearchVpcEndpointConfig struct {
	// Experimental.
	...
	// Experimental.
	VpcOptions *AwsElasticsearchVpcEndpoint_VpcOptionsProperty `field:"required" json:"vpcOptions" yaml:"vpcOptions"`
	...
	// Experimental.
	Timeouts *AwsElasticsearchVpcEndpoint_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
