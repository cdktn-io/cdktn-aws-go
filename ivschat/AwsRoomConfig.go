...
type AwsRoomConfig struct {
	...
	// Experimental.
	MessageReviewHandler *AwsRoom_MessageReviewHandlerProperty `field:"optional" json:"messageReviewHandler" yaml:"messageReviewHandler"`
	...
	// Experimental.
	Timeouts *AwsRoom_TimeoutsProperty `field:"optional" json:"timeouts" yaml:"timeouts"`
}
