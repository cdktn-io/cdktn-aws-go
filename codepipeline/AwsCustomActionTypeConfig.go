...
// Experimental.
type AwsCustomActionTypeConfig struct {
	// Experimental.
	...
	// Experimental.
	InputArtifactDetails *AwsCustomActionType_InputArtifactDetailsProperty `field:"required" json:"inputArtifactDetails" yaml:"inputArtifactDetails"`
	...
	// Experimental.
	OutputArtifactDetails *AwsCustomActionType_OutputArtifactDetailsProperty `field:"required" json:"outputArtifactDetails" yaml:"outputArtifactDetails"`
	...
	// Experimental.
	Settings *AwsCustomActionType_SettingsProperty `field:"optional" json:"settings" yaml:"settings"`
