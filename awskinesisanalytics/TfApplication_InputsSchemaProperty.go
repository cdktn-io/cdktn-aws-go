...
// Experimental.
type TfApplication_InputsSchemaProperty struct {
	...
	// Experimental.
	RecordFormat *TfApplication_InputsSchemaRecordFormatProperty `field:"required" json:"recordFormat" yaml:"recordFormat"`
