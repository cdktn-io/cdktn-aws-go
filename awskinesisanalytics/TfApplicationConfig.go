...
type TfApplicationConfig struct {
	...
	// Experimental.
	CloudwatchLoggingOptions *TfApplication_CloudwatchLoggingOptionsProperty `field:"optional" json:"cloudwatchLoggingOptions" yaml:"cloudwatchLoggingOptions"`
	...
	// Experimental.
	Inputs *TfApplication_InputsProperty `field:"optional" json:"inputs" yaml:"inputs"`
	// outputs block.
	//
	...
	// Experimental.
	ReferenceDataSources *TfApplication_ReferenceDataSourcesProperty `field:"optional" json:"referenceDataSources" yaml:"referenceDataSources"`
