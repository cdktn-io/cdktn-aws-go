...
// Experimental.
type AwsKinesisAnalyticsApplication_ReferenceDataSourcesSchemaProperty struct {
	...
	// Experimental.
	RecordFormat *AwsKinesisAnalyticsApplication_ReferenceDataSourcesSchemaRecordFormatProperty `field:"required" json:"recordFormat" yaml:"recordFormat"`
