...
func (t *jsiiProxy_TfApplication) validatePutCloudwatchLoggingOptionsParameters(value *TfApplication_CloudwatchLoggingOptionsProperty) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (t *jsiiProxy_TfApplication) validatePutInputsParameters(value *TfApplication_InputsProperty) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (t *jsiiProxy_TfApplication) validatePutOutputsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*TfApplication_OutputsProperty:
		value := value.(*[]*TfApplication_OutputsProperty)
	...
	case []*TfApplication_OutputsProperty:
		value_ := value.([]*TfApplication_OutputsProperty)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*TfApplication_OutputsProperty; received %#v (a %T)", value, value)
		}
	}
...
func (t *jsiiProxy_TfApplication) validatePutReferenceDataSourcesParameters(value *TfApplication_ReferenceDataSourcesProperty) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (j *jsiiProxy_TfApplication) validateSetCodeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_TfApplication) validateSetStartApplicationParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
