...
// Experimental.
type AwsKinesisAnalyticsApplicationConfig struct {
	// Experimental.
	...
	// Experimental.
	CloudwatchLoggingOptions *AwsKinesisAnalyticsApplication_CloudwatchLoggingOptionsProperty `field:"optional" json:"cloudwatchLoggingOptions" yaml:"cloudwatchLoggingOptions"`
	...
	// Experimental.
	Inputs *AwsKinesisAnalyticsApplication_InputsProperty `field:"optional" json:"inputs" yaml:"inputs"`
	// outputs block.
	//
	...
	// Experimental.
	ReferenceDataSources *AwsKinesisAnalyticsApplication_ReferenceDataSourcesProperty `field:"optional" json:"referenceDataSources" yaml:"referenceDataSources"`
