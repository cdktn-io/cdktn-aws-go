...
type TfMonitorConfig struct {
	...
	// Experimental.
	HealthEventsConfig *TfMonitor_HealthEventsConfigProperty `field:"optional" json:"healthEventsConfig" yaml:"healthEventsConfig"`
	...
	// Experimental.
	InternetMeasurementsLogDelivery *TfMonitor_InternetMeasurementsLogDeliveryProperty `field:"optional" json:"internetMeasurementsLogDelivery" yaml:"internetMeasurementsLogDelivery"`
