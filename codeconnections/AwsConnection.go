...
func (j *jsiiProxy_AwsConnection) ConnectionStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"connectionStatus",
...
func (j *jsiiProxy_AwsConnection) HostArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostArn",
...
func (j *jsiiProxy_AwsConnection) HostArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostArnInput",
...
func (j *jsiiProxy_AwsConnection) ProviderType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"providerType",
...
func (j *jsiiProxy_AwsConnection) ProviderTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"providerTypeInput",
...
func (j *jsiiProxy_AwsConnection) TagsAll() cdktn.StringMap {
...
func NewAwsConnection(scope constructs.Construct, id *string, config *AwsConnectionConfig) AwsConnection {
	...
	_jsii_.Create(
		"@cdktn/aws-codeconnections.AwsConnection",
...
func (j *jsiiProxy_AwsConnection)SetHostArn(val *string) {
...
func (j *jsiiProxy_AwsConnection)SetProviderType(val *string) {
...
func (a *jsiiProxy_AwsConnection) ResetHostArn() {
	_jsii_.InvokeVoid(
		a,
		"resetHostArn",
		nil, // no parameters
...
func (a *jsiiProxy_AwsConnection) ResetProviderType() {
	_jsii_.InvokeVoid(
		a,
		"resetProviderType",
		nil, // no parameters
